...
>
    <div class="absolute -top-6 -right-6 opacity-[0.03] group-hover/package:opacity-[0.1] transition-opacity pointer-events-none">
    ...
    <div class="relative z-20 pointer-events-none">
        <div class="flex justify-between items-start mb-6">
            ...
            <a href="https://github.com/{{ $package->github }}" target="_blank"
    ...
    <div class="mt-auto relative z-10 flex items-center justify-between">
        ...
        <div class="flex gap-4 pointer-events-auto">
            <a
                href="https://packagist.org/packages/{{ $package->packagist }}"
                target="_blank"
