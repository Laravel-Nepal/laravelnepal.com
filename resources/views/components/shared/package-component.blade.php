...
>
    <div
        class="absolute -top-6 -right-6 opacity-[0.03] group-hover/package:opacity-[0.1] transition-opacity pointer-events-none">
    ...
    <div class="relative z-20 pointer-events-none">
        <div class="flex justify-between items-start mb-6">
            ...
            <a
                href="{{ $package->github_url }}" target="_blank"
        ...
        <div class="bg-black/40 rounded-xl p-3 border border-white/5 group/code mb-6 z-30 relative pointer-events-auto">
            ...
            >
                ...
                <svg x-show="copied" class="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor"
                     viewBox="0 0 24 24">
            ...
            <span x-show="copied" x-transition
                  class="absolute -top-8 right-0 text-[9px] font-bold bg-green-600 text-white px-2 py-1 rounded">COPIED!</span>
        </div>
    </div>
