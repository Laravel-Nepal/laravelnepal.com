...
var Kc = (s, t, e) => (t in s ? Xc(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : (s[t] = e));
...
function eh(s) {
    ...
    return (
        s[0] === "#" &&
            (t === 4 || t === 5
                ? (e = { r: 255 & (_t[s[1]] * 17), g: 255 & (_t[s[2]] * 17), b: 255 & (_t[s[3]] * 17), a: t === 5 ? _t[s[4]] * 17 : 255 })
                : (t === 7 || t === 9) &&
                  (e = {
                      r: (_t[s[1]] << 4) | _t[s[2]],
                      g: (_t[s[3]] << 4) | _t[s[4]],
...
var nh = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function Cr(s, t, e) {
...
function In(s) {
    let e = s.r / 255,
        ...
        c,
        h;
    return o !== r && ((h = o - r), (c = a > 0.5 ? h / (2 - o - r) : h / (o + r)), (l = ah(e, i, n, h, o)), (l = l * 60 + 0.5)), [l | 0, c || 0, a];
}
function Cn(s, t, e, i) {
...
function hh(s) {
    ...
    let n = Fr(+t[2]),
        o = +t[3] / 100,
        r = +t[4] / 100;
    return t[1] === "hwb" ? (i = lh(n, o, r)) : t[1] === "hsv" ? (i = ch(n, o, r)) : (i = Fn(n, o, r)), { r: i[0], g: i[1], b: i[2], a: e };
}
function uh(s, t) {
    var e = In(s);
    (e[0] = Fr(e[0] + t)), (e = Fn(e)), (s.r = e[0]), (s.g = e[1]), (s.b = e[2]);
}
function dh(s) {
    if (!s) return;
    let t = In(s),
        ...
        i = Or(t[1]),
        n = Or(t[2]);
    return s.a < 255 ? `hsla(${e}, ${i}%, ${n}%, ${Bt(s.a)})` : `hsl(${e}, ${i}%, ${n}%)`;
}
var Dr = {
        x: "dark",
        Z: "light",
...
function fh() {
    ...
    for (i = 0; i < t.length; i++) {
        for (r = a = t[i], n = 0; n < e.length; n++) (o = e[n]), (a = a.replace(o, Dr[o]));
        (o = parseInt(Er[r], 16)), (s[a] = [(o >> 16) & 255, (o >> 8) & 255, o & 255]);
    }
    return s;
}
var Ti;
...
var gh = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
function ph(s) {
    let t = gh.exec(s),
        e = 255,
        i,
...
function yh(s) {
    return s && (s.a < 255 ? `rgba(${s.r}, ${s.g}, ${s.b}, ${Bt(s.a)})` : `rgb(${s.r}, ${s.g}, ${s.b})`);
}
var Dn = (s) => (s <= 0.0031308 ? s * 12.92 : Math.pow(s, 1 / 2.4) * 1.055 - 0.055),
...
function Oi(s, t, e) {
    if (s) {
        let i = In(s);
        (i[t] = Math.max(0, Math.min(i[t] + i[t] * e, t === 0 ? 360 : 1))), (i = Fn(i)), (s.r = i[0]), (s.g = i[1]), (s.b = i[2]);
    }
}
function Ar(s, t) {
...
function Ir(s) {
    ...
    return (
        Array.isArray(s)
            ? s.length >= 3 && ((t = { r: s[0], g: s[1], b: s[2], a: 255 }), s.length > 3 && (t.a = se(s[3])))
...
var Ss = class s {
    constructor(t) {
        ...
        let e = typeof t,
            i;
        e === "object" ? (i = Ir(t)) : e === "string" && (i = eh(t) || mh(t) || xh(t)), (this._rgb = i), (this._valid = !!i);
    }
    get valid() {
        return this._valid;
    }
...
var Ur = (s, t) => (typeof s == "string" && s.endsWith("%") ? parseFloat(s) / 100 : +s / t),
    Nn = (s, t) => (typeof s == "string" && s.endsWith("%") ? (parseFloat(s) / 100) * t : +s);
function B(s, t, e) {
...
function V(s, t, e, i) {
    ...
    else if (L(s)) for (r = Object.keys(s), o = r.length, n = 0; n < o; n++) t.call(e, s[r[n]], r[n]);
}
function Ts(s, t) {
    let e, i, n, o;
    if (!s || !t || s.length !== t.length) return !1;
    for (e = 0, i = s.length; e < i; ++e) if (((n = s[e]), (o = t[e]), n.datasetIndex !== o.datasetIndex || n.index !== o.index)) return !1;
    return !0;
}
function Fi(s) {
...
function wh(s, t, e) {
    ...
    let i = t[s],
        n = e[s];
    L(i) && L(n) ? He(i, n) : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = Fi(n));
}
...
function Sh(s) {
    let t = s.split("."),
        e = [],
        i = "";
    for (let n of t) (i += n), i.endsWith("\\") ? (i = i.slice(0, -1) + ".") : (e.push(i), (i = ""));
    return e;
}
function kh(s) {
    let t = Sh(s);
...
function ta(s, t) {
    ...
    Object.defineProperty(s, "_chartjs", { configurable: !0, enumerable: !1, value: { listeners: [t] } }),
        Qr.forEach((e) => {
            let i = "_onData" + Ni(e),
                n = s[e];
...
var zi = (s) => (s === "start" ? "left" : s === "end" ? "right" : "center"),
    ...
    sa = (s, t, e, i) => (s === (i ? "left" : "right") ? e : s === "center" ? (t + e) / 2 : t);
function Yn(s, t, e) {
    let i = t.length,
        n = 0,
        o = i;
    if (s._sorted) {
        let { iScale: r, vScale: a, _parsed: l } = s,
            ...
            h = r.axis,
            { min: u, max: d, minDefined: f, maxDefined: m } = r.getUserBounds();
        if (f) {
            if (((n = Math.min(Lt(l, h, u).lo, e ? i : Lt(t, h, r.getPixelForValue(u)).lo)), c)) {
                let g = l
                    .slice(0, n + 1)
                    .reverse()
        ...
        if (m) {
            let g = Math.max(Lt(l, r.axis, d, !0).hi + 1, e ? 0 : Lt(t, h, r.getPixelForValue(d), !0).hi + 1);
            if (c) {
...
var Di = (s) => s === 0 || s === 1,
    Nr = (s, t, e) => -(Math.pow(2, 10 * (s -= 1)) * Math.sin(((s - t) * j) / e)),
    ...
    We = {
        ...
        easeInOutExpo: (s) => (Di(s) ? s : s < 0.5 ? 0.5 * Math.pow(2, 10 * (s * 2 - 1)) : 0.5 * (-Math.pow(2, -10 * (s * 2 - 1)) + 2)),
        ...
        easeInOutElastic(s) {
            return Di(s) ? s : s < 0.5 ? 0.5 * Nr(s * 2, 0.1125, 0.45) : 0.5 + 0.5 * Rr(s * 2 - 1, 0.1125, 0.45);
        },
        easeInBack(s) {
        ...
        easeInOutBounce: (s) => (s < 0.5 ? We.easeInBounce(s * 2) * 0.5 : We.easeOutBounce(s * 2 - 1) * 0.5 + 0.5),
    };
function qn(s) {
...
function Ih(s) {
    s.set("animation", { delay: void 0, duration: 1e3, easing: "easeOutQuart", fn: void 0, from: void 0, loop: void 0, to: void 0, type: void 0 }),
        s.describe("animation", { _fallback: !1, _indexable: !1, _scriptable: (t) => t !== "onProgress" && t !== "onComplete" && t !== "fn" }),
        s.set("animations", { colors: { type: "color", properties: Eh }, numbers: { type: "number", properties: Dh } }),
...
var ia = {
    ...
    logarithmic(s, t, e) {
        ...
        return [1, 2, 3, 5, 10, 15].includes(i) || t > 0.8 * e.length ? ia.numeric.call(this, s, t, e) : "";
    },
};
function Ah(s, t) {
...
function Lh(s) {
    s.set("scale", {
        ...
        s.describe("scale.ticks", { _scriptable: (t) => t !== "backdropPadding" && t !== "callback", _indexable: (t) => t !== "backdropPadding" });
}
...
function Ph(s) {
    return !s || A(s.size) || A(s.family) ? null : (s.style ? s.style + " " : "") + (s.weight ? s.weight + " " : "") + s.size + "px " + s.family;
}
...
function na(s, t, e, i) {
    ...
    for (l = 0; l < a; l++)
        ...
        else if ($(u)) for (c = 0, h = u.length; c < h; c++) (d = u[c]), d != null && !$(d) && (r = vs(s, n, o, r, d));
    s.restore();
    let f = o.length / 2;
    if (f > e.length) {
...
function Kn(s, t, e, i, n) {
    ...
    if (f && typeof f == "object" && ((o = f.toString()), o === "[object HTMLImageElement]" || o === "[object HTMLCanvasElement]")) {
        s.save(), s.translate(e, i), s.rotate(p), s.drawImage(f, -f.width / 2, -f.height / 2, f.width, f.height), s.restore();
        return;
    }
    if (!(isNaN(g) || g <= 0)) {
        switch ((s.beginPath(), f)) {
            default:
                n ? s.ellipse(e, i, n / 2, g, 0, 0, j) : s.arc(e, i, g, 0, j), s.closePath();
                break;
            case "triangle":
                (h = n ? n / 2 : g),
            ...
            case "rect":
                if (!m) {
                    (l = Math.SQRT1_2 * g), (h = n ? n / 2 : l), s.rect(e - h, i - l, 2 * h, 2 * l);
                    break;
                }
                p += be;
            case "rectRot":
            ...
            case "star":
                ...
                break;
            case "line":
                (r = n ? n / 2 : Math.cos(p) * g), (a = Math.sin(p) * g), s.moveTo(e - r, i - a), s.lineTo(e + r, i + a);
                break;
            case "dash":
                s.moveTo(e, i), s.lineTo(e + Math.cos(p) * (n ? n / 2 : g), i + Math.sin(p) * g);
                break;
            case !1:
                s.closePath();
                break;
...
function Q(s, t) {
    ...
    i && !("" + i).match(Vh) && (console.warn('Invalid font style specified: "' + i + '"'), (i = void 0));
    let n = {
...
function Qn(s, t = { scriptable: !0, indexable: !0 }) {
    ...
    return { allKeys: n, scriptable: e, indexable: i, isScriptable: $t(e) ? e : () => e, isIndexable: $t(i) ? i : () => i };
}
var $h = (s, t) => (s ? s + Ni(t) : t),
    to = (s, t) => L(t) && s !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function la(s, t, e) {
...
function eo(s, t, e, i) {
    ...
    return l === null || (typeof o < "u" && o !== e && ((l = zr(a, r, o, l, i)), l === null)) ? !1 : $i(Array.from(a), [""], n, o, () => Gh(t, e, i));
}
...
function Xh(s, t, e, i) {
    let n;
    for (let o of t) if (((n = ha($h(o, s), e)), typeof n < "u")) return to(s, n) ? eo(e, i, s, n) : n;
}
function ha(s, t) {
    for (let e of t) {
        if (!e) continue;
...
function so(s, t, e, i) {
    let { iScale: n } = s,
        ...
        c,
        h;
    for (a = 0, l = i; a < l; ++a) (c = a + e), (h = t[c]), (r[a] = { r: n.parse(Ut(h, o), c) });
    return r;
}
...
function Qh(s, t, e, i) {
    ...
    let u = i * c,
        d = i * h;
    return { previous: { x: o.x - u * (r.x - n.x), y: o.y - u * (r.y - n.y) }, next: { x: o.x + d * (r.x - n.x), y: o.y + d * (r.y - n.y) } };
}
function tu(s, t, e) {
    let i = s.length,
        n,
...
function iu(s, t) {
    ...
    for (e = 0, i = s.length; e < i; ++e)
        (r = o),
            ...
            o &&
                ((n = s[e]),
                r && ((n.cp1x = Ei(n.cp1x, t.left, t.right)), (n.cp1y = Ei(n.cp1y, t.top, t.bottom))),
                a && ((n.cp2x = Ei(n.cp2x, t.left, t.right)), (n.cp2y = Ei(n.cp2y, t.top, t.bottom))));
}
function da(s, t, e, i, n) {
    let o, r, a, l;
    if ((t.spanGaps && (s = s.filter((c) => !c.skip)), t.cubicInterpolationMode === "monotone")) su(s, n);
    else {
        let c = i ? s[s.length - 1] : s[0];
        for (o = 0, r = s.length; o < r; ++o)
            (a = s[o]),
                (l = Qh(c, a, s[Math.min(o + 1, r - (i ? 0 : 1)) % r], t.tension)),
                (a.cp1x = l.previous.x),
                (a.cp1y = l.previous.y),
                (a.cp2x = l.next.x),
                (a.cp2y = l.next.y),
...
function le(s, t) {
    ...
    return (
        ...
        { x: Math.round((((l - u) / f) * e.width) / i), y: Math.round((((c - d) / m) * e.height) / i) }
    );
}
function lu(s, t, e) {
    let i, n;
...
function fa(s, t, e, i) {
    ...
    return (
        ...
        c && !h && (h = Ii(c / 2)),
        (t !== void 0 || e !== void 0) && i && l.height && h > l.height && ((h = l.height), (c = Ii(Math.floor(h * i)))),
        { width: c, height: h }
    );
}
function io(s, t, e) {
    ...
    let r = s.canvas;
    return (
        r.style && (e || (!r.style.height && !r.style.width)) && ((r.style.height = `${s.height}px`), (r.style.width = `${s.width}px`)),
        s.currentDevicePixelRatio !== i || r.height !== n || r.width !== o
            ? ((s.currentDevicePixelRatio = i), (r.height = n), (r.width = o), s.ctx.setTransform(i, 0, 0, i, 0, 0), !0)
            : !1
    );
}
var ma = (function () {
    ...
    try {
        ...
        ji() && (window.addEventListener("test", null, t), window.removeEventListener("test", null, t));
    } catch {}
    return s;
})();
function no(s, t) {
...
function ga(s, t, e, i) {
    return { x: s.x + e * (t.x - s.x), y: i === "middle" ? (e < 0.5 ? s.y : t.y) : i === "after" ? (e < 1 ? s.y : t.y) : e > 0 ? t.y : s.y };
}
function pa(s, t, e, i) {
...
function ya(s) {
    return s === "angle" ? { between: je, compare: Oh, normalize: ot } : { between: Rt, compare: (t, e) => t - e, normalize: (t) => t };
}
        ...
        (b = t[v % r]),
            !b.skip &&
                ...
                y !== _ &&
                    ...
                    p !== null && M() && (m.push(Hr({ start: p, end: v, loop: d, count: r, style: f })), (p = null)),
                    (O = v),
                    (_ = y)));
    return p !== null && m.push(Hr({ start: p, end: u, loop: d, count: r, style: f })), m;
}
function lo(s, t) {
    let e = [],
        i = s.segments;
...
function fu(s, t, e, i) {
    ...
    for (l = t + 1; l <= e; ++l) {
        let c = s[l % n];
        c.skip || c.stop
            ? a.skip || ((i = !1), o.push({ start: t % n, end: (l - 1) % n, loop: i }), (t = r = c.stop ? l : null))
            : ((r = l), a.skip && (t = l)),
            (a = c);
    }
...
function mu(s, t, e, i) {
    ...
    for (let m of t) {
        ...
        for (d = u + 1; d <= m.end; d++) {
            let y = e[d % l];
            (p = $r(i.setContext(Yt(n, { type: "segment", p0: g, p1: y, p0DataIndex: (d - 1) % l, p1DataIndex: d % l, datasetIndex: r })))),
...
function pu(s, t) {
    ...
    return e && i ? { left: Ci(e, t, "left"), right: Ci(e, t, "right"), top: Ci(i, t, "top"), bottom: Ci(i, t, "bottom") } : t;
}
function co(s, t) {
    let e = t._clip;
...
var So = class {
        ...
        _notify(t, e, i, n) {
            let o = e.listeners[n],
                r = e.duration;
            o.forEach((a) => a({ chart: t, initial: e.initial, numSteps: r, currentStep: Math.min(i - e.start, r) }));
        }
        _refresh() {
            this._request ||
                ((this._running = !0),
        ...
        _update(t = Date.now()) {
            ...
            this._charts.forEach((i, n) => {
                ...
                for (; r >= 0; --r)
                    (l = o[r]),
                        l._active ? (l._total > i.duration && (i.duration = l._total), l.tick(t), (a = !0)) : ((o[r] = o[o.length - 1]), o.pop());
                a && (n.draw(), this._notify(n, i, t, "progress")),
                    o.length || ((i.running = !1), this._notify(n, i, t, "complete"), (i.initial = !1)),
                    (e += o.length);
            }),
                (this._lastDate = t),
                e === 0 && (this._running = !1);
...
function wu(s) {
    let t, e, i, n;
    return (
        L(s) ? ((t = s.top), (e = s.right), (i = s.bottom), (n = s.left)) : (t = e = i = n = s),
...
function wa(s, t, e, i = {}) {
    ...
    for (r = 0, a = n.length; r < a; ++r) {
        ...
        (c = s.values[l]), Z(c) && (o || t === 0 || Ot(t) === Ot(c)) && (t += c);
    }
    return !h && !i.all ? 0 : t;
}
function Su(s, t) {
    let { iScale: e, vScale: i } = t,
        ...
        c,
        h;
    for (l = 0, c = r.length; l < c; ++l) (h = r[l]), (a[l] = { [n]: h, [o]: s[h] });
    return a;
}
function ho(s, t) {
...
function ka(s, t) {
    ...
    for (let f = 0; f < u; ++f) {
        ...
        (d = y[c] = vu(n, h, g)), (d[a] = p), (d._top = Sa(d, r, !0, i.type)), (d._bottom = Sa(d, r, !1, i.type));
...
function Tu(s, t) {
    return Yt(s, { active: !1, dataset: void 0, datasetIndex: t, index: t, mode: "default", type: "dataset" });
}
function Ou(s, t, e) {
    return Yt(s, { active: !1, dataIndex: t, parsed: void 0, raw: void 0, element: e, index: t, mode: "default", type: "data" });
}
function Is(s, t) {
...
var fo = (s) => s === "reset" || s === "none",
    ...
    Du = (s, t, e) => s && !t.hidden && t._stacked && { keys: bl(e, !0), values: null },
    pt = class {
        constructor(t, e) {
            (this.chart = t),
                (this._ctx = t.ctx),
        ...
        buildOrUpdateElements(t) {
            ...
            (e._stacked = ho(e.vScale, e)),
                ...
                (n || o !== e._stacked) && (ka(this, e._parsed), (e._stacked = ho(e.vScale, e)));
        }
        configure() {
        ...
        parsePrimitiveData(t, e, i, n) {
            let { iScale: o, vScale: r } = t,
                ...
                f,
                m;
            for (d = 0, f = n; d < f; ++d) (m = d + i), (u[d] = { [a]: h || o.parse(c[m], m), [l]: r.parse(e[m], m) });
            return u;
        }
        parseArrayData(t, e, i, n) {
            let { xScale: o, yScale: r } = t,
                ...
                h,
                u;
            for (l = 0, c = n; l < c; ++l) (h = l + i), (u = e[h]), (a[l] = { x: o.parse(u[0], h), y: r.parse(u[1], h) });
            return a;
        }
        parseObjectData(t, e, i, n) {
            let { xScale: o, yScale: r } = t,
                ...
                d,
                f;
            for (h = 0, u = n; h < u; ++h) (d = h + i), (f = e[d]), (c[h] = { x: o.parse(Ut(f, a), d), y: r.parse(Ut(f, l), d) });
            return c;
        }
        getParsed(t) {
        ...
        applyStack(t, e, i) {
            let n = this.chart,
                o = this._cachedMeta,
                r = e[t.axis],
                a = { keys: bl(n, !0), values: e._stacks[t.axis]._visualValues };
        ...
        updateRangeFromParsed(t, e, i, n) {
            ...
            n && a && ((n.values = a), (r = wa(n, o, this._cachedMeta.index))), (t.min = Math.min(t.min, r)), (t.max = Math.max(t.max, r));
        }
        getMinMax(t, e) {
        ...
        getAllParsedValues(t) {
            let e = this._cachedMeta._parsed,
                ...
                o,
                r;
            for (n = 0, o = e.length; n < o; ++n) (r = e[n][t.axis]), Z(r) && i.push(r);
            return i;
        }
        getMaxOverflow() {
            return !1;
        ...
        _update(t) {
            let e = this._cachedMeta;
            this.update(t || "default"), (e._clip = wu(I(this.options.clip, _u(e.xScale, e.yScale, this.getMaxOverflow()))));
        }
        update(t) {}
        draw() {
            let t = this._ctx,
        ...
        getContext(t, e, i) {
            ...
            if (t >= 0 && t < this._cachedMeta.data.length) {
                ...
                (o = this.$context || (this.$context = Tu(this.chart.getContext(), this.index))),
                    (o.dataset = n),
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return g.$shared && ((g.$shared = l), (o[r] = Object.freeze(Ma(g, l)))), g;
        }
        ...
        updateElement(t, e, i, n) {
            fo(n) ? Object.assign(t, i) : this._resolveAnimations(e, n).update(t, i);
        }
...
S(pt, "defaults", {}), S(pt, "datasetElementType", null), S(pt, "dataElementType", null);
function Eu(s, t) {
    if (!s._cache.$bar) {
        let e = s.getMatchingVisibleMetas(t),
            i = [];
        for (let n = 0, o = e.length; n < o; n++) i = i.concat(e[n].controller.getAllParsedValues(s));
...
function Iu(s) {
    let t = s.iScale,
        ...
        a,
        l = () => {
            r === 32767 || r === -32768 || (Be(a) && (i = Math.min(i, Math.abs(r - a) || i)), (a = r));
        };
...
function Cu(s, t, e, i) {
    let n = e.barThickness,
        ...
        r;
    return (
        A(n) ? ((o = t.min * e.categoryPercentage), (r = e.barPercentage)) : ((o = n * i), (r = 1)),
...
function va(s, t, e, i) {
    let n = s.iScale,
        ...
        u,
        d;
    for (c = e, h = e + i; c < h; ++c) (d = t[c]), (u = {}), (u[n.axis] = a || n.parse(r[c], c)), l.push(xl(d, u, o, c));
    return l;
}
function mo(s) {
...
function Lu(s, t, e) {
    return s !== 0 ? Ot(s) : (t.isHorizontal() ? 1 : -1) * (t.min >= e ? 1 : -1);
}
function Pu(s) {
    let t, e, i, n, o;
    return (
        s.horizontal ? ((t = s.base > s.x), (e = "left"), (i = "right")) : ((t = s.base < s.y), (e = "bottom"), (i = "top")),
...
function Nu(s, t, e, i) {
    ...
    n === "middle" &&
        e &&
        ((s.enableBorderRadius = !0), (e._top || 0) === i ? (n = c) : (e._bottom || 0) === i ? (n = h) : ((o[Ta(h, r, a, l)] = !0), (n = c))),
        (o[Ta(n, r, a, l)] = !0),
        (s.borderSkipped = o);
}
function Ta(s, t, e, i) {
...
var Ge = class extends pt {
    ...
    parseObjectData(t, e, i, n) {
        let { iScale: o, vScale: r } = t,
            ...
            m,
            g;
        for (d = i, f = i + n; d < f; ++d) (g = e[d]), (m = {}), (m[o.axis] = o.parse(Ut(g, c), d)), u.push(xl(Ut(g, h), m, r, d));
        return u;
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    getLabelAndValue(t) {
        let e = this._cachedMeta,
            ...
            o = this.getParsed(t),
            r = o._custom,
            a = mo(r) ? "[" + r.start + ", " + r.end + "]" : "" + n.getLabelForValue(o[n.axis]);
    ...
    updateElements(t, e, i, n) {
        ...
        for (let f = e; f < e + i; f++) {
            let m = this.getParsed(f),
                g = o || A(m[a.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(f),
                p = this._calculateBarIndexPixels(f, h),
                y = (m._stacks || {})[a.axis],
                b = {
                    horizontal: c,
                    base: g.base,
                    enableBorderRadius: !y || mo(m._custom) || r === y._top || r === y._bottom,
                    x: c ? g.head : p.center,
                    y: c ? p.center : g.head,
            ...
            Nu(b, _, y, r), Wu(b, _, h.ratio), this.updateElement(t[f], f, b, n);
        }
    }
    _getStacks(t, e) {
    ...
    _getAxis() {
        ...
        for (let i of this.chart.data.datasets) t[I(this.chart.options.indexAxis === "x" ? i.xAxisID : i.yAxisID, e)] = !0;
        return Object.keys(t);
    }
    ...
    _getRuler() {
        let t = this.options,
            ...
            o,
            r;
        for (o = 0, r = e.data.length; o < r; ++o) n.push(i.getPixelForValue(this.getParsed(o)[i.axis], o));
    ...
    _calculateBarValuePixels(t) {
        let {
            ...
            g;
        f !== u && ((d = f - u), (f = u)),
            h && ((u = c.barStart), (f = c.barEnd - c.barStart), u !== 0 && Ot(u) !== Ot(c.barEnd) && (d = 0), (d += u));
        let p = !A(o) && !h ? o : d,
            y = e.getPixelForValue(p);
        if ((this.chart.getDataVisibility(t) ? (m = e.getPixelForValue(d + f)) : (m = y), (g = m - y), Math.abs(g) < r)) {
            ...
            (y = Math.max(Math.min(y, x), w)),
                (m = y + g),
                i && !h && (l._stacks[e.axis]._visualValues[n] = e.getValueForPixel(m) - e.getValueForPixel(y));
        }
    ...
    _calculateBarIndexPixels(t, e) {
        ...
        if (e.grouped) {
            let h = o ? this._getStackCount(t) : e.stackCount,
                u = n.barThickness === "flex" ? Fu(t, e, n, h * c) : Cu(t, e, n, h * c),
                d = this.chart.options.indexAxis === "x" ? this.getDataset().xAxisID : this.getDataset().yAxisID,
                f = this._getAxis().indexOf(I(d, this.getFirstScaleIdForIndexAxis())),
    ...
    draw() {
        let t = this._cachedMeta,
            ...
            n = i.length,
            o = 0;
        for (; o < n; ++o) this.getParsed(o)[e.axis] !== null && !i[o].hidden && i[o].draw(this._ctx);
    }
};
S(Ge, "id", "bar"),
    S(Ge, "defaults", {
    ...
    S(Ge, "overrides", { scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
var Xe = class extends pt {
    ...
    updateElements(t, e, i, n) {
        ...
        for (let d = e; d < e + i; d++) {
            ...
            (g.skip = isNaN(p) || isNaN(y)),
                c && ((g.options = l || this.resolveDataElementOptions(d, f.active ? "active" : n)), o && (g.options.radius = 0)),
    ...
    resolveDataElementOptions(t, e) {
        ...
        let o = n.radius;
        return e !== "active" && (n.radius = 0), (n.radius += I(i && i._custom, o)), n;
    }
};
S(Xe, "id", "bubble"),
    S(Xe, "defaults", {
    ...
    S(Xe, "overrides", { scales: { x: { type: "linear" }, y: { type: "linear" } } });
function zu(s, t, e) {
    let i = 1,
        n = 1,
        o = 0,
    ...
    if (t < j) {
        let a = s,
            ...
            u = Math.cos(l),
            d = Math.sin(l),
            f = (_, w, x) => (je(_, a, l, !0) ? 1 : Math.max(w, w * e, x, x * e)),
            m = (_, w, x) => (je(_, a, l, !0) ? -1 : Math.min(w, w * e, x, x * e)),
            g = f(0, c, u),
            p = f(X, h, d),
            y = m(N, c, u),
            b = m(N + X, h, d);
        (i = (g - y) / 2), (n = (p - b) / 2), (o = -(g + y) / 2), (r = -(p + b) / 2);
    }
...
var Gt = class extends pt {
    ...
    _circumference(t, e) {
        ...
        return (e && i.animation.animateRotate) || !this.chart.getDataVisibility(t) || n._parsed[t] === null || n.data[t].hidden
            ? 0
    ...
    updateElements(t, e, i, n) {
        ...
        for (b = e; b < e + i; ++b) {
            let _ = this._circumference(b, o),
                w = t[b],
                x = { x: h + this.offsetX, y: u + this.offsetY, startAngle: y, endAngle: y + _, circumference: _, outerRadius: m, innerRadius: f };
            p && (x.options = g || this.resolveDataElementOptions(b, w.active ? "active" : n)), (y += _), this.updateElement(w, b, x, n);
        }
    }
    calculateTotal() {
        let t = this._cachedMeta,
    ...
    updateElements(t, e, i, n) {
        ...
        for (let x = 0; x < _; ++x) {
            ...
            let v = this.getParsed(x),
                ...
                C = (M[f] = o || O ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, v, l) : v[f], x));
            (M.skip = isNaN(E) || isNaN(C) || O),
                (M.stop = x > 0 && Math.abs(v[d] - w[d]) > p),
                g && ((M.parsed = v), (M.raw = c.data[x])),
                u && (M.options = h || this.resolveDataElementOptions(x, k.active ? "active" : n)),
...
S(Ke, "id", "line"),
    S(Ke, "defaults", { datasetElementType: "line", dataElementType: "point", showLine: !0, spanGaps: !1 }),
    S(Ke, "overrides", { scales: { _index_: { type: "category" }, _value_: { type: "linear" } } });
var Oe = class extends pt {
    ...
    updateElements(t, e, i, n) {
        ...
        for (m = e; m < e + i; m++) {
            let p = t[m],
                ...
                _ = r.getDataVisibility(m) ? c.getDistanceFromCenterForValue(this.getParsed(m).r) : 0;
            (f = b), o && (l.animateScale && (_ = 0), l.animateRotate && (y = b = d));
            let w = {
                x: h,
                y: u,
                innerRadius: 0,
    ...
    _computeAngle(t, e, i) {
        return this.chart.getDataVisibility(t) ? wt(this.resolveDataElementOptions(t, e).angle || i) : 0;
    }
};
S(Oe, "id", "polarArea"),
    S(Oe, "defaults", {
...
S(Ps, "id", "pie"), S(Ps, "defaults", { cutout: 0, rotation: 0, circumference: 360, radius: "100%" });
...
S(Je, "id", "radar"),
    S(Je, "defaults", { datasetElementType: "line", dataElementType: "point", indexAxis: "r", showLine: !0, elements: { line: { fill: "start" } } }),
    S(Je, "overrides", { aspectRatio: 1, scales: { r: { type: "radialLinear" } } });
var Qe = class extends pt {
    ...
    update(t) {
        ...
        if (((this._drawStart = o), (this._drawCount = r), Zn(e) && ((o = 0), (r = i.length)), this.options.showLine)) {
    ...
    updateElements(t, e, i, n) {
        ...
        for (let w = e; w < e + i; ++w) {
            let x = t[w],
                ...
                E = (M[m] = o || v ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, k, l) : k[m], w));
            (M.skip = isNaN(O) || isNaN(E) || v),
                (M.stop = w > 0 && Math.abs(k[f] - _[f]) > y),
                p && ((M.parsed = k), (M.raw = c.data[w])),
                d && (M.options = u || this.resolveDataElementOptions(w, x.active ? "active" : n)),
...
S(Qe, "id", "scatter"),
    S(Qe, "defaults", { datasetElementType: !1, dataElementType: "point", showLine: !1, fill: !1 }),
    S(Qe, "overrides", { interaction: { mode: "point" }, scales: { x: { type: "linear" }, y: { type: "linear" } } });
    ...
    return (
        (!n && !s.isPointInArea(t)) ||
            Ys(
                ...
                t,
                function (a, l, c) {
                    (!n && !Pt(a, s.chartArea, 0)) || (a.inRange(t.x, t.y, i) && o.push({ element: a, datasetIndex: l, index: c }));
                },
                !0,
            ),
        o
...
function ju(s, t, e, i, n, o) {
    ...
    function c(h, u, d) {
        ...
        let p = a(t, m);
        p < l ? ((r = [{ element: h, datasetIndex: u, index: d }]), (l = p)) : p === l && r.push({ element: h, datasetIndex: u, index: d });
    }
    return Ys(s, e, t, c), r;
}
function po(s, t, e, i, n, o) {
    return !o && !s.isPointInArea(t) ? [] : e === "r" && !i ? $u(s, t, e, n) : ju(s, t, e, i, n, o);
}
function Da(s, t, e, i, n) {
    let o = [],
...
function Ns(s, t, e, i) {
    ...
    for (o = 0, r = s.length, c = 0; o < r; ++o) {
        (a = s[o]), (l = a.box), l.update(a.width || t.w, a.height || t.h, Ju(a.horizontal, t));
    ...
    for (let a of s) {
        ...
        if (a.horizontal) {
            ...
            Be(c.start) && (r = c.start),
                l.fullSize ? Zi(l, n.left, r, e.outerWidth - n.right - n.left, d) : Zi(l, t.left + c.placed, r, u, d),
                (c.start = r),
                (c.placed += u),
                (r = l.bottom);
        } else {
            ...
            Be(c.start) && (o = c.start),
                l.fullSize ? Zi(l, o, n.top, d, e.outerHeight - n.bottom - n.top) : Zi(l, o, t.top + c.placed, d, u),
                (c.start = o),
                (c.placed += u),
                (o = l.right);
        }
...
var ct = {
        ...
        update(s, t, e, i) {
            ...
            Ns(a.fullSize, f, u, m),
                ...
                (s.chartArea = { left: f.left, top: f.top, right: f.left + f.w, bottom: f.top + f.h, height: f.h, width: f.w }),
                V(a.chartArea, (g) => {
                    let p = g.box;
                    Object.assign(p, s.chartArea), p.update(f.w, f.h, { left: 0, top: 0, right: 0, bottom: 0 });
                });
        },
    },
    sn = class {
...
function td(s, t) {
    ...
    if (
        ((s[Qi] = { initial: { height: i, width: n, style: { display: e.display, height: e.height, width: e.width } } }),
...
function nd(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((o) => {
            let r = !1;
            for (let a of o) (r = r || nn(a.addedNodes, i)), (r = r && !nn(a.removedNodes, i));
            r && e();
        });
...
function od(s, t, e) {
    let i = s.canvas,
        n = new MutationObserver((o) => {
            let r = !1;
            for (let a of o) (r = r || nn(a.removedNodes, i)), (r = r && !nn(a.addedNodes, i));
            r && e();
        });
    return n.observe(document, { childList: !0, subtree: !0 }), n;
}
...
var To = class extends sn {
    ...
    removeEventListener(t, e) {
        let i = t.$proxies || (t.$proxies = {}),
            n = i[e];
        if (!n) return;
        (({ attach: yo, detach: yo, resize: yo })[e] || sd)(t, e, n), (i[e] = void 0);
    }
    getDevicePixelRatio() {
...
function hd(s) {
    return !ji() || (typeof OffscreenCanvas < "u" && s instanceof OffscreenCanvas) ? vo : To;
}
var yt = class {
    constructor() {
        S(this, "x");
...
function ud(s, t) {
    ...
    if (r > 0) {
        ...
        for (qi(t, c, h, A(f) ? 0 : a - f, a), u = 0, d = r - 1; u < d; u++) qi(t, c, h, o[u], o[u + 1]);
...
function qi(s, t, e, i, n) {
    let o = I(i, 0),
        ...
        c,
        h;
    for (e = Math.ceil(e), n && ((l = n - i), (e = l / Math.floor(l / e))), h = o; h < 0; ) a++, (h = Math.round(o + a * e));
    for (c = Math.max(o, 0); c < r; c++) c === h && (t.push(s[c]), a++, (h = Math.round(o + a * e)));
}
function pd(s) {
    let t = s.length,
        e,
...
function bd(s, t, e) {
    ...
    if (
        !(
            e &&
            (i === 1 ? (c = Math.max(l - o, r - l)) : t === 0 ? (c = (s.getPixelForTick(1) - l) / 2) : (c = (l - s.getPixelForTick(n - 1)) / 2),
            (l += n < t ? c : -c),
            l < o - a || l > r + a)
        )
    )
...
function kd(s, t, e, i) {
    ...
    if (s.isHorizontal()) {
        ...
        } else e === "center" ? (m = (c.bottom + c.top) / 2 + g - t) : (m = La(s, e, t));
        d = a - o;
    } else {
        if (L(e)) {
            let y = Object.keys(e)[0],
        ...
        } else e === "center" ? (f = (c.left + c.right) / 2 - p + t) : (f = La(s, e, t));
...
var Ee = class s extends yt {
        ...
        getMinMax(t) {
            ...
            return (e = o && e > i ? i : e), (i = n && e > i ? e : i), { min: ut(e, ut(i, e)), max: ut(i, ut(e, i)) };
        }
        getPadding() {
        ...
        update(t, e, i) {
            ...
            this._convertTicksToLabels(l ? Na(this.ticks, a) : this.ticks),
                ...
                r.display &&
                    ...
                    ((this.ticks = ud(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
        ...
        generateTickLabels(t) {
            let e = this.options.ticks,
                ...
                n,
                o;
            for (i = 0, n = t.length; i < n; i++) (o = t[i]), (o.label = B(e.callback, [o.value, i, t], this));
        }
        ...
        calculateLabelRotation() {
            ...
            (a = t.offset ? this.maxWidth / i : f / (i - 1)),
                u + 6 > a &&
                    ...
                    (l = this.maxHeight - As(t.grid) - e.padding - Ra(t.title, this.chart.options.font)),
                    (c = Math.sqrt(u * u + d * d)),
                    (r = Ri(Math.min(Math.asin(tt((h.highest.height + 6) / a, -1, 1)), Math.asin(tt(l / c, -1, 1)) - Math.asin(tt(d / c, -1, 1))))),
        ...
        fit() {
            ...
            if (r) {
                ...
                if (
                    (a ? ((t.width = this.maxWidth), (t.height = As(o) + l)) : ((t.height = this.maxHeight), (t.width = As(o) + l)),
        ...
        _calculatePadding(t, e, i, n) {
            ...
            if (this.isHorizontal()) {
                ...
                l
                    ...
                    (this.paddingRight = Math.max(((f - u + r) * this.width) / (this.width - u), 0));
            } else {
                let h = e.height / 2,
                    u = t.height / 2;
        ...
        _convertTicksToLabels(t) {
            ...
            let e, i;
            for (e = 0, i = t.length; e < i; e++) A(t[e].label) && (t.splice(e, 1), i--, e--);
        ...
        _getLabelSizes() {
            ...
            if (!t) {
                let e = this.options.ticks.sampleSize,
                    i = this.ticks;
                e < i.length && (i = Na(i, e)), (this._labelSizes = t = this._computeLabelSizes(i, i.length, this.options.ticks.maxTicksLimit));
            }
            return t;
        }
        _computeLabelSizes(t, e, i) {
            ...
            for (u = 0; u < e; u += l) {
                ...
                else if ($(m)) for (d = 0, f = m.length; d < f; ++d) (x = m[d]), !A(x) && !$(x) && ((_ = vs(n, y.data, y.gc, _, x)), (w += b));
            ...
            return { first: v(0), last: v(e - 1), widest: v(k), highest: v(M), widths: r, heights: a };
        }
        getLabelForValue(t) {
            return t;
        }
        ...
        getContext(t) {
            ...
            return this.$context || (this.$context = _d(this.chart.getContext(), this));
        }
        _tickSize() {
        ...
        _computeGridLineItems(t) {
            let e = this.axis,
                ...
                P,
                nt;
            if (r === "top") (b = y(this.bottom)), (M = this.bottom - d), (O = b - p), (C = y(t.top) + p), (nt = t.bottom);
            else if (r === "bottom") (b = y(this.top)), (C = t.top), (nt = y(t.bottom) - p), (M = b + p), (O = this.top + d);
            else if (r === "left") (b = y(this.right)), (k = this.right - d), (v = b - p), (E = y(t.left) + p), (P = t.right);
            else if (r === "right") (b = y(this.left)), (E = t.left), (P = y(t.right) - p), (k = b + p), (v = this.left + d);
            else if (e === "x") {
        ...
        _computeLabelItems(t) {
            let e = this.axis,
                ...
                P,
                nt = "middle";
            if (n === "top") (k = this.bottom - m), (M = this._getXAxisLabelAlignment());
            else if (n === "bottom") (k = this.top + m), (M = this._getXAxisLabelAlignment());
            else if (n === "left") {
            ...
            e === "y" && (l === "start" ? (nt = "top") : l === "end" && (nt = "bottom"));
            let gt = this._getLabelSizes();
            for (y = 0, b = a.length; y < b; ++y) {
                (_ = a[y]), (w = _.label);
                let H = o.setContext(this.getContext(y));
                (v = this.getPixelForTick(y) + o.labelOffset), (O = this._resolveTickFontOptions(y)), (E = O.lineHeight), (C = $(w) ? w.length : 1);
                let Y = C / 2,
                    J = H.color,
                ...
                r
                    ? ((x = v),
                      ...
                      u && (P *= -1),
                      g !== 0 && !H.showLabelBackdrop && (x += (E / 2) * Math.sin(g)))
                    : ((k = v), (P = ((1 - C) * E) / 2));
                let Mi;
                if (H.showLabelBackdrop) {
                    ...
                    Mi = { left: ye, top: _s, width: pe + Ne.width, height: xs + Ne.height, color: H.backdropColor };
                }
                p.push({
                    label: w,
                    font: O,
        ...
        _getYAxisLabelAlignment(t) {
            ...
            return (
                e === "left"
                    ? n
                        ? ((h = this.right + o),
                          i === "near" ? (c = "left") : i === "center" ? ((c = "center"), (h += l / 2)) : ((c = "right"), (h += l)))
                        : ((h = this.right - a),
                          i === "near" ? (c = "right") : i === "center" ? ((c = "center"), (h -= l / 2)) : ((c = "left"), (h = this.left)))
                    : e === "right"
                      ? n
                          ? ((h = this.left + o),
                            i === "near" ? (c = "right") : i === "center" ? ((c = "center"), (h -= l / 2)) : ((c = "left"), (h -= l)))
                          : ((h = this.left + a),
                            i === "near" ? (c = "left") : i === "center" ? ((c = "center"), (h += l / 2)) : ((c = "right"), (h = this.right)))
                      : (c = "right"),
                { textAlign: c, x: h }
            );
        }
        ...
        drawBorder() {
            ...
            let a = n.setContext(this.getContext(0)).lineWidth,
                ...
                d;
            this.isHorizontal()
                ? ((c = oe(t, this.left, r) - r / 2), (h = oe(t, this.right, a) + a / 2), (u = d = l))
                : ((u = oe(t, this.top, r) - r / 2), (d = oe(t, this.bottom, a) + a / 2), (c = h = l)),
                e.save(),
                (e.lineWidth = o.width),
        ...
        drawTitle() {
            ...
            let o = Q(i.font),
                ...
                a = i.align,
                l = o.lineHeight / 2;
            e === "bottom" || e === "center" || L(e) ? ((l += r.bottom), $(i.text) && (l += o.lineHeight * (i.text.length - 1))) : (l += r.top);
            let { titleX: c, titleY: h, maxWidth: u, rotation: d } = kd(this, l, e, a);
            re(t, i.text, 0, 0, o, { color: i.color, maxWidth: u, rotation: d, textAlign: Sd(a, e, n), textBaseline: "middle", translation: [c, h] });
        }
        draw(t) {
    ...
    ss = class {
        ...
        register(t) {
            ...
            return o in n || ((n[o] = t), Md(t, r, i), this.override && U.override(t.id, t.overrides)), r;
        }
        get(t) {
            return this.items[t];
        }
        unregister(t) {
            let e = this.items,
                i = t.id,
                n = this.scope;
            i in e && delete e[i], n && i in U[n] && (delete U[n][i], this.override && delete ne[i]);
        }
    };
function Md(s, t, e) {
    let i = ze(Object.create(null), [e ? U.get(e) : {}, U.get(t), s.defaults]);
    U.set(t, i), s.defaultRoutes && vd(t, s.defaultRoutes), s.descriptors && U.describe(t, s.descriptors);
}
function vd(s, t) {
...
function Ed(s, { plugins: t, localIds: e }, i, n) {
    ...
    for (let a of t) {
        let l = a.id,
            c = Dd(i[l], n);
        c !== null && o.push({ plugin: a, options: Id(s.config, { plugin: a, local: e[l] }, c, r) });
    }
    return o;
}
function Id(s, { plugin: t, local: e }, i, n) {
    ...
    return e && t.defaults && r.push(t.defaults), s.createResolver(r, n, [""], { scriptable: !1, indexable: !1, allKeys: !0 });
}
function Eo(s, t) {
    let e = U.datasets[s] || {};
...
function Io(s, ...t) {
    if (Wa(s)) return s;
    for (let e of t) {
        let i = e.axis || Ad(e.position) || (s.length > 1 && Wa(s[0].toLowerCase()));
        if (i) return i;
    }
    ...
    return (
        ...
        s.data.datasets.forEach((r) => {
            ...
            Object.keys(h).forEach((u) => {
                let d = Cd(u, l),
                    f = r[d + "AxisID"] || d;
                (o[f] = o[f] || Object.create(null)), He(o[f], [{ axis: d }, i[f], h[u]]);
            });
        }),
...
var Ls = (s, t, e) => {
    ...
    Co = class {
        constructor(t) {
            (this._config = Nd(t)), (this._scopeCache = new Map()), (this._resolverCache = new Map());
        }
        get platform() {
        ...
        datasetElementScopeKeys(t, e) {
            return Gi(`${t}-${e}`, () => [[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, ""]]);
        }
        pluginScopeKeys(t) {
            let e = t.id,
                i = this.type;
            return Gi(`${i}-plugin-${e}`, () => [[`plugins.${e}`, ...(t.additionalOptionScopes || [])]]);
        }
        _cachedScopes(t, e) {
        ...
        getOptionScopes(t, e, i) {
            ...
            let c = Array.from(l);
            return c.length === 0 && c.push(Object.create(null)), Tl.has(e) && r.set(e, c), c;
        }
        chartOptionScopes() {
...
function Ha(s, t, e) {
    ...
    let n = e.join(),
        o = i.get(n);
    return o || ((o = { resolver: $i(t, e), subPrefixes: e.filter((a) => !a.toLowerCase().includes("hover")) }), i.set(n, o)), o;
}
...
function Ol(s) {
    return ji() && typeof s == "string" ? (s = document.getElementById(s)) : s && s.length && (s = s[0]), s && s.canvas && (s = s.canvas), s;
}
var tn = {},
    Ua = (s) => {
        let t = Ol(s);
...
var St = class {
    ...
    constructor(t, e) {
        ...
        (this.platform = new (i.platform || hd(n))()), this.platform.updateConfig(i);
        ...
        Zt.listen(this, "complete", ja), Zt.listen(this, "progress", Hd), this._initialize(), this.attached && this.update();
    }
    get aspectRatio() {
        let {
    ...
    _initialize() {
        return (
            ...
            this.options.responsive ? this.resize() : io(this, this.options.devicePixelRatio),
            this.bindEvents(),
    ...
    resize(t, e) {
        Zt.running(this) ? (this._resizeBeforeDraw = { width: t, height: e }) : this._resize(t, e);
    }
    _resize(t, e) {
        let i = this.options,
            n = this.canvas,
        ...
        (this.width = r.width),
            ...
            (this._aspectRatio = this.aspectRatio),
            io(this, a, !0) &&
                (this.notifyPlugins("resize", { size: r }), B(i.onResize, [this, r], this), this.attached && this._doResize(l) && this.render());
    }
    ensureScalesHaveIDs() {
        ...
        e &&
            ...
            V(o, (r) => {
                let a = r.options,
                    ...
                    c = Io(l, a),
                    h = I(a.type, r.dtype);
                (a.position === void 0 || Ba(a.position, c) !== Ba(r.dposition)) && (a.position = r.dposition), (n[l] = !0);
                let u = null;
    ...
    buildOrUpdateControllers() {
        ...
        for (this._removeUnreferencedMetasets(), i = 0, n = e.length; i < n; i++) {
            ...
            if (
                ...
                Object.assign(l, { dataElementType: zt.getElement(h), datasetElementType: c && zt.getElement(c) }),
    ...
    _checkEventBindings() {
        let t = this.options,
            ...
            i = new Set(t.events);
        (!Rn(e, i) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(), this.bindEvents());
    }
    ...
    render() {
        this.notifyPlugins("beforeRender", { cancelable: !0 }) !== !1 &&
            (Zt.has(this) ? this.attached && !Zt.running(this) && Zt.start(this) : (this.draw(), ja({ chart: this })));
    }
    draw() {
        let t;
    ...
    _drawDataset(t) {
        ...
        this.notifyPlugins("beforeDatasetDraw", i) !== !1 &&
            (n && Ds(e, n), t.controller.draw(), n && Es(e), (i.cancelable = !1), this.notifyPlugins("afterDatasetDraw", i));
    }
    isPointInArea(t) {
    ...
    _updateVisibility(t, e, i) {
        ...
        Be(e)
            ...
            : (this.setDatasetVisibility(t, i), r.update(o, { visible: i }), this.update((a) => (a.datasetIndex === t ? n : void 0)));
    }
    hide(t, e) {
    ...
    _stop() {
        let t, e;
        for (this.stop(), Zt.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t) this._destroyDatasetMeta(t);
    }
    destroy() {
        ...
        this._stop(),
            ...
            t && (this.unbindEvents(), Xn(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
            delete tn[this.id],
    ...
    setActiveElements(t) {
        ...
        !Ts(i, e) && ((this._active = i), (this._lastEvent = null), this._updateHoverStyles(i, e));
    }
    notifyPlugins(t, e, i) {
    ...
    _handleEvent(t, e, i) {
        ...
        i && ((this._lastEvent = null), B(o.onHover, [t, a, this], this), l && B(o.onClick, [t, a, this], this));
        let h = !Ts(a, n);
...
S(St, "defaults", U), S(St, "instances", tn), S(St, "overrides", ne), S(St, "registry", zt), S(St, "version", zd), S(St, "getChart", Ua);
function Ya() {
    return V(St.instances, (s) => s._plugins.invalidate());
}
function jd(s, t, e) {
    let { startAngle: i, x: n, y: o, outerRadius: r, innerRadius: a, options: l } = t,
...
function Ud(s, t, e) {
    ...
    s.beginPath(),
        s.arc(o, r, a, i - c, e + c),
        l > n ? ((c = n / l), s.arc(o, r, l, e + c, i - c, !0)) : s.arc(o, r, n, e + X, i - X),
        s.closePath(),
        s.clip();
}
function Yd(s) {
...
function Zd(s, t, e, i) {
    ...
    return { outerStart: a(n.outerStart), outerEnd: a(n.outerEnd), innerStart: tt(n.innerStart, 0, r), innerEnd: tt(n.innerEnd, 0, r) };
}
function qe(s, t, e, i) {
...
function on(s, t, e, i, n, o) {
    ...
    let g = Math.max(0.001, m * u - e / N) / u,
        ...
        y = l + p + f,
        b = n - p - f,
        { outerStart: _, outerEnd: w, innerStart: x, innerEnd: k } = Zd(t, d, u, b - y),
        M = u - _,
        v = u - w,
        O = y + _ / M,
        E = b - w / v,
    ...
    if ((s.beginPath(), o)) {
        ...
        let J = (b - k / d + (y + x / d)) / 2;
        if ((s.arc(r, a, d, b - k / d, J, !0), s.arc(r, a, d, J, y + x / d, !0), x > 0)) {
            let lt = qe(C, nt, r, a);
...
function Gd(s, t, e, i, n) {
    ...
    s.setLineDash(u || []),
        (s.lineDashOffset = d),
        m ? ((s.lineWidth = c * 2), (s.lineJoin = h || "round")) : ((s.lineWidth = c), (s.lineJoin = h || "bevel"));
    let g = t.endAngle;
    if (o) {
        on(s, t, e, i, g, n);
    ...
    m && Ud(s, t, g), l.selfJoin && g - r >= N && f === 0 && h !== "miter" && jd(s, t, g), o || (on(s, t, e, i, g, n), s.stroke());
}
var ve = class extends yt {
    ...
    draw(e) {
        ...
        let c = 1 - Math.sin(Math.min(N, n || 0)),
            h = o * c;
        (e.fillStyle = i.backgroundColor), (e.strokeStyle = i.borderColor), qd(e, this, h, r, a), Gd(e, this, h, r, a), e.restore();
    }
};
S(ve, "id", "arc"),
    S(ve, "defaults", {
    ...
    S(ve, "descriptors", { _scriptable: !0, _indexable: (e) => e !== "borderDash" });
function Dl(s, t, e = t) {
...
function Kd(s) {
    return s.stepped ? oa : s.tension || s.cubicInterpolationMode === "monotone" ? ra : Xd;
}
function El(s, t, e = {}) {
    let i = s.length,
...
function Jd(s, t, e, i) {
    let { points: n, options: o } = t,
        ...
        m,
        g;
    for (f = 0; f <= c; ++f) (m = n[(a + (d ? c - f : f)) % r]), !m.skip && (u ? (s.moveTo(m.x, m.y), (u = !1)) : h(s, g, m, d, o.stepped), (g = m));
...
function Qd(s, t, e, i) {
    ...
    for (l && ((f = n[b(0)]), s.moveTo(f.x, f.y)), d = 0; d <= a; ++d) {
        ...
        let w = f.x,
            x = f.y,
            k = w | 0;
        k === m ? (x < g ? (g = x) : x > p && (p = x), (h = (u * h + w) / ++u)) : (_(), s.lineTo(w, x), (m = k), (u = 0), (g = p = x)), (y = x);
    }
    _();
}
function Fo(s) {
    ...
    return !s._decimated && !s._loop && !t.tension && t.cubicInterpolationMode !== "monotone" && !t.stepped && !e ? Qd : Jd;
}
function tf(s) {
    return s.stepped ? ga : s.tension || s.cubicInterpolationMode === "monotone" ? pa : ie;
}
function ef(s, t, e, i) {
    let n = t._path;
    n || ((n = t._path = new Path2D()), t.path(n, e, i) && n.closePath()), Dl(s, t.options), s.stroke(n);
}
function sf(s, t, e, i) {
    let { segments: n, options: o } = t,
        r = Fo(t);
    for (let a of n) Dl(s, o, a.style), s.beginPath(), r(s, t, a, { start: e, end: e + i - 1 }) && s.closePath(), s.stroke();
}
...
var Vt = class extends yt {
    ...
    draw(t, e, i, n) {
        let o = this.options || {};
        (this.points || []).length && o.borderWidth && (t.save(), of(t, this, i, n), t.restore()),
...
S(Vt, "id", "line"),
    ...
    S(Vt, "defaultRoutes", { backgroundColor: "backgroundColor", borderColor: "borderColor" }),
    S(Vt, "descriptors", { _scriptable: !0, _indexable: (t) => t !== "borderDash" && t !== "fill" });
function Za(s, t, e, i) {
    let n = s.options,
        { [e]: o } = s.getProps([e], i);
...
var ts = class extends yt {
    ...
    draw(e, i) {
        ...
        this.skip ||
            ...
            ((e.strokeStyle = n.borderColor), (e.lineWidth = n.borderWidth), (e.fillStyle = n.backgroundColor), Hi(e, n, this.x, this.y));
    }
    getRange() {
        let e = this.options || {};
...
S(ts, "id", "point"),
    S(ts, "defaults", { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: "circle", radius: 3, rotation: 0 }),
    S(ts, "defaultRoutes", { backgroundColor: "backgroundColor", borderColor: "borderColor" });
function Il(s, t) {
    let { x: e, y: i, base: n, width: o, height: r } = s.getProps(["x", "y", "base", "width", "height"], t),
        a,
        l,
        c,
        h,
...
function rf(s, t, e) {
    let i = s.options.borderWidth,
        n = s.borderSkipped,
        o = Jn(i);
    return { t: ce(n.top, o.top, 0, e), r: ce(n.right, o.right, 0, t), b: ce(n.bottom, o.bottom, 0, e), l: ce(n.left, o.left, 0, t) };
}
function af(s, t, e) {
...
var es = class extends yt {
    ...
    draw(t) {
        let {
            ...
            a = cf(r.radius) ? Ye : hf;
        t.save(),
            (r.w !== o.w || r.h !== o.h) && (t.beginPath(), a(t, xo(r, e, o)), t.clip(), a(t, xo(o, -e, r)), (t.fillStyle = i), t.fill("evenodd")),
            t.beginPath(),
            a(t, xo(o, e)),
            (t.fillStyle = n),
            t.fill(),
    ...
    getCenterPoint(t) {
        let { x: e, y: i, base: n, horizontal: o } = this.getProps(["x", "y", "base", "horizontal"], t);
...
S(es, "id", "bar"),
    S(es, "defaults", { borderSkipped: "start", borderWidth: 0, borderRadius: 0, inflateAmount: "auto", pointStyle: void 0 }),
    S(es, "defaultRoutes", { backgroundColor: "backgroundColor", borderColor: "borderColor" });
var uf = Object.freeze({ __proto__: null, ArcElement: ve, BarElement: es, LineElement: Vt, PointElement: ts }),
    Ao = [
        "rgb(54, 162, 235)",
        "rgb(255, 99, 132)",
        "rgb(255, 159, 64)",
...
function gf(s) {
    ...
    return (e, i) => {
        ...
        n instanceof Gt ? (t = ff(e, t)) : n instanceof Oe ? (t = mf(e, t)) : n && (t = df(e, t));
    };
}
function Ga(s) {
    let t;
...
function xf(s, t, e, i, n) {
    ...
    for (r[l++] = s[h], u = 0; u < o - 2; u++) {
        ...
        let k = Math.floor(u * a) + 1 + t,
            ...
            { x: v, y: O } = s[h];
        for (f = m = -1, b = k; b < M; b++)
            (m = 0.5 * Math.abs((v - p) * (s[b].y - O) - (v - s[b].x) * (y - O))), m > f && ((f = m), (d = s[b]), (g = b));
        (r[l++] = d), (h = g);
    }
    return (r[l++] = s[c]), r;
}
function _f(s, t, e, i) {
    ...
    for (r = t; r < t + e; ++r) {
        ...
        let x = l | 0;
        if (x === h) c < m ? ((m = c), (u = r)) : c > g && ((g = c), (d = r)), (n = (o * n + a.x) / ++o);
        else {
            let k = r - 1;
            if (!A(u) && !A(d)) {
                let M = Math.min(u, d),
                    v = Math.max(u, d);
                M !== f && M !== k && p.push({ ...s[M], x: n }), v !== f && v !== k && p.push({ ...s[v], x: n });
            }
            r > 0 && k !== f && p.push(s[k]), p.push(a), (h = x), (o = 0), (m = g = c), (u = d = f = r);
        }
    }
    return p;
}
function Al(s) {
    if (s._decimated) {
        let t = s._data;
        delete s._decimated, delete s._data, Object.defineProperty(s, "data", { configurable: !0, enumerable: !0, writable: !0, value: t });
    }
}
function Xa(s) {
...
function wf(s, t) {
    ...
    return l && (i = tt(Lt(t, o.axis, r).lo, 0, e - 1)), c ? (n = tt(Lt(t, o.axis, a).hi + 1, i, e) - i) : (n = e - i), { start: i, count: n };
}
var Sf = {
    id: "decimation",
    ...
    for (let a of i) {
        ...
        for (let d of u) {
            let f = Lo(e, o[d.start], o[d.end], d.loop),
                m = ao(a, n, f);
            for (let g of m) r.push({ source: g, target: d, start: { [e]: Ka(h, f, "start", Math.max) }, end: { [e]: Ka(h, f, "end", Math.min) } });
        }
    }
    return r;
}
function Lo(s, t, e, i) {
    ...
    let n = t[s],
        o = e[s];
    return s === "angle" && ((n = ot(n)), (o = ot(o))), { property: s, start: n, end: o };
}
function Mf(s, t) {
    ...
    return (
        t.segments.forEach(({ start: r, end: a }) => {
            ...
            let l = n[r],
                c = n[a];
            i !== null ? (o.push({ x: l.x, y: i }), o.push({ x: c.x, y: i })) : e !== null && (o.push({ x: e, y: l.y }), o.push({ x: e, y: c.y }));
        }),
        o
    );
}
...
function Ll(s, t) {
    let e = [],
        i = !1;
    return $(s) ? ((i = !0), (e = s)) : (e = Mf(s, t)), e.length ? new Vt({ points: e, options: { tension: 0 }, _loop: i, _fullLoop: i }) : null;
}
function Ja(s) {
    return s && s.fill !== !1;
}
...
function Tf(s, t, e) {
    ...
    let n = parseFloat(i);
    return Z(n) && Math.floor(n) === n ? Of(i[0], t, n, e) : ["origin", "start", "end", "stack", "shape"].indexOf(i) >= 0 && i;
}
function Of(s, t, e, i) {
...
function Ef(s, t, e) {
    let i;
    return s === "start" ? (i = e) : s === "end" ? (i = t.options.reverse ? t.min : t.max) : L(s) ? (i = s.value) : (i = t.getBaseValue()), i;
}
function If(s) {
    let t = s.options,
        e = t.fill,
...
var rn = class {
    ...
    pathSegment(t, e, i) {
        ...
        return (e = e || { start: 0, end: j }), t.arc(n, o, r, e.end, e.start, !0), !i.bounds;
    }
    interpolate(t) {
...
function zf(s) {
    ...
    if (i.grid.circular) {
        ...
        return new rn({ x: l.x, y: l.y, radius: t.getDistanceFromCenterForValue(r) });
    }
...
function _o(s, t, e) {
    let i = Pf(t),
        ...
        g = co(n, m);
    i && r.points.length && (Ds(s, e), Vf(s, { line: r, target: i, above: d, below: f, area: e, scale: a, axis: l, clip: g }), Es(s));
}
function Vf(s, t) {
    let { line: e, target: i, above: n, below: o, area: r, scale: a, clip: l } = t,
        c = e._loop ? "angle" : t.axis;
    s.save();
    let h = o;
    o !== n &&
        (c === "x"
            ? (Qa(s, i, r.top), wo(s, { line: e, target: i, color: n, scale: a, property: c, clip: l }), s.restore(), s.save(), Qa(s, i, r.bottom))
            : c === "y" &&
              (tl(s, i, r.left),
              wo(s, { line: e, target: i, color: o, scale: a, property: c, clip: l }),
              s.restore(),
              s.save(),
              tl(s, i, r.right),
              (h = n))),
...
function tl(s, t, e) {
    ...
    for (let a of i) {
        let { start: l, end: c } = a,
            h = n[l],
            u = n[ln(l, c, n)];
        o ? (s.moveTo(h.x, h.y), (o = !1)) : (s.lineTo(e, h.y), s.lineTo(h.x, h.y)),
            (r = !!t.pathSegment(s, a, { move: r })),
...
function wo(s, t) {
    ...
    for (let { source: c, target: h, start: u, end: d } of l) {
        let { style: { backgroundColor: f = o } = {} } = c,
            m = i !== !0;
        s.save(), (s.fillStyle = f), Hf(s, r, a, m && Lo(n, u, d)), s.beginPath();
...
function Hf(s, t, e, i) {
    ...
    if (o === "x" || o === "y") {
        let l, c, h, u;
        o === "x" ? ((l = r), (c = n.top), (h = a), (u = n.bottom)) : ((l = n.left), (c = r), (h = n.right), (u = a)),
            s.beginPath(),
            e && ((l = Math.max(l, e.left)), (h = Math.min(h, e.right)), (c = Math.max(c, e.top)), (u = Math.min(u, e.bottom))),
            s.rect(l, c, h - l, u - c),
            s.clip();
    }
}
...
var Bf = {
        ...
        afterDatasetsUpdate(s, t, e) {
            ...
            for (r = 0; r < i; ++r)
                (o = s.getDatasetMeta(r)),
                    ...
                    (o.$filler = l),
                    n.push(l);
            for (r = 0; r < i; ++r) (l = n[r]), !(!l || l.fill === !1) && (l.fill = vf(n, r, e.propagate));
        },
        beforeDraw(s, t, e) {
            ...
            for (let r = n.length - 1; r >= 0; --r) {
                let a = n[r].$filler;
                a && (a.line.updateControlPoints(o, a.axis), i && a.fill && _o(s.ctx, a, o));
            }
        },
        ...
        beforeDatasetDraw(s, t, e) {
            let i = t.meta.$filler;
            !Ja(i) || e.drawTime !== "beforeDatasetDraw" || _o(s.ctx, i, s.chartArea);
        },
    ...
    $f = (s, t) => s !== null && t !== null && s.datasetIndex === t.datasetIndex && s.index === t.index,
    an = class extends yt {
        constructor(t) {
            super(),
                (this._added = !1),
        ...
        _fitRows(t, e, i, n) {
            ...
            return (
                this.legendItems.forEach((m, g) => {
                    ...
                    (g === 0 || c[c.length - 1] + p + 2 * a > r) && ((u += h), (c[c.length - (g > 0 ? 0 : 1)] = 0), (f += h), d++),
        ...
        _fitCols(t, e, i, n) {
            ...
            return (
                this.legendItems.forEach((p, y) => {
                    ...
                    y > 0 && f + _ + 2 * a > h && ((u += d + a), c.push({ width: d, height: f }), (m += d + a), g++, (d = f = 0)),
        ...
        adjustHitBoxes() {
            ...
            if (this.isHorizontal()) {
                ...
                for (let c of e)
                    a !== c.row && ((a = c.row), (l = rt(i, this.left + n, this.right - this.lineWidths[a]))),
                        (c.top += this.top + t + n),
                ...
                for (let c of e)
                    c.col !== a && ((a = c.col), (l = rt(i, this.top + t + n, this.bottom - this.columnSizes[a].height))),
                        (c.top = l),
                        (c.left += this.left + n),
        ...
        _draw() {
            ...
            let { boxWidth: m, boxHeight: g, itemHeight: p } = sl(r, u),
                y = function (k, M, v) {
                    ...
                    if (
                        ...
                        let E = { radius: (g * Math.SQRT2) / 2, pointStyle: v.pointStyle, rotation: v.rotation, borderWidth: O },
                            C = l.xPlus(k, m / 2),
                            P = M + d;
                        ...
                        let E = M + Math.max((u - g) / 2, 0),
                            ...
                            P = ae(v.borderRadius);
                        n.beginPath(),
                            Object.values(P).some((nt) => nt !== 0) ? Ye(n, { x: C, y: E, w: m, h: g, radius: P }) : n.rect(C, E, m, g),
                            n.fill(),
                            O !== 0 && n.stroke();
                    }
                    n.restore();
                ...
                b = function (k, M, v) {
                    re(n, v.text, k, M + p / 2, c, { strikethrough: v.hidden, textAlign: l.textAlign(v.textAlign) });
                },
                _ = this.isHorizontal(),
                w = this._computeTitleHeight();
            _
                ? (f = { x: rt(o, this.left + h, this.right - i[0]), y: this.top + h + w, line: 0 })
                : (f = { x: this.left + h, y: rt(o, this.top + w + h, this.bottom - e[0].height), line: 0 }),
            ...
            this.legendItems.forEach((k, M) => {
                ...
                l.setWidth(this.width),
                    _
                        ? M > 0 && C + E + h > this.right && ((P = f.y += x), f.line++, (C = f.x = rt(o, this.left + h, this.right - i[f.line])))
                        : M > 0 &&
                          P + x > this.bottom &&
                          ((C = f.x = C + e[f.line].width + h), f.line++, (P = f.y = rt(o, this.top + w + h, this.bottom - e[f.line].height)));
                let nt = l.x(C);
                if ((y(nt, P, k), (C = sa(O, C + m + d, _ ? C + E : this.right, t.rtl)), b(l.x(C), P, k), _)) f.x += E + h;
        ...
        drawTitle() {
            ...
            let o = Se(t.rtl, this.left, this.width),
                ...
                u = this.left,
                d = this.width;
            if (this.isHorizontal()) (d = Math.max(...this.lineWidths)), (h = this.top + c), (u = rt(t.align, u, this.right - d));
            else {
                let m = this.columnSizes.reduce((g, p) => Math.max(g, p.height), 0);
                h = c + rt(t.align, this.top, this.bottom - m - t.labels.padding - this._computeTitleHeight());
            }
            let f = rt(a, u, u + d);
        ...
        _getLegendItemAt(t, e) {
            ...
            if (Rt(t, this.left, this.right) && Rt(e, this.top, this.bottom)) {
                for (o = this.legendHitBoxes, i = 0; i < o.length; ++i)
                    if (((n = o[i]), Rt(t, n.left, n.left + n.width) && Rt(e, n.top, n.top + n.height))) return this.legendItems[i];
            }
            return null;
        }
        handleEvent(t) {
            ...
            if (t.type === "mousemove" || t.type === "mouseout") {
                let n = this._hoveredItem,
                    o = $f(n, i);
                n && !o && B(e.onLeave, [t, n, this], this), (this._hoveredItem = i), i && !o && B(e.onHover, [t, i, this], this);
...
var qf = {
            ...
            labels: {
                ...
                generateLabels(s) {
                    let t = s.data.datasets,
                        {
                            labels: { usePointStyle: e, pointStyle: i, textAlign: n, color: o, useBorderRadius: r, borderRadius: a },
                        } = s.legend.options;
        ...
        descriptors: { _scriptable: (s) => !s.startsWith("on"), labels: { _scriptable: (s) => !["generateLabels", "filter", "sort"].includes(s) } },
    },
    js = class extends yt {
        constructor(t) {
            super(),
        ...
        _drawArgs(t) {
            ...
            return (
                this.isHorizontal()
                    ...
                    : (r.position === "left" ? ((h = i + t), (u = rt(a, n, e)), (l = N * -0.5)) : ((h = o - t), (u = rt(a, e, n)), (l = N * 0.5)),
                      (c = n - e)),
        ...
        draw() {
            ...
            re(t, e.text, 0, 0, i, { color: e.color, maxWidth: l, rotation: c, textAlign: zi(e.align), textBaseline: "middle", translation: [r, a] });
        }
    };
function Gf(s, t) {
...
var Xf = {
    ...
    Rs = {
        average(s) {
            ...
            return o === 0 || i.size === 0 ? !1 : { x: [...i].reduce((a, l) => a + l) / i.size, y: n / o };
        },
        nearest(s, t) {
            if (!s.length) return !1;
            let e = t.x,
...
function il(s, t) {
    ...
    if (((y += s.beforeBody.length + s.afterBody.length), u && (g += u * c.lineHeight + (u - 1) * t.titleSpacing + t.titleMarginBottom), y)) {
...
function em(s, t, e, i) {
    let { x: n, width: o } = e,
        ...
        c = "center";
    return (
        i === "center" ? (c = n <= (a + l) / 2 ? "left" : "right") : n <= o / 2 ? (c = "left") : n >= r - o / 2 && (c = "right"),
        tm(c, s, t, e) && (c = "center"),
        c
    );
}
...
var Nl = {
    ...
    beforeLabel: Nt,
    label(s) {
        if (this && this.options && this.options.mode === "dataset") return s.label + ": " + s.formattedValue || s.formattedValue;
...
var Bs = class extends yt {
    ...
    getContext() {
        return this.$context || (this.$context = nm(this.chart.getContext(), this, this._tooltipItems));
    }
    getTitle(t, e) {
        let { callbacks: i } = e,
    ...
    _createItems(t) {
        ...
        return (
            ...
            V(a, (h) => {
                ...
                n.push(dt(u, "labelColor", this, h)), o.push(dt(u, "labelPointStyle", this, h)), r.push(dt(u, "labelTextColor", this, h));
            }),
            (this.labelColors = n),
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
            ...
            (this.xAlign = h.xAlign),
                ...
                (o = { opacity: 1, x: u.x, y: u.y, width: l.width, height: l.height, caretX: a.x, caretY: a.y });
        }
    ...
    getCaretPosition(t, e, i) {
        ...
        return (
            o === "center"
                ? ((w = f + g / 2),
                  n === "left" ? ((p = d), (y = p - r), (_ = w + r), (x = w - r)) : ((p = d + m), (y = p + r), (_ = w - r), (x = w + r)),
                  (b = p))
                : (n === "left" ? (y = d + Math.max(l, h) + r) : n === "right" ? (y = d + m - Math.max(c, u) - r) : (y = this.caretX),
                  o === "top" ? ((_ = f), (w = _ - r), (p = y - r), (b = y + r)) : ((_ = f + g), (w = _ + r), (p = y + r), (b = y - r)),
                  (x = _)),
    ...
    _drawColorBox(t, e, i, n, o) {
        let r = this.labelColors[i],
            ...
            m = e.y + f;
        if (o.usePointStyle) {
            let g = { radius: Math.min(c, l) / 2, pointStyle: a.pointStyle, rotation: a.rotation, borderWidth: 1 },
            ...
            (t.lineWidth = L(r.borderWidth) ? Math.max(...Object.values(r.borderWidth)) : r.borderWidth || 1),
                (t.strokeStyle = r.borderColor),
    ...
    drawBody(t, e, i) {
        let { body: n } = this,
            { bodySpacing: o, bodyAlign: r, displayColors: a, boxHeight: l, boxWidth: c, boxPadding: h } = i,
            u = Q(i.bodyFont),
            d = u.lineHeight,
            f = 0,
        ...
        for (
            ...
            for (
                y = n[w],
                    ...
                    V(y.before, g),
                    _ = y.lines,
                    a && _.length && (this._drawColorBox(e, t, w, m, i), (d = Math.max(u.lineHeight, l))),
                    x = 0,
                    M = _.length;
                x < M;
                ++x
    ...
    drawBackground(t, e, i, n) {
        let { xAlign: o, yAlign: r } = this,
            { x: a, y: l } = t,
            { width: c, height: h } = i,
            { topLeft: u, topRight: d, bottomLeft: f, bottomRight: m } = ae(n.cornerRadius);
    ...
    _updateAnimationTarget(t) {
        let e = this.chart,
            ...
            o = i && i.y;
        if (n || o) {
            let r = Rs[t.position].call(this, this._active, this._eventPosition);
            if (!r) return;
...
var om = {
    ...
    rm = Object.freeze({ __proto__: null, Colors: bf, Decimation: Sf, Filler: Bf, Legend: qf, SubTitle: Kf, Title: Xf, Tooltip: om }),
    am = (s, t, e, i) => (typeof t == "string" ? ((e = s.push(t) - 1), i.unshift({ index: e, label: t })) : isNaN(t) && (e = null), e);
function lm(s, t, e, i) {
    let n = s.indexOf(t);
...
var Ws = class extends Ee {
    ...
    parse(t, e) {
        if (A(t)) return null;
        let i = this.getLabels();
        return (e = isFinite(e) && i[e] === t ? e : lm(i, t, I(e, t), this._addedLabels)), cm(e, i.length - 1);
    }
    determineDataLimits() {
...
function hm(s, t) {
    let e = [],
        { bounds: n, step: o, min: r, max: a, precision: l, count: c, maxTicks: h, maxDigits: u, includeBounds: d } = s,
        f = o || 1,
        m = h - 1,
        { min: g, max: p } = t,
        y = !A(r),
    ...
    (O = Math.ceil(p / x) - Math.floor(g / x)),
        ...
        n === "ticks" ? ((M = Math.floor(g / x) * x), (v = Math.ceil(p / x) * x)) : ((M = g), (v = p)),
        y && b && o && Gr((a - r) / o, x / 1e3)
            ? ((O = Math.round(Math.min((a - r) / x, h))), (x = (a - r) / O), (M = r), (v = a))
            : _
              ? ((M = y ? r : M), (v = b ? a : v), (O = c - 1), (x = (v - M) / O))
              : ((O = (v - M) / x), $e(O, Math.round(O), x / 1e3) ? (O = Math.round(O)) : (O = Math.ceil(O)));
    let E = Math.max(Vn(x), Vn(M));
    (k = Math.pow(10, A(l) ? E : l)), (M = Math.round(M * k) / k), (v = Math.round(v * k) / k);
    let C = 0;
    for (
        y && (d && M !== r ? (e.push({ value: r }), M < r && C++, $e(Math.round((M + C * x) * k) / k, r, cl(r, w, s)) && C++) : M < r && C++);
        C < O;
        ++C
    ) {
            ...
            return (
                i
                    ? ((n = Math.ceil(this.max / i) - Math.floor(this.min / i) + 1),
                      n > 1e3 &&
                          (console.warn(`scales.${this.id}.ticks.stepSize: ${i} would result generating up to ${n} ticks. Limiting to 1000.`),
                          (n = 1e3)))
...
S(zs, "id", "linear"), S(zs, "defaults", { ticks: { callback: Os.formatters.numeric } });
...
var Vs = class extends Ee {
    ...
    buildTicks() {
        ...
        return (
            ...
            t.reverse ? (i.reverse(), (this.start = this.max), (this.end = this.min)) : ((this.start = this.min), (this.end = this.max)),
            i
        );
    }
    getLabelForValue(t) {
    ...
    getPixelForValue(t) {
        return (
            ...
            t === null || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (jt(t) - this._startValue) / this._valueRange)
        );
    }
    getValueForPixel(t) {
...
S(Vs, "id", "logarithmic"), S(Vs, "defaults", { ticks: { callback: Os.formatters.logarithmic, major: { enabled: !0 } } });
function Po(s) {
    let t = s.ticks;
...
function fm(s, t, e) {
    return (e = $(e) ? e : [e]), { w: na(s, t.string, e), h: e.length * t.lineHeight };
}
function dl(s, t, e, i, n) {
    return s === i || s === n ? { start: t - e / 2, end: t + e / 2 } : s < i || s > n ? { start: t - e, end: t } : { start: t, end: t + e };
}
function mm(s) {
    let t = { l: s.left + s._padding.left, r: s.right - s._padding.right, t: s.top + s._padding.top, b: s.bottom - s._padding.bottom },
        e = Object.assign({}, t),
        i = [],
        n = [],
    ...
    s.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), (s._pointLabelItems = bm(s, i, n));
}
...
function pm(s, t, e) {
    let i = s.drawingArea,
        ...
        u = xm(c),
        d = _m(l.x, a.w, u);
    return { visible: !0, x: l.x, y: h, textAlign: u, left: d, top: h, right: d + a.w, bottom: h + a.h };
}
function ym(s, t) {
    if (!t) return !0;
    let { left: e, top: i, right: n, bottom: o } = s;
    return !(Pt({ x: e, y: i }, t) || Pt({ x: e, y: o }, t) || Pt({ x: n, y: i }, t) || Pt({ x: n, y: o }, t));
}
function bm(s, t, e) {
    let i = [],
    ...
    for (let h = 0; h < n; h++) {
        ...
        let u = pm(s, h, l);
        i.push(u), a === "auto" && ((u.visible = ym(u, c)), u.visible && (c = u));
    }
    return i;
}
function xm(s) {
...
function Sm(s, t, e) {
    ...
    if (!A(a)) {
        ...
        let h = i - c.left,
            ...
            d = o - i + c.width,
            f = r - n + c.height;
        Object.values(l).some((m) => m !== 0) ? (s.beginPath(), Ye(s, { x: h, y: u, w: d, h: f, radius: l }), s.fill()) : s.fillRect(h, u, d, f);
    }
}
function km(s, t) {
    let {
    ...
    for (let n = t - 1; n >= 0; n--) {
        ...
        re(e, s._pointLabels[n], l, c + a.lineHeight / 2, a, { color: r.color, textAlign: h, textBaseline: "middle" });
    }
}
function Rl(s, t, e, i) {
    let { ctx: n } = s;
...
var Te = class extends is {
    ...
    determineDataLimits() {
        ...
        (this.min = Z(t) && !isNaN(t) ? t : 0), (this.max = Z(e) && !isNaN(e) ? e : 0), this.handleTickRangeOptions();
    }
    computeTickLimit() {
    ...
    drawLabels() {
        ...
        t.save(),
            ...
            this.ticks.forEach((a, l) => {
                ...
                re(t, a.label, 0, -o, h, { color: c.color, strokeColor: c.textStrokeColor, strokeWidth: c.textStrokeWidth });
            }),
            t.restore();
    }
    drawTitle() {}
...
S(Te, "id", "radialLinear"),
    ...
    S(Te, "defaultRoutes", { "angleLines.color": "borderColor", "pointLabels.color": "color", "ticks.color": "color" }),
...
function ml(s, t) {
    ...
    return (
        ...
        r === null ? null : (n && (r = n === "week" && (we(o) || o === !0) ? e.startOf(r, "isoWeek", o) : e.startOf(r, n)), +r)
    );
}
function gl(s, t, e, i) {
    let n = ft.length;
...
function Om(s) {
    for (let t = ft.indexOf(s) + 1, e = ft.length; t < e; ++t) if (cn[ft[t]].common) return ft[t];
}
function pl(s, t, e) {
    if (!e) s[t] = !0;
    else if (e.length) {
...
var De = class extends Ee {
    ...
    buildTicks() {
        ...
        return (
            (this._unit =
                e.unit ||
                (i.autoSkip ? gl(e.minUnit, this.min, this.max, this._getLabelCapacity(o)) : Tm(this, a.length, e.minUnit, this.min, this.max))),
            (this._majorUnit = !i.major.enabled || this._unit === "year" ? void 0 : Om(this._unit)),
            this.initOffsets(n),
            t.reverse && a.reverse(),
    ...
    initOffsets(t = []) {
        ...
        (e = tt(e, 0, r)), (i = tt(i, 0, r)), (this._offsets = { start: e, end: i, factor: 1 / (e + 1 + i) });
    }
    _generate() {
        let t = this._adapter,
            e = this.min,
    ...
    _getLabelCapacity(t) {
        let e = this.options.time,
            ...
            o = this._tickFormatFunction(t, 0, yl(this, [t], this._majorUnit), n),
...
function Ji(s, t, e) {
    let i = 0,
        ...
        l;
    e
        ? (t >= s[i].pos && t <= s[n].pos && ({ lo: i, hi: n } = Lt(s, "pos", t)), ({ pos: o, time: a } = s[i]), ({ pos: r, time: l } = s[n]))
        : (t >= s[i].time && t <= s[n].time && ({ lo: i, hi: n } = Lt(s, "time", t)), ({ time: o, pos: a } = s[i]), ({ time: r, pos: l } = s[n]));
    let c = r - o;
...
var Hs = class extends De {
    ...
    initOffsets() {
        ...
        (this._minPos = Ji(e, this.min)), (this._tableRange = Ji(e, this.max) - this._minPos), super.initOffsets(t);
    }
    buildLookupTable(t) {
...
var T = "numeric",
    ...
    ci = { year: T, month: bt, day: T, hour: T, minute: T, second: T, timeZoneName: It },
    hi = { year: T, month: bt, day: T, weekday: bt, hour: T, minute: T, timeZoneName: bt },
    ui = { year: T, month: bt, day: T, weekday: bt, hour: T, minute: T, second: T, timeZoneName: bt };
var mt = class {
    get type() {
        throw new Et();
    }
...
var Vo = new Map(),
    ht = class s extends mt {
        ...
        offset(t) {
            ...
            a === "BC" && (n = -Math.abs(n) + 1);
            let d = os({ year: n, month: o, day: r, hour: l === 24 ? 0 : l, minute: c, second: h, millisecond: 0 }),
                f = +e,
                m = f % 1e3;
...
function $o(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = Bo.get(e);
    return i === void 0 && ((i = new Intl.DateTimeFormat(s, t)), Bo.set(e, i)), i;
}
var jo = new Map();
function Pm(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = jo.get(e);
    return i === void 0 && ((i = new Intl.NumberFormat(s, t)), jo.set(e, i)), i;
}
var Uo = new Map();
function Nm(s, t = {}) {
    let { base: e, ...i } = t,
        ...
        o = Uo.get(n);
    return o === void 0 && ((o = new Intl.RelativeTimeFormat(s, t)), Uo.set(n, o)), o;
}
var di = null;
function Rm() {
    return di || ((di = new Intl.DateTimeFormat().resolvedOptions().locale), di);
}
var Yo = new Map();
function Vl(s) {
    let t = Yo.get(s);
    return t === void 0 && ((t = new Intl.DateTimeFormat(s).resolvedOptions()), Yo.set(s, t)), t;
}
var Zo = new Map();
function Wm(s) {
    let t = Zo.get(s);
    if (!t) {
        ...
        (t = "getWeekInfo" in e ? e.getWeekInfo() : e.weekInfo), "minimalDays" in t || (t = { ...Hl, ...t }), Zo.set(s, t);
    }
    return t;
}
function zm(s) {
...
function Vm(s, t, e) {
    return (e || t) && (s.includes("-u-") || (s += "-u"), e && (s += `-ca-${e}`), t && (s += `-nu-${t}`)), s;
}
function Hm(s) {
    let t = [];
    for (let e = 1; e <= 12; e++) {
...
function $m(s) {
    return s.numberingSystem && s.numberingSystem !== "latn"
        ? !1
        : s.numberingSystem === "latn" || !s.locale || s.locale.startsWith("en") || Vl(s.locale).numberingSystem === "latn";
}
var qo = class {
        constructor(t, e, i) {
            ...
            if (!e || Object.keys(r).length > 0) {
                ...
                i.padTo > 0 && (a.minimumIntegerDigits = i.padTo), (this.inf = Pm(t, a));
            }
        }
        format(t) {
            if (this.inf) {
        ...
        constructor(t, e, i) {
            ...
            if (this.opts.timeZone) this.dt = t;
                ...
                t.offset !== 0 && ht.create(a).valid
                    ? ((n = a), (this.dt = t))
                    : ((n = "UTC"), (this.dt = t.offset === 0 ? t : t.setZone("UTC").plus({ minutes: t.offset })), (this.originalZone = t.zone));
            } else
                t.zone.type === "system"
                    ? (this.dt = t)
                    : t.zone.type === "iana"
            ...
            return this.originalZone
                ? t.map((e) => {
                      if (e.type === "timeZoneName") {
                          let i = this.originalZone.offsetName(this.dt.ts, { locale: this.dt.locale, format: this.opts.timeZoneName });
                          return { ...e, value: i };
                      } else return e;
                  })
                : t;
    ...
    Xo = class {
        constructor(t, e, i) {
            (this.opts = { style: "long", ...i }), !e && pn() && (this.rtf = Nm(t, i));
        }
        format(t, e) {
            return this.rtf ? this.rtf.format(t, e) : Bl(e, t, this.opts.numeric, this.opts.style !== "long");
        }
        formatToParts(t, e) {
    ...
    W = class s {
        ...
        static resetCache() {
            (di = null), Bo.clear(), jo.clear(), Uo.clear(), Yo.clear(), Zo.clear();
        }
        ...
        constructor(t, e, i, n, o) {
            ...
            (this.locale = r),
                ...
                (this.weekSettings = n),
                (this.intl = Vm(this.locale, this.numberingSystem, this.outputCalendar)),
        ...
        get fastNumbers() {
            return this.fastNumbersCached == null && (this.fastNumbersCached = $m(this)), this.fastNumbersCached;
        }
        listingMode() {
        ...
        months(t, e = !1) {
            return gn(this, t, Ko, () => {
                ...
                if (!this.monthsCache[o][t]) {
                    let r = i ? (a) => this.dtFormatter(a, n).format() : (a) => this.extract(a, n, "month");
        ...
        weekdays(t, e = !1) {
            return gn(this, t, Jo, () => {
                ...
                return this.weekdaysCache[n][t] || (this.weekdaysCache[n][t] = Bm((o) => this.extract(o, i, "weekday"))), this.weekdaysCache[n][t];
            });
        }
        meridiems() {
            return gn(
                ...
                () => {
                    if (!this.meridiemCache) {
                        ...
                        this.meridiemCache = [F.utc(2016, 11, 13, 9), F.utc(2016, 11, 13, 19)].map((e) => this.extract(e, t, "dayperiod"));
                    }
        ...
        eras(t) {
            return gn(this, t, tr, () => {
                let e = { era: t };
                return (
                    this.eraCache[t] || (this.eraCache[t] = [F.utc(-40, 1, 1), F.utc(2017, 1, 1)].map((i) => this.extract(i, e, "era"))),
                    this.eraCache[t]
                );
            });
        }
        ...
        isEnglish() {
            return this.locale === "en" || this.locale.toLowerCase() === "en-us" || Vl(this.intl).locale.startsWith("en-us");
        }
        getWeekSettings() {
            return this.weekSettings ? this.weekSettings : yn() ? Wm(this.locale) : Hl;
        }
        getStartOfWeek() {
...
function Ct(s, t) {
    ...
    } else return Ft(s) ? et.instance(s) : typeof s == "object" && "offset" in s && typeof s.offset == "function" ? s : new as(s);
}
var nr = {
        arab: "[\u0660-\u0669]",
        arabext: "[\u06F0-\u06F9]",
...
function Mt(s, t) {
    return new st("unit out of range", `you specified ${t} (of type ${typeof t}) as a ${s}, which is invalid`);
}
function bn(s, t, e) {
...
function mi(s, t = 4, e = 1) {
    let { year: i, month: n, day: o } = s,
        ...
        c;
    return (
        l < 1 ? ((c = i - 1), (l = Ce(c, t, e))) : l > Ce(i, t, e) ? ((c = i + 1), (l = 1)) : (c = i),
...
function or(s, t = 4, e = 1) {
    let { weekYear: i, weekNumber: n, weekday: o } = s,
        ...
        l = n * 7 + o - r - 7 + t,
        c;
    l < 1 ? ((c = i - 1), (l += fe(c))) : l > a ? ((c = i + 1), (l -= fe(i))) : (c = i);
...
function ar(s, t) {
    if (!D(s.localWeekday) || !D(s.localWeekNumber) || !D(s.localWeekYear)) {
        if (!D(s.weekday) || !D(s.weekNumber) || !D(s.weekYear)) throw new Dt("Cannot mix locale-based week fields with ISO-based week fields");
        return (
...
function oc(s, t = 4, e = 1) {
    let i = gi(s.weekYear),
        ...
        o = xt(s.weekday, 1, 7);
    return i ? (n ? (o ? !1 : Mt("weekday", s.weekday)) : Mt("week", s.weekNumber)) : Mt("weekYear", s.weekYear);
}
function rc(s) {
    let t = gi(s.year),
...
function cr(s) {
    let { hour: t, minute: e, second: i, millisecond: n } = s,
        ...
        a = xt(i, 0, 59),
        l = xt(n, 0, 999);
    return o ? (r ? (a ? (l ? !1 : Mt("millisecond", n)) : Mt("second", i)) : Mt("minute", e)) : Mt("hour", t);
}
function D(s) {
    return typeof s > "u";
}
...
function fi(s) {
    ...
    if (!xt(s.firstDay, 1, 7) || !xt(s.minimalDays, 1, 7) || !Array.isArray(s.weekend) || s.weekend.some((t) => !xt(t, 1, 7)))
...
function ls(s, t) {
    let e = Um(t - 1, 12) + 1,
        i = s + (t - e) / 12;
    return e === 2 ? (Fe(i) ? 29 : 28) : [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e - 1];
}
function os(s) {
    let t = Date.UTC(s.year, s.month - 1, s.day, s.hour, s.minute, s.second, s.millisecond);
    return s.year < 100 && s.year >= 0 && ((t = new Date(t)), t.setUTCFullYear(s.year, s.month - 1, s.day)), +t;
}
function ac(s, t, e) {
...
function mn(s, t, e, i = null) {
    ...
    let r = { timeZoneName: t, ...o },
        a = new Intl.DateTimeFormat(e, r).formatToParts(n).find((l) => l.type.toLowerCase() === "timezonename");
...
function ur(s) {
    let t = Number(s);
    if (typeof s == "boolean" || s === "" || !Number.isFinite(t)) throw new K(`Invalid unit value ${s}`);
    return t;
}
function cs(s, t) {
    let e = {};
...
var Ym = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
    dr = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
...
var fr = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
    ...
    it = class s {
        ...
        static parseFormat(t) {
            ...
            for (let r = 0; r < t.length; r++) {
                let a = t.charAt(r);
                a === "'"
                    ? ((i.length > 0 || n) && o.push({ literal: n || /^\s+$/.test(i), val: i === "" ? "'" : i }), (e = null), (i = ""), (n = !n))
                    : n || a === e
                      ? (i += a)
                      : (i.length > 0 && o.push({ literal: /^\s+$/.test(i), val: i }), (i = a), (e = a));
            }
        ...
        num(t, e = 0, i = void 0) {
            ...
            let n = { ...this.opts };
            return e > 0 && (n.padTo = e), i && (n.signDisplay = i), this.loc.numberFormatter(n).format(t);
        }
        formatDateTimeFromString(t, e) {
            let i = this.loc.listingMode() === "en",
                ...
                r = (f) => (t.isOffsetFixed && t.offset === 0 && f.allowZ ? "Z" : t.isValid ? t.zone.formatOffset(t.ts, f.format) : ""),
                a = () => (i ? uc(t) : o({ hour: "numeric", hourCycle: "h12" }, "dayperiod")),
                l = (f, m) => (i ? fc(t, f) : o(m ? { month: f } : { month: f, day: "numeric" }, "month")),
                c = (f, m) => (i ? dc(t, f) : o(m ? { weekday: f } : { weekday: f, month: "long", day: "numeric" }, "weekday")),
                h = (f) => {
                ...
                d = (f) => {
                    switch (f) {
                        ...
                        case "EEEEE":
                            return c("narrow", !1);
                        case "L":
                            return n ? o({ month: "numeric", day: "numeric" }, "month") : this.num(t.month);
                        case "LL":
                            return n ? o({ month: "2-digit", day: "numeric" }, "month") : this.num(t.month, 2);
                        case "LLL":
                            return l("short", !0);
                        case "LLLL":
                            return l("long", !0);
                        ...
                        case "yy":
                            return n ? o({ year: "2-digit" }, "year") : this.num(t.year.toString().slice(-2), 2);
                        case "yyyy":
        ...
        formatDurationFromString(t, e) {
            let i = this.opts.signMode === "negativeLargestOnly" ? -1 : 1,
                ...
                o = (h, u) => (d) => {
                    let f = n(d);
                    if (f) {
                        let m = u.isNegativeDuration && f !== u.largestUnit ? i : 1,
                            g;
                        return (
                ...
                r = s.parseFormat(e),
                a = r.reduce((h, { literal: u, val: d }) => (u ? h : h.concat(d)), []),
                l = t.shiftTo(...a.map(n).filter((h) => h)),
                c = { isNegativeDuration: l < 0, largestUnit: Object.keys(l.values)[0] };
            return gc(r, o(l, c));
        }
    };
var yc = /[A-Za-z_+-]{1,256}(?::?\/[A-Za-z0-9_+-]{1,256}(?:\/[A-Za-z0-9_+-]{1,256})?)?/;
function us(...s) {
...
function ag(s, t) {
    return [{ year: hs(s, t), month: hs(s, t + 1, 1), day: hs(s, t + 2, 1) }, null, t + 3];
}
function ms(s, t) {
    return [{ hours: hs(s, t, 0), minutes: hs(s, t + 1, 0), seconds: hs(s, t + 2, 0), milliseconds: yi(s[t + 3]) }, null, t + 4];
}
function xi(s, t) {
    let e = !s[t] && !s[t + 1],
        i = Ie(s[t + 1], s[t + 2]),
...
var ug = { GMT: 0, EDT: -4 * 60, EST: -5 * 60, CDT: -5 * 60, CST: -6 * 60, MDT: -6 * 60, MST: -7 * 60, PDT: -7 * 60, PST: -8 * 60 };
function yr(s, t, e, i, n, o, r) {
    let a = { year: t.length === 2 ? bi(Kt(t)) : Kt(t), month: dr.indexOf(e) + 1, day: Kt(i), hour: Kt(n), minute: Kt(o) };
    return r && (a.second = Kt(r)), s && (a.weekday = s.length > 3 ? fr.indexOf(s) + 1 : mr.indexOf(s) + 1), a;
}
var dg =
...
var gg = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun), (\d\d) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (\d{4}) (\d\d):(\d\d):(\d\d) GMT$/,
    pg =
        /^(Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday), (\d\d)-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-(\d\d) (\d\d):(\d\d):(\d\d) GMT$/,
    yg = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) ( \d|\d\d) (\d\d):(\d\d):(\d\d) (\d{4})$/;
function pc(s) {
    let [, t, e, i, n, o, r, a] = s;
...
var Ec = "Invalid Duration",
    ...
    Cg = {
        ...
        months: { weeks: gs / 7, days: gs, hours: gs * 24, minutes: gs * 24 * 60, seconds: gs * 24 * 60 * 60, milliseconds: gs * 24 * 60 * 60 * 1e3 },
        ...Fc,
    },
...
var G = class s {
    ...
    static fromObject(t, e = {}) {
        ...
        return new s({ values: cs(t, s.normalizeUnit), loc: W.fromObject(e), conversionAccuracy: e.conversionAccuracy, matrix: e.matrix });
    }
    ...
    static fromISO(t, e) {
        let [i] = Tc(t);
        return i ? s.fromObject(i, e) : s.invalid("unparsable", `the input "${t}" can't be parsed as ISO 8601`);
    }
    ...
    toFormat(t, e = {}) {
        ...
        return this.isValid ? it.create(this.loc, i).formatDurationFromString(this, t) : Ec;
    }
    toHuman(t = {}) {
        ...
        let e = t.showZeros !== !1,
            i = Ae.map((n) => {
                ...
                return D(o) || (o === 0 && !e)
                    ? null
                    : this.loc.numberFormatter({ style: "unit", unitDisplay: "long", ...t, unit: n.slice(0, -1) }).format(o);
            }).filter((n) => n);
    ...
    toISO() {
        ...
        return (
            ...
            (this.seconds !== 0 || this.milliseconds !== 0) && (t += rs(this.seconds + this.milliseconds / 1e3, 3) + "S"),
            t === "P" && (t += "T0S"),
            t
        );
    }
    toISOTime(t = {}) {
        ...
        return e < 0 || e >= 864e5
            ? null
            : ((t = { suppressMilliseconds: !1, suppressSeconds: !1, includePrefix: !1, format: "extended", ...t, includeOffset: !1 }),
    ...
    plus(t) {
        ...
        let e = s.fromDurationLike(t),
            i = {};
        for (let n of Ae) (me(e.values, n) || me(this.values, n)) && (i[n] = e.get(n) + this.get(n));
    ...
    reconfigure({ locale: t, numberingSystem: e, conversionAccuracy: i, matrix: n } = {}) {
        let r = { loc: this.loc.clone({ locale: t, numberingSystem: e }), matrix: n, conversionAccuracy: i };
        return Jt(this, r);
    }
    as(t) {
...
function Ag(s, t) {
    return !s || !s.isValid
        ...
        : !t || !t.isValid
          ...
          : t < s
            ? Qt.invalid("end before start", `The end of an interval must be after its start, but you had start=${s.toISO()} and end=${t.toISO()}`)
            : null;
}
var Qt = class s {
    constructor(t) {
    ...
    splitBy(t) {
        ...
        for (; i < this.e; ) {
            ...
            (o = +a > +this.e ? this.e : a), r.push(s.fromDateTimes(i, o)), (i = o), (n += 1);
        }
        return r;
    }
    divideEqually(t) {
    ...
    static merge(t) {
        let [e, i] = t
            .sort((n, o) => n.s - o.s)
            .reduce(([n, o], r) => (o ? (o.overlaps(r) || o.abutsStart(r) ? [n, o.union(r)] : [n.concat([o]), r]) : [n, r]), [[], null]);
        return i && e.push(i), e;
    }
    static xor(t) {
        let e = null,
        ...
        for (let l of a)
            (i += l.type === "s" ? 1 : -1), i === 1 ? (e = l.time) : (e && +e != +l.time && n.push(s.fromDateTimes(e, l.time)), (e = null));
        return s.merge(n);
    }
    difference(...t) {
        return s
    ...
    toLocaleString(t = he, e = {}) {
        return this.isValid ? it.create(this.s.loc.clone(e), t).formatInterval(this) : ps;
    }
    toISO(t) {
    ...
    toISOTime(t) {
        return this.isValid ? `${this.s.toISOTime(t)}/${this.e.toISOTime(t)}` : ps;
    }
    toFormat(t, { separator: e = " \u2013 " } = {}) {
        return this.isValid ? `${this.s.toFormat(t)}${e}${this.e.toFormat(t)}` : ps;
    }
    toDuration(t, e) {
        return this.isValid ? this.e.diff(this.s, t, e) : G.invalid(this.invalidReason);
    }
    mapEndpoints(t) {
...
var te = class {
    ...
    static months(t = "long", { locale: e = null, numberingSystem: i = null, locObj: n = null, outputCalendar: o = "gregory" } = {}) {
        return (n || W.create(e, i, o)).months(t);
    }
    static monthsFormat(t = "long", { locale: e = null, numberingSystem: i = null, locObj: n = null, outputCalendar: o = "gregory" } = {}) {
        return (n || W.create(e, i, o)).months(t, !0);
    }
    static weekdays(t = "long", { locale: e = null, numberingSystem: i = null, locObj: n = null } = {}) {
        return (n || W.create(e, i, null)).weekdays(t);
    }
    static weekdaysFormat(t = "long", { locale: e = null, numberingSystem: i = null, locObj: n = null } = {}) {
...
function Lg(s, t, e) {
    ...
    for (let [l, c] of i)
        e.indexOf(l) >= 0 &&
            ((r = l), (n[l] = c(s, t)), (a = o.plus(n)), a > t ? (n[l]--, (s = o.plus(n)), s > t && ((a = s), n[l]--, (s = o.plus(n)))) : (s = a));
    return [s, n, a, r];
}
function Pc(s, t, e, i) {
    ...
    c.length === 0 && (r < t && (r = n.plus({ [a]: 1 })), r !== n && (o[a] = (o[a] || 0) + l / (r - n)));
...
function At(s, t) {
    return s === null ? null : { regex: RegExp(s.map(Rg).join("|")), deser: ([e]) => s.findIndex((i) => Nc(e) === Nc(i)) + t };
}
function Rc(s, t) {
...
function zg(s, t) {
    let e = kt(t),
        ...
        u = kt(t, "{2,4}"),
        d = kt(t, "{4,6}"),
        f = (p) => ({ regex: RegExp(Wg(p.val)), deser: ([y]) => y, literal: !0 }),
        g = ((p) => {
...
var wi = class {
    ...
    explainFromTokens(t) {
        if (this.isValid) {
            ...
            if (me(i, "a") && me(i, "H")) throw new Dt("Can't include meridiem when specifying 24-hour format");
            return { input: t, tokens: this.tokens, regex: this.regex, rawMatches: e, matches: i, result: n, zone: o, specificOffset: r };
...
function Vc(s, t, e) {
    let { result: i, zone: n, specificOffset: o, invalidReason: r } = _r(s, t, e);
    return [i, n, o, r];
}
function wr(s, t) {
    if (!s) return null;
...
function Mr(s) {
    return s.localWeekData === null && (s.localWeekData = mi(s.c, s.loc.getMinDaysInFirstWeek(), s.loc.getStartOfWeek())), s.localWeekData;
}
function Le(s, t) {
...
function Bc(s, t) {
    let e = s.o,
        ...
        o = { ...s.c, year: i, month: n, day: Math.min(s.c.day, ls(i, n)) + Math.trunc(t.days) + Math.trunc(t.weeks) * 7 },
        r = G.fromObject({
...
function bs(s, t, e, i, n, o) {
    ...
    } else return F.invalid(new st("unparsable", `the input "${n}" can't be parsed as ${i}`));
}
function kn(s, t, e = !0) {
    return s.isValid ? it.create(W.create("en-US"), { allowZ: e, forceSimple: !0 }).formatDateTimeFromString(s, t) : null;
}
function vr(s, t, e) {
    ...
    return (
        n &&
            (s.isOffsetFixed && s.offset === 0 && !o
                ? (l += "Z")
                : s.o < 0
                  ? ((l += "-"), (l += q(Math.trunc(-s.o / 60))), (l += ":"), (l += q(Math.trunc(-s.o % 60))))
                  : ((l += "+"), (l += q(Math.trunc(s.o / 60))), (l += ":"), (l += q(Math.trunc(s.o % 60))))),
        o && (l += "[" + s.zone.ianaName + "]"),
        l
    );
...
var Gc = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    Zg = { weekNumber: 1, weekday: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
...
function Kg(s) {
    if ((ki === void 0 && (ki = R.now()), s.type !== "iana")) return s.offset(ki);
    let t = s.name,
        e = Tr.get(t);
...
function Yc(s, t, e) {
    let i = D(e.round) ? !0 : e.round,
        ...
        o = (a, l) => ((a = rs(a, i || e.calendary ? 0 : 2, e.calendary ? "round" : n)), t.loc.clone(e).relFormatter(e).format(a, l)),
        r = (a) => (e.calendary ? (t.hasSame(s, a) ? 0 : t.startOf(a).diff(s.startOf(a), a).get(a)) : t.diff(s, a).get(a));
    ...
    F = class s {
        constructor(t) {
            let e = t.zone || R.defaultZone,
                i = t.invalid || (Number.isNaN(t.ts) ? new st("invalid input") : null) || (e.isValid ? null : Si(e));
            ...
            if (!i)
                if (t.old && t.old.ts === this.ts && t.old.zone.equals(e)) [n, o] = [t.old.c, t.old.o];
                    ...
                    (n = Sn(this.ts, a)), (i = Number.isNaN(n.year) ? new st("invalid input") : null), (n = i ? null : n), (o = i ? null : a);
                }
            (this._zone = e),
                (this.loc = t.loc || W.create()),
                (this.invalid = i),
        ...
        static local() {
            let [t, e] = Zc(arguments),
                [i, n, o, r, a, l, c] = e;
            return Uc({ year: i, month: n, day: o, hour: r, minute: a, second: l, millisecond: c }, t);
        }
        static utc() {
            let [t, e] = Zc(arguments),
                [i, n, o, r, a, l, c] = e;
            return (t.zone = et.utcInstance), Uc({ year: i, month: n, day: o, hour: r, minute: a, second: l, millisecond: c }, t);
        }
        static fromJSDate(t, e = {}) {
            ...
            return n.isValid ? new s({ ts: i, zone: n, loc: W.fromObject(e) }) : s.invalid(Si(n));
        }
        static fromMillis(t, e = {}) {
            if (Ft(t))
                return t < -Hc || t > Hc
                    ? s.invalid("Timestamp out of range")
                    : new s({ ts: t, zone: Ct(e.zone, R.defaultZone), loc: W.fromObject(e) });
            throw new K(`fromMillis requires a numerical input, but received a ${typeof t} with value ${t}`);
        }
        static fromSeconds(t, e = {}) {
            if (Ft(t)) return new s({ ts: t * 1e3, zone: Ct(e.zone, R.defaultZone), loc: W.fromObject(e) });
        ...
        static fromObject(t, e = {}) {
            ...
            if ((f || h) && m) throw new Dt("Can't mix weekYear/weekNumber units with year/month/day or ordinals");
            if (d && h) throw new Dt("Can't mix ordinal dates with month/day");
            let g = m || (o.weekday && !f),
                p,
                y,
                b = Sn(l, c);
            g ? ((p = Gg), (y = Zg), (b = mi(b, r, a))) : h ? ((p = Xg), (y = qg), (b = _n(b))) : ((p = vn), (y = Gc));
            let _ = !1;
            for (let E of p) {
                let C = o[E];
            ...
            return o.weekday && f && t.weekday !== O.weekday
                ? s.invalid("mismatched weekday", `you can't specify both a weekday of ${o.weekday} and a date of ${O.toISO()}`)
                : O.isValid
                  ? O
                  : s.invalid(O.invalid);
        }
        ...
        static fromFormat(t, e, i = {}) {
            if (D(t) || D(e)) throw new K("fromFormat requires an input string and a format");
            let { locale: n = null, numberingSystem: o = null } = i,
                r = W.fromOpts({ locale: n, numberingSystem: o, defaultToEN: !0 }),
                [a, l, c, h] = Vc(r, t, e);
        ...
        getPossibleOffsets() {
            ...
            let l = i - r * e,
                ...
                h = Sn(l, r),
                u = Sn(c, a);
            return h.hour === u.hour && h.minute === u.minute && h.second === u.second && h.millisecond === u.millisecond
        ...
        resolvedLocaleOptions(t = {}) {
            let { locale: e, numberingSystem: i, calendar: n } = it.create(this.loc.clone(t), t).resolvedOptions(this);
        ...
        set(t) {
            ...
            if ((c || r) && h) throw new Dt("Can't mix weekYear/weekNumber units with year/month/day or ordinals");
            if (l && r) throw new Dt("Can't mix ordinal dates with month/day");
            let u;
            o
                ? (u = or({ ...mi(this.c, i, n), ...e }, i, n))
                : D(e.ordinal)
                  ? ((u = { ...this.toObject(), ...e }), D(e.day) && (u.day = Math.min(ls(u.year, u.month), u.day)))
                  : (u = rr({ ..._n(this.c), ...e }));
            ...
            if (n === "weeks")
                if (e) {
                    let o = this.loc.getStartOfWeek(),
                        { weekday: r } = this;
                    r < o && (i.weekNumber = this.weekNumber - 1), (i.weekday = o);
                } else i.weekday = 1;
            if (n === "quarters") {
        ...
        toFormat(t, e = {}) {
            return this.isValid ? it.create(this.loc.redefaultToEN(e)).formatDateTimeFromString(this, t) : Sr;
        }
        toLocaleString(t = he, e = {}) {
            return this.isValid ? it.create(this.loc.clone(e), t).formatDateTime(this) : Sr;
        }
        toLocaleParts(t = {}) {
        ...
        toISO({
            ...
            let a = t === "extended",
                l = vr(this, a, r);
            return vn.indexOf(r) >= 3 && (l += "T"), (l += $c(this, a, e, i, n, o, r)), l;
        }
        ...
        toISOTime({
            ...
            return this.isValid ? ((a = Tn(a)), (n && vn.indexOf(a) >= 3 ? "T" : "") + $c(this, r === "extended", e, t, i, o, a)) : null;
        }
        toRFC2822() {
        ...
        toSQLTime({ includeOffset: t = !0, includeZone: e = !1, includeOffsetSpace: i = !0 } = {}) {
            let n = "HH:mm:ss.SSS";
            return (e || t) && (i && (n += " "), e ? (n += "z") : t && (n += "ZZ")), kn(this, n, !0);
        }
        toSQL(t = {}) {
        ...
        diff(t, e = "milliseconds", i = {}) {
            if (!this.isValid || !t.isValid) return G.invalid("created by diffing an invalid DateTime");
        ...
        toRelative(t = {}) {
            ...
            let e = t.base || s.fromObject({}, { zone: this.zone }),
                ...
                o = t.unit;
            return Array.isArray(t.unit) && ((n = t.unit), (o = void 0)), Yc(e, this.plus(i), { ...t, numeric: "always", units: n, unit: o });
        }
        ...
        static min(...t) {
            if (!t.every(s.isDateTime)) throw new K("min requires all arguments be DateTimes");
            return hr(t, (e) => e.valueOf(), Math.min);
        }
        static max(...t) {
            if (!t.every(s.isDateTime)) throw new K("max requires all arguments be DateTimes");
        ...
        static buildFormatParser(t, e = {}) {
            let { locale: i = null, numberingSystem: n = null } = e,
                o = W.fromOpts({ locale: i, numberingSystem: n, defaultToEN: !0 });
            return new wi(o, t);
        }
        static fromFormatParser(t, e, i = {}) {
            if (D(t) || D(e)) throw new K("fromFormatParser requires an input string and a format parser");
            let { locale: n = null, numberingSystem: o = null } = i,
                r = W.fromOpts({ locale: n, numberingSystem: o, defaultToEN: !0 });
            if (!r.equals(e.locale)) throw new K(`fromFormatParser called with a locale of ${r}, but the format parser was created for ${e.locale}`);
        ...
        return s === null || i === "undefined"
            ...
            : (i === "number"
                  ...
                  : i === "string"
                    ...
                    : s instanceof Date
                      ? (s = F.fromJSDate(s, e))
                      : i === "object" && !(s instanceof F) && (s = F.fromObject(s, e)),
    ...
    return {
        init() {
            this.initChart(),
                this.$wire.$on("updateChartData", ({ data: i }) => {
                    (On = this.getChart()), (On.data = i), On.update("resize");
                }),
                Alpine.effect(() => {
                    Alpine.store("theme"),
                        this.$nextTick(() => {
        ...
        initChart(i = null) {
            ...
            if (
                ...
                return;
            (Ht.defaults.animation.duration = 0), (Ht.defaults.backgroundColor = getComputedStyle(this.$refs.backgroundColorElement).color);
            let n = getComputedStyle(this.$refs.borderColorElement).color;
            (Ht.defaults.borderColor = n),
                (Ht.defaults.color = getComputedStyle(this.$refs.textColorElement).color),
                (Ht.defaults.font.family = getComputedStyle(this.$el).fontFamily),
            ...
            return (
                ...
                new Ht(this.$refs.canvas, { type: e, data: i ?? s, options: t, plugins: window.filamentChartJsPlugins ?? [] })
            );
        },
        getChart() {
