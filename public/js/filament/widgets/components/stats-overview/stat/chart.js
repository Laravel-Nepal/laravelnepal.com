...
function ia(i) {
    ...
    return (
        i[0] === "#" &&
            (t === 4 || t === 5
                ? (e = { r: 255 & (nt[i[1]] * 17), g: 255 & (nt[i[2]] * 17), b: 255 & (nt[i[3]] * 17), a: t === 5 ? nt[i[4]] * 17 : 255 })
                : (t === 7 || t === 9) &&
                  (e = {
                      r: (nt[i[1]] << 4) | nt[i[2]],
                      g: (nt[i[3]] << 4) | nt[i[4]],
...
var oa = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function Ns(i, t, e) {
...
function Ti(i) {
    let e = i.r / 255,
        ...
        c,
        h;
    return o !== a && ((h = o - a), (c = r > 0.5 ? h / (2 - o - a) : h / (o + a)), (l = la(e, s, n, h, o)), (l = l * 60 + 0.5)), [l | 0, c || 0, r];
}
function Li(i, t, e, s) {
...
function da(i) {
    ...
    let n = Hs(+t[2]),
        o = +t[3] / 100,
        a = +t[4] / 100;
    return t[1] === "hwb" ? (s = ca(n, o, a)) : t[1] === "hsv" ? (s = ha(n, o, a)) : (s = Ri(n, o, a)), { r: s[0], g: s[1], b: s[2], a: e };
}
function ua(i, t) {
    var e = Ti(i);
...
var ma = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
function ba(i) {
    let t = ma.exec(i),
        e = 255,
        s,
...
var Ci = (i) => (i <= 0.0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - 0.055),
...
function Ws(i) {
    ...
    return (
        Array.isArray(i)
            ? i.length >= 3 && ((t = { r: i[0], g: i[1], b: i[2], a: 255 }), i.length > 3 && (t.a = St(i[3])))
...
var _e = class i {
    constructor(t) {
        ...
        let e = typeof t,
            s;
        e === "object" ? (s = Ws(t)) : e === "string" && (s = ia(t) || pa(t) || ya(t)), (this._rgb = s), (this._valid = !!s);
    }
    get valid() {
        return this._valid;
    }
...
function Ma(i, t, e) {
    ...
    let s = t[i],
        n = e[i];
    T(s) && T(n) ? Qt(s, n) : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = Je(n));
}
...
function Xi(i, t, e) {
    ...
    if (i._sorted) {
        ...
        if (g) {
            let p = Math.max(ct(l, a.axis, u, !0).hi + 1, e ? 0 : ct(t, h, a.getPixelForValue(u), !0).hi + 1);
            if (c) {
...
var Ke = (i) => i === 0 || i === 1,
    ...
    Gt = {
        ...
        easeInOutElastic(i) {
            return Ke(i) ? i : i < 0.5 ? 0.5 * Us(i * 2, 0.1125, 0.45) : 0.5 + 0.5 * Xs(i * 2 - 1, 0.1125, 0.45);
        },
        easeInBack(i) {
...
function Ta(i) {
    i.set("animation", { delay: void 0, duration: 1e3, easing: "easeOutQuart", fn: void 0, from: void 0, loop: void 0, to: void 0, type: void 0 }),
        ...
        i.set("animations", { colors: { type: "color", properties: Aa }, numbers: { type: "number", properties: Ca } }),
...
var gn = {
    ...
    logarithmic(i, t, e) {
        ...
        return [1, 2, 3, 5, 10, 15].includes(s) || t > 0.8 * e.length ? gn.numeric.call(this, i, t, e) : "";
    },
};
function Ea(i, t) {
...
function pn(i, t, e, s) {
    ...
    for (l = 0; l < r; l++)
        ...
        else if (z(d)) for (c = 0, h = d.length; c < h; c++) (u = d[c]), u != null && !z(u) && (a = Me(i, n, o, a, u));
    i.restore();
    let f = o.length / 2;
    if (f > e.length) {
...
function $(i, t) {
    ...
    s && !("" + s).match(Na) && (console.warn('Invalid font style specified: "' + s + '"'), (s = void 0));
    let n = {
...
function ts(i, t = { scriptable: !0, indexable: !0 }) {
    ...
    return { allKeys: n, scriptable: e, indexable: s, isScriptable: bt(e) ? e : () => e, isIndexable: bt(s) ? s : () => s };
}
var $a = (i, t) => (i ? i + ii(t) : t),
    es = (i, t) => T(t) && i !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function _n(i, t, e) {
...
function is(i, t, e, s) {
    ...
    return l === null || (typeof o < "u" && o !== e && ((l = qs(r, a, o, l, s)), l === null)) ? !1 : ci(Array.from(r), [""], n, o, () => Ga(t, e, s));
}
...
function Za(i, t, e, s) {
    let n;
    for (let o of t) if (((n = vn($a(o, i), e)), typeof n < "u")) return es(i, n) ? is(e, s, i, n) : n;
}
function vn(i, t) {
    for (let e of t) {
        if (!e) continue;
...
function nr(i, t) {
    ...
    for (e = 0, s = i.length; e < s; ++e)
        (a = o),
            ...
            o &&
                ((n = i[e]),
                a && ((n.cp1x = qe(n.cp1x, t.left, t.right)), (n.cp1y = qe(n.cp1y, t.top, t.bottom))),
                r && ((n.cp2x = qe(n.cp2x, t.left, t.right)), (n.cp2y = qe(n.cp2y, t.top, t.bottom))));
}
function kn(i, t, e, s, n) {
    let o, a, r, l;
    if ((t.spanGaps && (i = i.filter((c) => !c.skip)), t.cubicInterpolationMode === "monotone")) sr(i, n);
    else {
...
function wn(i, t, e, s) {
    ...
    return (
        ...
        c && !h && (h = Ge(c / 2)),
        (t !== void 0 || e !== void 0) && s && l.height && h > l.height && ((h = l.height), (c = Ge(Math.floor(h * s)))),
        { width: c, height: h }
    );
}
function ns(i, t, e) {
    ...
    let a = i.canvas;
    return (
        a.style && (e || (!a.style.height && !a.style.width)) && ((a.style.height = `${i.height}px`), (a.style.width = `${i.width}px`)),
...
function On(i) {
    return i === "angle" ? { between: ie, compare: Oa, normalize: X } : { between: ut, compare: (t, e) => t - e, normalize: (t) => t };
}
        ...
        (x = t[S % a]),
            !x.skip &&
                ...
                b !== v &&
                    ...
                    m !== null && w() && (g.push(Zs({ start: m, end: S, loop: u, count: a, style: f })), (m = null)),
                    (P = S),
                    (v = b)));
    return m !== null && g.push(Zs({ start: m, end: d, loop: u, count: a, style: f })), g;
}
function cs(i, t) {
    let e = [],
        s = i.segments;
...
function pr(i, t, e, s) {
    ...
    for (let g of t) {
        ...
        for (u = d + 1; u <= g.end; u++) {
            let b = e[u % l];
            (m = Qs(s.setContext(yt(n, { type: "segment", p0: p, p1: b, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: a })))),
...
function br(i, t) {
    ...
    return e && s ? { left: Ze(e, t, "left"), right: Ze(e, t, "right"), top: Ze(s, t, "top"), bottom: Ze(s, t, "bottom") } : t;
}
function hs(i, t) {
    let e = t._clip;
...
function En(i, t) {
    ...
    for (let f = 0; f < d; ++f) {
        ...
        (u = b[c] = Pr(n, h, p)), (u[r] = m), (u._top = Rn(u, a, !0, s.type)), (u._bottom = Rn(u, a, !1, s.type));
...
function Dr(i, t) {
    return yt(i, { active: !1, dataset: void 0, datasetIndex: t, index: t, mode: "default", type: "dataset" });
}
function Or(i, t, e) {
    return yt(i, { active: !1, dataIndex: t, parsed: void 0, raw: void 0, element: e, index: t, mode: "default", type: "data" });
}
function De(i, t) {
...
var fs = (i) => i === "reset" || i === "none",
    ...
    Cr = (i, t, e) => i && !t.hidden && t._stacked && { keys: Ao(e, !0), values: null },
    it = class {
        constructor(t, e) {
            (this.chart = t),
                (this._ctx = t.ctx),
        ...
        updateRangeFromParsed(t, e, s, n) {
            ...
            n && r && ((n.values = r), (a = Ln(n, o, this._cachedMeta.index))), (t.min = Math.min(t.min, a)), (t.max = Math.max(t.max, a));
        }
        getMinMax(t, e) {
        ...
        _update(t) {
            let e = this._cachedMeta;
            this.update(t || "default"), (e._clip = Mr(D(this.options.clip, vr(e.xScale, e.yScale, this.getMaxOverflow()))));
        }
        update(t) {}
        draw() {
            let t = this._ctx,
...
function Tr(i) {
    let t = i.iScale,
        ...
        r,
        l = () => {
            a === 32767 || a === -32768 || (te(r) && (s = Math.min(s, Math.abs(a - r) || s)), (r = a));
        };
...
function Er(i, t, e, s) {
    let n = e.parse(i[0], s),
        ...
        l = a,
        c = r;
    Math.abs(a) > Math.abs(r) && ((l = r), (c = a)), (t[e.axis] = c), (t._custom = { barStart: l, barEnd: c, start: n, end: o, min: a, max: r });
}
function To(i, t, e, s) {
...
function zr(i, t, e, s) {
    ...
    n === "middle" &&
        e &&
        ((i.enableBorderRadius = !0), (e._top || 0) === s ? (n = c) : (e._bottom || 0) === s ? (n = h) : ((o[zn(h, a, r, l)] = !0), (n = c))),
        (o[zn(n, a, r, l)] = !0),
        (i.borderSkipped = o);
}
function zn(i, t, e, s) {
...
var re = class extends it {
    ...
    parseObjectData(t, e, s, n) {
        let { iScale: o, vScale: a } = t,
            ...
            g,
            p;
        for (u = s, f = s + n; u < f; ++u) (p = e[u]), (g = {}), (g[o.axis] = o.parse(_t(p, c), u)), d.push(To(_t(p, h), g, a, u));
        return d;
    }
    updateRangeFromParsed(t, e, s, n) {
    ...
    _getStacks(t, e) {
        ...
        for (let h of n)
            if (
                !(e !== void 0 && c(h)) &&
                ((o === !1 || a.indexOf(h.stack) === -1 || (o === void 0 && h.stack === void 0)) && a.push(h.stack), h.index === t)
            )
                break;
    ...
    _getAxis() {
        ...
        for (let s of this.chart.data.datasets) t[D(this.chart.options.indexAxis === "x" ? s.xAxisID : s.yAxisID, e)] = !0;
        return Object.keys(t);
    }
    ...
    _calculateBarValuePixels(t) {
        let {
            ...
            p;
        f !== d && ((u = f - d), (f = d)),
            h && ((d = c.barStart), (f = c.barEnd - c.barStart), d !== 0 && lt(d) !== lt(c.barEnd) && (u = 0), (u += d));
        let m = !A(o) && !h ? o : u,
...
M(re, "id", "bar"),
    ...
    M(re, "overrides", { scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
    ...
    updateElements(t, e, s, n) {
        ...
        for (let u = e; u < e + s; u++) {
            ...
            (p.skip = isNaN(m) || isNaN(b)),
                c && ((p.options = l || this.resolveDataElementOptions(u, f.active ? "active" : n)), o && (p.options.radius = 0)),
...
M(le, "id", "bubble"),
    ...
    M(le, "overrides", { scales: { x: { type: "linear" }, y: { type: "linear" } } });
function Wr(i, t, e) {
    let s = 1,
        n = 1,
        o = 0,
    ...
    if (t < B) {
        let r = i,
            ...
            d = Math.cos(l),
            u = Math.sin(l),
            f = (v, y, _) => (ie(v, r, l, !0) ? 1 : Math.max(y, y * e, _, _ * e)),
            g = (v, y, _) => (ie(v, r, l, !0) ? -1 : Math.min(y, y * e, _, _ * e)),
            p = f(0, c, d),
            m = f(H, h, u),
            b = g(R, c, d),
            x = g(R + H, h, u);
    ...
    updateElements(t, e, s, n) {
        ...
        for (x = e; x < e + s; ++x) {
            let v = this._circumference(x, o),
                y = t[x],
                _ = { x: h + this.offsetX, y: d + this.offsetY, startAngle: b, endAngle: b + v, circumference: v, outerRadius: g, innerRadius: f };
    ...
    updateElements(t, e, s, n) {
        ...
        for (let _ = 0; _ < v; ++_) {
            ...
            let S = this.getParsed(_),
                ...
                C = (w[f] = o || P ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, S, l) : S[f], _));
...
M(ce, "id", "line"),
    M(ce, "defaults", { datasetElementType: "line", dataElementType: "point", showLine: !0, spanGaps: !1 }),
    M(ce, "overrides", { scales: { _index_: { type: "category" }, _value_: { type: "linear" } } });
...
M(Le, "id", "pie"), M(Le, "defaults", { cutout: 0, rotation: 0, circumference: 360, radius: "100%" });
...
M(he, "id", "radar"),
    M(he, "defaults", { datasetElementType: "line", dataElementType: "point", indexAxis: "r", showLine: !0, elements: { line: { fill: "start" } } }),
    M(he, "overrides", { aspectRatio: 1, scales: { r: { type: "radialLinear" } } });
var de = class extends it {
    ...
    update(t) {
        ...
        if (((this._drawStart = o), (this._drawCount = a), Ki(e) && ((o = 0), (a = s.length)), this.options.showLine)) {
    ...
    updateElements(t, e, s, n) {
        ...
        for (let y = e; y < e + s; ++y) {
            let _ = t[y],
                ...
                O = (w[g] = o || S ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, k, l) : k[g], y));
...
M(de, "id", "scatter"),
    M(de, "defaults", { datasetElementType: !1, dataElementType: "point", showLine: !1, fill: !1 }),
    M(de, "overrides", { interaction: { mode: "point" }, scales: { x: { type: "linear" }, y: { type: "linear" } } });
    ...
    return (
        (!n && !i.isPointInArea(t)) ||
            je(
                ...
                t,
                function (r, l, c) {
                    (!n && !ht(r, i.chartArea, 0)) || (r.inRange(t.x, t.y, s) && o.push({ element: r, datasetIndex: l, index: c }));
                },
                !0,
            ),
        o
...
function Ur(i, t, e, s, n, o) {
    ...
    function c(h, d, u) {
        ...
        let m = r(t, g);
        m < l ? ((a = [{ element: h, datasetIndex: d, index: u }]), (l = m)) : m === l && a.push({ element: h, datasetIndex: d, index: u });
    }
    return je(i, e, t, c), a;
}
...
function Vn(i, t, e, s, n) {
    ...
    return (
        je(i, e, t, (l, c, h) => {
            l[a] && l[a](t[e], n) && (o.push({ element: l, datasetIndex: c, index: h }), (r = r || l.inRange(t.x, t.y, n)));
        }),
        s && !r ? [] : o
    );
}
...
function Kr(i) {
    ...
    for (e = 0, s = (i || []).length; e < s; ++e)
        (n = i[e]),
            ...
            t.push({ index: e, box: n, pos: o, horizontal: n.isHorizontal(), weight: n.weight, stack: a && o + a, stackWeight: r });
    return t;
}
function qr(i) {
    let t = {};
    ...
    for (let r of i) {
        ...
        if (r.horizontal) {
            ...
            te(c.start) && (a = c.start),
                l.fullSize ? fi(l, n.left, a, e.outerWidth - n.right - n.left, u) : fi(l, t.left + c.placed, a, d, u),
                (c.start = a),
                (c.placed += d),
                (a = l.bottom);
        } else {
            ...
            te(c.start) && (o = c.start),
                l.fullSize ? fi(l, o, n.top, u, e.outerHeight - n.bottom - n.top) : fi(l, o, t.top + c.placed, u, d),
                (c.start = o),
                (c.placed += d),
                (o = l.right);
        }
...
var Z = {
        ...
        update(i, t, e, s) {
            ...
            Re(r.fullSize, f, d, g),
                ...
                (i.chartArea = { left: f.left, top: f.top, right: f.left + f.w, bottom: f.top + f.h, height: f.h, width: f.w }),
                E(r.chartArea, (p) => {
                    let m = p.box;
...
function il(i, t) {
    ...
    if (
        ((i[_i] = { initial: { height: s, width: n, style: { display: e.display, height: e.height, width: e.width } } }),
...
function fl(i, t) {
    ...
    if (a > 0) {
        ...
        for (gi(t, c, h, A(f) ? 0 : r - f, r), d = 0, u = a - 1; d < u; d++) gi(t, c, h, o[d], o[d + 1]);
...
function yl(i, t, e) {
    ...
    if (
        !(
            e &&
            (s === 1 ? (c = Math.max(l - o, a - l)) : t === 0 ? (c = (i.getPixelForTick(1) - l) / 2) : (c = (l - i.getPixelForTick(n - 1)) / 2),
            (l += n < t ? c : -c),
            l < o - r || l > a + r)
        )
    )
...
var Ut = class i extends st {
        ...
        generateTickLabels(t) {
            let e = this.options.ticks,
                ...
                n,
                o;
            for (s = 0, n = t.length; s < n; s++) (o = t[s]), (o.label = F(e.callback, [o.value, s, t], this));
        }
        ...
        calculateLabelRotation() {
            ...
            (r = t.offset ? this.maxWidth / s : f / (s - 1)),
                d + 6 > r &&
                    ...
                    (l = this.maxHeight - Ae(t.grid) - e.padding - Kn(t.title, this.chart.options.font)),
                    (c = Math.sqrt(d * d + u * u)),
                    (a = si(Math.min(Math.asin(Y((h.highest.height + 6) / r, -1, 1)), Math.asin(Y(l / c, -1, 1)) - Math.asin(Y(u / c, -1, 1))))),
        ...
        fit() {
            ...
            if (a) {
                ...
                if (
                    (r ? ((t.width = this.maxWidth), (t.height = Ae(o) + l)) : ((t.height = this.maxHeight), (t.width = Ae(o) + l)),
        ...
        _getLabelSizes() {
            ...
            if (!t) {
                let e = this.options.ticks.sampleSize,
                    s = this.ticks;
                e < s.length && (s = Xn(s, e)), (this._labelSizes = t = this._computeLabelSizes(s, s.length, this.options.ticks.maxTicksLimit));
            }
            return t;
        }
        _computeLabelSizes(t, e, s) {
            ...
            for (d = 0; d < e; d += l) {
                ...
                else if (z(g)) for (u = 0, f = g.length; u < f; ++u) (_ = g[u]), !A(_) && !z(_) && ((v = Me(n, b.data, b.gc, v, _)), (y += x));
        ...
        _computeGridLineItems(t) {
            let e = this.axis,
                ...
                L,
                U;
            if (a === "top") (x = b(this.bottom)), (w = this.bottom - u), (P = x - m), (C = b(t.top) + m), (U = t.bottom);
            else if (a === "bottom") (x = b(this.top)), (C = t.top), (U = b(t.bottom) - m), (w = x + m), (P = this.top + u);
            else if (a === "left") (x = b(this.right)), (k = this.right - u), (S = x - m), (O = b(t.left) + m), (L = t.right);
            else if (a === "right") (x = b(this.left)), (O = t.left), (L = b(t.right) - m), (k = x + m), (S = this.left + u);
            else if (e === "x") {
        ...
        _computeLabelItems(t) {
            ...
            for (b = 0, x = r.length; b < x; ++b) {
                ...
                (S = this.getPixelForTick(b) + o.labelOffset), (P = this._resolveTickFontOptions(b)), (O = P.lineHeight), (C = z(y) ? y.length : 1);
                let W = C / 2,
                    j = I.color,
                ...
                a
                    ? ((_ = S),
                      ...
                      d && (L *= -1),
                      p !== 0 && !I.showLabelBackdrop && (_ += (O / 2) * Math.sin(p)))
                    : ((k = S), (L = ((1 - C) * O) / 2));
                let $e;
                if (I.showLabelBackdrop) {
                    ...
                    $e = { left: Et, top: be, width: Rt + Kt.width, height: me + Kt.height, color: I.backdropColor };
                }
                m.push({
                    label: y,
                    font: P,
        ...
        _getYAxisLabelAlignment(t) {
            ...
            return (
                e === "left"
                    ? n
                        ? ((h = this.right + o),
                          s === "near" ? (c = "left") : s === "center" ? ((c = "center"), (h += l / 2)) : ((c = "right"), (h += l)))
                        : ((h = this.right - r),
                          s === "near" ? (c = "right") : s === "center" ? ((c = "center"), (h -= l / 2)) : ((c = "left"), (h = this.left)))
                    : e === "right"
                      ? n
                          ? ((h = this.left + o),
                            s === "near" ? (c = "right") : s === "center" ? ((c = "center"), (h -= l / 2)) : ((c = "left"), (h -= l)))
                          : ((h = this.left + r),
                            s === "near" ? (c = "left") : s === "center" ? ((c = "center"), (h += l / 2)) : ((c = "right"), (h = this.right)))
                      : (c = "right"),
                { textAlign: c, x: h }
            );
        }
        ...
        drawTitle() {
            ...
            let o = $(s.font),
                ...
                r = s.align,
                l = o.lineHeight / 2;
            e === "bottom" || e === "center" || T(e) ? ((l += a.bottom), z(s.text) && (l += o.lineHeight * (s.text.length - 1))) : (l += a.top);
            let { titleX: c, titleY: h, maxWidth: d, rotation: u } = Sl(this, l, e, r);
            Ct(t, s.text, 0, 0, o, { color: s.color, maxWidth: d, rotation: u, textAlign: wl(r, e, n), textBaseline: "middle", translation: [c, h] });
        }
        draw(t) {
    ...
    ge = class {
        ...
        register(t) {
            ...
            return o in n || ((n[o] = t), Pl(t, a, s), this.override && V.override(t.id, t.overrides)), a;
        }
        get(t) {
            return this.items[t];
        }
        unregister(t) {
            let e = this.items,
                s = t.id,
                n = this.scope;
            s in e && delete e[s], n && s in V[n] && (delete V[n][s], this.override && delete Dt[s]);
        }
    };
function Pl(i, t, e) {
...
function Ll(i, { plugin: t, local: e }, s, n) {
    ...
    return e && t.defaults && a.push(t.defaults), i.createResolver(a, n, [""], { scriptable: !1, indexable: !1, allKeys: !0 });
}
function Cs(i, t) {
    let e = V.datasets[i] || {};
    ...
    return (
        ...
        i.data.datasets.forEach((a) => {
            ...
            Object.keys(h).forEach((d) => {
                let u = Rl(d, l),
                    f = a[u + "AxisID"] || u;
                (o[f] = o[f] || Object.create(null)), Qt(o[f], [{ axis: u }, s[f], h[d]]);
            });
        }),
...
var Te = (i, t, e) => {
    ...
    Ts = class {
        ...
        datasetElementScopeKeys(t, e) {
            return pi(`${t}-${e}`, () => [[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, ""]]);
        }
        pluginScopeKeys(t) {
            let e = t.id,
                s = this.type;
...
function Jn(i, t, e) {
    ...
    let n = e.join(),
        o = s.get(n);
    return o || ((o = { resolver: ci(t, e), subPrefixes: e.filter((r) => !r.toLowerCase().includes("hover")) }), s.set(n, o)), o;
}
...
var at = class {
    ...
    constructor(t, e) {
        ...
        vt.listen(this, "complete", eo), vt.listen(this, "progress", jl), this._initialize(), this.attached && this.update();
    }
    get aspectRatio() {
        let {
    ...
    _resize(t, e) {
        ...
        (this.width = a.width),
            ...
            (this._aspectRatio = this.aspectRatio),
            ns(this, r, !0) &&
                (this.notifyPlugins("resize", { size: a }), F(s.onResize, [this, a], this), this.attached && this._doResize(l) && this.render());
    }
    ensureScalesHaveIDs() {
            ...
            (o = o.concat(
                Object.keys(e).map((a) => {
                    let r = e[a],
                        ...
                        c = l === "r",
                        h = l === "x";
                    return { options: r, dposition: c ? "chartArea" : h ? "bottom" : "left", dtype: c ? "radialLinear" : h ? "category" : "linear" };
                }),
            )),
            E(o, (a) => {
                let r = a.options,
    ...
    buildOrUpdateControllers() {
        ...
        for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
            ...
            if (
                ...
                Object.assign(l, { dataElementType: gt.getElement(h), datasetElementType: c && gt.getElement(c) }),
    ...
    _updateDatasets(t) {
        if (this.notifyPlugins("beforeDatasetsUpdate", { mode: t, cancelable: !0 }) !== !1) {
            ...
            for (let e = 0, s = this.data.datasets.length; e < s; ++e) this._updateDataset(e, bt(t) ? t({ datasetIndex: e }) : t);
    ...
    render() {
        this.notifyPlugins("beforeRender", { cancelable: !0 }) !== !1 &&
            (vt.has(this) ? this.attached && !vt.running(this) && vt.start(this) : (this.draw(), eo({ chart: this })));
    }
    draw() {
        let t;
    ...
    _drawDataset(t) {
        ...
        this.notifyPlugins("beforeDatasetDraw", s) !== !1 &&
            (n && Se(e, n), t.controller.draw(), n && Pe(e), (s.cancelable = !1), this.notifyPlugins("afterDatasetDraw", s));
    }
    isPointInArea(t) {
    ...
    _updateVisibility(t, e, s) {
        ...
        te(e)
            ...
            : (this.setDatasetVisibility(t, s), a.update(o, { visible: s }), this.update((r) => (r.datasetIndex === t ? n : void 0)));
    }
    hide(t, e) {
    ...
    destroy() {
        ...
        this._stop(),
            ...
            t && (this.unbindEvents(), Zi(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)),
            delete yi[this.id],
    ...
    updateHoverStyle(t, e, s) {
        let n = s ? "set" : "remove",
            ...
            l;
        for (
            e === "dataset" && ((o = this.getDatasetMeta(t[0].datasetIndex)), o.controller["_" + n + "DatasetHoverStyle"]()), r = 0, l = t.length;
            r < l;
            ++r
        ) {
            a = t[r];
    ...
    _handleEvent(t, e, s) {
        ...
        s && ((this._lastEvent = null), F(o.onHover, [t, r, this], this), l && F(o.onClick, [t, r, this], this));
        let h = !ke(r, n);
...
M(at, "defaults", V), M(at, "instances", yi), M(at, "overrides", Dt), M(at, "registry", gt), M(at, "version", Nl), M(at, "getChart", io);
function so() {
...
function ql(i, t, e, s) {
    ...
    return { outerStart: r(n.outerStart), outerEnd: r(n.outerEnd), innerStart: Y(n.innerStart, 0, a), innerEnd: Y(n.innerEnd, 0, a) };
}
function ae(i, t, e, s) {
...
function Zl(i, t, e, s, n) {
    ...
    i.setLineDash(d || []),
        (i.lineDashOffset = u),
        g ? ((i.lineWidth = c * 2), (i.lineJoin = h || "round")) : ((i.lineWidth = c), (i.lineJoin = h || "bevel"));
    let p = t.endAngle;
    if (o) {
        wi(i, t, e, s, p, n);
    ...
    g && Xl(i, t, p), l.selfJoin && p - a >= R && f === 0 && h !== "miter" && Ul(i, t, p), o || (wi(i, t, e, s, p, n), i.stroke());
}
var Ht = class extends st {
    ...
    draw(e) {
        ...
        let c = 1 - Math.sin(Math.min(R, n || 0)),
            h = o * c;
        (e.fillStyle = s.backgroundColor), (e.strokeStyle = s.borderColor), Gl(e, this, h, a, r), Zl(e, this, h, a, r), e.restore();
    }
};
M(Ht, "id", "arc"),
    M(Ht, "defaults", {
    ...
    M(Ht, "descriptors", { _scriptable: !0, _indexable: (e) => e !== "borderDash" });
function Wo(i, t, e = t) {
...
function Ql(i) {
    return i.stepped ? mn : i.tension || i.cubicInterpolationMode === "monotone" ? bn : Jl;
}
function No(i, t, e = {}) {
    let s = i.length,
...
function Ls(i) {
    ...
    return !i._decimated && !i._loop && !t.tension && t.cubicInterpolationMode !== "monotone" && !t.stepped && !e ? ec : tc;
}
function ic(i) {
...
function sc(i, t, e, s) {
    let n = t._path;
    n || ((n = t._path = new Path2D()), t.path(n, e, s) && n.closePath()), Wo(i, t.options), i.stroke(n);
}
function nc(i, t, e, s) {
    let { segments: n, options: o } = t,
        a = Ls(t);
    for (let r of n) Wo(i, o, r.style), i.beginPath(), a(i, t, r, { start: e, end: e + s - 1 }) && i.closePath(), i.stroke();
}
...
var pt = class extends st {
    ...
    get segments() {
        return this._segments || (this._segments = Cn(this, this.options.segment));
    }
    first() {
        let t = this.segments,
            e = this.points;
...
var ue = class extends st {
    ...
    draw(e, s) {
        ...
        this.skip ||
            ...
            ((e.strokeStyle = n.borderColor), (e.lineWidth = n.borderWidth), (e.fillStyle = n.backgroundColor), ri(e, n, this.x, this.y));
    }
    getRange() {
        let e = this.options || {};
...
M(ue, "id", "point"),
    M(ue, "defaults", { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: "circle", radius: 3, rotation: 0 }),
    M(ue, "defaultRoutes", { backgroundColor: "backgroundColor", borderColor: "borderColor" });
function Ho(i, t) {
...
function rc(i, t, e) {
    let s = i.options.borderWidth,
        n = i.borderSkipped,
        o = Qi(s);
    return { t: Lt(n.top, o.top, 0, e), r: Lt(n.right, o.right, 0, t), b: Lt(n.bottom, o.bottom, 0, e), l: Lt(n.left, o.left, 0, t) };
}
function lc(i, t, e) {
...
var fe = class extends st {
    ...
    draw(t) {
        let {
            ...
            r = hc(a.radius) ? ne : dc;
        t.save(),
            (a.w !== o.w || a.h !== o.h) && (t.beginPath(), r(t, _s(a, e, o)), t.clip(), r(t, _s(o, -e, a)), (t.fillStyle = s), t.fill("evenodd")),
            t.beginPath(),
            r(t, _s(o, e)),
            (t.fillStyle = n),
            t.fill(),
...
M(fe, "id", "bar"),
    M(fe, "defaults", { borderSkipped: "start", borderWidth: 0, borderRadius: 0, inflateAmount: "auto", pointStyle: void 0 }),
    M(fe, "defaultRoutes", { backgroundColor: "backgroundColor", borderColor: "borderColor" });
var uc = Object.freeze({ __proto__: null, ArcElement: Ht, BarElement: fe, LineElement: pt, PointElement: ue }),
    Rs = [
        "rgb(54, 162, 235)",
        "rgb(255, 99, 132)",
        "rgb(255, 159, 64)",
...
function mc(i) {
    ...
    return (e, s) => {
        ...
        n instanceof kt ? (t = gc(e, t)) : n instanceof $t ? (t = pc(e, t)) : n && (t = fc(e, t));
    };
}
function ao(i) {
    let t;
    ...
    for (a = t; a < t + e; ++a) {
        ...
        if (_ === h) c < g ? ((g = c), (d = a)) : c > p && ((p = c), (u = a)), (n = (o * n + r.x) / ++o);
            ...
            if (!A(d) && !A(u)) {
                let w = Math.min(d, u),
                    S = Math.max(d, u);
                w !== f && w !== k && m.push({ ...i[w], x: n }), S !== f && S !== k && m.push({ ...i[S], x: n });
            }
...
function Yo(i) {
    if (i._decimated) {
        let t = i._data;
        delete i._decimated, delete i._data, Object.defineProperty(i, "data", { configurable: !0, enumerable: !0, writable: !0, value: t });
    }
}
function ro(i) {
...
function Mc(i, t) {
    ...
    return l && (s = Y(ct(t, o.axis, a).lo, 0, e - 1)), c ? (n = Y(ct(t, o.axis, r).hi + 1, s, e) - s) : (n = e - s), { start: s, count: n };
}
var kc = {
    id: "decimation",
    ...
    beforeElementsUpdate: (i, t, e) => {
        ...
        i.data.datasets.forEach((n, o) => {
            let { _data: a, indexAxis: r } = n,
                ...
                c = a || n.data;
            if (oe([r, i.options.indexAxis]) === "y" || !l.controller.supportsDecimation) return;
    ...
    for (let r of s) {
        ...
        for (let u of d) {
            let f = Es(e, o[u.start], o[u.end], u.loop),
                g = ls(r, n, f);
            for (let p of g) a.push({ source: p, target: u, start: { [e]: lo(h, f, "start", Math.max) }, end: { [e]: lo(h, f, "end", Math.min) } });
        }
    }
    return a;
}
...
function Uo(i, t) {
    let e = [],
        s = !1;
    return z(i) ? ((s = !0), (e = i)) : (e = Sc(i, t)), e.length ? new pt({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s }) : null;
}
function co(i) {
    return i && i.fill !== !1;
}
...
function Dc(i, t, e) {
    ...
    let n = parseFloat(s);
    return N(n) && Math.floor(n) === n ? Oc(s[0], t, n, e) : ["origin", "start", "end", "stack", "shape"].indexOf(s) >= 0 && s;
}
function Oc(i, t, e, s) {
...
function ys(i, t, e) {
    let s = Fc(t),
        ...
        p = hs(n, g);
    s && a.points.length && (Se(i, e), Nc(i, { line: a, target: s, above: u, below: f, area: e, scale: r, axis: l, clip: p }), Pe(i));
}
function Nc(i, t) {
    ...
    o !== n &&
        (c === "x"
            ? (ho(i, s, a.top), vs(i, { line: e, target: s, color: n, scale: r, property: c, clip: l }), i.restore(), i.save(), ho(i, s, a.bottom))
            : c === "y" &&
              (uo(i, s, a.left),
...
function Hc(i, t, e, s) {
    ...
    if (o === "x" || o === "y") {
        let l, c, h, d;
        o === "x" ? ((l = a), (c = n.top), (h = r), (d = n.bottom)) : ((l = n.left), (c = a), (h = n.right), (d = r)),
            i.beginPath(),
        ...
        afterDatasetsUpdate(i, t, e) {
            ...
            for (a = 0; a < s; ++a)
                (o = i.getDatasetMeta(a)),
                    ...
                    (o.$filler = l),
                    n.push(l);
            for (a = 0; a < s; ++a) (l = n[a]), !(!l || l.fill === !1) && (l.fill = Pc(n, a, e.propagate));
        },
        beforeDraw(i, t, e) {
    ...
    Pi = class extends st {
        ...
        _fitRows(t, e, s, n) {
            ...
            return (
                this.legendItems.forEach((g, p) => {
                    ...
                    (p === 0 || c[c.length - 1] + m + 2 * r > a) && ((d += h), (c[c.length - (p > 0 ? 0 : 1)] = 0), (f += h), u++),
        ...
        _fitCols(t, e, s, n) {
            ...
            return (
                this.legendItems.forEach((m, b) => {
                    ...
                    b > 0 && f + v + 2 * r > h && ((d += u + r), c.push({ width: u, height: f }), (g += u + r), p++, (u = f = 0)),
        ...
        adjustHitBoxes() {
            ...
            if (this.isHorizontal()) {
                ...
                for (let c of e)
                    c.col !== r && ((r = c.col), (l = K(s, this.top + t + n, this.bottom - this.columnSizes[r].height))),
                        (c.top = l),
                        (c.left += this.left + n),
        ...
        _draw() {
            ...
            let { boxWidth: g, boxHeight: p, itemHeight: m } = go(a, d),
                b = function (k, w, S) {
                    ...
                    if (
                        ...
                        let O = { radius: (p * Math.SQRT2) / 2, pointStyle: S.pointStyle, rotation: S.rotation, borderWidth: P },
                            C = l.xPlus(k, g / 2),
                            L = w + u;
                        ...
                        let O = w + Math.max((d - p) / 2, 0),
                            ...
                            L = At(S.borderRadius);
                        n.beginPath(),
                            Object.values(L).some((U) => U !== 0) ? ne(n, { x: C, y: O, w: g, h: p, radius: L }) : n.rect(C, O, g, p),
                            n.fill(),
                            P !== 0 && n.stroke();
                    }
                    n.restore();
                ...
                x = function (k, w, S) {
                    Ct(n, S.text, k, w + m / 2, c, { strikethrough: S.hidden, textAlign: l.textAlign(S.textAlign) });
                },
                v = this.isHorizontal(),
            ...
            this.legendItems.forEach((k, w) => {
                ...
                l.setWidth(this.width),
                    v
                        ? w > 0 && C + O + h > this.right && ((L = f.y += _), f.line++, (C = f.x = K(o, this.left + h, this.right - s[f.line])))
                        : w > 0 &&
                          L + _ > this.bottom &&
                          ((C = f.x = C + e[f.line].width + h), f.line++, (L = f.y = K(o, this.top + y + h, this.bottom - e[f.line].height)));
                let U = l.x(C);
                if ((b(U, L, k), (C = fn(P, C + g + u, v ? C + O : this.right, t.rtl)), x(l.x(C), L, k), v)) f.x += O + h;
        ...
        drawTitle() {
            ...
            let o = Vt(t.rtl, this.left, this.width),
                ...
                d = this.left,
                u = this.width;
            if (this.isHorizontal()) (u = Math.max(...this.lineWidths)), (h = this.top + c), (d = K(t.align, d, this.right - u));
            else {
        ...
        _getLegendItemAt(t, e) {
            ...
            if (ut(t, this.left, this.right) && ut(e, this.top, this.bottom)) {
                for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
                    if (((n = o[s]), ut(t, n.left, n.left + n.width) && ut(e, n.top, n.top + n.height))) return this.legendItems[s];
            }
            return null;
        }
        handleEvent(t) {
            ...
            if (t.type === "mousemove" || t.type === "mouseout") {
                let n = this._hoveredItem,
                    o = $c(n, s);
                n && !o && F(e.onLeave, [t, n, this], this), (this._hoveredItem = s), s && !o && F(e.onHover, [t, s, this], this);
...
var qc = {
            ...
            labels: {
                ...
                generateLabels(i) {
                    let t = i.data.datasets,
                        {
                            labels: { usePointStyle: e, pointStyle: s, textAlign: n, color: o, useBorderRadius: a, borderRadius: r },
                        } = i.legend.options;
        ...
        descriptors: { _scriptable: (i) => !i.startsWith("on"), labels: { _scriptable: (i) => !["generateLabels", "filter", "sort"].includes(i) } },
    },
    Ne = class extends st {
        constructor(t) {
            super(),
        ...
        _drawArgs(t) {
            ...
            return (
                this.isHorizontal()
                    ...
                    : (a.position === "left" ? ((h = s + t), (d = K(r, n, e)), (l = R * -0.5)) : ((h = o - t), (d = K(r, e, n)), (l = R * 0.5)),
                      (c = n - e)),
        ...
        draw() {
            ...
            Ct(t, e.text, 0, 0, s, { color: e.color, maxWidth: l, rotation: c, textAlign: oi(e.align), textBaseline: "middle", translation: [a, r] });
        }
    };
function Gc(i, t) {
...
var Zc = {
    ...
    Ee = {
        average(i) {
            ...
            return o === 0 || s.size === 0 ? !1 : { x: [...s].reduce((r, l) => r + l) / s.size, y: n / o };
        },
        nearest(i, t) {
            if (!i.length) return !1;
            let e = t.x,
...
function ih(i, t, e, s) {
    let { x: n, width: o } = e,
        ...
        c = "center";
    return (
        s === "center" ? (c = n <= (r + l) / 2 ? "left" : "right") : n <= o / 2 ? (c = "left") : n >= a - o / 2 && (c = "right"),
        eh(c, i, t, e) && (c = "center"),
        c
    );
}
...
var Ve = class extends st {
    ...
    getCaretPosition(t, e, s) {
        ...
        return (
            o === "center"
                ? ((y = f + p / 2),
                  n === "left" ? ((m = u), (b = m - a), (v = y + a), (_ = y - a)) : ((m = u + g), (b = m + a), (v = y - a), (_ = y + a)),
                  (x = m))
                : (n === "left" ? (b = u + Math.max(l, h) + a) : n === "right" ? (b = u + g - Math.max(c, d) - a) : (b = this.caretX),
                  o === "top" ? ((v = f), (y = v - a), (m = b - a), (x = b + a)) : ((v = f + p), (y = v + a), (m = b + a), (x = b - a)),
                  (_ = v)),
    ...
    _drawColorBox(t, e, s, n, o) {
        let a = this.labelColors[s],
            ...
            g = e.y + f;
        if (o.usePointStyle) {
            let p = { radius: Math.min(c, l) / 2, pointStyle: r.pointStyle, rotation: r.rotation, borderWidth: 1 },
            ...
            (t.lineWidth = T(a.borderWidth) ? Math.max(...Object.values(a.borderWidth)) : a.borderWidth || 1),
                (t.strokeStyle = a.borderColor),
    ...
    drawBackground(t, e, s, n) {
        let { xAlign: o, yAlign: a } = this,
            { x: r, y: l } = t,
            { width: c, height: h } = s,
            { topLeft: d, topRight: u, bottomLeft: f, bottomRight: g } = At(n.cornerRadius);
    ...
    _updateAnimationTarget(t) {
        let e = this.chart,
            ...
            o = s && s.y;
        if (n || o) {
            let a = Ee[t.position].call(this, this._active, this._eventPosition);
            if (!a) return;
    ...
    handleEvent(t, e, s = !0) {
        ...
        let n = this.options,
            ...
            l = e || !ke(a, o) || r;
        return l && ((this._active = a), (n.enabled || n.external) && ((this._eventPosition = { x: t.x, y: t.y }), this.update(!0, e))), l;
    }
    _getActiveElements(t, e, s, n) {
        let o = this.options;
        if (t.type === "mouseout") return [];
        if (!n)
            return e.filter(
                (r) => this.chart.data.datasets[r.datasetIndex] && this.chart.getDatasetMeta(r.datasetIndex).controller.getParsed(r.index) !== void 0,
            );
...
var ah = {
    ...
    rh = Object.freeze({ __proto__: null, Colors: _c, Decimation: kc, Filler: jc, Legend: qc, SubTitle: Jc, Title: Zc, Tooltip: ah }),
    lh = (i, t, e, s) => (typeof t == "string" ? ((e = i.push(t) - 1), s.unshift({ index: e, label: t })) : isNaN(t) && (e = null), e);
function ch(i, t, e, s) {
    let n = i.indexOf(t);
...
var Ie = class extends Ut {
    ...
    parse(t, e) {
        if (A(t)) return null;
        let s = this.getLabels();
        return (e = isFinite(e) && s[e] === t ? e : ch(s, t, D(e, t), this._addedLabels)), hh(e, s.length - 1);
    }
    determineDataLimits() {
    ...
    (P = Math.ceil(m / _) - Math.floor(p / _)),
        ...
        b && x && o && an((r - a) / o, _ / 1e3)
            ...
            : v
              ...
              : ((P = (S - w) / _), ee(P, Math.round(P), _ / 1e3) ? (P = Math.round(P)) : (P = Math.ceil(P)));
    let O = Math.max(Ni(_), Ni(w));
    (k = Math.pow(10, A(l) ? O : l)), (w = Math.round(w * k) / k), (S = Math.round(S * k) / k);
    let C = 0;
    for (
        b && (u && w !== a ? (e.push({ value: a }), w < a && C++, ee(Math.round((w + C * _) * k) / k, a, vo(a, y, i)) && C++) : w < a && C++);
        C < P;
        ++C
    ) {
...
var pe = class extends Ut {
            ...
            return (
                s
                    ? ((n = Math.ceil(this.max / s) - Math.floor(this.min / s) + 1),
                      n > 1e3 &&
                          (console.warn(`scales.${this.id}.ticks.stepSize: ${s} would result generating up to ${n} ticks. Limiting to 1000.`),
                          (n = 1e3)))
        ...
        buildTicks() {
            ...
            return (
                ...
                t.reverse ? (a.reverse(), (this.start = this.max), (this.end = this.min)) : ((this.start = this.min), (this.end = this.max)),
                a
            );
        }
        configure() {
...
M(Fe, "id", "linear"), M(Fe, "defaults", { ticks: { callback: we.formatters.numeric } });
...
var ze = class extends Ut {
    ...
    determineDataLimits() {
        ...
        (this.min = N(t) ? Math.max(0, t) : null),
            ...
            this._zero &&
                ...
                !N(this._userMin) &&
                (this.min = t === Nt(this.min, 0) ? Nt(this.min, -1) : Nt(this.min, 0)),
    ...
    getLabelForValue(t) {
        return t === void 0 ? "0" : se(t, this.chart.options.locale, this.options.ticks.format);
    }
    configure() {
        let t = this.min;
    ...
    getPixelForValue(t) {
        return (
            ...
            t === null || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (xt(t) - this._startValue) / this._valueRange)
        );
    }
    getValueForPixel(t) {
...
M(ze, "id", "logarithmic"), M(ze, "defaults", { ticks: { callback: we.formatters.logarithmic, major: { enabled: !0 } } });
function Is(i) {
    let t = i.ticks;
...
function wo(i, t, e, s, n) {
    return i === s || i === n ? { start: t - e / 2, end: t + e / 2 } : i < s || i > n ? { start: t - e, end: t } : { start: t, end: t + e };
}
function ph(i) {
    let t = { l: i.left + i._padding.left, r: i.right - i._padding.right, t: i.top + i._padding.top, b: i.bottom - i._padding.bottom },
        e = Object.assign({}, t),
        s = [],
        n = [],
    ...
    i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), (i._pointLabelItems = _h(i, s, n));
}
...
function xh(i, t) {
    ...
    return !(ht({ x: e, y: s }, t) || ht({ x: e, y: o }, t) || ht({ x: n, y: s }, t) || ht({ x: n, y: o }, t));
}
function _h(i, t, e) {
    let s = [],
...
function kh(i, t, e) {
    ...
    if (!A(r)) {
        ...
        let h = s - c.left,
            ...
            u = o - s + c.width,
            f = a - n + c.height;
        Object.values(l).some((g) => g !== 0) ? (i.beginPath(), ne(i, { x: h, y: d, w: u, h: f, radius: l }), i.fill()) : i.fillRect(h, d, u, f);
    }
}
function wh(i, t) {
    let {
    ...
    for (let n = t - 1; n >= 0; n--) {
        ...
        Ct(e, i._pointLabels[n], l, c + r.lineHeight / 2, r, { color: a.color, textAlign: h, textBaseline: "middle" });
    }
}
function qo(i, t, e, s) {
    let { ctx: n } = i;
    ...
    drawLabels() {
        ...
        t.save(),
            ...
            this.ticks.forEach((r, l) => {
                ...
                Ct(t, r.label, 0, -o, h, { color: c.color, strokeColor: c.textStrokeColor, strokeWidth: c.textStrokeWidth });
            }),
            t.restore();
    }
    drawTitle() {}
...
M(jt, "id", "radialLinear"),
    ...
    M(jt, "defaultRoutes", { "angleLines.color": "borderColor", "pointLabels.color": "color", "ticks.color": "color" }),
...
function Po(i, t) {
    ...
    return (
        ...
        a === null ? null : (n && (a = n === "week" && (Bt(o) || o === !0) ? e.startOf(a, "isoWeek", o) : e.startOf(a, n)), +a)
    );
}
function Do(i, t, e, s) {
    let n = tt.length;
...
function Oh(i) {
    for (let t = tt.indexOf(i) + 1, e = tt.length; t < e; ++t) if (Oi[tt[t]].common) return tt[t];
}
function Oo(i, t, e) {
    if (!e) i[t] = !0;
    else if (e.length) {
...
var Yt = class extends Ut {
    ...
    buildTicks() {
        ...
        return (
            (this._unit =
                e.unit ||
                (s.autoSkip ? Do(e.minUnit, this.min, this.max, this._getLabelCapacity(o)) : Dh(this, r.length, e.minUnit, this.min, this.max))),
            (this._majorUnit = !s.major.enabled || this._unit === "year" ? void 0 : Oh(this._unit)),
            this.initOffsets(n),
            t.reverse && r.reverse(),
    ...
    _getLabelCapacity(t) {
        let e = this.options.time,
            ...
            o = this._tickFormatFunction(t, 0, Co(this, [t], this._majorUnit), n),
...
function xi(i, t, e) {
    let s = 0,
        ...
        l;
    e
        ? (t >= i[s].pos && t <= i[n].pos && ({ lo: s, hi: n } = ct(i, "pos", t)), ({ pos: o, time: r } = i[s]), ({ pos: a, time: l } = i[n]))
        : (t >= i[s].time && t <= i[n].time && ({ lo: s, hi: n } = ct(i, "time", t)), ({ time: o, pos: r } = i[s]), ({ time: a, pos: l } = i[n]));
    let c = a - o;
...
var Be = class extends Yt {
    ...
    initOffsets() {
        ...
        (this._minPos = xi(e, this.min)), (this._tableRange = xi(e, this.max) - this._minPos), super.initOffsets(t);
    }
    buildLookupTable(t) {
        ...
        for (a = 0, r = n.length; a < r; ++a)
            (h = n[a + 1]), (l = n[a - 1]), (c = n[a]), Math.round((h + l) / 2) !== c && o.push({ time: c, pos: a / (r - 1) });
        return o;
    }
    _generate() {
        let t = this.min,
