(() => {
    ...
    var S = d((ut, _) => {
        ...
        v ||
            ((T = new Array(16)),
            (v = function () {
                for (var i = 0, t; i < 16; i++) (i & 3) === 0 && (t = Math.random() * 4294967296), (T[i] = (t >>> ((i & 3) << 3)) & 255);
                return T;
            }));
        var T;
        _.exports = v;
    ...
    var R = d((lt, b) => {
        ...
        function tt(i, t, e) {
            ...
            var r = i.clockseq !== void 0 ? i.clockseq : F,
                ...
                l = o - D + (h - A) / 1e4;
            if ((l < 0 && i.clockseq === void 0 && (r = (r + 1) & 16383), (l < 0 || o > D) && i.nsecs === void 0 && (h = 0), h >= 1e4))
                    ...
                    s.snapshot.data.isFilamentNotificationsComponent &&
                        requestAnimationFrame(() => {
                            ...
                            h(() => {
                                (e = () => {
                                    this.isShown &&
                                        this.$el.animate([{ transform: `translateY(${c - l()}px)` }, { transform: "translateY(0px)" }], {
