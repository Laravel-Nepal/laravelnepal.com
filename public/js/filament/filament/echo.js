                ...
                function (l, h, a) {
                            ...
                            switch (typeof i) {
                                case "object":
                                    ...
                                    if ((t.push(i), n.push(o), Object.prototype.toString.apply(i) === "[object Array]"))
                                        ...
                                        _ = {};
                                        for (p in i)
                                            Object.prototype.hasOwnProperty.call(i, p) && (_[p] = r(i[p], o + "[" + JSON.stringify(p) + "]"));
                                    }
                                    return _;
                                case "number":
                                case "string":
                        ...
                        cn = (function (e) {
                            ...
                            return (
                                ...
                                (t.prototype.onClose = function (n) {
                                    n
                                        ? this.changeState("closed", { code: n.code, reason: n.reason, wasClean: n.wasClean })
                    ...
                    var _n = ht,
                        ...
                        Vt = {
                            ...
                            processHandshake: function (e) {
                                ...
                                if (t.event === "pusher:connection_established") {
                                    ...
                                    if (t.event === "pusher:error") return { action: this.getCloseAction(t.data), error: this.getCloseError(t.data) };
                        ...
                        Rn = (function (e) {
                            ...
                            function t(n, r) {
                                ...
                                return (
                                    (i.name = n), (i.pusher = r), (i.subscribed = !1), (i.subscriptionPending = !1), (i.subscriptionCancelled = !1), i
                                );
                            }
                            return (
                                ...
                                for (; n; )
                                    try {
                                        if (
                                            ((r = 1),
                                            i &&
                                                (o = g[0] & 2 ? i.return : g[0] ? i.throw || ((o = i.return) && o.call(i), 0) : i.next) &&
                                                !(o = o.call(i, g[1])).done)
                                        )
                                            return o;
                                                    ...
                                                    case 0:
                                                        return o
                                                            ...
                                                            : ((u = u),
                                                              u.channel_data == null
                                                                  ? [3, 1]
                                                                  : ((p = JSON.parse(u.channel_data)), this.members.setMyID(p.user_id), [3, 3]));
                                                    case 1:
                            ...
                            return (
                                ...
                                (t.prototype.handleEncryptedEvent = function (n, r) {
                                    ...
                                    if (!r.ciphertext || !r.nonce) {
                                        A.error(
                                            "Unexpected format for encrypted event, expected object with `ciphertext` and `nonce` fields, got: " + r,
                                        );
                                        return;
                                    }
                                    ...
                                    if (u.length < this.nacl.secretbox.nonceLength) {
                                        A.error(
                                            "Expected encrypted event nonce length to be " + this.nacl.secretbox.nonceLength + ", got: " + u.length,
                                        );
                                        return;
                                    }
                                ...
                                (e.prototype.connect = function (t, n) {
                                    ...
                                    var p = j.now(),
                                        _ = o.pop().connect(t, function g(k, E) {
                                            k
                                                ? (Qt(r), o.length > 0 ? ((p = j.now()), (_ = o.pop().connect(t, g))) : n(k))
                    ...
                    var pr = function (e, t, n) {
                            ...
                            return (
                                ...
                                new sr(new fr(new it(ot(E), Ot, xt)), r, { ttl: 18e5, timeline: t.timeline, useTLS: t.useTLS })
                            );
                        },
                        dr = pr,
                        vr = function () {
                    ...
                    function ii(e, t) {
                        ...
                        return (
                            "channelAuthorization" in e
                                ...
                                : ((n = { transport: e.authTransport || d.authTransport, endpoint: e.authEndpoint || d.authEndpoint }),
                                  "auth" in e &&
                                      ("params" in e.auth && (n.params = e.auth.params), "headers" in e.auth && (n.headers = e.auth.headers)),
                        ...
                        value: function (s, f) {
                            (this.listeners[s] = this.listeners[s] || []),
                                ...
                                (!f || this.listeners[s].length === 0) &&
                                    (this.events[s] && (this.socket.removeListener(s, this.events[s]), delete this.events[s]),
            ...
            return (
                R(a, [
                    ...
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels["private-" + s] || (this.channels["private-" + s] = new ve(this.pusher, "private-" + s, this.options)),
                        ...
                        value: function (s) {
                            return (
                                this.channels["private-encrypted-" + s] ||
                                    (this.channels["private-encrypted-" + s] = new qi(this.pusher, "private-encrypted-" + s, this.options)),
                                this.channels["private-encrypted-" + s]
                            );
                        },
                    },
                        ...
                        value: function (s) {
                            return (
                                this.channels["presence-" + s] ||
                                    (this.channels["presence-" + s] = new Ui(this.pusher, "presence-" + s, this.options)),
                                this.channels["presence-" + s]
                            );
                        },
                    },
            ...
            return (
                R(a, [
                    ...
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels["private-" + s] || (this.channels["private-" + s] = new ge(this.socket, "private-" + s, this.options)),
                                this.channels["private-" + s]
                            );
                        },
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels["presence-" + s] ||
                                    (this.channels["presence-" + s] = new Di(this.socket, "presence-" + s, this.options)),
                                this.channels["presence-" + s]
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            if (this.options.broadcaster == "reverb") this.connector = new fe(at(at({}, this.options), { cluster: "" }));
                                ...
                                throw new Error(
                                    "Broadcaster ".concat(st(this.options.broadcaster), " ").concat(this.options.broadcaster, " is not supported."),
                                );
                        },
                    },
                    {
                            ...
                            if (this.connector instanceof pe)
                                throw new Error(
                                    "Broadcaster "
                                        ...
                                        .concat(this.options.broadcaster, " does not support encrypted private channels."),
                                );
