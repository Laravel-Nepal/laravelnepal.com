...
var We = Ke((Yo, Qo) => {
    (function (o, p) {
        ...
        var o = navigator.userAgent,
            ...
            M = /PhantomJS/.test(o),
            _ = k && (/Mobile\/\w+/.test(o) || navigator.maxTouchPoints > 2),
            W = /Android/.test(o),
            E = _ || W || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(o),
            N = _ || /Mac/.test(p),
            G = /\bCrOS\b/.test(o),
            J = /win/i.test(p),
            re = d && o.match(/Version\/(\d*\.\d*)/);
        re && (re = Number(re[1])), re && re >= 15 && ((d = !1), (g = !0));
        var q = N && (T || (d && (re == null || re < 12.11))),
            O = v || (s && h >= 9);
        function D(e) {
        ...
        var It = (function () {
            ...
            return function (m, A) {
                ...
                for (var _e = 0, be = B; _e < ee; ++_e) {
                    var Ce = Y[_e];
                    Ce == "1" && be == "r" ? (Y[_e] = "n") : a.test(Ce) && ((be = Ce), Ce == "r" && (Y[_e] = "R"));
                }
                for (var Ne = 1, Ie = Y[0]; Ne < ee - 1; ++Ne) {
                    var $e = Y[Ne];
                    $e == "+" && Ie == "1" && Y[Ne + 1] == "1"
                        ? (Y[Ne] = "1")
                ...
                for (var Ve = 0; Ve < ee; ++Ve) {
                    ...
                    if (vt == ",") Y[Ve] = "N";
                        ...
                        for (var Ot = (Ve && Y[Ve - 1] == "!") || (rt < ee && Y[rt] == "1") ? "1" : "N", At = Ve; At < rt; ++At) Y[At] = Ot;
                        Ve = rt - 1;
                    }
                }
                ...
                for (var ft = 0; ft < ee; ++ft)
                    if (i.test(Y[ft])) {
                        ...
                        for (
                            var lt = (ft ? Y[ft - 1] : B) == "L", qt = (ct < ee ? Y[ct] : B) == "L", pn = lt == qt ? (lt ? "L" : "R") : B, Sr = ft;
                            Sr < ct;
                            ++Sr
                        )
                            Y[Sr] = pn;
                ...
                return (
                    A == "ltr" &&
                        ...
                        ce(St).level == 1 && (rr = m.match(/\s+$/)) && ((ce(St).to -= rr[0].length), St.push(new f(0, ee - rr[0].length, ee)))),
                    A == "rtl" ? St.reverse() : St
                );
            };
        })();
        ...
        function ei(e) {
            if (Hr == null) {
                ...
                V(e, y("span", [t, document.createTextNode("x")])),
                    e.firstChild.offsetHeight != 0 && (Hr = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(s && h < 8));
            }
            var n = Hr ? y("span", "\u200B") : y("span", "\xA0", null, "display: inline-block; width: 1px; margin-right: -1px");
                    ...
                    for (var B = 0; ; ) {
                        ...
                        if (ee[0] == "	") {
                            ...
                            ee[0] ==
                                `
`
                                ? ((ue = A.appendChild(y("span", ee[0] == "\r" ? "\u240D" : "\u2424", "cm-invalidchar"))),
        ...
        function Uc(e, t) {
            return function (n, r, i, a, l, u, f) {
                ...
                for (var m = n.pos, A = m + r.length; ; ) {
                    for (var B = void 0, ee = 0; ee < t.length && ((B = t[ee]), !(B.to > m && B.from <= m)); ee++);
                    if (B.to >= A) return e(n, r, i, a, l, u, f);
                    e(n, r.slice(0, B.to - m), i, a, null, u, f), (a = null), (r = r.slice(B.to - m)), (m = B.to);
                }
            };
        }
        function Ea(e, t, n, r) {
        ...
        function $c(e, t, n) {
            ...
            for (var u = i.length, f = 0, m = 1, A = "", B, ee, Y = 0, ie, ue, me, ve, _e; ; ) {
                if (Y == f) {
                ...
                for (var Ot = Math.min(u, Y); ; ) {
                    if (A) {
                        ...
                        if (!ve) {
                            ...
                            t.addToken(t, ut, B ? B + ie : ie, me, f + ut.length == Y ? ue : "", ee, _e);
                        }
                        if (At >= Ot) {
                            (A = A.slice(Ot - f)), (f = Ot);
                            break;
            ...
            if (e.options.lineNumbers || a) {
                ...
                if (
                    ...
                    for (var f = 0; f < e.display.gutterSpecs.length; ++f) {
                        ...
                        A &&
                            u.appendChild(
                                y("div", [A], "CodeMirror-gutter-elt", "left: " + r.gutterLeft[m] + "px; width: " + r.gutterWidth[m] + "px"),
                            );
                    }
            }
        }
        ...
        function Ia(e, t, n, r, i) {
            if (t.widgets)
                for (var a = Ln(n), l = 0, u = t.widgets; l < u.length; ++l) {
                    var f = u[l],
                        m = y("div", [f.node], "CodeMirror-linewidget" + (f.className ? " " + f.className : ""));
        ...
        function Fa(e) {
            ...
            var t = V(e.measure, y("pre", "x", "CodeMirror-line-like")),
        ...
        function Na(e, t, n) {
            ...
            if (e.rest) {
                ...
                for (var i = 0; i < e.rest.length; i++)
                    if (x(e.rest[i]) > n) return { map: e.measure.maps[i], cache: e.measure.caches[i], before: !0 };
            }
        }
        function rf(e, t) {
            t = Zt(t);
        ...
        function of(e, t, n, r) {
            ...
            if (s && h < 9 && !l && (!m || (!m.left && !m.right))) {
                ...
                ee ? (m = { left: ee.left, right: ee.left + Jr(e.display), top: ee.top, bottom: ee.bottom }) : (m = Pa);
            }
            for (
        ...
        function ci(e, t, n, r, i) {
            ...
            if ((r == "local" ? (l += ui(e.display)) : (l -= e.display.viewOffset), r == "page" || r == "window")) {
                ...
                var f = u.left + (r == "window" ? 0 : Ha(L(e)));
                (n.left += f), (n.right += f);
            }
        ...
        function lf(e, t, n, r, i) {
            ...
            var ee = null,
                ...
                ie = De(
                    function (Ne) {
                        var Ie = tr(e, a, Ne);
                        return (Ie.top += l), (Ie.bottom += l), vo(Ie, r, i, !1) ? (Ie.top <= i && Ie.left <= r && ((ee = Ne), (Y = Ie)), !0) : !1;
                    },
                    u,
                    f,
                ),
            ...
            if (Y) {
                var _e = r - Y.left < Y.right - r,
                    be = _e == m;
                (ie = ee + (be ? 0 : 1)), (me = be ? "after" : "before"), (ue = _e ? Y.left : Y.right);
            } else {
                !m && (ie == f || ie == u) && ie++,
        ...
        function sf(e, t, n, r, i, a, l) {
            var u = De(
                    function (B) {
                        var ee = i[B],
                            Y = ee.level != 1;
                        return vo(Xt(e, ne(n, Y ? ee.to : ee.from, Y ? "before" : "after"), "line", t, r), a, l, !0);
                    },
                    0,
                    i.length - 1,
                ),
        ...
        function Vr(e) {
            ...
            if (zr == null) {
                ...
                for (var t = 0; t < 49; ++t) zr.appendChild(document.createTextNode("x")), zr.appendChild(y("br"));
        ...
        function ff(e, t, n) {
            ...
            if (ee.line == Y.line) B(ee.line, ee.ch, Y.ch);
                ...
                var ie = Ae(i, ee.line),
                    ...
                    _e = B(Y.line, me ? 0 : null, Y.ch).start;
                me &&
                    (ve.top < _e.top - 2
            ...
            for (
                ...
                if (!u.hidden) {
                    if (((i += u.line.height), s && h < 8)) {
                        ...
                        (m = ee.bottom - ee.top), !f && u.text.firstChild && (A = u.text.firstChild.getBoundingClientRect().right - ee.left - 1);
                    }
        ...
        function gi(e, t, n) {
            ...
            if (n && n.ensure) {
                ...
                u < a
                    ...
                    : Math.min(f, t.lastLine()) >= l && ((a = P(t, ar(Ae(t, f)) - e.wrapper.clientHeight)), (l = f));
            }
        ...
        function pf(e, t, n, r) {
            ...
            for (var a = 0; a < 5; a++) {
                ...
                if (
                    ...
                    m.scrollLeft != null && (Dr(e, m.scrollLeft), Math.abs(e.doc.scrollLeft - B) > 1 && (l = !0)),
                    !l)
                )
                    break;
            }
        ...
        var qr = function (e, t, n) {
            this.cm = n;
            var r = (this.vert = y("div", [y("div", null, null, "min-width: 1px")], "CodeMirror-vscrollbar")),
                i = (this.horiz = y("div", [y("div", null, null, "height: 100%; min-height: 1px")], "CodeMirror-hscrollbar"));
        ...
        function Cf(e, t, n) {
            ...
            function u(ie) {
                ...
                return g && N && e.display.currentWheelTarget == ie ? (ie.style.display = "none") : ie.parentNode.removeChild(ie), ue;
            }
                ...
                if (!B.hidden)
                    if (!B.node || B.node.parentNode != a) {
                        ...
                        B.changes && (Se(B.changes, "gutter") > -1 && (Y = !1), Ma(e, B, m, n)),
                            Y && (j(B.lineNumber), B.lineNumber.appendChild(document.createTextNode(he(e.options, m)))),
        ...
        function al(e) {
            ...
            if (n.length != r.lineNumChars) {
                var i = r.measure.appendChild(y("div", [y("div", n)], "CodeMirror-linenumber CodeMirror-gutter-elt")),
        ...
        function Ef(e, t, n, r) {
            ...
            (i.mover = y("div", [a], null, "position: relative")),
                ...
                (i.sizerWidth = null),
                (i.heightForcer = y("div", null, null, "position: absolute; height: " + Be + "px; width: 1px;")),
        ...
        function Io(e, t, n, r) {
            ...
            if (t.full) e.insert(0, l(0, m.length)), e.remove(m.length, e.size - m.length);
                ...
                if (m.length == 1) a(A, A.text.slice(0, u.ch) + ee + A.text.slice(f.ch), Y);
                    ...
                    me.push(new Xr(ee + A.text.slice(f.ch), Y, r)), a(A, A.text.slice(0, u.ch) + m[0], i(0)), e.insert(u.line + 1, me);
                }
            else if (m.length == 1) a(A, A.text.slice(0, u.ch) + m[0] + B.text.slice(f.ch), i(0)), e.remove(u.line + 1, ie);
            else {
            ...
            for (var r = [], i = 0; i < e.length; ++i) {
                ...
                for (var f = 0; f < l.length; ++f) {
                    ...
                    if ((u.push({ from: m.from, to: m.to, text: m.text }), t))
                        for (var B in m) (A = B.match(/^spans_(\d+)$/)) && Se(t, Number(A[1])) > -1 && ((ce(u)[B] = m[B]), delete m[B]);
                }
            }
            return r;
        }
        ...
        function _i(e, t, n, r, i) {
            i == null && (i = e.cm && (e.cm.display.shift || e.extend)), wt(e, new jt([No(e.sel.primary(), t, n, i)], 0), r);
        }
        function yl(e, t, n) {
        ...
        function Of(e, t, n) {
            var r = {
                ...
                update: function (i) {
                    this.ranges = [];
                    for (var a = 0; a < i.length; a++) this.ranges[a] = new Ye(je(e, i[a].anchor), je(e, i[a].head));
                },
                origin: n && n.origin,
            };
            return (
        ...
        function kl(e, t) {
            t.equals(e.sel) ||
                ((e.sel = t), e.cm && ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), Rt(e.cm)), ht(e, "cursorActivity", e));
        }
        function wl(e) {
            ...
            return (
                n &&
                    (r.update = function (i, a, l, u) {
                        i && (r.from = je(e, i)), a && (r.to = je(e, a)), l && (r.text = l), u !== void 0 && (r.origin = u);
                    }),
        ...
        function Si(e, t, n) {
            ...
            if (!(r && !n)) {
                ...
                if (m != u.length) {
                    ...
                    for (
                        var B = Ft(e, "beforeChange") || (e.cm && Ft(e.cm, "beforeChange")),
                            ee = function (ue) {
                                var me = a.changes[ue];
        ...
        function Pf(e, t, n) {
            ...
            if (B || A) {
                ...
                B && ht(e, "change", e, ee), A && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(ee);
            }
        ...
        function Pn(e, t, n, r) {
            var i = t,
                a = t;
            return typeof t == "number" ? (a = Ae(e, ua(e, t))) : (i = x(t)), i == null ? null : (r(a, i) && e.cm && vr(e.cm, i, n), a);
        }
        function Bn(e) {
        ...
        (Rn.prototype.clear = function () {
            ...
            (Rn.prototype.changed = function () {
                ...
                i &&
                    ...
                    n &&
                        Nt(n, function () {
                            (n.curOp.forceUpdate = !0), ql(n, r, i), ht(n, "lineWidgetChanged", n, e, x(r));
                        }));
            }),
            Wt(Rn);
        function ql(e, t, n) {
        ...
        function Bf(e, t, n, r) {
            ...
            return (
                ...
                a && ht(a, "lineWidgetAdded", a, i, typeof t == "number" ? t : x(t)),
                i
            );
        }
        var Il = 0,
        ...
        (kr.prototype.clear = function () {
            if (!this.explicitlyCleared) {
                ...
                for (var r = null, i = null, a = 0; a < this.lines.length; ++a) {
                    ...
                    e && !this.collapsed ? vr(e, x(l), "text") : e && (u.to != null && (i = x(l)), u.from != null && (r = x(l))),
            ...
            (kr.prototype.find = function (e, t) {
                ...
                for (var n, r, i = 0; i < this.lines.length; ++i) {
                    ...
                    if (l.from != null && ((n = ne(t ? a : x(a), l.from)), e == -1)) return n;
                    if (l.to != null && ((r = ne(t ? a : x(a), l.to)), e == 1)) return r;
                }
            ...
            if (
                (e.iter(u, n.line + 1, function (B) {
                    f && a.collapsed && !f.options.lineWrapping && Zt(B) == f.display.maxLine && (m = !0),
                        ...
                        Mc(B, new ni(a, u == t.line ? t.ch : null, u == n.line ? n.ch : null), e.cm && e.cm.curOp),
                        ++u;
                }),
                a.collapsed &&
        ...
        (Mt.prototype = oe(jn.prototype, {
            ...
            setSelections: mt(function (e, t, n) {
                if (e.length) {
                    for (var r = [], i = 0; i < e.length; i++) r[i] = new Ye(je(this, e[i].anchor), je(this, e[i].head || e[i].anchor));
            ...
            unlinkDoc: function (e) {
                if ((e instanceof tt && (e = e.doc), this.linked))
                    for (var t = 0; t < this.linked.length; ++t) {
                        var n = this.linked[t];
                        if (n.doc == e) {
                            this.linked.splice(t, 1), e.unlinkDoc(this), Hf(Fl(this));
                            break;
                        }
                    }
...
`
                ...
                if (!(!n || t.isReadOnly()))
                    if (r && r.length && window.FileReader && window.File)
                        ...
                        try {
                            ...
                            if (A) {
                                var B;
                                if ((t.state.draggingText && !t.state.draggingText.copy && (B = t.listSelections()), ki(t.doc, yr(n, n)), B))
                                    for (var ee = 0; ee < B.length; ++ee) ln(t.doc, "", B[ee].anchor, B[ee].head, "drag");
        ...
        function $f(e, t) {
            ...
            if (
                ...
                (t.dataTransfer.setData("Text", e.getSelection()), (t.dataTransfer.effectAllowed = "copyMove"), t.dataTransfer.setDragImage && !k)
            ) {
        ...
        function Hl(e, t) {
            ...
            var n = wr[e.keyCode];
            return n == null || e.altGraphKey ? !1 : (e.keyCode == 3 && e.code && (n = e.code), Rl(n, e, t));
        }
        function Li(e) {
        ...
        function Vf(e, t, n, r) {
            ...
            var a = Pt(i, n.ch, n.sticky),
                l = i[a];
            if (e.doc.direction == "ltr" && l.level % 2 == 0 && (r > 0 ? l.to > n.ch : l.from < n.ch)) return Bo(t, n, r);
...
`,
        ...
        function Gl(e) {
            var t = this;
            if (!(e.target && e.target != t.display.input.getField()) && ((t.curOp.focus = R(de(t))), !ot(t, e))) {
                s && h < 11 && e.keyCode == 27 && (e.returnValue = !1);
                var n = e.keyCode;
                t.display.shift = n == 16 || e.shiftKey;
                var r = Kl(t, e);
                d && ((Ro = r ? n : null), !r && n == 88 && !ti && (N ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
                    v && !N && !r && n == 46 && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
                        ...
                        !(r && ad(t, i, r, a, e)) &&
                            (i == 1
                                ...
                                : i == 2
                                  ...
                                  : i == 3 && (O ? t.display.input.onContextMenu(e) : wo(t)));
                }
            }
        }
        ...
        function Jl(e, t) {
            lr(e.display, t) || dd(e, t) || ot(e, t, "contextmenu") || O || e.display.input.onContextMenu(t);
        }
        function dd(e, t) {
        ...
        function Xn(e, t, n, r) {
            ...
            if ((ee < A && (B += Z(A - ee)), B != m)) return ln(i, B, ne(t, 0), ne(t, m.length), "+input"), (u.stateAfter = null), !0;
...
`) &&
        ...
        function os() {
            ...
            return g ? (e.style.width = "1000px") : e.setAttribute("wrap", "off"), _ && (e.style.border = "1px solid black"), t;
        }
        function vd(e) {
            var t = e.optionHandlers,
                n = (e.helpers = {});
            (e.prototype = {
                ...
                indentSelection: Tt(function (r) {
                    for (var i = this.doc.sel.ranges, a = -1, l = 0; l < i.length; l++) {
                        ...
                        if (u.empty()) u.head.line > a && (Xn(this, u.head.line, r, !0), (a = u.head.line), l == this.doc.sel.primIndex && tn(this));
                            ...
                            f.ch == 0 && i.length == ee.length && ee[l].from().ch > 0 && Oo(this.doc, l, new Ye(f, ee[l].to()), ke);
                        }
                    }
                }),
                ...
                cursorCoords: function (r, i) {
                    ...
                    return (
                        r == null ? (a = l.head) : typeof r == "object" ? (a = je(this.doc, r)) : (a = r ? l.from() : l.to()),
                        Xt(this, a, i || "page")
                    );
                },
                ...
                lineAtHeight: function (r, i) {
                    return (r = Ua(this, { top: r, left: 0 }, i || "page").top), P(this.doc, r + this.display.viewOffset);
                },
                ...
                findPosH: function (r, i, a, l) {
                    var u = 1;
                    i < 0 && ((u = -1), (i = -i));
                    for (var f = je(this.doc, r), m = 0; m < i && ((f = Go(this.doc, f, u, a, l)), !f.hitSide); ++m);
                    return f;
                },
                ...
                findPosV: function (r, i, a, l) {
                    ...
                    for (var m = je(this.doc, r), A = 0; A < i; ++A) {
                        var B = Xt(this, m, "div");
                        if ((f == null ? (f = B.left) : (B.left = f), (m = as(this, B, u, a)), m.hitSide)) break;
                    }
                    return m;
                },
                moveV: Tt(function (r, i) {
                    ...
                    if (
                        (l.extendSelectionsBy(function (A) {
                            ...
                            var ee = as(a, B, r, i);
                            return i == "page" && A == l.sel.primary() && Lo(a, fi(a, ee, "div").top - B.top), ee;
                        }, Re),
                        u.length)
                    )
        ...
        function Go(e, t, n, r, i) {
            ...
            if (r == "char" || r == "codepoint") A();
                ...
                for (var B = null, ee = r == "group", Y = e.cm && e.cm.getHelper(t, "wordChars"), ie = !0; !(n < 0 && !A(!ie)); ie = !1) {
                    var ue =
                            u.text.charAt(t.ch) ||
                            `
`,
...
`));
            ...
            (Qe.prototype.focus = function () {
                this.cm.options.readOnly != "nocursor" &&
                    ((!this.selectionInEditor() || R(ze(this.div)) != this.div) && this.showSelection(this.prepareSelection(), !0), this.div.focus());
            }),
            ...
            (Qe.prototype.pollSelection = function () {
                if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
                    var e = this.getSelection(),
                        t = this.cm;
                    if (W && w && this.cm.display.gutterSpecs.length && bd(e.anchorNode)) {
            ...
            (Qe.prototype.pollContent = function () {
                ...
                r.line == t.viewFrom || (a = Ar(e, r.line)) == 0
                    ...
                    : ((l = x(t.view[a].line)), (u = t.view[a - 1].node.nextSibling));
                var f = Ar(e, i.line),
                    m,
                    A;
                if (
                    (f == t.view.length - 1
                        ...
                        : ((m = x(t.view[f + 1].line) - 1), (A = t.view[f + 1].node.previousSibling)),
                    !u)
                )
                    return !1;
                for (
                    var B = e.doc.splitLines(yd(e, u, A, l, m)), ee = ir(e.doc, ne(l, 0), ne(m, Ae(e.doc, m).text.length));
                ...
                for (var Y = 0, ie = 0, ue = B[0], me = ee[0], ve = Math.min(ue.length, me.length); Y < ve && ue.charCodeAt(Y) == me.charCodeAt(Y); )
                    ++Y;
                for (
                    var _e = ce(B), be = ce(ee), Ce = Math.min(_e.length - (B.length == 1 ? Y : 0), be.length - (ee.length == 1 ? Y : 0));
                ...
                (B[B.length - 1] = _e.slice(0, _e.length - ie).replace(/^\u200b+/, "")), (B[0] = B[0].slice(Y).replace(/\u200b+$/, ""));
                var Ne = ne(l, Y),
                    Ie = ne(m, ee.length ? ce(ee).length - ie : 0);
                if (B.length > 1 || B[0] || ye(Ne, Ie)) return ln(e.doc, B, Ne, Ie, "+input"), !0;
            }),
        ...
        function xd(e, t, n) {
            var r = e.text.firstChild,
                i = !1;
            if (!t || !F(r, t)) return dn(ne(x(e.line), 0), !0);
...
`)),
            ...
            (st.prototype.reset = function (e) {
                if (!(this.contextMenuPending || (this.composing && e))) {
                    ...
                    if (((this.resetting = !0), t.somethingSelected())) {
                        ...
                        (this.textarea.value = n), t.state.focused && I(this.textarea), s && h >= 9 && (this.hasSelection = n);
            ...
            (st.prototype.poll = function () {
                ...
                if ((s && h >= 9 && this.hasSelection === i) || (N && /[\uf700-\uf7ff]/.test(i))) return t.display.input.reset(), !1;
    ...
    (function (o) {
        ...
        o.commands.newlineAndIndentContinueMarkdownList = function (S) {
            ...
            for (var s = S.listSelections(), h = [], g = 0; g < s.length; g++) {
                var T = s[g].head,
                    w = S.getStateAfter(T.line),
                    c = o.innerMode(S.getMode(), w);
                ...
                if (v.test(z)) {
                    var W = k && />\s*$/.test(z),
                        E = !/>\s*$/.test(z);
                    (W || E) && S.replaceRange("", { line: T.line, ch: 0 }, { line: T.line, ch: T.ch + 1 }),
                        (h[g] = `
`);
                } else {
                    var N = M[1],
...
` +
        ...
        function b(S, s) {
            ...
            do {
                ...
                if (z) {
                    var M = z[1],
                        _ = parseInt(w[3], 10) + g - T,
                        W = parseInt(z[3], 10),
                        E = W;
                    if (c === M && !isNaN(W))
                        _ === W && (E = W + 1),
                            _ > W && (E = _ + 1),
                            S.replaceRange(k.replace(p, M + E + z[4] + z[5]), { line: d, ch: 0 }, { line: d, ch: k.length });
                    else {
...
var ys = Ke((vs, bs) => {
    (function (o) {
        ...
        o.defineOption("styleSelectedText", !1, function (w, c, d) {
            ...
            c && !k
                ? ((w.state.markedSelection = []),
                  (w.state.markedSelectionStyle = typeof c == "string" ? c : "CodeMirror-selectedtext"),
                  g(w),
                  w.on("cursorActivity", p),
                  w.on("change", v))
                : !c && k && (w.off("cursorActivity", p), w.off("change", v), h(w), (w.state.markedSelection = w.state.markedSelectionStyle = null));
        });
        function p(w) {
            w.state.markedSelection &&
        ...
        function s(w, c, d, k) {
            if (S(c, d) != 0)
                for (var z = w.state.markedSelection, M = w.state.markedSelectionStyle, _ = c.line; ; ) {
                    var W = _ == c.line ? c : b(_, 0),
                        E = _ + C,
                        N = E >= d.line,
                        G = N ? d : b(E, 0),
                        J = w.markText(W, G, { className: M });
                    if ((k == null ? z.push(J) : z.splice(k++, 0, J), N)) break;
                    _ = E;
                }
        }
        function h(w) {
            for (var c = w.state.markedSelection, d = 0; d < c.length; ++d) c[d].clear();
            c.length = 0;
        }
        function g(w) {
            h(w);
            for (var c = w.listSelections(), d = 0; d < c.length; d++) s(w, c[d].from(), c[d].to());
        }
        function T(w) {
            if (!w.somethingSelected()) return h(w);
            if (w.listSelections().length > 1) return g(w);
            var c = w.getCursor("start"),
                d = w.getCursor("end"),
                k = w.state.markedSelection;
            if (!k.length) return s(w, c, d);
            var z = k[0].find(),
                M = k[k.length - 1].find();
            if (!z || !M || d.line - c.line <= C || S(c, M.to) >= 0 || S(d, z.from) <= 0) return g(w);
            for (; S(c, z.from) > 0; ) k.shift().clear(), (z = k[0].find());
            for (S(c, z.from) < 0 && (z.to.line - c.line < C ? (k.shift().clear(), s(w, c, z.to, 0)) : s(w, c, z.from, 0)); S(d, M.to) < 0; )
                k.pop().clear(), (M = k[k.length - 1].find());
            S(d, M.to) > 0 && (d.line - M.from.line < C ? (k.pop().clear(), s(w, M.from, d)) : s(w, M.to, d));
        }
    });
});
var ks = Ke((xs, _s) => {
    (function (o) {
        ...
        function v(_) {
            var W = _.flags;
            return W ?? (_.ignoreCase ? "i" : "") + (_.global ? "g" : "") + (_.multiline ? "m" : "");
        }
        function C(_, W) {
            for (var E = v(_), N = E, G = 0; G < W.length; G++) N.indexOf(W.charAt(G)) == -1 && (N += W.charAt(G));
            return E == N ? _ : new RegExp(_.source, N);
        }
        function b(_) {
            return /\\s|\\n|\n|\\W|\\D|\[\^/.test(_.source);
        }
        function S(_, W, E) {
            W = C(W, "g");
            for (var N = E.line, G = E.ch, J = _.lastLine(); N <= J; N++, G = 0) {
                W.lastIndex = G;
                var re = _.getLine(N),
                    q = W.exec(re);
        ...
        function s(_, W, E) {
            ...
            W = C(W, "gm");
            for (var N, G = 1, J = E.line, re = _.lastLine(); J <= re; ) {
...
`),
                    ...
                    return { from: p(V, y), to: p(V + j.length - 1, j.length == 1 ? y + j[0].length : j[j.length - 1].length), match: D };
                }
            }
        }
        function h(_, W, E) {
            for (var N, G = 0; G <= _.length; ) {
                W.lastIndex = G;
                var J = W.exec(_);
                if (!J) break;
                var re = J.index + J[0].length;
                if (re > _.length - E) break;
                (!N || re > N.index + N[0].length) && (N = J), (G = J.index + 1);
            }
            return N;
        }
        function g(_, W, E) {
            W = C(W, "g");
            for (var N = E.line, G = E.ch, J = _.firstLine(); N >= J; N--, G = -1) {
                var re = _.getLine(N),
        ...
        function T(_, W, E) {
            ...
            W = C(W, "gm");
            for (var N, G = 1, J = _.getLine(E.line).length - E.ch, re = E.line, q = _.firstLine(); re >= q; ) {
                for (var O = 0; O < G && re >= q; O++) {
                    var D = _.getLine(re--);
                    N =
                        N == null
                            ? D
...
`),
                    ...
                    return { from: p(y, K), to: p(y + V.length - 1, V.length == 1 ? K + V[0].length : V[V.length - 1].length), match: Q };
                }
            }
        }
        var w, c;
        ...
        function d(_, W, E, N) {
            ...
            for (var G = 0, J = E + Math.max(0, _.length - W.length); ; ) {
                if (G == J) return G;
                var re = (G + J) >> 1,
                    q = N(_.slice(0, re)).length;
                if (q == E) return re;
                q > E ? (J = re) : (G = re + 1);
            }
        }
        function k(_, W, E, N) {
            ...
            var G = N ? w : c,
                J = G(W).split(/\r|\n\r?/);
            e: for (var re = E.line, q = E.ch, O = _.lastLine() + 1 - J.length; re <= O; re++, q = 0) {
                var D = _.getLine(re).slice(q),
                    Q = G(D);
                if (J.length == 1) {
                    var j = Q.indexOf(J[0]);
                    if (j == -1) continue e;
                    var E = d(D, Q, j, G) + q;
                    return { from: p(re, d(D, Q, j, G) + q), to: p(re, d(D, Q, j + J[0].length, G) + q) };
                } else {
                    var V = Q.length - J[0].length;
                    if (Q.slice(V) != J[0]) continue e;
                    for (var y = 1; y < J.length - 1; y++) if (G(_.getLine(re + y)) != J[y]) continue e;
                    var K = _.getLine(re + J.length - 1),
                        X = G(K),
                        F = J[J.length - 1];
                    if (X.slice(0, F.length) != F) continue e;
                    return { from: p(re, d(D, Q, V, G) + q), to: p(re + J.length - 1, d(K, X, F.length, G)) };
                }
            }
        }
        function z(_, W, E, N) {
            ...
            var G = N ? w : c,
                J = G(W).split(/\r|\n\r?/);
            e: for (var re = E.line, q = E.ch, O = _.firstLine() - 1 + J.length; re >= O; re--, q = -1) {
                var D = _.getLine(re);
                q > -1 && (D = D.slice(0, q));
                var Q = G(D);
                if (J.length == 1) {
                    ...
                    if (j == -1) continue e;
                    return { from: p(re, d(D, Q, j, G)), to: p(re, d(D, Q, j + J[0].length, G)) };
                } else {
                    var V = J[J.length - 1];
                    if (Q.slice(0, V.length) != V) continue e;
                    for (var y = 1, E = re - J.length + 1; y < J.length - 1; y++) if (G(_.getLine(E + y)) != J[y]) continue e;
                    var K = _.getLine(re + 1 - J.length),
                        X = G(K);
                    if (X.slice(X.length - J[0].length) != J[0]) continue e;
                    return { from: p(re + 1 - J.length, d(K, X, K.length - J[0].length, G)), to: p(re, d(D, Q, V.length, G)) };
                }
            }
        }
        function M(_, W, E, N) {
            (this.atOccurrence = !1), (this.afterEmptyMatch = !1), (this.doc = _), (E = E ? _.clipPos(E) : p(0, 0)), (this.pos = { from: E, to: E });
            var G;
        ...
        (M.prototype = {
            ...
            find: function (_) {
                var W = this.doc.clipPos(_ ? this.pos.from : this.pos.to);
                if (
            ...
            replace: function (_, W) {
                if (this.atOccurrence) {
                    var E = o.splitLines(_);
                    this.doc.replaceRange(E, this.pos.from, this.pos.to, W),
                        (this.pos.to = p(this.pos.from.line + E.length - 1, E[E.length - 1].length + (E.length == 1 ? this.pos.from.ch : 0)));
                }
            },
        }),
            ...
            o.defineExtension("selectMatches", function (_, W) {
                for (
                    var E = [], N = this.getSearchCursor(_, this.getCursor("from"), W);
...
var Vo = Ke((ws, Ss) => {
    (function (o) {
        ...
        "use strict";
        function p(F, R, le, xe, I, L) {
            (this.indented = F), (this.column = R), (this.type = le), (this.info = xe), (this.align = I), (this.prev = L);
        }
        function v(F, R, le, xe) {
            var I = F.indented;
            return (
                F.context && F.context.type == "statement" && le != "statement" && (I = F.context.indented),
                (F.context = new p(I, R, le, xe, null, F.context))
            );
        }
        function C(F) {
            var R = F.context.type;
            return (R == ")" || R == "]" || R == "}") && (F.indented = F.context.indented), (F.context = F.context.prev);
        }
        function b(F, R, le) {
            if (
                R.prevToken == "variable" ||
                R.prevToken == "type" ||
                /\S(?:[^- ]>|[*\]])\s*$|\*$/.test(F.string.slice(0, le)) ||
                (R.typeAtEndOfLine && F.column() == F.indentation())
            )
                return !0;
        }
        function S(F) {
            for (;;) {
                if (!F || F.type == "top") return !0;
                if (F.type == "}" && F.prev.info != "namespace") return !1;
                F = F.prev;
            }
        }
        o.defineMode("clike", function (F, R) {
            var le = F.indentUnit,
                xe = R.statementIndentUnit || le,
                I = R.dontAlignCalls,
                L = R.keywords || {},
                de = R.types || {},
                ze = R.builtin || {},
            ...
            function te(we, Me) {
                ...
                var H = we.current();
                return h(L, H)
                    ? (h(pe, H) && (ce = "newstatement"), h(Ee, H) && (He = !0), "keyword")
                    : h(de, H)
                      ? "type"
                      : h(ze, H) || (Z && Z(H))
            ...
            function Ue(we, Me) {
                R.typeFirstDefinitions && we.eol() && S(Me.context) && (Me.typeAtEndOfLine = b(we, Me, we.pos));
            }
            return {
                ...
                token: function (we, Me) {
                    ...
                    if (
                        ($ == "variable" &&
                            (Me.prevToken == "def" || (R.typeFirstDefinitions && b(we, Me, we.start) && S(Me.context) && we.match(/^\s*\(/, !1))) &&
                            ($ = "def"),
                        Oe.token)
                    ) {
                ...
                indent: function (we, Me) {
                    ...
                    return Le.type == "statement"
                        ...
                        : Le.align && (!I || Le.type != ")")
                          ...
                          : Le.type == ")" && !H
                            ? Le.indented + xe
                            : Le.indented + (H ? 0 : le) + (!H && De && !/^(?:case|default)\b/.test(Me) ? le : 0);
                },
        ...
        function s(F) {
            for (var R = {}, le = F.split(" "), xe = 0; xe < le.length; ++xe) R[le[xe]] = !0;
            return R;
        }
        function h(F, R) {
            return typeof F == "function" ? F(R) : F.propertyIsEnumerable(R);
        }
        var g =
        ...
        function z(F) {
            return h(d, F) || /.+_t$/.test(F);
        }
        function M(F) {
            return z(F) || h(k, F);
        }
        var _ = "case do else for if switch while struct enum union",
            W = "struct enum union";
        function E(F, R) {
            if (!R.startOfLine) return !1;
            for (var le, xe = null; (le = F.peek()); ) {
                if (le == "\\" && F.match(/^.$/)) {
                    xe = E;
                    break;
                } else if (le == "/" && F.match(/^\/[\/\*]/, !1)) break;
                F.next();
            }
        ...
        function G(F) {
            return !F || F.length < 2 || F[0] != "_" ? !1 : F[1] == "_" || F[1] !== F[1].toLowerCase();
        }
        function J(F) {
            return F.eatWhile(/[\w\.']/), "number";
        }
        function re(F, R) {
            if ((F.backUp(1), F.match(/^(?:R|u8R|uR|UR|LR)/))) {
                var le = F.match(/^"([^\s\\()]{0,16})\(/);
                return le ? ((R.cpp11RawStringDelim = le[1]), (R.tokenize = D), D(F, R)) : !1;
            }
            return F.match(/^(?:u8|u|U|L)/) ? (F.match(/^["']/, !1) ? "string" : !1) : (F.next(), !1);
        }
        function q(F) {
            var R = /(\w+)::~?(\w+)$/.exec(F);
            return R && R[1] == R[2];
        ...
        function D(F, R) {
            var le = R.cpp11RawStringDelim.replace(/[^\w\s]/g, "\\$&"),
                xe = F.match(new RegExp(".*?\\)" + le + '"'));
            return xe ? (R.tokenize = null) : F.skipToEnd(), "string";
        }
        function Q(F, R) {
            typeof F == "string" && (F = [F]);
            var le = [];
            ...
            xe(R.keywords), xe(R.types), xe(R.builtin), xe(R.atoms), le.length && ((R.helperType = F[0]), o.registerHelper("hintWords", F[0], le));
            for (var I = 0; I < F.length; ++I) o.defineMIME(F[I], R);
        }
        Q(["text/x-csrc", "text/x-c", "text/x-chdr"], {
            ...
            Q("text/x-java", {
                ...
                hooks: {
                    "@": function (F) {
                        return F.match("interface", !1) ? !1 : (F.eatWhile(/[\w\$_]/), "meta");
                    },
                    '"': function (F, R) {
                        return F.match(/""$/) ? ((R.tokenize = j), R.tokenize(F, R)) : !1;
                    },
                },
            ...
            Q("text/x-csharp", {
                ...
                hooks: {
                    "@": function (F, R) {
                        return F.eat('"') ? ((R.tokenize = O), O(F, R)) : (F.eatWhile(/[\w\$_]/), "meta");
                    },
                },
            });
        function j(F, R) {
                ...
                for (var xe; (xe = R.next()); )
                    if (xe == "*" && R.eat("/"))
                        if (F == 1) {
                            le.tokenize = null;
                            break;
                        } else return (le.tokenize = V(F - 1)), le.tokenize(R, le);
                    else if (xe == "/" && R.eat("*")) return (le.tokenize = V(F + 1)), le.tokenize(R, le);
                return "comment";
            };
        }
        Q("text/x-scala", {
            ...
            hooks: {
                "@": function (F) {
                    return F.eatWhile(/[\w\$_]/), "meta";
                },
                '"': function (F, R) {
                    return F.match('""') ? ((R.tokenize = j), R.tokenize(F, R)) : !1;
                },
                "'": function (F) {
                    return F.match(/^(\\[^'\s]+|[^\\'])'/) ? "string-2" : (F.eatWhile(/[\w\$_\xa1-\uffff]/), "atom");
                },
                "=": function (F, R) {
                    var le = R.context;
                    return le.type == "}" && le.align && F.eat(">")
                        ? ((R.context = new p(le.indented, le.column, le.type, le.info, null, le.prev)), "operator")
                        : !1;
                },
                "/": function (F, R) {
                    return F.eat("*") ? ((R.tokenize = V(1)), R.tokenize(F, R)) : !1;
                },
            },
        ...
        function y(F) {
            return function (R, le) {
                for (var xe = !1, I, L = !1; !R.eol(); ) {
                    ...
                    (I = R.next()), !xe && I == "$" && R.match("{") && R.skipTo("}"), (xe = !xe && I == "\\" && !F);
                }
                return (L || !F) && (le.tokenize = null), "string";
            };
        }
        Q("text/x-kotlin", {
            name: "clike",
            ...
            hooks: {
                ...
                '"': function (F, R) {
                    return (R.tokenize = y(F.match('""'))), R.tokenize(F, R);
                },
                "/": function (F, R) {
                    return F.eat("*") ? ((R.tokenize = V(1)), R.tokenize(F, R)) : !1;
                },
                indent: function (F, R, le, xe) {
                    var I = le && le.charAt(0);
                    if ((F.prevToken == "}" || F.prevToken == ")") && le == "") return F.indented;
                    if (
                        (F.prevToken == "operator" && le != "}" && F.context.type != "}") ||
                        (F.prevToken == "variable" && I == ".") ||
                        ((F.prevToken == "}" || F.prevToken == ")") && I == ".")
                    )
                        return xe * 2 + R.indented;
                    if (R.align && R.type == "}") return R.indented + (F.context.type == (le || "").charAt(0) ? 0 : xe);
                },
            },
            ...
            Q("text/x-objectivec", {
                ...
                types: M,
                builtin: s(c),
                blockKeywords: s(_ + " @synthesize @try @catch @finally @autoreleasepool @synchronized"),
            ...
            Q("text/x-objectivec++", {
                ...
                types: M,
                builtin: s(c),
                blockKeywords: s(_ + " @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch"),
        ...
        function X(F) {
            return function (R, le) {
                for (var xe = !1, I, L = !1; !R.eol(); ) {
                    if (!xe && R.match('"') && (F == "single" || R.match('""'))) {
                        L = !0;
                        break;
                    }
                    if (!xe && R.match("``")) {
        ...
        Q("text/x-ceylon", {
            ...
            hooks: {
                ...
                '"': function (F, R) {
                    return (R.tokenize = X(F.match('""') ? "triple" : "single")), R.tokenize(F, R);
                },
                "`": function (F, R) {
                    return !K || !F.match("`") ? !1 : ((R.tokenize = K), (K = null), R.tokenize(F, R));
                },
                "'": function (F) {
                    return F.eatWhile(/[\w\$_\xa1-\uffff]/), "atom";
                },
                token: function (F, R, le) {
                    if ((le == "variable" || le == "type") && R.prevToken == ".") return "variable-2";
                },
            },
    ...
    (function (o) {
        ...
        o.defineMode("css", function (O, D) {
            ...
            var j = O.indentUnit,
                ...
                ge = O.highlightNonStandardPropertyKeywords !== !1,
                Oe,
                qe;
            function Se(te, fe) {
                return (Oe = fe), te;
            ...
            return (
                ...
                (He.block = function (te, fe, oe) {
                    if (te == "word") {
                        ...
                        return te == "meta" ? "block" : !ze && (te == "hash" || te == "qualifier") ? ((qe = "error"), "block") : He.top(te, fe, oe);
                }),
                ...
                (He.documentTypes = function (te, fe, oe) {
                    return te == "word" && y.hasOwnProperty(fe.current()) ? ((qe = "tag"), oe.context.type) : He.atBlock(te, fe, oe);
                }),
                ...
                (He.atBlock_parens = function (te, fe, oe) {
                    return te == ")" ? Ge(oe) : te == "{" || te == "}" ? Z(te, fe, oe, 2) : He.atBlock(te, fe, oe);
                }),
                ...
                (He.keyframes = function (te, fe, oe) {
                    return te == "word" ? ((qe = "variable"), "keyframes") : te == "{" ? Re(oe, fe, "top") : U(te, fe, oe);
                }),
        ...
        function p(O) {
            for (var D = {}, Q = 0; Q < O.length; ++Q) D[O[Q].toLowerCase()] = !0;
            return D;
        }
        var v = ["domain", "regexp", "url", "url-prefix"],
            ...
            J = p(G),
            re = v.concat(b).concat(s).concat(g).concat(w).concat(d).concat(E).concat(G);
        o.registerHelper("hintWords", "css", re);
        function q(O, D) {
            for (var Q = !1, j; (j = O.next()) != null; ) {
                if (Q && j == "/") {
                    D.tokenize = null;
                    break;
                }
        ...
        o.defineMIME("text/css", {
            ...
            o.defineMIME("text/x-scss", {
                ...
                tokenHooks: {
                    ...
                    $: function (O) {
                        return O.match(/^[\w-]+/), O.match(/^\s*:/, !1) ? ["variable-2", "variable-definition"] : ["variable-2", "variable"];
                    },
                    "#": function (O) {
            ...
            o.defineMIME("text/x-less", {
                ...
                tokenHooks: {
                    ...
                    "@": function (O) {
                        return O.eat("{")
                            ? [null, "interpolation"]
                            : O.match(/^(charset|document|font-face|import|(-(moz|ms|o|webkit)-)?keyframes|media|namespace|page|supports)\b/i, !1)
                              ? !1
                              : (O.eatWhile(/[\w\\\-]/), O.match(/^\s*:/, !1) ? ["variable-2", "variable-definition"] : ["variable-2", "variable"]);
                    },
                    "&": function () {
                        return ["atom", "atom"];
                    },
...
var mn = Ke((qs, Is) => {
    (function (o) {
        ...
        o.defineMode("xml", function (C, b) {
                        ...
                        ? y.eat("[")
                            ...
                            : y.match("--")
                              ...
                              : y.match("DOCTYPE", !0, !0)
                                ...
                                : null
                        : y.eat("?")
                          ? (y.eatWhile(/[\w\._\-]/), (K.tokenize = z("meta", "?>")), "meta")
                          : ((T = y.eat("/") ? "closeTag" : "openTag"), (K.tokenize = d), "tag bracket");
                if (F == "&") {
                    var R;
                    return (
                        y.eat("#")
            ...
            function d(y, K) {
                var X = y.next();
                if (X == ">" || (X == "/" && y.eat(">"))) return (K.tokenize = c), (T = X == ">" ? "endTag" : "selfcloseTag"), "tag bracket";
                if (X == "=") return (T = "equals"), null;
                if (X == "<") {
                    (K.tokenize = c), (K.state = G), (K.tagName = K.tagStart = null);
                    var F = K.tokenize(y, K);
                    return F ? F + " tag error" : "tag error";
                } else
                    return /[\'\"]/.test(X)
                        ? ((K.tokenize = k(X)), (K.stringStartCol = y.column()), K.tokenize(y, K))
                        : (y.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), "word");
            }
            function k(y) {
                var K = function (X, F) {
            ...
            function M(y) {
                return function (K, X) {
                    for (var F; (F = K.next()) != null; ) {
                        if (F == "<") return (X.tokenize = M(y + 1)), X.tokenize(K, X);
                        if (F == ">")
                            if (y == 1) {
                                X.tokenize = c;
                                break;
                            } else return (X.tokenize = M(y - 1)), X.tokenize(K, X);
                    }
                    return "meta";
                };
            }
            ...
            function W(y, K, X) {
                (this.prev = y.context),
                    ...
                    (this.startOfLine = X),
                    (s.doNotIndent.hasOwnProperty(K) || (y.context && y.context.noIndent)) && (this.noIndent = !0);
            }
            function E(y) {
            ...
            function N(y, K) {
                for (var X; ; ) {
                    if (
                        !y.context ||
                        ((X = y.context.tagName), !s.contextGrabbers.hasOwnProperty(_(X)) || !s.contextGrabbers[_(X)].hasOwnProperty(_(K)))
                    )
                        return;
                    E(y);
                }
            ...
            function G(y, K, X) {
                return y == "openTag" ? ((X.tagStart = K.column()), J) : y == "closeTag" ? re : G;
            }
            function J(y, K, X) {
                return y == "word"
            ...
            function re(y, K, X) {
                if (y == "word") {
                    var F = K.current();
                    return (
                        X.context && X.context.tagName != F && s.implicitlyClosed.hasOwnProperty(_(X.context.tagName)) && E(X),
                        (X.context && X.context.tagName == F) || s.matchClosing === !1 ? ((w = "tag"), q) : ((w = "tag error"), O)
                    );
                } else return s.allowMissingTagName && y == "endTag" ? ((w = "tag bracket"), q(y, K, X)) : ((w = "error"), O);
            }
            function q(y, K, X) {
            ...
            function D(y, K, X) {
                ...
                if (y == "endTag" || y == "selfcloseTag") {
                    ...
                    return (
                        ...
                        y == "selfcloseTag" || s.autoSelfClosers.hasOwnProperty(_(F))
                            ? N(X, F)
                            : (N(X, F), (X.context = new W(X, F, R == X.indented))),
                        G
                    );
                }
                return (w = "error"), D;
            ...
            function Q(y, K, X) {
                return y == "equals" ? j : (s.allowMissing || (w = "error"), D(y, K, X));
            }
            function j(y, K, X) {
                return y == "string" ? V : y == "word" && s.allowUnquoted ? ((w = "string"), D) : ((w = "error"), D(y, K, X));
            }
            function V(y, K, X) {
            ...
            return {
                startState: function (y) {
                    var K = { tokenize: c, state: G, indented: y || 0, tagName: null, tagStart: null, context: null };
                    return y != null && (K.baseIndent = y), K;
                },
                token: function (y, K) {
                    if ((!K.tagName && y.sol() && (K.indented = y.indentation()), y.eatSpace())) return null;
                    T = null;
                    var X = K.tokenize(y, K);
                    return (
                        (X || T) && X != "comment" && ((w = null), (K.state = K.state(T || X, y, K)), w && (X = w == "error" ? X + " error" : w)), X
                    );
                },
                indent: function (y, K, X) {
                    var F = y.context;
                    if (y.tokenize.isInAttribute) return y.tagStart == y.indented ? y.stringStartCol + 1 : y.indented + S;
                    if (F && F.noIndent) return o.Pass;
                    ...
                    if (R && R[1])
                        for (; F; )
                            if (F.tagName == R[2]) {
                                F = F.prev;
                                break;
                            } else if (s.implicitlyClosed.hasOwnProperty(_(F.tagName))) F = F.prev;
                            else break;
                    else if (R)
                        for (; F; ) {
                            var le = s.contextGrabbers[_(F.tagName)];
                            if (le && le.hasOwnProperty(_(R[2]))) F = F.prev;
                            else break;
                        }
                    for (; F && F.prev && !F.startOfLine; ) F = F.prev;
                    return F ? F.indent + S : y.baseIndent || 0;
                },
                electricInput: /<\/[\s\w:]+>$/,
                blockCommentStart: "<!--",
                blockCommentEnd: "-->",
                ...
                xmlCurrentContext: function (y) {
                    for (var K = [], X = y.context; X; X = X.prev) K.push(X.tagName);
                    return K.reverse();
                },
            };
        }),
...
var vn = Ke((Fs, Ns) => {
    (function (o) {
        ...
        o.defineMode("javascript", function (p, v) {
            ...
            function W(x, P) {
                var ae = x.next();
                if (ae == '"' || ae == "'") return (P.tokenize = E(ae)), P.tokenize(x, P);
                if (ae == "." && x.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/)) return _("number", "number");
                if (ae == "." && x.match("..")) return _("spread", "meta");
                if (/[\[\]{}\(\),;\:\.]/.test(ae)) return _(ae);
                if (ae == "=" && x.eat(">")) return _("=>", "operator");
                if (ae == "0" && x.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)) return _("number", "number");
                if (/\d/.test(ae)) return x.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), _("number", "number");
                if (ae == "/")
                    return x.eat("*")
                        ? ((P.tokenize = N), N(x, P))
                        : x.eat("/")
                          ...
                          : Bt(x, P, 1)
                            ? (k(x), x.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), _("regexp", "string-2"))
                            : (x.eat("="), _("operator", "operator", x.current()));
                if (ae == "`") return (P.tokenize = G), G(x, P);
                if (ae == "#" && x.peek() == "!") return x.skipToEnd(), _("meta", "meta");
                if (ae == "#" && x.eatWhile(T)) return _("variable", "property");
                if ((ae == "<" && x.match("!--")) || (ae == "-" && x.match("->") && !/\S/.test(x.string.slice(0, x.start))))
                    return x.skipToEnd(), _("comment", "comment");
                if (c.test(ae))
                    return (
                        (ae != ">" || !P.lexical || P.lexical.type != ">") &&
                            (x.eat("=") ? (ae == "!" || ae == "=") && x.eat("=") : /[<>*+\-|&?]/.test(ae) && (x.eat(ae), ae == ">" && x.eat(ae))),
                        ae == "?" && x.eat(".") ? _(".") : _("operator", "operator", x.current())
                    );
                if (T.test(ae)) {
                    x.eatWhile(T);
                    var he = x.current();
                    if (P.lastType != ".") {
                        ...
                        if (he == "async" && x.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1)) return _("async", "keyword", he);
                    }
            ...
            function E(x) {
                return function (P, ae) {
                    var he = !1,
                        ne;
                    if (S && P.peek() == "@" && P.match(d)) return (ae.tokenize = W), _("jsonld-keyword", "meta");
                    for (; (ne = P.next()) != null && !(ne == x && !he); ) he = !he && ne == "\\";
            ...
            function re(x, P) {
                ...
                if (!(ae < 0)) {
                    if (g) {
                        var he = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(x.string.slice(x.start, ae));
                        he && (ae = he.index);
                    }
            ...
            var q = { atom: !0, number: !0, variable: !0, string: !0, regexp: !0, this: !0, import: !0, "jsonld-keyword": !0 };
            function O(x, P, ae, he, ne, ye) {
                (this.indented = x), (this.column = P), (this.type = ae), (this.prev = ne), (this.info = ye), he != null && (this.align = he);
            }
            function D(x, P) {
                if (!h) return !1;
                for (var ae = x.localVars; ae; ae = ae.next) if (ae.name == P) return !0;
                for (var he = x.context; he; he = he.prev) for (var ae = he.vars; ae; ae = ae.next) if (ae.name == P) return !0;
            }
            function Q(x, P, ae, he, ne) {
                var ye = x.cc;
                for (
                    j.state = x, j.stream = ne, j.marked = null, j.cc = ye, j.style = P, x.lexical.hasOwnProperty("align") || (x.lexical.align = !0);
                    ;
                    ...
                    if (Xe(ae, he)) {
                        ...
                        return j.marked ? j.marked : ae == "variable" && D(x, he) ? "variable-2" : P;
                    }
                }
            }
            var j = { state: null, column: null, marked: null, cc: null };
            function V() {
                for (var x = arguments.length - 1; x >= 0; x--) j.cc.push(arguments[x]);
            }
            function y() {
            ...
            function X(x) {
                ...
                if (((j.marked = "def"), !!h)) {
                    ...
                    v.globalVars && !K(x, P.globalVars) && (P.globalVars = new xe(x, P.globalVars));
                }
            }
            function F(x, P) {
                if (P)
                    ...
                    } else return K(x, P.vars) ? P : new le(P.prev, new xe(x, P.vars), !1);
                else return null;
            }
            function R(x) {
                return x == "public" || x == "private" || x == "protected" || x == "abstract" || x == "readonly";
            }
            function le(x, P, ae) {
            ...
            var I = new xe("this", new xe("arguments", null));
            function L() {
                (j.state.context = new le(j.state.context, j.state.localVars, !1)), (j.state.localVars = I);
            }
            function de() {
            ...
            function pe(x, P) {
                var ae = function () {
                    ...
                    he.lexical = new O(ne, j.stream.column(), x, null, he.lexical, P);
                };
                return (ae.lex = !0), ae;
            }
            function Ee() {
                var x = j.state;
                x.lexical.prev && (x.lexical.type == ")" && (x.indented = x.lexical.indented), (x.lexical = x.lexical.prev));
            }
            Ee.lex = !0;
            function ge(x) {
                function P(ae) {
                    return ae == x ? y() : x == ";" || ae == "}" || ae == ")" || ae == "]" ? V() : y(P);
                }
                return P;
            }
            function Oe(x, P) {
                                  ...
                                  : x == "function"
                                    ...
                                    : x == "for"
                                      ...
                                      : x == "class" || (g && P == "interface")
                                        ? ((j.marked = "keyword"), y(pe("form", x == "class" ? x : P), Wr, Ee))
                                        : x == "variable"
                                          ? g && P == "declare"
                                              ? ((j.marked = "keyword"), y(Oe))
                                              : g && (P == "module" || P == "enum" || P == "type") && j.stream.match(/^\s*\w/, !1)
                                                ? ((j.marked = "keyword"),
                                                  P == "enum"
                                                      ? y(Ae)
                                                      : P == "type"
                                                        ? y(ti, ge("operator"), Pe, ge(";"))
                                                        : y(pe("form"), Ct, ge("{"), pe("}"), De, Ee, Ee))
                                                : g && P == "namespace"
                                                  ? ((j.marked = "keyword"), y(pe("form"), Se, Oe, Ee))
                                                  : g && P == "abstract"
                                                    ? ((j.marked = "keyword"), y(Oe))
                                                    : y(pe("stat"), Ue)
                                          : x == "switch"
                                            ? y(pe("form"), Ze, ge("{"), pe("}", "switch"), de, De, Ee, Ee, ze)
                                            : x == "case"
                                              ? y(Se, ge(":"))
                                              : x == "default"
                                                ? y(ge(":"))
                                                : x == "catch"
                                                  ? y(pe("form"), L, qe, Oe, Ee, ze)
                                                  : x == "export"
                                                    ? y(pe("stat"), Ur, Ee)
                                                    : x == "import"
                                                      ? y(pe("stat"), gr, Ee)
            ...
            function ke(x, P, ae) {
                if (j.state.fatArrowAt == j.stream.start) {
                    var he = ae ? He : ce;
                    if (x == "(") return y(L, pe(")"), H($t, ")"), Ee, ge("=>"), he, ze);
            ...
            function Ge(x, P, ae) {
                ...
                if (x != ";") {
                    ...
                    if (g && P == "as") return (j.marked = "keyword"), y(Pe, he);
                    if (x == "regexp") return (j.state.lastType = j.marked = "operator"), j.stream.backUp(j.stream.pos - j.stream.start - 1), y(ne);
                }
            }
            function U(x, P) {
                return x != "quasi" ? V() : P.slice(P.length - 2) != "${" ? y(U) : y(Je, Z);
            }
            function Z(x) {
                if (x == "}") return (j.marked = "string-2"), (j.state.tokenize = G), y(U);
            }
            function ce(x) {
            ...
            function te(x) {
                return function (P) {
                    return P == "." ? y(x ? oe : fe) : P == "variable" && g ? y(Ft, x ? Ge : Re) : V(x ? Be : Se);
                };
            }
            function fe(x, P) {
            ...
            function Me(x, P) {
                ...
                if (x == "variable" || j.style == "keyword") {
                    ...
                    if (x == "number" || x == "string") return (j.marked = S ? "property" : j.style + " property"), y($);
            ...
            function Le(x) {
                return x != "variable" ? V($) : ((j.marked = "property"), y(Ht));
            }
            function $(x) {
                if (x == ":") return y(Be);
                if (x == "(") return V(Ht);
            ...
            function H(x, P, ae) {
                function he(ne, ye) {
                    ...
                    return ne == P || ye == P ? y() : ae && ae.indexOf(";") > -1 ? V(x) : y(ge(P));
                }
            ...
            function Pt(x) {
                if (g && x == ":") return j.stream.match(/^\s*\w+\s+is\b/, !1) ? y(Se, It, Pe) : y(Pe);
            }
            function It(x, P) {
                if (P == "is") return (j.marked = "keyword"), y();
            }
            function Pe(x, P) {
                if (P == "keyof" || P == "typeof" || P == "infer" || P == "readonly") return (j.marked = "keyword"), y(P == "typeof" ? Be : Pe);
                if (x == "variable" || P == "void") return (j.marked = "type"), y(Rt);
                if (P == "|" || P == "&") return y(Pe);
                if (x == "string" || x == "number" || x == "atom") return y(Rt);
                if (x == "[") return y(pe("]"), H(Pe, "]", ","), Ee, Rt);
                if (x == "{") return y(pe("}"), Fe, Ee, Rt);
            ...
            function Fe(x) {
                return x.match(/[\}\)\]]/) ? y() : x == "," || x == ";" ? y(Fe) : V(nr, Fe);
            }
            function nr(x, P) {
                if (x == "variable" || j.style == "keyword") return (j.marked = "property"), y(nr);
            ...
            function _t(x, P) {
                return x != "quasi" ? V() : P.slice(P.length - 2) != "${" ? y(_t) : y(Pe, it);
            }
            function it(x) {
                if (x == "}") return (j.marked = "string-2"), (j.state.tokenize = G), y(_t);
            }
            function ot(x, P) {
                return (x == "variable" && j.stream.match(/^\s*[?:]/, !1)) || P == "?" ? y(ot) : x == ":" ? y(Pe) : x == "spread" ? y(ot) : V(Pe);
            }
            function Rt(x, P) {
            ...
            function Rr(x, P) {
                return P == "enum" ? ((j.marked = "keyword"), y(Ae)) : V(Ct, nt, Ut, eo);
            }
            function Ct(x, P) {
            ...
            function dr(x, P) {
                return x == "variable" && !j.stream.match(/^\s*:/, !1)
                    ...
                    : (x == "variable" && (j.marked = "property"),
                      x == "spread" ? y(Ct) : x == "}" ? V() : x == "[" ? y(Se, ge("]"), ge(":"), dr) : y(ge(":"), Ct, Ut));
            }
            function yn() {
                return V(Ct, Ut);
            }
            ...
            function Hr(x, P) {
                if (x == "keyword b" && P == "else") return y(pe("form", "else"), Oe, Ee);
            }
            function ei(x, P) {
            ...
            function pr(x, P) {
                return x == ")" ? y() : x == ";" ? y(pr) : P == "in" || P == "of" ? ((j.marked = "keyword"), y(Se, pr)) : V(Se, pr);
            }
            function Ht(x, P) {
            ...
            function ti(x, P) {
                if (x == "keyword" || x == "variable") return (j.marked = "type"), y(ti);
                if (P == "<") return y(pe(">"), H(Wt, ">"), Ee);
            }
            function $t(x, P) {
                return (
                    P == "@" && y(Se, $t),
                    x == "spread" ? y($t) : g && R(P) ? ((j.marked = "keyword"), y($t)) : g && x == "this" ? y(nt, Ut) : V(Ct, nt, Ut)
                );
            }
            function to(x, P) {
            ...
            function Kt(x, P) {
                ...
                if (P == "extends" || P == "implements" || (g && x == ",")) return P == "implements" && (j.marked = "keyword"), y(g ? Pe : Se, Kt);
                if (x == "{") return y(pe("}"), Gt, Ee);
            }
            function Gt(x, P) {
                if (
                    x == "async" ||
                    (x == "variable" && (P == "static" || P == "get" || P == "set" || (g && R(P))) && j.stream.match(/^\s+#?[\w$\xa1-\uffff]/, !1))
                )
                    return (j.marked = "keyword"), y(Gt);
                if (x == "variable" || j.style == "keyword") return (j.marked = "property"), y(Cr, Gt);
            ...
            function gr(x) {
                return x == "string" ? y() : x == "(" ? V(Se) : x == "." ? V(Re) : V(Kr, Vt, Gr);
            }
            function Kr(x, P) {
                return x == "{" ? se(Kr, "}") : (x == "variable" && X(P), P == "*" && (j.marked = "keyword"), y(_n));
            }
            function Vt(x) {
                if (x == ",") return y(Kr, Vt);
            }
            ...
            function kn(x, P) {
                return x.lastType == "operator" || x.lastType == "," || c.test(P.charAt(0)) || /[,.]/.test(P.charAt(0));
            }
            function Bt(x, P, ae) {
                return (
                    (P.tokenize == W && /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(P.lastType)) ||
                    (P.lastType == "quasi" && /\{\s*$/.test(x.string.slice(0, x.pos - (ae || 0))))
                );
            }
            return {
                startState: function (x) {
                    var P = {
                        ...
                        lastType: "sof",
                        cc: [],
                        lexical: new O((x || 0) - C, 0, "block", !1),
                        localVars: v.localVars,
                        context: v.localVars && new le(null, null, !1),
                        indented: x || 0,
                    };
                    return v.globalVars && typeof v.globalVars == "object" && (P.globalVars = v.globalVars), P;
                },
                token: function (x, P) {
                    if (
                        (x.sol() && (P.lexical.hasOwnProperty("align") || (P.lexical.align = !1), (P.indented = x.indentation()), re(x, P)),
                        P.tokenize != N && x.eatSpace())
                    )
                        return null;
                    var ae = P.tokenize(x, P);
                    return z == "comment" ? ae : ((P.lastType = z == "operator" && (M == "++" || M == "--") ? "incdec" : z), Q(P, ae, z, M, x));
                },
                indent: function (x, P) {
                    if (x.tokenize == N || x.tokenize == G) return o.Pass;
                    ...
                    for (
                        ...
                        (ae == "}" || ((ne = x.cc[x.cc.length - 1]) && (ne == Re || ne == Ge) && !/^[,\.=+\-*:?[\(]/.test(P)));
                    ...
                    var pt = he.type,
                        Et = ae == pt;
                    return pt == "vardef"
                        ? he.indented + (x.lastType == "operator" || x.lastType == "," ? he.info.length + 1 : 0)
                        : pt == "form" && ae == "{"
                          ? he.indented
                          : pt == "form"
                            ? he.indented + C
                ...
                skipExpression: function (x) {
                    Q(x, "atom", "atom", "true", new o.StringStream("", 2, null));
                },
            };
        }),
...
var Qn = Ke((Os, Ps) => {
    (function (o) {
        ...
        function v(T, w, c) {
            var d = T.current(),
                k = d.search(w);
            return k > -1 ? T.backUp(d.length - k) : d.match(/<\/?$/) && (T.backUp(d.length), T.match(w, !1) || T.match(d)), c;
        }
        var C = {};
        function b(T) {
            var w = C[T];
            return w || (C[T] = new RegExp("\\s+" + T + `\\s*=\\s*('|")?([^'"]+)('|")?\\s*`));
        }
        function S(T, w) {
            var c = T.match(b(w));
        ...
        function h(T, w) {
            for (var c in T) for (var d = w[c] || (w[c] = []), k = T[c], z = k.length - 1; z >= 0; z--) d.unshift(k[z]);
        }
        function g(T, w) {
        ...
        o.defineMode(
            ...
            function (T, w) {
                var c = o.getMode(T, {
                    ...
                    k = w && w.tags,
                    z = w && w.scriptTypes;
                if ((h(p, d), k && h(k, d), z)) for (var M = z.length - 1; M >= 0; M--) d.script.unshift(["type", z[M].matches, z[M].mode]);
                function _(W, E) {
                    var N = c.token(W, E.htmlState),
                        G = /\btag\b/.test(N),
                        J;
                    if (G && !/[<>\s\/]/.test(W.current()) && (J = E.htmlState.tagName && E.htmlState.tagName.toLowerCase()) && d.hasOwnProperty(J))
                        E.inTag = J + " ";
                        ...
                        (E.token = function (j, V) {
                            return j.match(D, !1)
                                ? ((V.token = _), (V.localState = V.localMode = null), null)
                                : v(j, Q, V.localMode.token(j, V.localState));
                        }),
                            (E.localMode = O),
                            (E.localState = o.startState(O, c.indent(E.htmlState, "", "")));
                ...
                return {
                    startState: function () {
                        ...
                        return { token: _, inTag: null, localMode: null, localState: null, htmlState: W };
                    },
                    copyState: function (W) {
                        var E;
                        return (
                            W.localState && (E = o.copyState(W.localMode, W.localState)),
                            { token: W.token, inTag: W.inTag, localMode: W.localMode, localState: E, htmlState: o.copyState(c, W.htmlState) }
                        );
                    },
                    token: function (W, E) {
                        return E.token(W, E);
                    ...
                    : c.match(/\b(\w+)\b/)
                      ...
                      : c.match("%}")
                        ? ((d.waitProperty = null),
                          ...
                          (d.waitDot = null),
                          (d.waitPipe = null),
                          d.blockCommentTag ? ((d.blockCommentTag = !1), (d.tokenize = w)) : (d.tokenize = S),
                          "tag")
                        : (c.next(), "null");
            }
            function T(c, d) {
...
var Di = Ke((Hs, Ws) => {
    (function (o) {
            ...
            (o.simpleMode = function (w, c) {
                ...
                for (var M in c)
                    if (M != k && c.hasOwnProperty(M))
                        for (var _ = (d[M] = []), W = c[M], E = 0; E < W.length; E++) {
                            var N = W[E];
                            _.push(new b(N, c)), (N.indent || N.dedent) && (z = !0);
                        }
                var G = {
                    startState: function () {
                        return { state: "start", pending: null, local: null, localState: null, indent: z ? [] : null };
                    },
                    copyState: function (re) {
                        var q = { state: re.state, pending: re.pending, local: re.local, localState: null, indent: re.indent && re.indent.slice(0) };
                        re.localState && (q.localState = o.copyState(re.local.mode, re.localState)), re.stack && (q.stack = re.stack.slice(0));
                        for (var O = re.persistentStates; O; O = O.next)
                            q.persistentStates = {
                                mode: O.mode,
                                spec: O.spec,
                                state: O.state == re.localState ? q.localState : o.copyState(O.mode, O.state),
        ...
        function p(w, c) {
            if (!w.hasOwnProperty(c)) throw new Error("Undefined state " + c + " in simple mode");
        }
        function v(w, c) {
            if (!w) return /(?:)/;
            var d = "";
            return (
                w instanceof RegExp ? (w.ignoreCase && (d = "i"), w.unicode && (d += "u"), (w = w.source)) : (w = String(w)),
                new RegExp((c === !1 ? "" : "^") + "(?:" + w + ")", d)
            );
        }
        function C(w) {
            ...
            for (var c = [], d = 0; d < w.length; d++) c.push(w[d] && w[d].replace(/\./g, " "));
            return c;
        }
        function b(w, c) {
            (w.next || w.push) && p(c, w.next || w.push), (this.regex = v(w.regex)), (this.token = C(w.token)), (this.data = w);
        }
        function S(w, c) {
            return function (d, k) {
                if (k.pending) {
                    var z = k.pending.shift();
                    return k.pending.length == 0 && (k.pending = null), (d.pos += z.text.length), z.token;
                }
                if (k.local)
                    if (k.local.end && d.match(k.local.end)) {
                        ...
                        var M = k.local.mode.token(d, k.localState),
                            _;
                        return k.local.endScan && (_ = k.local.endScan.exec(d.current())) && (d.pos = d.start + _.index), M;
                    }
                for (var W = w[k.state], E = 0; E < W.length; E++) {
                    var N = W[E],
                        G = (!N.data.sol || d.sol()) && d.match(N.regex);
                    if (G) {
                        N.data.next
                            ? (k.state = N.data.next)
                            : N.data.push
                              ? ((k.stack || (k.stack = [])).push(k.state), (k.state = N.data.push))
                              : N.data.pop && k.stack && k.stack.length && (k.state = k.stack.pop()),
                            N.data.mode && h(c, k, N.data.mode, N.token),
                            N.data.indent && k.indent.push(d.indentation() + c.indentUnit),
                            N.data.dedent && k.indent.pop();
                        var J = N.token;
                        if ((J && J.apply && (J = J(G)), G.length > 2 && N.token && typeof N.token != "string")) {
                            for (var re = 2; re < G.length; re++)
                                G[re] && (k.pending || (k.pending = [])).push({ text: G[re], token: N.token[re - 1] });
        ...
        function h(w, c, d, k) {
            var z;
            if (d.persistent) for (var M = c.persistentStates; M && !z; M = M.next) (d.spec ? s(d.spec, M.spec) : d.mode == M.mode) && (z = M);
            var _ = z ? z.mode : d.mode || o.getMode(w, d.spec),
                W = z ? z.state : o.startState(_);
            d.persistent && !z && (c.persistentStates = { mode: _, spec: d.spec, state: W, next: c.persistentStates }),
                (c.localState = W),
                (c.local = {
                    mode: _,
                    end: d.end && v(d.end),
        ...
        function g(w, c) {
            for (var d = 0; d < c.length; d++) if (c[d] === w) return !0;
        }
        function T(w, c) {
            return function (d, k, z) {
                if (d.local && d.local.mode.indent) return d.local.mode.indent(d.localState, k, z);
                ...
                e: for (;;) {
                    for (var W = 0; W < _.length; W++) {
                        ...
                        if (E.data.dedent && E.data.dedentIfLineStart !== !1) {
                            var N = E.regex.exec(k);
                            if (N && N[0]) {
                                M--, (E.next || E.push) && (_ = w[E.next || E.push]), (k = k.slice(N[0].length));
                                continue e;
                            }
                        }
                    }
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (p, v) {
                ...
                function S(I) {
                    if (o.findModeByName) {
                        var L = o.findModeByName(I);
                        L && (I = L.mime || L.mimes[0]);
                    }
                    var de = o.getMode(p, I);
                ...
                var g = /^([*\-_])(?:\s*\1){2,}\s*$/,
                    ...
                    W = "    ";
                function E(I, L, de) {
                    return (L.f = L.inline = de), de(I, L);
                }
                function N(I, L, de) {
                    return (L.f = L.block = de), de(I, L);
                }
                function G(I) {
                ...
                function J(I) {
                    if (
                        ...
                        var L = b;
                        if (!L) {
                            var de = o.innerMode(C, I.htmlState);
                            L = de.mode.name == "xml" && de.state.tagStart === null && !de.state.context && de.state.tokenize.isInText;
                        }
                        L && ((I.f = j), (I.block = re), (I.htmlState = null));
                    }
                    return (I.trailingSpace = 0), (I.trailingSpaceNewLine = !1), (I.prevLine = I.thisLine), (I.thisLine = { stream: null }), null;
                }
                function re(I, L) {
                    var de = I.column() === L.indentation,
                    ...
                    var Se = !ze && !Ee && !L.prevLine.header && (!ge || !pe) && !L.prevLine.fencedCodeEnd,
                        Be = (L.list === !1 || Ee || ze) && L.indentation <= Oe && I.match(g),
                        Ze = null;
                    if (L.indentationDiff >= 4 && (pe || L.prevLine.fencedCodeEnd || L.prevLine.header || ze))
                        return I.skipToEnd(), (L.indentedCode = !0), s.code;
                    if (I.eatSpace()) return null;
                    if (de && L.indentation <= Oe && (Ze = I.match(c)) && Ze[1].length <= 6)
                        return (
                            (L.quote = 0),
                    ...
                    if (L.indentation <= Oe && I.eat(">"))
                        return (L.quote = de ? 1 : L.quote + 1), v.highlightFormatting && (L.formatting = "quote"), I.eatSpace(), D(L);
                    if (!Be && !L.setext && de && L.indentation <= Oe && (Ze = I.match(T))) {
                        var ke = Ze[1] ? "ol" : "ul";
                        return (
                            (L.indentation = qe + I.current().length),
                            (L.list = !0),
                            (L.quote = 0),
                            ...
                            (L.code = !1),
                            (L.strikethrough = !1),
                            v.taskLists && I.match(w, !1) && (L.taskList = !0),
                            (L.f = L.inline),
                            v.highlightFormatting && (L.formatting = ["list", "list-" + ke]),
                            D(L)
                        );
                    } else {
                        if (de && L.indentation <= Oe && (Ze = I.match(z, !0)))
                            return (
                                (L.quote = 0),
                        ...
                        if (
                            ...
                            return (
                                L.setext
                                    ? ((L.header = L.setext), (L.setext = 0), I.skipToEnd(), v.highlightFormatting && (L.formatting = "header"))
                                    : ((L.header = Ze[0].charAt(0) == "=" ? 1 : 2), (L.setext = L.header)),
                                (L.thisLine.header = !0),
                                (L.f = L.inline),
                                D(L)
                            );
                        if (Be) return I.skipToEnd(), (L.hr = !0), (L.thisLine.hr = !0), s.hr;
                        if (I.peek() === "[") return E(I, L, F);
                    }
                    return E(I, L, L.inline);
                }
                function q(I, L) {
                    var de = C.token(I, L.htmlState);
                    if (!b) {
                        var ze = o.innerMode(C, L.htmlState);
                        ((ze.mode.name == "xml" && ze.state.tagStart === null && !ze.state.context && ze.state.tokenize.isInText) ||
                            (L.md_inside && I.current().indexOf(">") > -1)) &&
                ...
                function O(I, L) {
                    var de = L.listStack[L.listStack.length - 1] || 0,
                        ze = L.indentation < de,
                        pe = de + 3;
                    if (L.fencedEndRE && L.indentation <= pe && (ze || I.match(L.fencedEndRE))) {
                        v.highlightFormatting && (L.formatting = "code-block");
                        var Ee;
                        return (
                            ze || (Ee = D(L)),
                    ...
                    } else return L.localMode ? L.localMode.token(I, L.localState) : (I.skipToEnd(), s.code);
                }
                function D(I) {
                    var L = [];
                    if (I.formatting) {
                        L.push(s.formatting), typeof I.formatting == "string" && (I.formatting = [I.formatting]);
                        for (var de = 0; de < I.formatting.length; de++)
                            L.push(s.formatting + "-" + I.formatting[de]),
                                I.formatting[de] === "header" && L.push(s.formatting + "-" + I.formatting[de] + "-" + I.header),
                                I.formatting[de] === "quote" &&
                                    (!v.maxBlockquoteDepth || v.maxBlockquoteDepth >= I.quote
                                        ? L.push(s.formatting + "-" + I.formatting[de] + "-" + I.quote)
                                        : L.push("error"));
                    }
                    if (I.taskOpen) return L.push("meta"), L.length ? L.join(" ") : null;
                    if (I.taskClosed) return L.push("property"), L.length ? L.join(" ") : null;
                    if (
                        (I.linkHref
                            ? L.push(s.linkHref, "url")
                            : (I.strong && L.push(s.strong),
                              I.em && L.push(s.em),
                              I.strikethrough && L.push(s.strikethrough),
                              I.emoji && L.push(s.emoji),
                              I.linkText && L.push(s.linkText),
                              I.code && L.push(s.code),
                              I.image && L.push(s.image),
                              I.imageAltText && L.push(s.imageAltText, "link"),
                              I.imageMarker && L.push(s.imageMarker)),
                        I.header && L.push(s.header, s.header + "-" + I.header),
                        I.quote &&
                            (L.push(s.quote),
                            !v.maxBlockquoteDepth || v.maxBlockquoteDepth >= I.quote
                                ? L.push(s.quote + "-" + I.quote)
                    ...
                    return (
                        I.trailingSpaceNewLine
                            ...
                            : I.trailingSpace && L.push("trailing-space-" + (I.trailingSpace % 2 ? "a" : "b")),
                        L.length ? L.join(" ") : null
                    );
                }
                function Q(I, L) {
                    if (I.match(k, !0)) return D(L);
                }
                function j(I, L) {
                    var de = L.text(I, L);
                    ...
                    if (pe === "`") {
                        var Oe = L.formatting;
                        v.highlightFormatting && (L.formatting = "code"), I.eatWhile("`");
                    ...
                    if (pe === "\\" && (I.next(), v.highlightFormatting)) {
                        var Be = D(L),
                    ...
                    if (pe === "]" && L.imageAltText) {
                        ...
                        var Be = D(L);
                        return (L.imageAltText = !1), (L.image = !1), (L.inline = L.f = y), Be;
                    }
                    if (pe === "[" && !L.image)
                        return (L.linkText && I.match(/^.*?\]/)) || ((L.linkText = !0), v.highlightFormatting && (L.formatting = "link")), D(L);
                    if (pe === "]" && L.linkText) {
                        v.highlightFormatting && (L.formatting = "link");
                        var Be = D(L);
                        return (L.linkText = !1), (L.inline = L.f = I.match(/\(.*?\)| ?\[.*?\]/, !1) ? y : j), Be;
                    }
                    if (pe === "<" && I.match(/^(https?|ftps?):\/\/(?:[^\\>]|\\.)+>/, !1)) {
                    ...
                    if (v.xml && pe === "<" && I.match(/^(!--|\?|!\[CDATA\[|[a-z][a-z0-9-]*(?:\s+[a-z_:.\-]+(?:\s*=\s*[^>]+)?)*\s*(?:>|$))/i, !1)) {
                        var ke = I.string.indexOf(">", I.pos);
                        if (ke != -1) {
                            var Je = I.string.substring(I.start, ke);
                            /markdown\s*=\s*('|"){0,1}1('|"){0,1}/.test(Je) && (L.md_inside = !0);
                        }
                        return I.backUp(1), (L.htmlState = o.startState(C)), N(I, L, q);
                    }
                    if (v.xml && pe === "<" && I.match(/^\/\w*?>/)) return (L.md_inside = !1), "tag";
                    if (pe === "*" || pe === "_") {
                        for (var Re = 1, Ge = I.pos == 1 ? " " : I.string.charAt(I.pos - 2); Re < 3 && I.eat(pe); ) Re++;
                        var U = I.peek() || " ",
                            Z = !/\s/.test(U) && (!_.test(U) || /\s/.test(Ge) || _.test(Ge)),
                            ce = !/\s/.test(Ge) && (!_.test(Ge) || /\s/.test(U) || _.test(U)),
                            He = null,
                            te = null;
                        if (
                            (Re % 2 &&
                                (!L.em && Z && (pe === "*" || !ce || _.test(Ge))
                                    ? (He = !0)
                                    : L.em == pe && ce && (pe === "*" || !Z || _.test(U)) && (He = !1)),
                            Re > 1 &&
                                (!L.strong && Z && (pe === "*" || !ce || _.test(Ge))
                                    ? (te = !0)
                                    : L.strong == pe && ce && (pe === "*" || !Z || _.test(U)) && (te = !1)),
                            te != null || He != null)
                        ) {
                            v.highlightFormatting && (L.formatting = He == null ? "strong" : te == null ? "em" : "strong em"),
                                He === !0 && (L.em = pe),
                                te === !0 && (L.strong = pe);
                            var Se = D(L);
                            return He === !1 && (L.em = !1), te === !1 && (L.strong = !1), Se;
                        }
                    } else if (pe === " " && (I.eat("*") || I.eat("_"))) {
                        if (I.peek() === " ") return D(L);
                        I.backUp(1);
                    }
                    if (v.strikethrough) {
                        if (pe === "~" && I.eatWhile(pe)) {
                        ...
                        } else if (pe === " " && I.match("~~", !0)) {
                            if (I.peek() === " ") return D(L);
                            I.backUp(2);
                        }
                    }
                    if (v.emoji && pe === ":" && I.match(/^(?:[a-z_\d+][a-z_\d+-]*|\-[a-z_\d+][a-z_\d+-]*):/)) {
                        (L.emoji = !0), v.highlightFormatting && (L.formatting = "emoji");
                        var fe = D(L);
                        return (L.emoji = !1), fe;
                    }
                    return pe === " " && (I.match(/^ +$/, !1) ? L.trailingSpace++ : L.trailingSpace && (L.trailingSpaceNewLine = !0)), D(L);
                }
                function V(I, L) {
                    var de = I.next();
                    if (de === ">") {
                ...
                function X(I) {
                    return function (L, de) {
                        ...
                        return L.match(K[I]), (de.linkHref = !0), D(de);
                    };
                }
                function F(I, L) {
                    return I.match(/^([^\]\\]|\\.)*\]:/, !1)
                        ? ((L.f = R), I.next(), v.highlightFormatting && (L.formatting = "link"), (L.linkText = !0), D(L))
                        : E(I, L, j);
                }
                function R(I, L) {
                    if (I.match("]:", !0)) {
                ...
                var xe = {
                    ...
                    copyState: function (I) {
                        return {
                            ...
                            thisLine: I.thisLine,
                            block: I.block,
                            htmlState: I.htmlState && o.copyState(C, I.htmlState),
                    ...
                    token: function (I, L) {
                        if (((L.formatting = !1), I != L.thisLine.stream)) {
                            if (((L.header = 0), (L.hr = !1), I.match(/^\s*$/, !0))) return J(L), null;
                            if (
                                ...
                                var de = I.match(/^\s*/, !0)[0].replace(/\t/g, W).length;
                    ...
                    innerMode: function (I) {
                        return I.block == q
                            ? { state: I.htmlState, mode: C }
                            : I.localState
                              ? { state: I.localState, mode: I.localMode }
                              : { state: I, mode: xe };
                    },
                    indent: function (I, L, de) {
                        return I.block == q && C.indent
                            ? C.indent(I.htmlState, L, de)
                            : I.localState && I.localMode.indent
                              ? I.localMode.indent(I.localState, L, de)
                              : o.Pass;
                    },
                    blankLine: J,
                    getType: D,
        ...
        o.defineMode(
            ...
            function (v, C) {
                ...
                var s = {
                        ...
                        token: function (T, w) {
                            if (((w.combineTokens = null), w.codeBlock)) return T.match(/^```+/) ? ((w.codeBlock = !1), null) : (T.skipToEnd(), null);
                            if ((T.sol() && (w.code = !1), T.sol() && T.match(/^```+/))) return T.skipToEnd(), (w.codeBlock = !0), null;
                            if (T.peek() === "`") {
                                T.next();
                                var c = T.pos;
                                T.eatWhile("`");
                                var d = 1 + T.pos - c;
                                return w.code ? d === b && (w.code = !1) : ((b = d), (w.code = !0)), null;
                            } else if (w.code) return T.next(), null;
                            if (T.eatSpace()) return (w.ateSpace = !0), null;
                            if ((T.sol() || w.ateSpace) && ((w.ateSpace = !1), C.gitHubSpice !== !1)) {
                                if (T.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+@)?(?=.{0,6}\d)(?:[a-f0-9]{7,40}\b)/))
                                    return (w.combineTokens = !0), "link";
                                if (T.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+)?#[0-9]+\b/)) return (w.combineTokens = !0), "link";
                            }
                            return T.match(p) &&
...
var nu = Ke((tu, ru) => {
    (function (o) {
        ...
        o.defineMode("go", function (p) {
            ...
            function h(k, z) {
                var M = k.next();
                if (M == '"' || M == "'" || M == "`") return (z.tokenize = g(M)), z.tokenize(k, z);
                if (/[\d\.]/.test(M))
                    return (
                        M == "."
                ...
                return C.propertyIsEnumerable(_)
                    ? ((_ == "case" || _ == "default") && (s = "case"), "keyword")
            ...
            function g(k) {
                return function (z, M) {
                    ...
                    return (E || !(_ || k == "`")) && (M.tokenize = h), "string";
                };
            }
            function T(k, z) {
            ...
            function w(k, z, M, _, W) {
                (this.indented = k), (this.column = z), (this.type = M), (this.align = _), (this.prev = W);
            }
            function c(k, z, M) {
            ...
            function d(k) {
                if (k.context.prev) {
                    ...
                    return (z == ")" || z == "]" || z == "}") && (k.indented = k.context.indented), (k.context = k.context.prev);
                }
            }
            return {
                startState: function (k) {
                    return { tokenize: null, context: new w((k || 0) - v, 0, "top", !1), indented: 0, startOfLine: !0 };
                },
                token: function (k, z) {
                    var M = z.context;
                    if (
                ...
                indent: function (k, z) {
                    ...
                    var M = k.context,
                        _ = z && z.charAt(0);
                    if (M.type == "case" && /^(?:case|default)\b/.test(z)) return (k.context.type = "}"), M.indented;
                    var W = _ == M.type;
...
var au = Ke((iu, ou) => {
    (function (o) {
        ...
        o.defineMode("http", function () {
            ...
            function s(T, w) {
                return T.match(/^HTTP\/\d\.\d$/) ? ((w.cur = h), "keyword") : p(T, w);
            }
            function h(T) {
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (C, b) {
                ...
                function g(c, d) {
                    return d.context.mode == S ? T(c, d, d.context) : w(c, d, d.context);
                }
                function T(c, d, k) {
                    if (k.depth == 2) return c.match(/^.*?\*\//) ? (k.depth = 1) : c.skipToEnd(), "comment";
                    if (c.peek() == "{") {
                        ...
                        if (M && c.match(/^[^>]*>\s*$/, !1)) {
                            ...
                            M.startOfLine ? (z -= C.indentUnit) : k.prev.state.lexical && (z = k.prev.state.lexical.indented);
                        } else k.depth == 1 && (z += C.indentUnit);
                        return (d.context = new p(o.startState(s, z), s, 0, d.context)), null;
                    }
                    if (k.depth == 1) {
                        if (c.peek() == "<") return S.skipAttribute(k.state), (d.context = new p(o.startState(S, h(k.state)), S, 0, d.context)), null;
                        if (c.match("//")) return c.skipToEnd(), "comment";
                        if (c.match("/*")) return (k.depth = 2), g(c, d);
                    }
                    var _ = S.token(c, k.state),
                        W = c.current(),
                        E;
                    return (
                        /\btag\b/.test(_)
                            ? />$/.test(W)
                                ...
                                : /^</.test(W) && (k.depth = 1)
                            : !_ && (E = W.indexOf("{")) > -1 && c.backUp(W.length - E),
                        _
                    );
                }
                function w(c, d, k) {
                    if (c.peek() == "<" && !c.match(/^<([^<>]|<[^>]*>)+,\s*>/, !1) && s.expressionAllowed(c, k.state))
                        return (d.context = new p(o.startState(S, s.indent(k.state, "", "")), S, 0, d.context)), s.skipExpression(k.state), null;
                    var z = s.token(c, k.state);
                    if (!z && k.depth != null) {
                        var M = c.current();
                        M == "{" ? k.depth++ : M == "}" && --k.depth == 0 && (d.context = d.context.prev);
                    }
                    return z;
                }
                return {
...
var gu = Ke((pu, hu) => {
    (function (o) {
        ...
        o.defineMode("nginx", function (p) {
            function v(k) {
                for (var z = {}, M = k.split(" "), _ = 0; _ < M.length; ++_) z[M[_]] = !0;
                return z;
            }
            var C = v(
            ...
            function T(k, z) {
                ...
                var _ = k.next();
                if (_ == "@") return k.eatWhile(/[\w\\\-]/), g("meta", k.current());
            ...
            function d(k) {
                return function (z, M) {
                    for (var _ = !1, W; (W = z.next()) != null && !(W == k && !_); ) _ = !_ && W == "\\";
            ...
            return {
                ...
                token: function (k, z) {
                    ...
                    var M = z.tokenize(k, z),
                        _ = z.stack[z.stack.length - 1];
                    return (
                        h == "hash" && _ == "rule"
                            ? (M = "atom")
                            : M == "variable" && (_ == "rule" ? (M = "number") : (!_ || _ == "@media{") && (M = "tag")),
                        ...
                        h == "{"
                            ...
                            : h == "}"
                              ...
                              : h == "@media"
                                ? z.stack.push("@media")
                                : _ == "{" && h != "comment" && z.stack.push("rule"),
                        M
                    );
                },
                indent: function (k, z) {
                    var M = k.stack.length;
                    return /^\}/.test(z) && (M -= k.stack[k.stack.length - 1] == "rule" ? 2 : 1), k.baseIndent + M * s;
                },
                electricChars: "}",
            };
        }),
...
var bu = Ke((mu, vu) => {
    (function (o) {
        ...
        o.defineMode("pascal", function () {
            function p(T) {
                for (var w = {}, c = T.split(" "), d = 0; d < c.length; ++d) w[c[d]] = !0;
                return w;
            }
            var v = p(
            ...
            function S(T, w) {
                ...
                if (c == '"' || c == "'") return (w.tokenize = s(c)), w.tokenize(T, w);
        ...
        o.defineMode("perl", function () {
            ...
            function g(c, d, k, z, M) {
                return (
                    ...
                    (d.tokenize = function (_, W) {
                        for (var E = !1, N, G = 0; (N = _.next()); ) {
                            if (N === k[G] && !E)
                                return k[++G] !== void 0 ? ((W.chain = k[G]), (W.style = z), (W.tail = M)) : M && _.eatWhile(M), (W.tokenize = w), z;
                            E = !E && N == "\\";
                        }
                        return z;
                    }),
            ...
            function T(c, d, k) {
                return (
                    (d.tokenize = function (z, M) {
                        return z.string == k && (M.tokenize = w), z.skipToEnd(), "string";
                    }),
                    d.tokenize(c, d)
                );
            }
            function w(c, d) {
                ...
                if (k == "q") {
                    ...
                    if (!(_ && /\w/.test(_))) {
                        if (((_ = p(c, 0)), _ == "x")) {
                            if (((_ = p(c, 1)), _ == "(")) return b(c, 2), g(c, d, [")"], s, h);
                            if (_ == "[") return b(c, 2), g(c, d, ["]"], s, h);
                            if (_ == "{") return b(c, 2), g(c, d, ["}"], s, h);
                            if (_ == "<") return b(c, 2), g(c, d, [">"], s, h);
                            if (/[\^'"!~\/]/.test(_)) return b(c, 1), g(c, d, [c.eat(_)], s, h);
                        } else if (_ == "q") {
                            if (((_ = p(c, 1)), _ == "(")) return b(c, 2), g(c, d, [")"], "string");
                            if (_ == "[") return b(c, 2), g(c, d, ["]"], "string");
                            if (_ == "{") return b(c, 2), g(c, d, ["}"], "string");
                            if (_ == "<") return b(c, 2), g(c, d, [">"], "string");
                            if (/[\^'"!~\/]/.test(_)) return b(c, 1), g(c, d, [c.eat(_)], "string");
                        } else if (_ == "w") {
                            if (((_ = p(c, 1)), _ == "(")) return b(c, 2), g(c, d, [")"], "bracket");
                            if (_ == "[") return b(c, 2), g(c, d, ["]"], "bracket");
                            if (_ == "{") return b(c, 2), g(c, d, ["}"], "bracket");
                            if (_ == "<") return b(c, 2), g(c, d, [">"], "bracket");
                            if (/[\^'"!~\/]/.test(_)) return b(c, 1), g(c, d, [c.eat(_)], "bracket");
                        } else if (_ == "r") {
                            if (((_ = p(c, 1)), _ == "(")) return b(c, 2), g(c, d, [")"], s, h);
                            if (_ == "[") return b(c, 2), g(c, d, ["]"], s, h);
                            if (_ == "{") return b(c, 2), g(c, d, ["}"], s, h);
                            ...
                            if (_ == "(") return b(c, 1), g(c, d, [")"], "string");
                            if (_ == "[") return b(c, 1), g(c, d, ["]"], "string");
                            if (_ == "{") return b(c, 1), g(c, d, ["}"], "string");
                            if (_ == "<") return b(c, 1), g(c, d, [">"], "string");
                            if (/[\^'"!~\/]/.test(_)) return g(c, d, [c.eat(_)], "string");
                        }
                    }
                }
                if (k == "m") {
                    var _ = p(c, -2);
                    if (!(_ && /\w/.test(_)) && ((_ = c.eat(/[(\[{<\^'"!~\/]/)), _)) {
                ...
                if (k == "/") return /~\s*$/.test(v(c)) ? g(c, d, [k], s, h) : "operator";
                if (k == "$") {
                    var z = c.pos;
                ...
                if (/[$@%&]/.test(k) && (c.eatWhile(/[\w$]/) || (c.eat("{") && c.eatWhile(/[\w$]/) && c.eat("}")))) {
                    var _ = c.current();
            ...
            return {
                startState: function () {
                    return { tokenize: w, chain: null, style: null, tail: null };
                },
                token: function (c, d) {
    ...
    (function (o) {
        ...
        function v(T, w, c) {
            return T.length == 0
                ? C(w)
                : function (d, k) {
                      for (var z = T[0], M = 0; M < z.length; M++) if (d.match(z[M][0])) return (k.tokenize = v(T.slice(1), w)), z[M][1];
        ...
        function b(T, w, c, d) {
            if ((d !== !1 && T.match("${", !1)) || T.match("{$", !1)) return (w.tokenize = null), "string";
            if (d !== !1 && T.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/))
                return (
                    ...
                    T.match(/^->\w/, !1) && (w.tokenize = v([[["->", null]], [[/[\w]+/, "variable"]]], c, d)),
                    "variable-2"
                );
            for (var k = !1; !T.eol() && (k || d === !1 || (!T.match("{$", !1) && !T.match(/^(\$[a-zA-Z_][a-zA-Z0-9_]*|\$\{)/, !1))); ) {
                if (!k && T.match(c)) {
            ...
            hooks: {
                ...
                "<": function (T, w) {
                    ...
                    if ((c = T.match(/^<<\s*/))) {
                        ...
                        if ((d && T.eat(d), k)) return (w.tokStack || (w.tokStack = [])).push(k, 0), (w.tokenize = C(k, d != "'")), "string";
                    }
                    return !1;
                },
                "#": function (T) {
                ...
                '"': function (T, w) {
                    return (w.tokStack || (w.tokStack = [])).push('"', 0), (w.tokenize = C('"')), "string";
                },
                "{": function (T, w) {
        ...
        o.defineMode(
            "php",
            function (T, w) {
                var c = o.getMode(T, (w && w.htmlMode) || "text/html"),
                    d = o.getMode(T, g);
                function k(z, M) {
                    var _ = M.curMode == d;
                    if ((z.sol() && M.pending && M.pending != '"' && M.pending != "'" && (M.pending = null), _))
                        return _ && M.php.tokenize == null && z.match("?>")
                            ? ((M.curMode = c), (M.curState = M.html), M.php.context.prev || (M.php = null), "meta")
                            : d.token(z, M.curState);
                    if (z.match(/^<\?\w*/))
                        return (M.curMode = d), M.php || (M.php = o.startState(d, c.indent(M.html, "", ""))), (M.curState = M.php), "meta";
                ...
                return {
                    startState: function () {
                        var z = o.startState(c),
                            M = w.startOpen ? o.startState(d) : null;
                        return { html: z, php: M, curMode: w.startOpen ? d : c, curState: w.startOpen ? M : z, pending: null };
                    },
                    copyState: function (z) {
                        var M = z.html,
                            ...
                            E = W && o.copyState(d, W),
                            N;
                        return z.curMode == c ? (N = _) : (N = E), { html: _, php: E, curMode: z.curMode, curState: N, pending: z.pending };
                    },
                    token: k,
                    indent: function (z, M, _) {
                        return (z.curMode != d && /^\s*<\//.test(M)) || (z.curMode == d && /^\?>/.test(M))
                            ? c.indent(z.html, M, _)
...
var Mu = Ke((Eu, zu) => {
    (function (o) {
        ...
        o.defineMode("python", function (h, g) {
            for (
                var T = "error",
                    w = g.delimiters || g.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/,
                    c = [
                        g.singleOperators,
                        g.doubleOperators,
                        g.doubleDelimiters,
            ...
            var k = g.hangingIndent || h.indentUnit,
                z = C,
                M = b;
            g.extra_keywords != null && (z = z.concat(g.extra_keywords)), g.extra_builtins != null && (M = M.concat(g.extra_builtins));
            var _ = !(g.version && Number(g.version) < 3);
            if (_) {
                var W = g.identifiers || /^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/;
                (z = z.concat(["nonlocal", "None", "aiter", "anext", "async", "await", "breakpoint", "match", "case"])),
            ...
            var N = p(z),
                G = p(M);
            function J(K, X) {
                var F = K.sol() && X.lastToken != "\\";
                if ((F && (X.indent = K.indentation()), F && S(X).type == "py")) {
                    var R = S(X).offset;
                    if (K.eatSpace()) {
                        var le = K.indentation();
                        return le > R ? D(X) : le < R && j(K, X) && K.peek() != "#" && (X.errorToken = !0), null;
                    } else {
                        var xe = re(K, X);
            ...
            function re(K, X, F) {
                if (K.eatSpace()) return null;
                if (!F && K.match(/^#.*/)) return "comment";
                if (K.match(/^[0-9\.]/, !1)) {
                    var R = !1;
                    if ((K.match(/^[\d_]*\.\d+(e[\+\-]?\d+)?/i) && (R = !0), K.match(/^[\d_]+\.\d*/) && (R = !0), K.match(/^\.\d+/) && (R = !0), R))
                ...
                if (K.match(E)) {
                    ...
                    return xe
                        ...
                        : ((X.tokenize = O(K.current(), X.tokenize)), X.tokenize(K, X));
                }
                for (var I = 0; I < c.length; I++) if (K.match(c[I])) return "operator";
                return K.match(w)
                    ? "punctuation"
            ...
            function q(K, X) {
                    ...
                    return function (L, de) {
                        ...
                        return (
                            ze == "punctuation" &&
                                (L.current() == "{"
                                    ? (de.tokenize = le(I + 1))
                                    : L.current() == "}" && (I > 1 ? (de.tokenize = le(I - 1)) : (de.tokenize = xe))),
                            ze
                        );
                    };
                }
                function xe(I, L) {
                    for (; !I.eol(); )
                        if ((I.eatWhile(/[^'"\{\}\\]/), I.eat("\\"))) {
                            if ((I.next(), F && I.eol())) return R;
                        } else {
                            if (I.match(K)) return (L.tokenize = X), R;
                            if (I.match("{{")) return R;
                            if (I.match("{", !1)) return (L.tokenize = le(0)), I.current() ? R : L.tokenize(I, L);
                            if (I.match("}}")) return R;
                            if (I.match("}")) return T;
                            I.eat(/['"]/);
                        }
                ...
                function le(xe, I) {
                    for (; !xe.eol(); )
                        if ((xe.eatWhile(/[^'"\\]/), xe.eat("\\"))) {
                            if ((xe.next(), F && xe.eol())) return R;
                        } else {
                            if (xe.match(K)) return (I.tokenize = X), R;
                            xe.eat(/['"]/);
                        }
                    if (F) {
                        if (g.singleLineStringErrors) return T;
            ...
            function Q(K, X, F) {
                var R = K.match(/^[\s\[\{\(]*(?:#|$)/, !1) ? null : K.column() + 1;
                X.scopes.push({ offset: X.indent + k, type: F, align: R });
            }
            function j(K, X) {
                for (var F = K.indentation(); X.scopes.length > 1 && S(X).offset > F; ) {
            ...
            function V(K, X) {
                ...
                var F = X.tokenize(K, X),
                    R = K.current();
                if (X.beginningOfLine && R == "@") return K.match(W, !1) ? "meta" : _ ? "operator" : T;
                if (
                    (/\S/.test(R) && (X.beginningOfLine = !1),
                    (F == "variable" || F == "builtin") && X.lastToken == "meta" && (F = "meta"),
                    (R == "pass" || R == "return") && (X.dedent = !0),
                    R == "lambda" && (X.lambda = !0),
                    R == ":" && !X.lambda && S(X).type == "py" && K.match(/^\s*(?:#|$)/, !1) && D(X),
                    R.length == 1 && !/string|comment/.test(F))
                ) {
                    var le = "[({".indexOf(R);
                    if ((le != -1 && Q(K, X, "])}".slice(le, le + 1)), (le = "])}".indexOf(R)), le != -1))
                        if (S(X).type == R) X.indent = X.scopes.pop().offset - k;
                        else return T;
                }
                return X.dedent && K.eol() && S(X).type == "py" && X.scopes.length > 1 && X.scopes.pop(), F;
            }
            var y = {
                startState: function (K) {
                    return {
                ...
                token: function (K, X) {
                    ...
                    var R = V(K, X);
                    return (
                        R && R != "comment" && (X.lastToken = R == "keyword" || R == "punctuation" ? K.current() : R),
                ...
                indent: function (K, X) {
                    ...
                    var F = S(K),
                        R = F.type == X.charAt(0) || (F.type == "py" && !K.dedent && /^(else:|elif |except |finally:)/.test(X));
                    return F.align != null ? F.align - (R ? 1 : 0) : F.offset - (R ? k : 0);
                },
    ...
    (function (o) {
        ...
        o.defineMode("ruby", function (g) {
            ...
            function c(E, N) {
                ...
                var G = E.next(),
                    J;
                if (G == "`" || G == "'" || G == '"') return w(M(G, "string", G == '"' || G == "`"), E, N);
                if (G == "/") return d(E) ? w(M(G, "string-2", !0), E, N) : "operator";
                if (G == "%") {
                    var re = "string",
                        q = !0;
                    E.eat("s")
                    ...
                    var O = E.eat(/[^\w\s=]/);
                    return O ? (s.propertyIsEnumerable(O) && (O = s[O]), w(M(O, re, q, !0), E, N)) : "operator";
                } else {
                    if (G == "#") return E.skipToEnd(), "comment";
                    if (G == "<" && (J = E.match(/^<([-~])[\`\"\']?([a-zA-Z_?]\w*)[\`\"\']?(?:;|$)/))) return w(_(J[2], J[1]), E, N);
                    if (G == "0") return E.eat("x") ? E.eatWhile(/[\da-fA-F]/) : E.eat("b") ? E.eatWhile(/[01]/) : E.eatWhile(/[0-7]/), "number";
                    if (/\d/.test(G)) return E.match(/^[\d_]*(?:\.[\d_]+)?(?:[eE][+\-]?[\d_]+)?/), "number";
                    if (G == "?") {
                        for (; E.match(/^\\[CM]-/); );
                                  ...
                                  : E.eat(/[\<\>]/)
                                    ...
                                    : E.eat(/[\+\-\*\/\&\|\:\!]/)
                                      ...
                                      : E.eat(/[a-zA-Z$@_\xa1-\uffff]/)
                                        ...
                                        : "operator";
                        if (G == "@" && E.match(/^@?[a-zA-Z_\xa1-\uffff]/)) return E.eat("@"), E.eatWhile(/[\w\xa1-\uffff]/), "variable-2";
                        if (G == "$") return E.eat(/[a-zA-Z_]/) ? E.eatWhile(/[\w]/) : E.eat(/\d/) ? E.eat(/\d/) : E.next(), "variable-3";
                        if (/[a-zA-Z_\xa1-\uffff]/.test(G)) return E.eatWhile(/[\w\xa1-\uffff]/), E.eat(/[\?\!]/), E.eat(":") ? "atom" : "ident";
                        if (G == "|" && (N.varList || N.lastTok == "{" || N.lastTok == "do")) return (T = "|"), null;
            ...
            function d(E) {
                for (var N = E.pos, G = 0, J, re = !1, q = !1; (J = E.next()) != null; )
                    if (q) q = !1;
                    else {
                        if ("[{(".indexOf(J) > -1) G++;
                        else if ("]})".indexOf(J) > -1) {
            ...
            function k(E) {
                return (
                    ...
                    function (N, G) {
                        if (N.peek() == "}") {
                            if (E == 1) return G.tokenize.pop(), G.tokenize[G.tokenize.length - 1](N, G);
                            G.tokenize[G.tokenize.length - 1] = k(E - 1);
                        } else N.peek() == "{" && (G.tokenize[G.tokenize.length - 1] = k(E + 1));
                        return c(N, G);
                    }
                );
            }
            function z() {
                var E = !1;
                return function (N, G) {
                    return E ? (G.tokenize.pop(), G.tokenize[G.tokenize.length - 1](N, G)) : ((E = !0), c(N, G));
                };
            }
            function M(E, N, G, J) {
                return function (re, q) {
                    var O = !1,
                        D;
                    for (q.context.type === "read-quoted-paused" && ((q.context = q.context.prev), re.eat("}")); (D = re.next()) != null; ) {
                        if (D == E && (J || !O)) {
                            q.tokenize.pop();
                            break;
                        }
                        if (G && D == "#" && !O) {
                            if (re.eat("{")) {
                                E == "}" && (q.context = { prev: q.context, type: "read-quoted-paused" }), q.tokenize.push(k());
                                break;
            ...
            function _(E, N) {
                return function (G, J) {
                    return N && G.eatSpace(), G.match(E) ? J.tokenize.pop() : G.skipToEnd(), "string";
                };
            }
            function W(E, N) {
                return E.sol() && E.match("=end") && E.eol() && N.tokenize.pop(), E.skipToEnd(), "comment";
            }
            return {
                startState: function () {
                    return {
                ...
                token: function (E, N) {
                    ...
                    var G = N.tokenize[N.tokenize.length - 1](E, N),
                        J,
                        re = T;
                    if (G == "ident") {
                        var q = E.current();
                    ...
                    return (
                        ...
                        J == "indent" || /[\(\[\{]/.test(T)
                            ? (N.context = { prev: N.context, type: T || G, indented: N.indented })
                            : (J == "dedent" || /[\)\]\}]/.test(T)) && N.context.prev && (N.context = N.context.prev),
                        E.eol() && (N.continuedLine = T == "\\" || G == "operator"),
                        G
                    );
                },
                indent: function (E, N) {
                    ...
                    var G = N && N.charAt(0),
                        J = E.context,
                        re = J.type == h[G] || (J.type == "keyword" && /^(?:end|until|else|elsif|when|rescue)\b/.test(N));
                    return J.indented + (re ? 0 : g.indentUnit) + (E.continuedLine ? g.indentUnit : 0);
                },
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (p) {
                ...
                function _(q, O) {
                    return function (D, Q) {
                        return D.sol() && D.indentation() <= q
                            ? ((Q.tokenizer = J), J(D, Q))
                            : (O && D.skipTo("*/") ? (D.next(), D.next(), (Q.tokenizer = J)) : D.skipToEnd(), "comment");
                    };
                }
                function W(q, O) {
                    O == null && (O = !0);
                    function D(Q, j) {
                        var V = Q.next(),
                            ...
                            X = (V !== "\\" && y === q) || (V === q && K !== "\\");
                        return X
                            ? (V !== q && O && Q.next(), z(Q) && (j.cursorHalf = 0), (j.tokenizer = J), "string")
                            : V === "#" && y === "{"
                ...
                function J(q, O) {
                    var D = q.peek();
                    if (q.match("/*")) return (O.tokenizer = _(q.indentation(), !0)), O.tokenizer(q, O);
                    if (q.match("//")) return (O.tokenizer = _(q.indentation(), !1)), O.tokenizer(q, O);
                    if (q.match("#{")) return (O.tokenizer = E(J)), "operator";
                    if (D === '"' || D === "'") return q.next(), (O.tokenizer = W(D)), "string";
                    if (O.cursorHalf) {
                        if ((D === "#" && (q.next(), q.match(/[0-9a-fA-F]{6}|[0-9a-fA-F]{3}/))) || q.match(/^-?[0-9\.]+/))
                            return z(q) && (O.cursorHalf = 0), "number";
                        if (q.match(/^(px|em|in)\b/)) return z(q) && (O.cursorHalf = 0), "unit";
                        if (q.match(T)) return z(q) && (O.cursorHalf = 0), "keyword";
                        if (q.match(/^url/) && q.peek() === "(") return (O.tokenizer = M), z(q) && (O.cursorHalf = 0), "atom";
                        if (D === "$") return q.next(), q.eatWhile(/[\w-]/), z(q) && (O.cursorHalf = 0), "variable-2";
                        if (D === "!") return q.next(), (O.cursorHalf = 0), q.match(/^[\w]+/) ? "keyword" : "operator";
                        if (q.match(c)) return z(q) && (O.cursorHalf = 0), "operator";
                        if (q.eatWhile(/[\w-]/))
                            return (
                                z(q) && (O.cursorHalf = 0),
                                ...
                                S.hasOwnProperty(k)
                                    ...
                                    : b.hasOwnProperty(k)
                                      ? "keyword"
                                      : C.hasOwnProperty(k)
                                        ? ((O.prevProp = q.current().toLowerCase()), "property")
                                        : "tag"
                            );
                        ...
                        if (D === ".") {
                            if ((q.next(), q.match(/^[\w-]+/))) return N(O), "qualifier";
                            if (q.peek() === "#") return N(O), "tag";
                        }
                        if (D === "#") {
                            if ((q.next(), q.match(/^[\w-]+/))) return N(O), "builtin";
                            if (q.peek() === "#") return N(O), "tag";
                        }
                        ...
                        if (q.match(/^url/) && q.peek() === "(") return (O.tokenizer = M), "atom";
                        if (D === "=" && q.match(/^=[\w-]+/)) return N(O), "meta";
                        if (D === "+" && q.match(/^\+[\w-]+/)) return "variable-3";
                        if (
                            (D === "@" && q.match("@extend") && (q.match(/\s*[\w]/) || G(O)),
                        ...
                        if (q.eatWhile(/[\w-]/))
                            if (q.match(/ *: *[\w-\+\$#!\("']/, !1)) {
                                ...
                                return q.match(/ *:/, !1)
                                    ? (N(O), (O.cursorHalf = 1), (O.prevProp = q.current().toLowerCase()), "property")
                                    : (q.match(/ *,/, !1) || N(O), "tag");
                        if (D === ":") return q.match(d) ? "variable-3" : (q.next(), (O.cursorHalf = 1), "operator");
                    }
                    return q.match(c) ? "operator" : (q.next(), null);
                }
                function re(q, O) {
                    q.sol() && (O.indentCount = 0);
                    var D = O.tokenizer(q, O),
                        Q = q.current();
                    if (((Q === "@return" || Q === "}") && G(O), D !== null)) {
                        for (var j = q.pos - Q.length, V = j + p.indentUnit * O.indentCount, y = [], K = 0; K < O.scopes.length; K++) {
                            var X = O.scopes[K];
                            X.offset <= V && y.push(X);
                        }
                        O.scopes = y;
                ...
                return {
                    ...
                    token: function (q, O) {
                        var D = re(q, O);
                        return (O.lastToken = { style: D, content: q.current() }), D;
                    },
                    indent: function (q) {
    ...
    (function (o) {
        ...
        o.defineMode("shell", function () {
            ...
            function s(d, k) {
                ...
                if (M === "'" || M === '"' || M === "`") return k.tokens.unshift(h(M, M === "`" ? "quote" : "string")), c(d, k);
                if (M === "#") return z && d.eat("!") ? (d.skipToEnd(), "meta") : (d.skipToEnd(), "comment");
                ...
                if (/\d/.test(M) && (d.eatWhile(/\d/), d.eol() || !/\w/.test(d.peek()))) return "number";
                d.eatWhile(/[\w-]/);
                var W = d.current();
                ...
                return function (M, _) {
                    for (var W, E = !1; (W = M.next()) != null; ) {
                        if (W === z && !E) {
                            ...
                            if (!E && d !== z && W === d) return _.tokens.unshift(h(d, k)), c(M, _);
                            if (!E && /['"]/.test(W) && !/['"]/.test(d)) {
            ...
            var T = function (d, k) {
                ...
                var z = d.next();
                return /['"({]/.test(z)
                    ? ((k.tokens[0] = h(z, z == "(" ? "quote" : z == "{" ? "def" : "string")), c(d, k))
                    : (/\d/.test(z) || d.eatWhile(/\w/), k.tokens.shift(), "def");
            };
            function w(d) {
                return function (k, z) {
                    return k.sol() && k.string == d && z.tokens.shift(), k.skipToEnd(), "string-2";
                };
            }
            function c(d, k) {
    ...
    (function (o) {
        ...
        o.defineMode("sql", function (g, T) {
            ...
            function J(Q, j) {
                ...
                if (M.hexNumber && ((V == "0" && Q.match(/^[xX][0-9a-fA-F]+/)) || ((V == "x" || V == "X") && Q.match(/^'[0-9a-fA-F]*'/))))
                    return "number";
                if (M.binaryNumber && (((V == "b" || V == "B") && Q.match(/^'[01]*'/)) || (V == "0" && Q.match(/^b[01]+/)))) return "number";
                if (V.charCodeAt(0) > 47 && V.charCodeAt(0) < 58)
                    return Q.match(/^[0-9]*(\.[0-9]+)?([eE][-+]?[0-9]+)?/), M.decimallessFloat && Q.match(/^\.(?!\.)/), "number";
                if (V == "?" && (Q.eatSpace() || Q.eol() || Q.eat(";"))) return "variable-3";
                if (V == "'" || (V == '"' && M.doubleQuote)) return (j.tokenize = re(V)), j.tokenize(Q, j);
                if (
                    ((M.nCharCast && (V == "n" || V == "N")) || (M.charsetCast && V == "_" && Q.match(/[a-z][a-z0-9]*/i))) &&
                    (Q.peek() == "'" || Q.peek() == '"')
                )
                    return "keyword";
                if (M.escapeConstant && (V == "e" || V == "E") && (Q.peek() == "'" || (Q.peek() == '"' && M.doubleQuote)))
                    return (
                        (j.tokenize = function (X, F) {
                            return (F.tokenize = re(X.next(), !0))(X, F);
                        }),
                        "keyword"
                    );
                if (M.commentSlashSlash && V == "/" && Q.eat("/")) return Q.skipToEnd(), "comment";
                if ((M.commentHash && V == "#") || (V == "-" && Q.eat("-") && (!M.commentSpaceRequired || Q.eat(" "))))
                    return Q.skipToEnd(), "comment";
                if (V == "/" && Q.eat("*")) return (j.tokenize = q(1)), j.tokenize(Q, j);
                if (V == ".") {
                    if (M.zerolessFloat && Q.match(/^(?:\d+(?:e[+-]?\d+)?)/i)) return "number";
                    ...
                    return W.hasOwnProperty(K) && (Q.match(/^( )+'[^']*'/) || Q.match(/^( )+"[^"]*"/))
                        ? "number"
                        : c.hasOwnProperty(K)
                          ? "atom"
                          : d.hasOwnProperty(K)
            ...
            function q(Q) {
                return function (j, V) {
                    var y = j.match(/^.*?(\/\*|\*\/)/);
                    return (
                        y ? (y[1] == "/*" ? (V.tokenize = q(Q + 1)) : Q > 1 ? (V.tokenize = q(Q - 1)) : (V.tokenize = J)) : j.skipToEnd(), "comment"
                    );
                };
            }
            function O(Q, j, V) {
            ...
            return {
                ...
                token: function (Q, j) {
                    if ((Q.sol() && j.context && j.context.align == null && (j.context.align = !1), j.tokenize == J && Q.eatSpace())) return null;
                    var V = j.tokenize(Q, j);
                    if (V == "comment") return V;
                    j.context && j.context.align == null && (j.context.align = !0);
                    var y = Q.current();
                    return y == "(" ? O(Q, j, ")") : y == "[" ? O(Q, j, "]") : j.context && j.context.type == y && D(j), V;
                },
                indent: function (Q, j) {
                    var V = Q.context;
                    if (!V) return o.Pass;
                    var y = j.charAt(0) == V.type;
                    return V.align ? V.col + (y ? 0 : 1) : V.indent + (y ? 0 : g.indentUnit);
                },
                blockCommentStart: "/*",
                blockCommentEnd: "*/",
        ...
        function s(g) {
            for (var T = {}, w = g.split(" "), c = 0; c < w.length; ++c) T[w[c]] = !0;
            return T;
        }
        var h =
...
var ta = Ke(($u, Ku) => {
    (function (o) {
        ...
        o.defineMode("stylus", function (E) {
            ...
            function Oe($, H) {
                if (
                    ...
                    (H.context.line.firstWord = L ? L[0].replace(/^\s*/, "") : ""),
            ...
            function Be($, H) {
                return $.next(), $.match(/\s*[\"\')]/, !1) ? (H.tokenize = null) : (H.tokenize = Se(")")), [null, "("];
            }
            function Ze($, H, se, De) {
                (this.type = $), (this.indent = H), (this.prev = se), (this.line = De || { firstWord: "", indent: 0 });
            }
            function ke($, H, se, De) {
                return (De = De >= 0 ? De : N), ($.context = new Ze(se, H.indentation() + De, $.context)), se;
            }
            function Je($, H) {
                var se = $.context.indent - N;
                return (H = H || !1), ($.context = $.context.prev), H && ($.context.indent = se), $.context.type;
            }
            function Re($, H, se) {
            ...
            function fe($, H) {
                return (Me(H) && ($ == "{" || $ == "]" || $ == "hash" || $ == "qualifier")) || $ == "block-mixin";
            }
            function oe($, H) {
            ...
            function Le($) {
                var H = /^\s*[-_]*[a-z0-9]+[\w-]*/i,
                    se = typeof $ == "string" ? $.match(H) : $.string.match(H);
                return se ? se[0].replace(/^\s*/, "") : "";
            }
            return (
                (de.block = function ($, H, se) {
                    if (($ == "comment" && we(H)) || ($ == "," && Me(H)) || $ == "mixin") return ke(se, H, "block", 0);
                    if (oe($, H)) return ke(se, H, "interpolation");
                    if (Me(H) && $ == "]" && !/^\s*(\.|#|:|\[|\*|&)/.test(H.string) && !U(Le(H))) return ke(se, H, "block", 0);
                    if (fe($, H)) return ke(se, H, "block");
                    if ($ == "}" && Me(H)) return ke(se, H, "block", 0);
                    if ($ == "variable-name")
                        return H.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/) || ce(Le(H)) ? ke(se, H, "variableName") : ke(se, H, "variableName", 0);
                    if ($ == "=") return !Me(H) && !ce(Le(H)) ? ke(se, H, "block", 0) : ke(se, H, "block");
                    if ($ == "*" && (Me(H) || H.match(/\s*(,|\.|#|\[|:|{)/, !1))) return (ge = "tag"), ke(se, H, "block");
                    if (Ue($, H)) return ke(se, H, "pseudo");
                    if (/@(font-face|media|supports|(-moz-)?document)/.test($)) return ke(se, H, Me(H) ? "block" : "atBlock");
                    if (/@(-(moz|ms|o|webkit)-)?keyframes$/.test($)) return ke(se, H, "keyframes");
                    ...
                    if ($ == "vendor-prefixes") return ke(se, H, "vendorPrefixes");
                    if ($ == "word") {
                        var De = H.current();
                        if (((ge = te(De)), ge == "property")) return we(H) ? ke(se, H, "block", 0) : ((ge = "atom"), "block");
                        if (ge == "tag") {
                            if (
                            ...
                            if (
                                re.test(De) &&
                                ((we(H) && H.string.match(/=/)) || (!we(H) && !H.string.match(/^(\s*\.|#|\&|\[|\/|>|\*)/) && !U(Le(H))))
                            )
                                return (ge = "variable-2"), ce(Le(H)) ? "block" : ke(se, H, "block", 0);
                            if (Me(H)) return ke(se, H, "block");
                        }
                        if (ge == "block-keyword") return (ge = "keyword"), H.current(/(if|unless)/) && !we(H) ? "block" : ke(se, H, "block");
                        if (De == "return") return ke(se, H, "block", 0);
                        if (ge == "variable-2" && H.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/)) return ke(se, H, "block");
                    }
                            ...
                            : (H.string.match(/^[a-z][\w-]*\(/i) && Me(H)) ||
                              ...
                              : H.string.match(/^[\$-]?[a-z][\w-\.\[\]\'\"]*\s*=/) ||
                                ...
                                : Me(H)
                                  ? ke(se, H, "block")
                                  : ke(se, H, "block", 0);
                    if (($ && $.charAt(0) == "@" && Z(H.current().slice(1)) && (ge = "variable-2"), $ == "word")) {
                        var De = H.current();
                        (ge = te(De)), ge == "tag" && re.test(De) && (ge = "variable-2"), (ge == "property" || De == "to") && (ge = "atom");
                    }
                    return $ == "variable-name" ? ke(se, H, "variableName") : Ue($, H) ? ke(se, H, "pseudo") : se.context.type;
                }),
                (de.vendorPrefixes = function ($, H, se) {
                    return $ == "word" ? ((ge = "property"), ke(se, H, "block", 0)) : Je(se);
                }),
                (de.pseudo = function ($, H, se) {
                    return Z(Le(H.string)) ? Ge($, H, se) : (H.match(/^[a-z-]+/), (ge = "variable-3"), Me(H) ? ke(se, H, "block") : Je(se));
                }),
                (de.atBlock = function ($, H, se) {
                    ...
                    return $ == "operator" && /^(not|and|or)$/.test(H.current()) && (ge = "keyword"), se.context.type;
                }),
                (de.atBlock_parens = function ($, H, se) {
                    if ($ == "{" || $ == "}") return se.context.type;
                    if ($ == ")") return Me(H) ? ke(se, H, "block") : ke(se, H, "atBlock");
                    if ($ == "word") {
                        var De = H.current().toLowerCase();
                        return (
                            (ge = te(De)),
                ...
                (de.keyframes = function ($, H, se) {
                    return H.indentation() == "0" && (($ == "}" && we(H)) || $ == "]" || $ == "hash" || $ == "qualifier" || U(H.current()))
                        ? Ge($, H, se)
                        : $ == "{"
                          ? ke(se, H, "keyframes")
                          : $ == "}"
                ...
                (de.interpolation = function ($, H, se) {
                    return (
                        $ == "{" && Je(se) && ke(se, H, "block"),
                        $ == "}"
                            ? H.string.match(/^\s*(\.|#|:|\[|\*|&|>|~|\+|\/)/i) || (H.string.match(/^\s*[a-z]/i) && U(Le(H)))
                                ? ke(se, H, "block")
                            ...
                            : $ == "variable-name"
                              ...
                              : ($ == "word" && ((ge = te(H.current())), ge == "tag" && (ge = "atom")), se.context.type)
                    );
                }),
                (de.extend = function ($, H, se) {
                    return $ == "[" || $ == "=" ? "extend" : $ == "]" ? Je(se) : $ == "word" ? ((ge = te(H.current())), "extend") : Je(se);
                }),
                ...
                }),
                {
                    ...
                    indent: function ($, H, se) {
                        var De = $.context,
                            ...
                            dt = De.indent,
                            Pt = Le(H),
                            It = se.match(/^\s*/)[0].replace(/\t/g, G).length,
        ...
        var p = [
            ...
            w = ["in", "and", "or", "not", "is not", "is a", "is", "isnt", "defined", "if unless"],
            c = ["for", "if", "else", "unless", "from", "to"],
            d = ["null", "true", "false", "href", "title", "type", "not-allowed", "readonly", "disabled"],
            k = ["@font-face", "@keyframes", "@media", "@viewport", "@page", "@host", "@supports", "@block", "@css"],
            z = p.concat(v, C, b, S, s, g, T, h, w, c, d, k);
        function M(E) {
            return (
        ...
        o.registerHelper("hintWords", "stylus", z), o.defineMIME("text/x-styl", "stylus");
    });
});
var Xu = Ke((Gu, Zu) => {
    (function (o) {
        ...
        var v = p([
            ...
            g = /^\-?0b[01][01_]*/,
            T = /^\-?0o[0-7][0-7_]*/,
            w = /^\-?0x[\dA-Fa-f][\dA-Fa-f_]*(?:(?:\.[\dA-Fa-f][\dA-Fa-f_]*)?[Pp]\-?\d[\d_]*)?/,
            c = /^\-?\d[\d_]*(?:\.\d[\d_]*)?(?:[Ee]\-?\d[\d_]*)?/,
        ...
        function _(q, O, D) {
            if ((q.sol() && (O.indented = q.indentation()), q.eatSpace())) return null;
            var Q = q.peek();
            if (Q == "/") {
            ...
            if (q.match(g) || q.match(T) || q.match(w) || q.match(c)) return "number";
            ...
            if (q.match(d)) {
                ...
                return S.hasOwnProperty(y)
                    ...
                    : b.hasOwnProperty(y)
                      ? "atom"
                      : v.hasOwnProperty(y)
                        ? (C.hasOwnProperty(y) && (O.prev = "define"), "keyword")
                        : D == "define"
                          ? "def"
                          : "variable";
            }
            ...
            return function (O, D, Q) {
                ...
                if (j == "punctuation") {
                    if (O.current() == "(") ++q;
                        ...
                        if (q == 0) return O.backUp(1), D.tokenize.pop(), D.tokenize[D.tokenize.length - 1](O, D);
                        --q;
                    }
                }
                return j;
        ...
        function E(q, O, D) {
            for (var Q = q.length == 1, j, V = !1; (j = O.peek()); )
                if (V) {
                    if ((O.next(), j == "(")) return D.tokenize.push(W()), "string";
                    V = !1;
                } else {
        ...
        function J(q, O) {
            var D = O.match(/^\s*($|\/[\/\*])/, !1) ? null : O.column() + 1;
        ...
        o.defineMode("swift", function (q) {
            return {
                ...
                token: function (O, D) {
                    var Q = D.prev;
                    D.prev = null;
                    var j = D.tokenize[D.tokenize.length - 1] || _,
                        V = j(O, D, Q);
                    if ((!V || V == "comment" ? (D.prev = Q) : D.prev || (D.prev = V), V == "punctuation")) {
                        var y = /[\(\[\{]|([\]\)\}])/.exec(O.current());
                        y && (y[1] ? re : J)(D, O);
                    }
                    return V;
                },
    ...
    (function (o) {
        ...
        o.defineMode("coffeescript", function (p, v) {
            ...
            var S = /^(?:->|=>|\+[+=]?|-[\-=]?|\*[\*=]?|\/[\/=]?|[=!]=|<[><]?=?|>>?=?|%=?|&=?|\|=?|\^=?|\~|!|\?|(or|and|\|\||&&|\?)=)/,
                ...
                w = ["for", "while", "loop", "if", "unless", "else", "switch", "try", "catch", "finally", "class"],
                c = [
                    "break",
                    "by",
                    "continue",
            ...
            function W(O, D) {
                ...
                if (O.match(/^-?[0-9\.]/, !1)) {
                    var y = !1;
                    if ((O.match(/^-?\d*\.\d+(e[\+\-]?\d+)?/i) && (y = !0), O.match(/^-?\d+\.\d*/) && (y = !0), O.match(/^-?\.\d+/) && (y = !0), y))
                ...
                if (O.match(k)) return (D.tokenize = E(O.current(), !1, "string")), D.tokenize(O, D);
                if (O.match(z)) {
                    if (O.current() != "/" || O.match(/^.*\//, !1)) return (D.tokenize = E(O.current(), !0, "string-2")), D.tokenize(O, D);
                    O.backUp(1);
                }
                ...
                return function (j, V) {
                    for (; !j.eol(); )
                        if ((j.eatWhile(/[^'"\/\\]/), j.eat("\\"))) {
                            ...
                            if (j.match(O)) return (V.tokenize = W), Q;
                            j.eat(/['"\/]/);
                        }
                    return D && (v.singleLineStringErrors ? (Q = C) : (V.tokenize = W)), Q;
                };
            }
            function N(O, D) {
                for (; !O.eol(); ) {
            ...
            function G(O, D, Q) {
                ...
                Q !== "coffee" ? ((V = null), (y = O.column() + O.current().length)) : D.scope.align && (D.scope.align = !1),
                    (D.scope = { offset: j, type: Q, prev: D.scope, align: V, alignOffset: y });
            }
            function J(O, D) {
                if (D.scope.prev)
                    if (D.scope.type === "coffee") {
                        for (var Q = O.indentation(), j = !1, V = D.scope; V; V = V.prev)
                            if (Q === V.offset) {
                                j = !0;
                                break;
                            }
            ...
            function re(O, D) {
                var Q = D.tokenize(O, D),
                    j = O.current();
                j === "return" && (D.dedent = !0), (((j === "->" || j === "=>") && O.eol()) || Q === "indent") && G(O, D);
                var V = "[({".indexOf(j);
                if ((V !== -1 && G(O, D, "])}".slice(V, V + 1)), w.exec(j) && G(O, D), j == "then" && J(O, D), Q === "dedent" && J(O, D))) return C;
                if (((V = "])}".indexOf(j)), V !== -1)) {
                    for (; D.scope.type == "coffee" && D.scope.prev; ) D.scope = D.scope.prev;
                    D.scope.type == j && (D.scope = D.scope.prev);
                }
                return D.dedent && O.eol() && (D.scope.type == "coffee" && D.scope.prev && (D.scope = D.scope.prev), (D.dedent = !1)), Q;
            }
            var q = {
                startState: function (O) {
                    return { tokenize: W, scope: { offset: O || 0, type: "coffee", prev: null, align: !1 }, prop: !1, dedent: 0 };
                },
                token: function (O, D) {
                    var Q = D.scope.align === null && D.scope;
                    Q && O.sol() && (Q.align = !1);
                    var j = re(O, D);
                    return j && j != "comment" && (Q && (Q.align = !0), (D.prop = j == "punctuation" && O.current() == ".")), j;
                },
                indent: function (O, D) {
    ...
    (function (o) {
        ...
        o.defineMode(
            ...
            function (p) {
                ...
                function T(U, Z) {
                    if ((U.sol() && ((Z.javaScriptLine = !1), (Z.javaScriptLineExcludesColon = !1)), Z.javaScriptLine)) {
                ...
                function w(U, Z) {
                    if (Z.javaScriptArguments) {
                        ...
                        if (
                            (U.peek() === "(" ? Z.javaScriptArgumentsDepth++ : U.peek() === ")" && Z.javaScriptArgumentsDepth--,
                ...
                function k(U, Z) {
                    if (U.match("#{")) return (Z.isInterpolating = !0), (Z.interpolationNesting = 0), "punctuation";
                }
                function z(U, Z) {
                    if (Z.isInterpolating) {
                        if (U.peek() === "}") {
                            if ((Z.interpolationNesting--, Z.interpolationNesting < 0)) return U.next(), (Z.isInterpolating = !1), "punctuation";
                ...
                function _(U, Z) {
                    if (U.match(/^when\b/)) return (Z.javaScriptLine = !0), (Z.javaScriptLineExcludesColon = !0), v;
                }
                function W(U) {
                ...
                function q(U, Z) {
                    if (U.match(/^include:([a-zA-Z0-9\-]+)/, !1) && U.match("include")) return (Z.isIncludeFiltered = !0), v;
                }
                function O(U, Z) {
                ...
                function Q(U, Z) {
                    if (U.match(/^\+([-\w]+)/))
                        return U.match(/^\( *[-\w]+ *=/, !1) || ((Z.javaScriptArguments = !0), (Z.javaScriptArgumentsDepth = 0)), "variable";
                    if (U.match("+#{", !1)) return U.next(), (Z.mixinCallAfter = !0), k(U, Z);
                }
                function j(U, Z) {
                    if (Z.mixinCallAfter)
                        return (
                            (Z.mixinCallAfter = !1),
                            U.match(/^\( *[-\w]+ *=/, !1) || ((Z.javaScriptArguments = !0), (Z.javaScriptArgumentsDepth = 0)),
                            !0
                        );
                }
                function V(U, Z) {
                ...
                function F(U, Z) {
                    var ce;
                    if ((ce = U.match(/^(\w(?:[-:\w]*\w)?)\/?/)))
                        return (Z.lastTag = ce[1].toLowerCase()), Z.lastTag === "script" && (Z.scriptType = "application/javascript"), "tag";
                }
                function R(U, Z) {
                    if (U.match(/^:([\w\-]+)/)) {
                        var ce;
                ...
                function de(U, Z) {
                    if (Z.isAttrs) {
                        if ((s[U.peek()] && Z.attrsNest.push(s[U.peek()]), Z.attrsNest[Z.attrsNest.length - 1] === U.peek())) Z.attrsNest.pop();
                        ...
                        if (
                            ...
                            Z.attrsNest.length === 0 && (ce === "string" || ce === "variable" || ce === "keyword"))
                        )
                            try {
                                return (
                ...
                function ze(U, Z) {
                    if (U.match(/^&attributes\b/)) return (Z.javaScriptArguments = !0), (Z.javaScriptArgumentsDepth = 0), "keyword";
                }
                function pe(U) {
                ...
                function Oe(U, Z) {
                    if (U.match(/^(?:\| ?| )([^\n]+)/)) return "string";
                    if (U.match(/^(<[^\n]*)/, !1)) return Be(U, Z, "htmlmixed"), (Z.innerModeForLine = !0), Ze(U, Z, !0);
                }
                function qe(U, Z) {
                    if (U.eat(".")) {
                        var ce = null;
                ...
                function Ze(U, Z, ce) {
                    if (U.indentation() > Z.indentOf || (Z.innerModeForLine && !U.sol()) || ce)
                        return Z.innerMode
                            ? (Z.innerState || (Z.innerState = Z.innerMode.startState ? o.startState(Z.innerMode, U.indentation()) : {}),
                              U.hideFirstChars(Z.indentOf + 2, function () {
                                  return Z.innerMode.token(U, Z.innerState) || !0;
                              }))
                            : (U.skipToEnd(), Z.indentToken);
                    U.sol() && ((Z.indentOf = 1 / 0), (Z.indentToken = null), (Z.innerMode = null), (Z.innerState = null));
                }
                function ke(U, Z) {
            ...
            return {
                ...
                token: function (b, S) {
                    if (S.innerActive) {
                        var z = S.innerActive,
                            h = b.string;
                        if (!z.close && b.sol()) return (S.innerActive = S.inner = null), this.token(b, S);
                        var w = z.close && !S.startingInner ? C(h, z.close, b.pos, z.parseDelimiters) : -1;
                        if (w == b.pos && !z.parseDelimiters)
                            return b.match(z.close), (S.innerActive = S.inner = null), z.delimStyle && z.delimStyle + " " + z.delimStyle + "-close";
                        w > -1 && (b.string = h.slice(0, w));
                        var M = z.mode.token(b, S.inner);
                        return (
                            w > -1 ? (b.string = h) : b.pos > b.start && (S.startingInner = !1),
                            w == b.pos && z.parseDelimiters && (S.innerActive = S.inner = null),
                            z.innerStyle && (M ? (M = M + " " + z.innerStyle) : (M = z.innerStyle)),
                            M
                        );
                    } else {
...
function Pi(o) {
    ...
    function b(K, X, F, R, le) {
        (F = F || K.getLineHandle(X)),
            (R = R || K.getTokenAt({ line: X, ch: 1 })),
            (le = le || (!!F.text && K.getTokenAt({ line: X, ch: F.text.length - 1 })));
        var xe = R.type ? R.type.split(" ") : [];
        return le && C(le).indentedCode
            ? "indented"
            : xe.indexOf("comment") === -1
              ? !1
              : C(R).fencedChars || C(le).fencedChars || v(F)
                ? "fenced"
                : "single";
    }
    function S(K, X, F, R) {
...
`),
    ...
    var s = o.codemirror,
        ...
        w = s.getLineHandle(h.line),
        c = b(s, h.line, w, T),
        d,
        k,
        z;
    if (c === "single") {
        var M = w.text.slice(0, h.ch).replace("`", ""),
            _ = w.text.slice(h.ch).replace("`", "");
        s.replaceRange(M + _, { line: h.line, ch: 0 }, { line: h.line, ch: 99999999999999 }),
            h.ch--,
            h !== g && g.ch--,
            s.setSelection(h, g),
            s.focus();
...
`),
                ...
                s.operation(function () {
                    s.replaceRange(J, { line: re, ch: 0 }, { line: re + (J ? 0 : 1), ch: 0 }),
                        s.replaceRange(N, { line: G, ch: 0 }, { line: G + (N ? 0 : 1), ch: 0 });
                }),
                s.setSelection({ line: G + (N ? 1 : 0), ch: 0 }, { line: re + (N ? 1 : -1), ch: 0 }),
                s.focus();
        } else {
            var q = h.line;
            if (
                (v(s.getLineHandle(h.line)) && (b(s, h.line + 1) === "fenced" ? ((d = h.line), (q = h.line + 1)) : ((k = h.line), (q = h.line - 1))),
                d === void 0)
            )
                for (d = q; d >= 0 && ((w = s.getLineHandle(d)), !v(w)); d--);
            if (k === void 0) for (z = s.lineCount(), k = q; k < z && ((w = s.getLineHandle(k)), !v(w)); k++);
            s.operation(function () {
                s.replaceRange("", { line: d, ch: 0 }, { line: d + 1, ch: 0 }), s.replaceRange("", { line: k - 1, ch: 0 }, { line: k, ch: 0 });
            }),
                s.focus();
        }
    else if (c === "indented") {
        if (h.line !== g.line || h.ch !== g.ch) (d = h.line), (k = g.line), g.ch === 0 && k--;
        else {
            for (d = h.line; d >= 0; d--)
                if (((w = s.getLineHandle(d)), !w.text.match(/^\s*$/) && b(s, d, w) !== "indented")) {
                    d += 1;
                    break;
                }
            for (z = s.lineCount(), k = h.line; k < z; k++)
                if (((w = s.getLineHandle(k)), !w.text.match(/^\s*$/) && b(s, k, w) !== "indented")) {
                    k -= 1;
                    break;
                }
        }
        var O = s.getLineHandle(k + 1),
            D = O && s.getTokenAt({ line: k + 1, ch: O.text.length - 1 }),
...
`,
        ...
        for (var j = d; j <= k; j++) s.indentLine(j, "subtract");
        s.focus();
    } else {
...
function yc(o, p) {
    var v = o.codemirror,
        ...
        s = S.substring(S.lastIndexOf(".") + 1)
            .replace(/\?.*$/, "")
            .toLowerCase();
    if (["png", "jpg", "jpeg", "gif", "svg", "apng", "avif", "webp"].includes(s)) jr(v, C.image, b.insertTexts.uploadedImage, p);
    else {
...
function bn(o) {
    ...
    C.classList.contains("editor-preview-active-side")
        ...
        : (setTimeout(function () {
              p.getOption("fullScreen") || (o.options.sideBySideFullscreen === !1 ? s.classList.add("sided--no-fullscreen") : Br(o)),
    ...
    if ((p.sideBySideRenderingFunction || (p.sideBySideRenderingFunction = w), S)) {
    ...
    if (!o.getWrapperElement().lastChild.classList.contains("editor-preview-active")) {
        for (
            var C = /^(\s*)(\*|-|\+|\d*\.)(\s+)/,
                ...
                T = function (z, M) {
                    var _ = { quote: ">", "unordered-list": v, "ordered-list": "%%i." };
                    return _[z].replace("%%i", M);
                },
                w = function (z, M) {
                    var _ = { quote: ">", "unordered-list": "\\" + v, "ordered-list": "\\d+." },
                        W = new RegExp(_[z]);
                    return M && W.test(M);
                },
                c = function (z, M, _) {
                    ...
                    return (
                        W !== null
                            ? (w(z, W[2]) && (E = ""), (M = W[1] + E + W[3] + M.replace(b, "").replace(g[z], "$1")))
                            : _ == !1 && (M = E + " " + M),
                        M
                    );
                },
            ...
            (function (z) {
                var M = o.getLine(z);
                S[p] ? (M = M.replace(g[p], "$1")) : (p == "unordered-list" && (M = c("ordered-list", M, !0)), (M = c(p, M, !1)), (d += 1)),
                    o.replaceRange(M, { line: z, ch: 0 }, { line: z, ch: 99999999999999 });
            })(k);
        o.focus();
    }
}
function xc(o, p, v, C) {
    if (!(!o.codemirror || o.isPreviewActive())) {
        ...
        var h = b.getCursor("start"),
            ...
            w = T.slice(0, h.ch),
            c = T.slice(h.ch);
        p == "link" ? (w = w.replace(/(.*)[^!]\[/, "$1")) : p == "image" && (w = w.replace(/(.*)!\[$/, "$1")),
            (c = c.replace(/]\(.*?\)/, "")),
            b.replaceRange(w + c, { line: h.line, ch: 0 }, { line: h.line, ch: 99999999999999 }),
            (h.ch -= v[0].length),
            h !== g && (g.ch -= v[0].length),
            b.setSelection(h, g),
            b.focus();
    ...
    if (!(!o.codemirror || o.isPreviewActive())) {
        ...
        S[p]
            ? ((s = b.getLine(T.line)),
              ...
              p == "bold" || p == "strikethrough" ? ((T.ch -= 2), T !== w && (w.ch -= 2)) : p == "italic" && ((T.ch -= 1), T !== w && (w.ch -= 1)))
            : ((s = b.getSelection()),
              p == "bold"
    ...
    wc = Cd(() => {
        ...
        (et = {
            ...
            (Pr = {
                ...
                "heading-bigger": { name: "heading-bigger", action: ji, className: et["heading-bigger"], title: "Bigger Heading" },
                "heading-1": { name: "heading-1", action: Ri, className: et["heading-1"], title: "Big Heading" },
                "heading-2": { name: "heading-2", action: Hi, className: et["heading-2"], title: "Medium Heading" },
...
Maximum file size is #image_max_size#.`,
        ...
        Te.prototype.render = function (o) {
            ...
            var p = this.options,
                ...
                C = {};
            function b(E) {
                let N = E.getInputField().form;
                if (N) {
                    let G = Array.from(N.elements),
                        J = G.indexOf(E.getInputField());
                ...
                if (N) {
                    ...
                    if (J !== -1)
                        for (let re = J - 1; re >= 0; re--) {
                            let q = G[re];
                            if (q && q.tagName === "INPUT" && !q.closest(".editor-toolbar")) {
                                q.focus();
                                break;
                            }
                        }
            ...
            (C.Enter = "newlineAndIndentContinueMarkdownList"),
                ...
                (this.documentOnKeyDown = function (E) {
                    (E = E || window.event), E.keyCode == 27 && v.codemirror.getOption("fullScreen") && Br(v);
                }),
            ...
            function k(E, N) {
                var G,
                    J = window.getComputedStyle(document.querySelector(".CodeMirror-sizer")).width.replace("px", "");
            ...
            function M(E, N) {
                E.setAttribute("data-img-src", N.url),
                    E.setAttribute(
                        "style",
                        "--bg-image:url(" + N.url + ");--width:" + N.naturalWidth + "px;--height:" + k(N.naturalWidth, N.naturalHeight),
                    ),
                ...
                p.previewImagesInEditor &&
                    c.querySelectorAll(".cm-image-marker").forEach(function (E) {
                        ...
                        if (N.innerText.match(/^!\[.*?\]\(.*\)/g) && !N.hasAttribute("data-img-src")) {
                            var G = N.innerText.match("\\((.*)\\)");
                            if ((window.EMDEimagesCache || (window.EMDEimagesCache = {}), G && G.length >= 2)) {
                                var J = G[1];
                                if (p.imagesPreviewHandler) {
                                    var re = p.imagesPreviewHandler(G[1]);
                                    typeof re == "string" && (J = re);
                                }
                                if (window.EMDEimagesCache[J]) M(N, window.EMDEimagesCache[J]);
                                else {
                                    var q = document.createElement("img");
                                    (q.onload = function () {
                                        (window.EMDEimagesCache[J] = { naturalWidth: q.naturalWidth, naturalHeight: q.naturalHeight, url: J }),
                        ...
                        (function (T) {
                            ...
                            if (
                                (T === "|"
                                    ? (w = Nd())
                                    : T.children
                                      ? (w = Fd(T, C.options.toolbarTips, C.options.shortcuts, C))
                                      : (w = qi(T, !0, C.options.toolbarTips, C.options.shortcuts, "button", C)),
                                (b[T.name || T] = w),
                                v.appendChild(w),
                                T.name === "upload-image")
                            ) {
                        ...
                        g === "words"
                            ...
                            : g === "lines"
                              ...
                              : g === "cursor"
                                ...
                                : g === "autosave"
                                  ? (h = function (k) {
                                        p.autosave != null && p.autosave.enabled === !0 && k.setAttribute("id", "autosaved");
                                    })
                                  : g === "upload-image" &&
                                    (h = function (k) {
...
function Kd({
    ...
    return {
            ...
            this.$root._editor && (this.$root._editor.toTextArea(), (this.$root._editor = null)),
                ...
                this.editor.codemirror.on("changes", (d, k) => {
                    try {
                        ...
                        if (z.origin === "+input") {
                            let M = "(https://)",
                                _ = z.text[z.text.length - 1];
                            if (_.endsWith(M) && _ !== "[]" + M) {
                                let W = z.from,
                                    E = z.to,
                                    G = z.text.length > 1 ? 0 : W.ch;
                                setTimeout(() => {
                                    d.setSelection({ line: E.line, ch: G + _.lastIndexOf("(") + 1 }, { line: E.line, ch: G + _.lastIndexOf(")") });
                                }, 25);
                            }
                        }
                    } catch {}
        ...
        getToolbar() {
            ...
            return (
                w.forEach((k) => {
                    k.forEach((z) => d.push(this.getToolbarButton(z))), k.length > 0 && d.push("|");
                }),
                d[d.length - 1] === "|" && d.pop(),
                d
            );
        ...
        getBoldToolbarButton() {
            return { name: "bold", action: EasyMDE.toggleBold, title: T.tools?.bold };
        },
        getItalicToolbarButton() {
            return { name: "italic", action: EasyMDE.toggleItalic, title: T.tools?.italic };
        },
        getStrikeToolbarButton() {
            return { name: "strikethrough", action: EasyMDE.toggleStrikethrough, title: T.tools?.strike };
        },
        getLinkToolbarButton() {
            return { name: "link", action: EasyMDE.drawLink, title: T.tools?.link };
        },
        getHeadingToolbarButton() {
            return { name: "heading", action: EasyMDE.toggleHeadingSmaller, title: T.tools?.heading };
        },
        getBlockquoteToolbarButton() {
            return { name: "quote", action: EasyMDE.toggleBlockquote, title: T.tools?.blockquote };
        },
        getCodeBlockToolbarButton() {
            return { name: "code", action: EasyMDE.toggleCodeBlock, title: T.tools?.code_block };
        },
        getBulletListToolbarButton() {
            return { name: "unordered-list", action: EasyMDE.toggleUnorderedList, title: T.tools?.bullet_list };
        },
        getOrderedListToolbarButton() {
            return { name: "ordered-list", action: EasyMDE.toggleOrderedList, title: T.tools?.ordered_list };
        },
        getTableToolbarButton() {
            return { name: "table", action: EasyMDE.drawTable, title: T.tools?.table };
        },
        getAttachFilesToolbarButton() {
            return { name: "upload-image", action: EasyMDE.drawUploadedImage, title: T.tools?.attach_files };
        },
