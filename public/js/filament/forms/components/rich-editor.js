...
he.prototype = {
    ...
    update: function (t, e, n) {
        var r = n && n != t ? this.remove(n) : this,
            o = r.find(t),
            i = r.content.slice();
        return o == -1 ? i.push(n || t, e) : ((i[o + 1] = e), n && (i[o] = n)), new he(i);
    },
    remove: function (t) {
        var e = this.find(t);
        if (e == -1) return this;
    ...
    prepend: function (t) {
        return (t = he.from(t)), t.size ? new he(t.content.concat(this.subtract(t).content)) : this;
    },
    append: function (t) {
        return (t = he.from(t)), t.size ? new he(this.subtract(t).content.concat(t.content)) : this;
    },
    subtract: function (t) {
        var e = this;
        t = he.from(t);
...
function ca(t, e, n) {
    for (let r = 0; ; r++) {
        ...
        if (o.content.size || i.content.size) {
            let s = ca(o.content, i.content, n + 1);
            if (s != null) return s;
        }
        n += o.nodeSize;
    }
...
function ua(t, e, n, r) {
    for (let o = t.childCount, i = e.childCount; ; ) {
        ...
        if (s.isText && s.text != l.text) {
            ...
            for (; c < u && s.text[s.text.length - c - 1] == l.text[l.text.length - c - 1]; ) c++, n--, r--;
            return { a: n, b: r };
        }
        if (s.content.size || l.content.size) {
            let c = ua(s.content, l.content, n - 1, r - 1);
            if (c) return c;
        }
        (n -= a), (r -= a);
    }
...
var w = class t {
    constructor(e, n) {
        if (((this.content = e), (this.size = n || 0), n == null)) for (let r = 0; r < e.length; r++) this.size += e[r].nodeSize;
    }
        ...
        for (let o = 0; o < e.length; o++) {
            ...
            (r += i.nodeSize),
                o && i.isText && e[o - 1].sameMarkup(i)
                    ? (n || (n = e.slice(0, o)), (n[n.length - 1] = i.withText(n[n.length - 1].text + i.text)))
                    : n && n.push(i);
        }
        return new t(n || e, r);
    }
...
function Cr(t, e) {
    ...
    if (n) {
        ...
        for (let r in t) if (!(r in e) || !Cr(t[r], e[r])) return !1;
...
var Bt = class extends Error {},
    M = class t {
        ...
        insertAt(e, n) {
            let r = fa(this.content, e + this.openStart, n);
            return r && new t(r, this.openStart, this.openEnd);
        }
        removeBetween(e, n) {
            return new t(da(this.content, e + this.openStart, n + this.openStart), this.openStart, this.openEnd);
        }
        eq(e) {
        ...
        static fromJSON(e, n) {
            ...
            let r = n.openStart || 0,
                o = n.openEnd || 0;
            if (typeof r != "number" || typeof o != "number") throw new RangeError("Invalid input for Slice.fromJSON");
            return new t(w.fromJSON(e, n.content), r, o);
        }
        static maxOpen(e, n = !0) {
            let r = 0,
                o = 0;
            for (let i = e.firstChild; i && !i.isLeaf && (n || !i.type.spec.isolating); i = i.firstChild) r++;
            for (let i = e.lastChild; i && !i.isLeaf && (n || !i.type.spec.isolating); i = i.lastChild) o++;
            return new t(e, r, o);
        }
    };
...
function fa(t, e, n, r) {
    ...
    let l = fa(s.content, e - i - 1, n);
    return l && t.replaceChild(o, s.copy(l));
}
function Hh(t, e, n) {
    if (n.openStart > t.depth) throw new Bt("Inserted content deeper than insertion position");
    if (t.depth - n.openStart != e.depth - n.openEnd) throw new Bt("Inconsistent open depths");
    return ha(t, e, n, 0);
}
function ha(t, e, n, r) {
    let o = t.index(r),
    ...
    if (o == e.index(r) && r < t.depth - n.openStart) {
        ...
        if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
            let s = t.parent,
                l = s.content;
            return Lt(s, l.cut(0, t.parentOffset).append(n.content).append(l.cut(e.parentOffset)));
        } else {
            let { start: s, end: l } = Fh(n, t);
            return Lt(i, ma(t, s, l, e, r));
        }
    else return Lt(i, Mr(t, e, r));
}
function pa(t, e) {
    if (!e.type.compatibleContent(t.type)) throw new Bt("Cannot join " + e.type.name + " onto " + t.type.name);
}
function Si(t, e, n) {
    let r = t.node(n);
...
function Nn(t, e, n, r) {
    ...
    t && ((i = t.index(n)), t.depth > n ? i++ : t.textOffset && (It(t.nodeAfter, r), i++));
...
function ma(t, e, n, r, o) {
    let i = t.depth > o && Si(t, e, o + 1),
        s = r.depth > o && Si(n, r, o + 1),
        l = [];
    return (
        Nn(null, t, o, l),
        i && s && e.index(o) == n.index(o)
            ? (pa(i, s), It(Lt(i, ma(t, e, n, r, o + 1)), l))
            : (i && It(Lt(i, Mr(t, e, o + 1)), l), Nn(e, n, o, l), s && It(Lt(s, Mr(n, r, o + 1)), l)),
        Nn(r, null, o, l),
        new w(l)
    );
}
...
function Fh(t, e) {
    ...
    return { start: o.resolveNoCache(t.openStart + n), end: o.resolveNoCache(o.content.size - t.openEnd - n) };
}
var vr = class t {
        constructor(e, n, r) {
        ...
        marks() {
            ...
            let i = r.marks;
            for (var s = 0; s < i.length; s++) i[s].type.spec.inclusive === !1 && (!o || !i[s].isInSet(o.marks)) && (i = i[s--].removeFromSet(i));
            return i;
        }
        marksAcross(e) {
            ...
            for (var i = 0; i < r.length; i++) r[i].type.spec.inclusive === !1 && (!o || !r[i].isInSet(o.marks)) && (r = r[i--].removeFromSet(r));
            return r;
        }
        sharedDepth(e) {
        ...
        blockRange(e = this, n) {
            ...
            for (let r = this.depth - (this.parent.inlineContent || this.pos == e.pos ? 1 : 0); r >= 0; r--)
                if (e.pos <= this.end(r) && (!n || n(this.node(r)))) return new zt(this, e, r);
            return null;
        }
        sameParent(e) {
    ...
    le = class t {
        constructor(e, n, r, o = V.none) {
            (this.type = e), (this.attrs = n), (this.marks = o), (this.content = r || w.empty);
        }
        get children() {
        ...
        hasMarkup(e, n, r) {
            return this.type == e && Cr(this.attrs, n || e.defaultAttrs || Vh) && V.sameSet(this.marks, r || V.none);
        }
        copy(e = null) {
...
var Ht = class t {
    ...
    compatible(e) {
        for (let n = 0; n < this.next.length; n++) for (let r = 0; r < e.next.length; r++) if (this.next[n].type == e.next[r].type) return !0;
        return !1;
    }
    fillBefore(e, n = !1, r = 0) {
        ...
        function i(s, l) {
            ...
            if (a && (!n || a.validEnd)) return w.from(l.map((c) => c.createAndFill()));
    ...
    toString() {
        ...
        return (
            ...
            e.map((r, o) => {
                let i = o + (r.validEnd ? "*" : " ") + " ";
                for (let s = 0; s < r.next.length; s++) i += (s ? ", " : "") + r.next[s].type.name + "->" + e.indexOf(r.next[s].next);
                return i;
            }).join(`
`)
        );
...
function Uh(t) {
    if (t.eat("(")) {
        ...
        let e = Kh(t, t.next).map(
            (n) => (
                t.inline == null ? (t.inline = n.isInline) : t.inline != n.isInline && t.err("Mixing inline and block content"),
                { type: "name", value: n }
            ),
        );
    ...
    function n(r) {
        ...
        r.forEach((s) => {
            t[s].forEach(({ term: l, to: a }) => {
                if (!l) return;
                let c;
                for (let u = 0; u < o.length; u++) o[u][0] == l && (c = o[u][1]);
                na(t, a).forEach((u) => {
...
function Sa(t, e, n, r) {
    for (let o in e) if (!(o in t)) throw new RangeError(`Unsupported attribute ${o} for ${n} of type ${o}`);
    for (let o in t) {
        let i = t[o];
...
function ka(t, e) {
    let n = Object.create(null);
    if (e) for (let r in e) n[r] = new vi(t, r, e[r]);
    return n;
}
var Tr = class t {
    constructor(e, n, r) {
    ...
    createChecked(e = null, n, r) {
        return (n = w.from(n)), this.checkContent(n), new le(this, this.computeAttrs(e), n, V.setFrom(r));
    }
    ...
    allowedMarks(e) {
        ...
        let n;
        for (let r = 0; r < e.length; r++) this.allowsMarkType(e[r].type) ? n && n.push(e[r]) : n || (n = e.slice(0, r));
...
var vi = class {
        constructor(e, n, r) {
            (this.hasDefault = Object.prototype.hasOwnProperty.call(r, "default")),
                ...
                (this.validate = typeof r.validate == "string" ? Yh(e, n, r.validate) : r.validate);
        }
        get isRequired() {
    ...
    Dn = class t {
        constructor(e, n, r, o) {
            (this.name = e), (this.rank = n), (this.schema = r), (this.spec = o), (this.attrs = ka(e, o.attrs)), (this.excluded = null);
            let i = xa(this.attrs);
            this.instance = i ? new V(this, i) : null;
        }
        create(e = null) {
            return !e && this.instance ? this.instance : new V(this, wa(this.attrs, e));
        }
        static compile(e, n) {
            let r = Object.create(null),
                o = 0;
        ...
        constructor(e) {
            ...
            for (let o in this.nodes) {
                ...
                if (
                    ...
                    if (!i.isInline || !i.isLeaf) throw new RangeError("Linebreak replacement nodes must be inline leaf nodes");
                    this.linebreakReplacement = i;
                }
                i.markSet = l == "_" ? null : l ? ra(this, l.split(" ")) : l == "" || !i.inlineContent ? [] : null;
            }
            for (let o in this.marks) {
                let i = this.marks[o],
                    s = i.spec.excludes;
                i.excluded = s == null ? [i] : s == "" ? [] : ra(this, s.split(" "));
            }
...
var Ue = class t {
        ...
        static schemaRules(e) {
            ...
            for (let o in e.marks) {
                ...
                i &&
                    i.forEach((s) => {
                        r((s = ia(s))), s.mark || s.ignore || s.clearMark || (s.mark = o);
                    });
            }
            for (let o in e.nodes) {
                ...
                i &&
                    i.forEach((s) => {
                        r((s = ia(s))), s.node || s.ignore || s.mark || (s.node = o);
                    });
            }
            return n;
        }
    ...
    Zh = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
    Ma = { ol: !0, ul: !0 },
    Pn = 1,
    Ti = 2,
    Rn = 4;
function oa(t, e, n) {
    return e != null ? (e ? Pn : 0) | (e === "full" ? Ti : 0) : t && t.whitespace == "pre" ? Pn | Ti : n & ~Rn;
}
var on = class {
            ...
            if (!(this.options & Pn)) {
                ...
                if (r && r.isText && (o = /[ \t\r\n\u000c]+$/.exec(r.text))) {
                    ...
                    r.text.length == o[0].length
                        ? this.content.pop()
                        : (this.content[this.content.length - 1] = i.withText(i.text.slice(0, i.text.length - o[0].length)));
                }
            }
            let n = w.from(this.content);
            return (
                !e && this.match && (n = n.append(this.match.fillBefore(w.empty, !0))), this.type ? this.type.create(this.attrs, n, this.marks) : n
            );
        }
        inlineContext(e) {
            return this.type
                ...
                : this.content.length
                  ...
                  : e.parentNode && !Ca.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
        }
    },
    Ar = class {
        constructor(e, n, r) {
            ...
            let o = n.topNode,
                i,
                s = oa(null, n.preserveWhitespace, 0) | (r ? Rn : 0);
            o
                ? (i = new on(o.type, o.attrs, V.none, !0, n.topMatch || o.type.contentMatch, s))
                : r
        ...
        addTextNode(e, n) {
            let r = e.nodeValue,
                o = this.top,
                i = o.options & Ti ? "full" : this.localPreserveWS || (o.options & Pn) > 0;
...
`,
        ...
        addElement(e, n, r) {
            ...
            e: if (a ? a.ignore : Zh.hasOwnProperty(s)) this.findInside(e), this.ignoreFallback(e, n);
...
`),
        ...
        addElementByRule(e, n, r, o) {
            ...
            else if (n.getContent) this.findInside(e), n.getContent(e, this.parser.schema).forEach((a) => this.insertNode(a, r, !1));
            else {
                let a = e;
        ...
        insertNode(e, n, r) {
            ...
            if (o) {
                ...
                let s = V.none;
                for (let l of o.concat(e.marks)) (i.type ? i.type.allowsMarkType(l.type) : sa(l.type, e.type)) && (s = l.addToSet(s));
        ...
        enterInner(e, n, r, o = !1, i) {
            ...
            let a = V.none;
            return (
                (r = r.filter((c) => ((s.type ? s.type.allowsMarkType(c.type) : sa(c.type, e)) ? ((a = c.addToSet(a)), !1) : !0))),
        ...
        findAtPoint(e, n) {
            if (this.find)
                for (let r = 0; r < this.find.length; r++) this.find[r].node == e && this.find[r].offset == n && (this.find[r].pos = this.currentPos);
        }
        findInside(e) {
            if (this.find)
...
var it = class t {
    ...
    serializeNodeInner(e, n) {
        let { dom: r, contentDOM: o } = kr(wi(n), this.nodes[e.type.name](e), null, e.attrs);
        if (o) {
...
function kr(t, e, n, r) {
    ...
    for (let d = u; d < e.length; d++) {
        ...
        if (f === 0) {
            ...
            let { dom: h, contentDOM: p } = kr(t, f, n, r);
...
var Oa = 1,
    ...
    st = class t {
        ...
        recover(e) {
            let n = 0,
                r = va(e);
            if (!this.inverted) for (let o = 0; o < r; o++) n += this.ranges[o * 3 + 2] - this.ranges[o * 3 + 1];
            ...
            for (let l = 0; l < this.ranges.length; l += 3) {
                ...
                if (e <= d) {
                    let f = c ? (e == a ? -1 : e == d ? 1 : n) : n,
                        h = a + o + (f < 0 ? 0 : u);
                    if (r) return h;
                    let p = e == (n < 0 ? a : d) ? null : op(l / 3, e - a),
                        m = e == a ? Na : e == d ? Oa : Er;
                    return (n < 0 ? e != a : e != d) && (m |= Ra), new Bn(h, m, p);
                }
                o += u - c;
            }
...
var zn = class t {
        ...
        getMirror(e) {
            if (this.mirror) {
                for (let n = 0; n < this.mirror.length; n++) if (this.mirror[n] == e) return this.mirror[n + (n % 2 ? -1 : 1)];
            }
        }
        setMirror(e, n) {
...
function Di(t, e, n) {
    ...
    for (let o = 0; o < t.childCount; o++) {
        let i = t.child(o);
        i.content.size && (i = i.copy(Di(i.content, e, i))), i.isInline && (i = e(i, n, o)), r.push(i);
    }
...
var Hn = class t extends ae {
    ...
    apply(e) {
        let n = e.slice(this.from, this.to),
            ...
            i = new M(
                Di(n.content, (s, l) => (!s.isAtom || !l.type.allowsMarkType(this.mark.type) ? s : s.mark(this.mark.addToSet(s.marks))), o),
                n.openStart,
                n.openEnd,
            );
...
var Fn = class t extends ae {
    ...
    apply(e) {
        ...
        return ce.fromReplace(e, this.pos, this.pos + 1, new M(w.from(r), 0, n.isLeaf ? 0 : 1));
    }
    invert(e) {
        let n = e.nodeAt(this.pos);
        if (n) {
            ...
            if (r.length == n.marks.length) {
                for (let o = 0; o < n.marks.length; o++) if (!n.marks[o].isInSet(r)) return new t(this.pos, n.marks[o]);
...
var ln = class t extends ae {
    ...
    invert(e) {
        let n = e.nodeAt(this.pos);
        return !n || !this.mark.isInSet(n.marks) ? this : new Fn(this.pos, this.mark);
    }
    map(e) {
        let n = e.mapResult(this.pos, 1);
        return n.deletedAfter ? null : new t(n.pos, this.mark);
...
var pe = class t extends ae {
    ...
    map(e) {
        let n = e.mapResult(this.from, 1),
            r = e.mapResult(this.to, -1);
        return n.deletedAcross && r.deletedAcross ? null : new t(n.pos, Math.max(n.pos, r.pos), this.slice, this.structure);
    }
    merge(e) {
        ...
        if (this.from + this.slice.size == e.from && !this.slice.openEnd && !e.slice.openStart) {
            let n =
                this.slice.size + e.slice.size == 0
                    ? M.empty
                    : new M(this.slice.content.append(e.slice.content), this.slice.openStart, e.slice.openEnd);
            return new t(this.from, this.to + (e.to - e.from), n, this.structure);
        } else if (e.to == this.from && !this.slice.openStart && !e.slice.openEnd) {
            let n =
                this.slice.size + e.slice.size == 0
                    ? M.empty
                    : new M(e.slice.content.append(this.slice.content), e.slice.openStart, this.slice.openEnd);
...
var ne = class t extends ae {
    ...
    getMap() {
        return new st([this.from, this.gapFrom - this.from, this.insert, this.gapTo, this.to - this.gapTo, this.slice.size - this.insert]);
    }
    invert(e) {
    ...
    static fromJSON(e, n) {
        ...
        return new t(n.from, n.to, n.gapFrom, n.gapTo, M.fromJSON(e, n.slice), n.insert, !!n.structure);
    }
};
    ...
    t.doc.nodesBetween(e, n, (a, c, u) => {
        ...
        if (!r.isInSet(d) && u.type.allowsMarkType(r.type)) {
            let f = Math.max(c, e),
                ...
                p = r.addToSet(d);
            for (let m = 0; m < d.length; m++) d[m].isInSet(p) || (s && s.to == f && s.mark.eq(d[m]) ? (s.to = h) : o.push((s = new lt(f, h, d[m]))));
...
function Pi(t, e, n, r = n.contentMatch, o = !0) {
    ...
    for (let a = 0; a < i.childCount; a++) {
        ...
        if (!d) s.push(new pe(l, u, M.empty));
            ...
            r = d;
            for (let f = 0; f < c.marks.length; f++) n.allowsMarkType(c.marks[f].type) || t.step(new lt(l, u, c.marks[f]));
            if (o && c.isText && n.whitespace != "pre") {
                let f,
                    h = /\r?\n|\r/g,
                    p;
                for (; (f = h.exec(c.text)); )
                    p || (p = new M(w.from(n.schema.text(" ", n.allowedMarks(c.marks))), 0, 0)),
...
function cp(t, e, n) {
    let { $from: r, $to: o, depth: i } = e,
        ...
        u = w.empty,
        d = 0;
    for (let p = i, m = !1; p > n; p--) m || r.index(p) > 0 ? ((m = !0), (u = w.from(r.node(p).copy(u))), d++) : a--;
    let f = w.empty,
        h = 0;
    for (let p = i, m = !1; p > n; p--) m || o.after(p + 1) < o.end(p) ? ((m = !0), (f = w.from(o.node(p).copy(f))), h++) : c++;
...
function hp(t, e, n, r, o) {
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (s.isTextblock && !s.hasMarkup(r, a) && pp(t.doc, t.mapping.slice(i).map(l), r)) {
            let c = null;
            ...
            c === !1 && Pa(t, s, l, i), Pi(t, t.mapping.slice(i).map(l, 1), r, void 0, c === null);
            let u = t.mapping.slice(i),
                d = u.map(l, 1),
                f = u.map(l + s.nodeSize, 1);
            return t.step(new ne(d, f, d + 1, f - 1, new M(w.from(r.create(a, null, s.marks)), 0, 0), 1, !0)), c === !0 && Da(t, s, l, i), !1;
        }
    });
}
function Da(t, e, n, r) {
...
function mp(t, e, n, r, o) {
    ...
    t.step(new ne(e, e + i.nodeSize, e + 1, e + i.nodeSize - 1, new M(w.from(s), 0, 0), 1, !0));
}
...
function bp(t, e, n) {
    ...
    s.inlineContent && Pi(t, e + n - 1, s, i.node().contentMatchAt(i.index()), r == null);
...
var Ri = class {
    constructor(e, n, r) {
        ...
        for (let o = e.depth; o > 0; o--) this.placed = w.from(e.node(o).copy(this.placed));
    }
    get depth() {
    ...
    fit() {
        ...
        let a = new M(i, s, l);
        return e > -1 ? new ne(r.pos, e, this.$to.pos, this.$to.end(), a, n) : a.size || r.pos != this.$to.pos ? new pe(r.pos, o.pos, a) : null;
    }
    findFittable() {
        ...
        for (let n = 1; n <= 2; n++)
            for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
                let o,
                    i = null;
                r ? ((i = Ei(this.unplaced.content, r - 1).firstChild), (o = i.content)) : (o = this.unplaced.content);
                let s = o.firstChild;
                for (let l = this.depth; l >= 0; l--) {
                    let { type: a, match: c } = this.frontier[l],
                        u,
                        d = null;
                    if (n == 1 && (s ? c.matchType(s.type) || (d = c.fillBefore(w.from(s), !1)) : i && a.compatibleContent(i.type)))
                        return { sliceDepth: r, frontierDepth: l, parent: i, inject: d };
                    if (n == 2 && s && (u = c.findWrapping(s.type))) return { sliceDepth: r, frontierDepth: l, parent: i, wrap: u };
    ...
    openMore() {
        let { content: e, openStart: n, openEnd: r } = this.unplaced,
            o = Ei(e, n);
        return !o.childCount || o.firstChild.isLeaf ? !1 : ((this.unplaced = new M(e, n + 1, Math.max(r, o.size + n >= e.size - r ? n + 1 : 0))), !0);
    }
    dropNode() {
        let { content: e, openStart: n, openEnd: r } = this.unplaced,
            o = Ei(e, n);
    ...
    placeNodes({ sliceDepth: e, frontierDepth: n, parent: r, inject: o, wrap: i }) {
        ...
        for (; c < l.childCount; ) {
            ...
            c++,
                (c > 1 || a == 0 || m.content.size) &&
                    ((d = g), u.push(Ba(m.mark(f.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
        }
        ...
        this.unplaced = p
            ? e == 0
                ? M.empty
                : new M(In(s.content, e - 1, 1), e - 1, h < 0 ? s.openEnd : e - 1)
    ...
    close(e) {
        ...
        n.fit.childCount && (this.placed = Ln(this.placed, n.depth, n.fit)), (e = n.move);
    ...
    closeFrontierNode() {
        ...
        n.childCount && (this.placed = Ln(this.placed, this.frontier.length, n));
    }
};
function In(t, e, n) {
    return e == 0 ? t.cutByIndex(n, t.childCount) : t.replaceChild(0, t.firstChild.copy(In(t.firstChild.content, e - 1, n)));
}
function Ln(t, e, n) {
    return e == 0 ? t.append(n) : t.replaceChild(t.childCount - 1, t.lastChild.copy(Ln(t.lastChild.content, e - 1, n)));
}
function Ei(t, e) {
...
function Ba(t, e, n) {
    ...
    let r = t.content;
    return (
        e > 1 && (r = r.replaceChild(0, Ba(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0))),
        e > 0 &&
            ((r = t.type.contentMatch.fillBefore(r).append(r)),
            n <= 0 && (r = r.append(t.type.contentMatch.matchFragment(r).fillBefore(w.empty, !0)))),
        t.copy(r)
    );
}
        ...
        if (p)
            for (let m = 0; m < s.length; m++) {
                ...
                if (b.canReplaceWith(x, x, p.type, p.marks))
                    return t.replace(o.before(g), y ? i.after(g) : n, new M(za(r.content, 0, r.openStart, h), h, r.openEnd));
            }
    }
...
function Mp(t, e, n) {
    ...
    for (let s = 0; s < i.length; s++) {
        let l = i[s],
            a = s == i.length - 1;
        if ((a && l == 0) || r.node(l).type.contentMatch.validEnd) return t.delete(r.start(l), o.end(l));
        if (l > 0 && (a || r.node(l - 1).canReplace(r.index(l - 1), o.indexAfter(l - 1)))) return t.delete(r.before(l), o.after(l));
    }
...
function Ha(t, e) {
    ...
    for (let o = r; o >= 0; o--) {
        let i = t.start(o);
        if (i < t.pos - (t.depth - o) || e.end(o) > e.pos + (e.depth - o) || t.node(o).type.spec.isolating || e.node(o).type.spec.isolating) break;
        (i == e.start(o) || (o == t.depth && o == e.depth && t.parent.inlineContent && e.parent.inlineContent && o && e.start(o - 1) == i - 1)) &&
            n.push(o);
    }
    return n;
}
var Or = class t extends ae {
    ...
    apply(e) {
        ...
        return ce.fromReplace(e, this.pos, this.pos + 1, new M(w.from(o), 0, n.isLeaf ? 0 : 1));
    }
    getMap() {
        return st.empty;
    }
    ...
    removeNodeMark(e, n) {
        ...
        if (n instanceof V) n.isInSet(r.marks) && this.step(new ln(e, n));
            ...
            let o = r.marks,
                i,
                s = [];
            for (; (i = n.isInSet(o)); ) s.push(new ln(e, i)), (o = i.removeFromSet(o));
...
var Ii = Object.create(null),
    E = class {
        constructor(e, n, r) {
            (this.$anchor = e), (this.$head = n), (this.ranges = r || [new dn(e.min(n), e.max(n))]);
        }
        get anchor() {
        ...
        replace(e, n = M.empty) {
            ...
            for (let l = 0; l < s.length; l++) {
                let { $from: a, $to: c } = s[l],
                    u = e.mapping.slice(i);
                e.replaceRange(u.map(a.pos), u.map(c.pos), l ? M.empty : n), l == 0 && Va(e, i, (r ? r.isInline : o && o.isTextblock) ? -1 : 1);
            }
        }
        replaceWith(e, n) {
            ...
            for (let i = 0; i < o.length; i++) {
                let { $from: s, $to: l } = o[i],
                    ...
                    c = a.map(s.pos),
                    u = a.map(l.pos);
                i ? e.deleteRange(c, u) : (e.replaceRangeWith(c, u, n), Va(e, r, n.isInline ? -1 : 1));
            }
        }
        static findFrom(e, n, r = !1) {
            let o = e.parent.inlineContent ? new A(e) : un(e.node(0), e.parent, e.pos, e.index(), n, r);
            if (o) return o;
            for (let i = e.depth - 1; i >= 0; i--) {
                let s =
                    n < 0
                        ? un(e.node(0), e.node(i), e.before(i + 1), e.index(i), n, r)
                        : un(e.node(0), e.node(i), e.after(i + 1), e.index(i) + 1, n, r);
                if (s) return s;
            }
            return null;
        }
...
function $a(t) {
    !Fa &&
        ...
        ((Fa = !0), console.warn("TextSelection endpoint not pointing into a node with inline content (" + t.parent.type.name + ")"));
}
    ...
    static between(e, n, r) {
        ...
        return (
            e.parent.inlineContent ||
                (o == 0 ? (e = n) : ((e = (E.findFrom(e, -r, !0) || E.findFrom(e, r, !0)).$anchor), e.pos < n.pos != o < 0 && (e = n))),
            new t(e, n)
        );
    }
};
...
function un(t, e, n, r, o, i = !1) {
    ...
    for (let s = r - (o > 0 ? 0 : 1); o > 0 ? s < e.childCount : s >= 0; s += o) {
        let l = e.child(s);
        if (l.isAtom) {
            if (!i && O.isSelectable(l)) return O.create(t, n - (o < 0 ? l.nodeSize : 0));
        } else {
...
var Wa = 1,
    ...
    zi = class extends kt {
        ...
        addStep(e, n) {
            super.addStep(e, n), (this.updated = this.updated & ~Dr), (this.storedMarks = null);
        }
        setTime(e) {
        ...
        replaceSelectionWith(e, n = !0) {
            ...
            return (
                n && (e = e.mark(this.storedMarks || (r.empty ? r.$from.marks() : r.$from.marksAcross(r.$to) || V.none))),
        ...
        insertText(e, n, r) {
            ...
            if (n == null) return e ? this.replaceSelectionWith(o.text(e), !0) : this.deleteSelection();
            {
                ...
                return this.replaceRangeWith(n, r, o.text(e, i)), this.selection.empty || this.setSelection(E.near(this.selection.$to)), this;
            }
        }
        setMeta(e, n) {
            ...
            (this.schema = e),
                ...
                n &&
                    n.forEach((r) => {
                        ...
                        this.plugins.push(r), (this.pluginsByKey[r.key] = r), r.spec.state && this.fields.push(new $t(r.key, r.spec.state, r));
                    });
        }
    },
    Ir = class t {
        ...
        static fromJSON(e, n, r) {
            ...
            return (
                o.fields.forEach((s) => {
                    ...
                    else if (s.name == "selection") i.selection = E.fromJSON(i.doc, n.selection);
                    else if (s.name == "storedMarks") n.storedMarks && (i.storedMarks = n.storedMarks.map(e.schema.markFromJSON));
                    else {
                        if (r)
                            for (let l in r) {
                                let a = r[l],
...
function Ka(t, e, n) {
    for (let r in t) {
        let o = t[r];
        o instanceof Function ? (o = o.bind(e)) : r == "handleDOMEvents" && (o = Ka(o, e, {})), (n[r] = o);
    }
    return n;
}
var N = class {
        constructor(e) {
            (this.spec = e), (this.props = {}), e.props && Ka(e.props, this, this.props), (this.key = e.key ? e.key.key : Ua("plugin"));
        }
        getState(e) {
            return e[this.key];
        }
...
var ue = function (t) {
    ...
    _i = null,
    ut = function (t, e, n) {
        let r = _i || (_i = document.createRange());
    ...
    Ep = /^(img|br|input|textarea|hr)$/i;
function Ja(t, e, n, r, o) {
    for (var i; ; ) {
        if (t == n && e == r) return !0;
        if (e == (o < 0 ? 0 : De(t))) {
            let s = t.parentNode;
            if (!s || s.nodeType != 1 || Gn(t) || Ep.test(t.nodeName) || t.contentEditable == "false") return !1;
            (e = ue(t) + (o < 0 ? 0 : 1)), (t = s);
...
function Np(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !Gn(t)) (e = ue(t) + 1), (t = t.parentNode);
        else return null;
    }
}
function Rp(t, e, n) {
...
var Kr = function (t) {
    return t.focusNode && Jt(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset);
};
function Vt(t, e) {
...
function Pp(t, e, n) {
    if (t.caretPositionFromPoint)
        try {
            ...
            if (r) return { node: r.offsetNode, offset: Math.min(De(r.offsetNode), r.offset) };
        } catch {}
    if (t.caretRangeFromPoint) {
        let r = t.caretRangeFromPoint(e, n);
        if (r) return { node: r.startContainer, offset: Math.min(De(r.startContainer), r.startOffset) };
    }
}
var Je = typeof navigator < "u" ? navigator : null,
    ...
    ji = /Edge\/(\d+)/.exec(Et),
    Tc = /MSIE \d/.exec(Et),
    Ki = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Et),
    ke = !!(Tc || Ki || ji),
    Tt = Tc ? document.documentMode : Ki ? +Ki[1] : ji ? +ji[1] : 0,
    Ve = !ke && /gecko\/(\d+)/i.test(Et);
Ve && +(/Firefox\/(\d+)/.exec(Et) || [0, 0])[1];
var Ui = !ke && /Chrome\/(\d+)/.exec(Et),
    ge = !!Ui,
    Ac = Ui ? +Ui[1] : 0,
    xe = !ke && !!Je && /Apple Computer/.test(Je.vendor),
    yn = xe && (/Mobile\/\w+/.test(Et) || (!!Je && Je.maxTouchPoints > 2)),
    Re = yn || (Je ? /Mac/.test(Je.platform) : !1),
    Ip = Je ? /Win/.test(Je.platform) : !1,
    dt = /Android \d/.test(Et),
    Yn = !!qa && "webkitFontSmoothing" in qa.documentElement.style,
    Lp = Yn ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Bp(t) {
        ...
        if (
            (e.top < c.top + ct(r, "top")
                ...
                : e.bottom > c.bottom - ct(r, "bottom") &&
                  (d = e.bottom - e.top > c.bottom - c.top ? e.top + ct(o, "top") - c.top : e.bottom - c.bottom + ct(o, "bottom")),
            e.left < c.left + ct(r, "left")
                ? (u = -(c.left - e.left + ct(o, "left")))
                : e.right > c.right - ct(r, "right") && (u = e.right - c.right + ct(o, "right")),
            u || d)
        )
...
function Ec(t) {
    let e = [],
        n = t.ownerDocument;
    for (let r = t; r && (e.push({ dom: r, top: r.scrollTop, left: r.scrollLeft }), t != n); r = gn(r));
    return e;
}
...
function Nc(t, e) {
        ...
        for (let h = 0; h < f.length; h++) {
            ...
            if (p.top <= s && p.bottom >= l) {
                ...
                if (m < r) {
                    (n = u),
                        (r = m),
                        (o = m && n.nodeType == 3 ? { left: p.right < e.left ? p.right : p.left, top: e.top } : e),
                        u.nodeType == 1 && m && (i = d + (e.left >= (p.left + p.right) / 2 ? 1 : 0));
                    continue;
                }
            } else
                p.top > e.top &&
    ...
    return !n && a && ((n = a), (o = c), (r = 0)), n && n.nodeType == 3 ? Vp(n, o) : !n || (r && n.nodeType == 1) ? { node: t, offset: i } : Nc(n, o);
}
function Vp(t, e) {
    ...
    for (let o = 0; o < n; o++) {
        ...
        let i = Ct(r, 1);
        if (i.top != i.bottom && as(e, i)) return { node: t, offset: o + (e.left >= (i.left + i.right) / 2 ? 1 : 0) };
    }
...
function jp(t, e, n, r) {
    ...
    for (let i = e, s = !1; i != t.dom; ) {
        ...
        if (
            ...
            (l.node.isBlock &&
                l.parent &&
                ((!s && a.left > r.left) || a.top > r.top ? (o = l.posBefore) : ((!s && a.right < r.left) || a.bottom < r.top) && (o = l.posAfter),
                (s = !0)),
...
function Kp(t, e) {
    ...
    if (((s = Wp(s, e)), r)) {
        if (Ve && r.nodeType == 1 && ((o = Math.min(o, r.childNodes.length)), o < r.childNodes.length)) {
        ...
        Yn &&
            ...
            o--,
            r == t.dom && o == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom
                ? (l = t.state.doc.content.size)
                : (o == 0 || r.nodeType != 1 || r.childNodes[o - 1].nodeName != "BR") && (l = jp(t, r, o, e));
    }
    l == null && (l = _p(t, s, e));
...
function Dc(t, e, n) {
    let { node: r, offset: o, atom: i } = t.docView.domFromPos(e, n < 0 ? -1 : 1),
        s = Yn || Ve;
    if (r.nodeType == 3)
        if (s && (Up.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))) {
            let a = Ct(ut(r, o, o), n);
            if (Ve && o && /\s/.test(r.nodeValue[o - 1]) && o < r.nodeValue.length) {
            ...
            let a = o,
                ...
                u = n < 0 ? 1 : -1;
            return (
                n < 0 && !o ? (c++, (u = -1)) : n >= 0 && o == r.nodeValue.length ? (a--, (u = 1)) : n < 0 ? a-- : c++, Wn(Ct(ut(r, a, c), u), u < 0)
            );
        }
    ...
    if (i == null && o && (n < 0 || o == De(r))) {
        let a = r.childNodes[o - 1],
            c = a.nodeType == 3 ? ut(a, De(a) - (s ? 0 : 1)) : a.nodeType == 1 && (a.nodeName != "BR" || !a.nextSibling) ? a : null;
        if (c) return Wn(Ct(c, 1), !1);
    }
    if (i == null && o < De(r)) {
        let a = r.childNodes[o];
        for (; a.pmViewDesc && a.pmViewDesc.ignoreForCoords; ) a = a.nextSibling;
        let c = a ? (a.nodeType == 3 ? ut(a, 0, s ? 0 : 1) : a.nodeType == 1 ? a : null) : null;
...
function Jp(t, e, n) {
    ...
    return Pc(t, e, () => {
        ...
        for (let l = i.firstChild; l; l = l.nextSibling) {
            ...
            else if (l.nodeType == 3) a = ut(l, 0, l.nodeValue.length).getClientRects();
            else continue;
    ...
    return l
        ? !qp.test(r.parent.textContent) || !l.modify
            ? n == "left" || n == "backward"
                ...
                : s
            : Pc(t, e, () => {
                  let { focusNode: a, focusOffset: c, anchorNode: u, anchorOffset: d } = t.domSelectionRange(),
                      f = l.caretBidiLevel;
...
var Xa = null,
    ...
    Za = !1;
function Yp(t, e, n) {
    return Xa == e && Qa == n ? Za : ((Xa = e), (Qa = n), (Za = n == "up" || n == "down" ? Jp(t, e, n) : Gp(t, e, n)));
}
var Pe = 0,
    ec = 1,
    Wt = 2,
    ...
    qt = class {
        constructor(e, n, r, o) {
            (this.parent = e), (this.children = n), (this.dom = r), (this.contentDOM = o), (this.dirty = Pe), (r.pmViewDesc = this);
        }
        matchesWidget(e) {
            return !1;
        }
        ...
        nearestDesc(e, n = !1) {
            for (let r = !0, o = e; o; o = o.parentNode) {
                let i = this.getDesc(o),
                    s;
                if (i && (!n || i.node))
                    if (r && (s = i.nodeDOM) && !(s.nodeType == 1 ? s.contains(e.nodeType == 1 ? e : e.parentNode) : s == e)) r = !1;
                    else return i;
            }
        }
        getDesc(e) {
        ...
        domFromPos(e, n) {
            ...
            for (let i; r && !(i = this.children[r - 1]).size && i instanceof Lr && i.side >= 0; r--);
            if (n <= 0) {
                let i,
                    s = !0;
                for (; (i = r ? this.children[r - 1] : null), !(!i || i.dom.parentNode == this.contentDOM); r--, s = !1);
                return i && n && s && !i.border && !i.domAtom ? i.domFromPos(i.size, n) : { node: this.contentDOM, offset: i ? ue(i.dom) + 1 : 0 };
            } else {
                let i,
                    s = !0;
                ...
                return i && s && !i.border && !i.domAtom
                    ? i.domFromPos(0, n)
                    : { node: this.contentDOM, offset: i ? ue(i.dom) : this.contentDOM.childNodes.length };
            }
        }
        parseRange(e, n, r = 0) {
            ...
            for (let s = r, l = 0; ; l++) {
                ...
                if (o == -1 && e <= c) {
                    let u = s + a.border;
                    if (e >= u && n <= c - a.border && a.node && a.contentDOM && this.contentDOM.contains(a.contentDOM)) return a.parseRange(e, n, u);
                    e = s;
                    for (let d = l; d > 0; d--) {
...
`
            ...
            if (!(o || (d && xe)) && Jt(l.node, l.offset, u.anchorNode, u.anchorOffset) && Jt(a.node, a.offset, u.focusNode, u.focusOffset)) return;
            let f = !1;
            if ((c.extend || e == n) && !d) {
                ...
                if (r == s ? e <= s && n >= r : e < s && n > r) {
                    ...
                    if (e >= l && n <= a) {
                        (this.dirty = e == r || n == s ? Wt : ec),
                            e == l && n == a && (i.contentLost || i.dom.parentNode != this.contentDOM) ? (i.dirty = qe) : i.markDirty(e - l, n - l);
                        return;
                    } else i.dirty = i.dom == i.contentDOM && i.dom.parentNode == this.contentDOM && !i.children.length ? Wt : qe;
                }
                r = s;
            }
            this.dirty = Wt;
    ...
    bn = class t extends qt {
        ...
        static create(e, n, r, o) {
            let i = o.nodeViews[n.type.name],
                s = i && i(n, o, r);
            return (
                (!s || !s.dom) && (s = it.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)), new t(e, n, s.dom, s.contentDOM || s.dom, s)
            );
        }
        parseRule() {
    ...
    At = class t extends qt {
        ...
        static create(e, n, r, o, i, s) {
            ...
            } else u || ({ dom: u, contentDOM: d } = it.renderSpec(document, n.type.spec.toDOM(n), null, n.attrs));
            !d &&
                !n.isText &&
                u.nodeName != "BR" &&
                (u.hasAttribute("contenteditable") || (u.contentEditable = "false"), n.type.spec.draggable && (u.draggable = !0));
            let f = u;
            return (
                (u = Bc(u, r, n)),
                c
        ...
        matchesNode(e, n, r) {
            return this.dirty == Pe && e.eq(this.node) && Hr(n, this.outerDeco) && r.eq(this.innerDeco);
        }
        get size() {
            ...
            em(
                ...
                (c, u, d) => {
                    c.spec.marks
                        ...
                        : c.type.side >= 0 && !d && a.syncToMarks(u == this.node.childCount ? V.none : this.node.child(u).marks, r, e),
                        a.placeWidget(c, e, o);
                },
                (c, u, d, f) => {
                ...
                (a.changed || this.dirty == Wt) &&
                    (s && this.protectLocalComposition(e, s), Ic(this.contentDOM, this.children, e), yn && tm(this.dom));
        }
        localCompositionInfo(e, n) {
            let { from: r, to: o } = e.state.selection;
            if (!(e.state.selection instanceof A) || r < n || o > n + this.node.content.size) return null;
        ...
        protectLocalComposition(e, { node: n, pos: r, text: o }) {
            ...
            let s = new Ji(this, i, n, o);
            e.input.compositionNodes.push(s), (this.children = Xi(this.children, r, r + o.length, e, s));
        }
        update(e, n, r, o) {
            return this.dirty == qe || !e.sameMarkup(this.node) ? !1 : (this.updateInner(e, n, r, o), !0);
        }
        updateInner(e, n, r, o) {
        ...
        updateOuterDeco(e) {
            ...
            let n = this.nodeDOM.nodeType != 1,
                r = this.dom;
            (this.dom = Lc(this.dom, this.nodeDOM, Gi(this.outerDeco, this.node, n), Gi(e, this.node, n))),
...
var Br = class t extends At {
            ...
            return this.dirty == qe || (this.dirty != Pe && !this.inParent()) || !e.sameMarkup(this.node)
                ...
                : (this.updateOuterDeco(n),
                  (this.dirty != Pe || e.text != this.node.text) &&
                      ...
                      ((this.nodeDOM.nodeValue = e.text), o.trackWrites == this.nodeDOM && (o.trackWrites = null)),
                  (this.node = e),
                  (this.dirty = Pe),
                  !0);
        }
        ...
        markDirty(e, n) {
            super.markDirty(e, n), this.dom != this.nodeDOM && (e == 0 || n == this.nodeDOM.nodeValue.length) && (this.dirty = qe);
        }
        get domAtom() {
            return !1;
        }
...
function Ic(t, e, n) {
    ...
    for (let i = 0; i < e.length; i++) {
        ...
        if (s instanceof bn) {
            ...
            Ic(s.contentDOM, s.children, n), (r = a ? a.nextSibling : t.firstChild);
        }
    }
    for (; r; ) (r = nc(r)), (o = !0);
    ...
    for (let i = 0; i < t.length; i++) {
        ...
        if (s) {
            ...
            for (let l in s) {
                let a = s[l];
                a != null &&
                    (n && o.length == 1 && o.push((r = new _n(e.isInline ? "span" : "div"))),
                    l == "class"
...
function Lc(t, e, n, r) {
    ...
    for (let i = 0; i < r.length; i++) {
        ...
        if (i) {
            let a;
            (l && l.nodeName == s.nodeName && o != t && (a = o.parentNode) && a.nodeName.toLowerCase() == s.nodeName) ||
                ((a = document.createElement(s.nodeName)), (a.pmIsDeco = !0), a.appendChild(o), (l = _t[0])),
                (o = a);
        }
        Xp(o, l || _t[0], s);
    }
...
var Yi = class {
    ...
    syncToMarks(e, n, r) {
        ...
        for (; o < s && (o == i - 1 ? this.top : this.stack[(o + 1) << 1]).matchesMark(e[o]) && e[o].type.spec.spanning !== !1; ) o++;
        for (; o < i; ) this.destroyRest(), (this.top.dirty = Pe), (this.index = this.stack.pop()), (this.top = this.stack.pop()), i--;
        for (; i < e.length; ) {
    ...
    findIndexWithChild(e) {
        for (;;) {
            ...
            if (n == this.top.contentDOM) {
                let r = e.pmViewDesc;
                if (r) {
                    for (let o = this.index; o < this.top.children.length; o++) if (this.top.children[o] == r) return o;
                }
                return -1;
            }
            e = n;
        ...
        for (let l = this.index; l < this.top.children.length; l++) {
            ...
            if (a instanceof At) {
                ...
                let u = a.dom,
                    ...
                    f =
                        this.isLocked(u) &&
                        !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != qe && Hr(n, a.outerDeco));
                if (!f && a.update(e, n, r, o)) return this.destroyBetween(this.index, l), a.dom != u && (this.changed = !0), this.index++, !0;
                if (!f && (d = this.recreateWrapper(a, e, n, r, o, s)))
                    return (
                        this.destroyBetween(this.index, l),
                        (this.top.children[this.index] = d),
                        d.contentDOM && ((d.dirty = Wt), d.updateChildren(o, s + 1), (d.dirty = Pe)),
                        (this.changed = !0),
                        this.index++,
                        !0
                    );
    ...
    recreateWrapper(e, n, r, o, i, s) {
        if (e.dirty || n.isAtom || !e.children.length || !e.node.content.eq(n.content) || !Hr(r, e.outerDeco) || !o.eq(e.innerDeco)) return null;
    ...
    addTextblockHacks() {
        let e = this.top.children[this.index - 1],
            n = this.top;
        for (; e instanceof bn; ) (n = e), (e = n.children[n.children.length - 1]);
        (!e || !(e instanceof Br) || /\n$/.test(e.node.text) || (this.view.requiresGeckoHackNode && /\s$/.test(e.node.text))) &&
            ((xe || ge) && e && e.dom.contentEditable == "false" && this.addHackNode("IMG", n), this.addHackNode("BR", this.top));
    }
    addHackNode(e, n) {
...
function Xi(t, e, n, r, o) {
    ...
    for (let s = 0, l = 0; s < t.length; s++) {
        ...
        c >= n || u <= e
            ? i.push(a)
            : (c < e && i.push(a.slice(0, e - c, r)), o && (i.push(o), (o = void 0)), u > n && i.push(a.slice(n - c, a.size, r)));
    }
    return i;
}
function cs(t, e = null) {
    ...
    if (Kr(n)) {
        ...
        let d = o.node;
        if (o && d.isAtom && O.isSelectable(d) && o.parent && !(d.isInline && Rp(n.focusNode, n.focusOffset, o.dom))) {
            let f = o.posBefore;
...
function zc(t) {
    return t.editable ? t.hasFocus() : Fc(t) && document.activeElement && document.activeElement.contains(t.dom);
}
function ft(t, e = !1) {
    ...
    if ((Hc(t, n), !!zc(t))) {
        if (!e && t.input.mouseDown && t.input.mouseDown.allowDefault && ge) {
            ...
            if (r.anchorNode && o.anchorNode && Jt(r.anchorNode, r.anchorOffset, o.anchorNode, o.anchorOffset)) {
        ...
        if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) om(t);
            ...
            rc &&
                !(n instanceof A) &&
                (n.$from.parent.inlineContent || (i = oc(t, n.from)), !n.empty && !n.$from.parent.inlineContent && (s = oc(t, n.to))),
                t.docView.setSelection(r, o, t, e),
                rc && (i && ic(i), s && ic(s)),
                n.visible
                    ? t.dom.classList.remove("ProseMirror-hideselection")
                    : (t.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && rm(t));
        }
...
function Fi(t) {
    return (t.contentEditable = "true"), xe && t.draggable && ((t.draggable = !1), (t.wasDraggable = !0)), t;
}
function ic(t) {
    ...
    e.addEventListener(
        ...
        (t.input.hideSelectionGuard = () => {
            (n.anchorNode != r || n.anchorOffset != o) &&
                (e.removeEventListener("selectionchange", t.input.hideSelectionGuard),
                setTimeout(() => {
                    (!zc(t) || t.state.selection.visible) && t.dom.classList.remove("ProseMirror-hideselection");
                }, 20));
        }),
    );
}
function om(t) {
    ...
    o ? n.setStart(r.parentNode, ue(r) + 1) : n.setStart(r, 0),
        ...
        e.removeAllRanges(),
        e.addRange(n),
        !o && !t.state.selection.visible && ke && Tt <= 11 && ((r.disabled = !0), (r.disabled = !1));
}
function Hc(t, e) {
    if (e instanceof O) {
        let n = t.docView.descAt(e.from);
        n != t.lastSelectedViewDesc && (sc(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else sc(t);
}
function sc(t) {
...
function us(t, e, n, r) {
    return t.someProp("createSelectionBetween", (o) => o(t, e, n)) || A.between(e, n, r);
}
function lc(t) {
        ...
        if (n.indexOf("s") > -1) {
            ...
            if (t.endOfTextblock(e > 0 ? "forward" : "backward")) {
                ...
                return i.isAtom || ((s = t.docView.descAt(l)) && !s.contentDOM)
                    ? O.isSelectable(i)
                        ? Mt(t, new O(e < 0 ? t.state.doc.resolve(o.pos - i.nodeSize) : o))
                        : Yn
                          ? Mt(t, new A(t.state.doc.resolve(e < 0 ? l : l + i.nodeSize)))
                          : !1
                    : !1;
            }
        } else return !1;
    else {
        if (r instanceof O && r.node.isInline) return Mt(t, new A(e > 0 ? r.$to : r.$from));
        {
            let o = Qi(t.state, e);
            return o ? Mt(t, o) : !1;
        }
...
function sm(t) {
    ...
    let o,
        i,
        s = !1;
    for (Ve && n.nodeType == 1 && r < Fr(n) && jn(n.childNodes[r], -1) && (s = !0); ; )
        if (r > 0) {
            ...
            if ($c(n)) break;
            {
                ...
                for (; l && jn(l, -1); ) (o = n.parentNode), (i = ue(l)), (l = l.previousSibling);
                if (l) (n = l), (r = Fr(n));
                else {
...
function lm(t) {
    ...
    for (;;)
        if (r < o) {
            ...
            {
                let l = n.nextSibling;
                for (; l && jn(l, 1); ) (i = l.parentNode), (s = ue(l) + 1), (l = l.nextSibling);
                if (l) (n = l), (r = 0), (o = Fr(n));
                else {
                    if (((n = n.parentNode), n == t.dom)) break;
                    r = o = 0;
...
function am(t, e) {
    for (; t && e == t.childNodes.length && !Gn(t); ) (e = ue(t) + 1), (t = t.parentNode);
...
function Zi(t, e, n) {
    if (e.nodeType != 3) {
        let i, s;
        (s = am(e, n)) ? ((e = s), (n = 0)) : (i = cm(e, n)) && ((e = i), (n = i.nodeValue.length));
    }
    ...
    if (!(ge || Ip) && n.parent.inlineContent) {
        ...
        if (e > n.start()) {
            let i = t.coordsAtPos(e - 1),
                s = (i.top + i.bottom) / 2;
            if (s > o.top && s < o.bottom && Math.abs(i.left - o.left) > 1) return i.left < o.left ? "ltr" : "rtl";
        }
        if (e < n.end()) {
            let i = t.coordsAtPos(e + 1),
                s = (i.top + i.bottom) / 2;
...
function uc(t, e, n) {
    let r = t.state.selection;
    if ((r instanceof A && !r.empty) || n.indexOf("s") > -1 || (Re && n.indexOf("m") > -1)) return !1;
    let { $from: o, $to: i } = r;
...
function fm(t, e) {
    ...
    if ((n == 46 && !e.shiftKey) || (Re && n == 68 && r == "c")) return dc(t, 1) || hn(t, 1);
    if (n == 13 || n == 27) return !0;
    if (n == 37 || (Re && n == 66 && r == "c")) {
        let o = n == 37 ? (cc(t, t.state.selection.from) == "ltr" ? -1 : 1) : -1;
        return ac(t, o, r) || hn(t, o);
    } else if (n == 39 || (Re && n == 70 && r == "c")) {
        let o = n == 39 ? (cc(t, t.state.selection.from) == "ltr" ? 1 : -1) : 1;
        return ac(t, o, r) || hn(t, o);
    } else {
        if (n == 38 || (Re && n == 80 && r == "c")) return uc(t, -1, r) || hn(t, -1);
        if (n == 40 || (Re && n == 78 && r == "c")) return um(t) || uc(t, 1, r) || hn(t, 1);
        if (r == (Re ? "m" : "c") && (n == 66 || n == 73 || n == 89 || n == 90)) return !0;
    }
    return !1;
}
function ds(t, e) {
...
`,
    ...
    if (
        (l ||
            (l = (t.someProp("clipboardParser") || t.someProp("domParser") || Ue.fromSchema(t.state.schema)).parseSlice(s, {
                preserveWhitespace: !!(a || u),
                context: o,
                ruleFromNode(f) {
                    return f.nodeName == "BR" && !f.nextSibling && f.parentNode && !hm.test(f.parentNode.nodeName) ? { ignore: !0 } : null;
                },
            })),
        u)
    )
        l = bm(hc(l, +u[1], +u[2]), u[4]);
    else if (((l = M.maxOpen(pm(l.content, o), !0)), l.openStart || l.openEnd)) {
        let d = 0,
            f = 0;
...
var hm = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function pm(t, e) {
        ...
        if (
            (t.forEach((l) => {
                ...
                let a = o.findWrapping(l.type),
                    c;
                if (!a) return (s = null);
                if ((c = s.length && i.length && _c(a, i, l, s[s.length - 1], 0))) s[s.length - 1] = c;
                else {
                    s.length && (s[s.length - 1] = jc(s[s.length - 1], i.length));
                    let u = Wc(l, a);
...
function _c(t, e, n, r, o) {
    if (o < t.length && o < e.length && t[o] == e[o]) {
        let i = _c(t, e, n, r.lastChild, o + 1);
        if (i) return r.copy(r.content.replaceChild(r.childCount - 1, i));
        if (r.contentMatchAt(r.childCount).matchType(o == t.length - 1 ? n.type : t[o + 1])) return r.copy(r.content.append(w.from(Wc(n, t, o + 1))));
    }
}
function jc(t, e) {
    if (e == 0) return t;
    let n = t.content.replaceChild(t.childCount - 1, jc(t.lastChild, e - 1)),
            ...
            (l =
                e < 0
                    ? s
                          ...
                          .fillBefore(l, i <= o)
                          .append(l)
                    : l.append(s.contentMatchAt(s.childCount).fillBefore(w.empty, !0))),
        t.replaceChild(e < 0 ? 0 : t.childCount - 1, s.copy(l))
    );
}
function hc(t, e, n) {
    return (
        e < t.openStart && (t = new M(es(t.content, -1, e, t.openStart, 0, t.openEnd), e, t.openEnd)),
        n < t.openEnd && (t = new M(es(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
        t
    );
}
var Kc = {
...
function mm(t) {
    ...
    return e ? ($i || ($i = e.defaultPolicy || e.createPolicy("ProseMirrorClipboard", { createHTML: (n) => n })), $i.createHTML(t)) : t;
}
function gm(t) {
    let e = /^(\s*<meta [^>]*>)*/.exec(t);
...
function ym(t) {
    ...
    for (let n = 0; n < e.length; n++) {
        let r = e[n];
        r.childNodes.length == 1 && r.textContent == "\xA0" && r.parentNode && r.parentNode.replaceChild(t.ownerDocument.createTextNode(" "), r);
    }
}
function bm(t, e) {
    if (!t.size) return t;
    ...
    for (let e in we) {
        ...
        t.dom.addEventListener(
            ...
            (t.input.eventHandlers[e] = (r) => {
                km(t, r) && !fs(t, r) && (t.editable || !(r.type in Se)) && n(t, r);
            }),
...
function ns(t) {
    t.someProp("handleDOMEvents", (e) => {
        for (let n in e) t.input.eventHandlers[n] || t.dom.addEventListener(n, (t.input.eventHandlers[n] = (r) => fs(t, r)));
    });
}
function fs(t, e) {
...
function km(t, e) {
    ...
    for (let n = e.target; n != t.dom; n = n.parentNode) if (!n || n.nodeType == 11 || (n.pmViewDesc && n.pmViewDesc.stopEvent(e))) return !1;
    return !0;
}
function Cm(t, e) {
    !fs(t, e) && we[e.type] && (t.editable || !(e.type in Se)) && we[e.type](t, e);
}
Se.keydown = (t, e) => {
    let n = e;
    if (
        ((t.input.shiftKey = n.keyCode == 16 || n.shiftKey),
        !qc(t, n) && ((t.input.lastKeyCode = n.keyCode), (t.input.lastKeyCodeTime = Date.now()), !(dt && ge && n.keyCode == 13)))
    )
        if ((n.keyCode != 229 && t.domObserver.forceFlush(), yn && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)) {
            let r = Date.now();
            (t.input.lastIOSEnter = r),
                (t.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
                    t.input.lastIOSEnter == r && (t.someProp("handleKeyDown", (o) => o(t, Vt(13, "Enter"))), (t.input.lastIOSEnter = 0));
                }, 200));
        } else t.someProp("handleKeyDown", (r) => r(t, n)) || fm(t, n) ? n.preventDefault() : vt(t, "key");
};
Se.keyup = (t, e) => {
...
Se.keypress = (t, e) => {
    let n = e;
    if (qc(t, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (Re && n.metaKey)) return;
...
function hs(t, e, n, r, o) {
    ...
    for (let s = i.depth + 1; s > 0; s--)
        if (t.someProp(e, (l) => (s > i.depth ? l(t, n, i.nodeAfter, i.before(s), o, !0) : l(t, n, i.node(s), i.before(s), o, !1)))) return !0;
    return !1;
}
function mn(t, e, n) {
...
function vm(t, e) {
    ...
    let n = t.state.doc.resolve(e),
        r = n.nodeAfter;
    return r && r.isAtom && O.isSelectable(r) ? (mn(t, new O(n), "pointer"), !0) : !1;
}
function Tm(t, e) {
    if (e == -1) return !1;
    let n = t.state.selection,
...
function Am(t, e, n, r, o) {
    return hs(t, "handleClickOn", e, n, r) || t.someProp("handleClick", (i) => i(t, e, r)) || (o ? Tm(t, n) : vm(t, n));
}
function Em(t, e, n, r) {
    return hs(t, "handleDoubleClickOn", e, n, r) || t.someProp("handleDoubleClick", (o) => o(t, e, r));
}
function Om(t, e, n, r) {
    return hs(t, "handleTripleClickOn", e, n, r) || t.someProp("handleTripleClick", (o) => o(t, e, r)) || Nm(t, n, r);
}
function Nm(t, e, n) {
    if (n.button != 0) return !1;
    let r = t.state.doc;
    if (e == -1) return r.inlineContent ? (mn(t, A.create(r, 0, r.content.size), "pointer"), !0) : !1;
    let o = r.resolve(e);
    for (let i = o.depth + 1; i > 0; i--) {
        let s = i > o.depth ? o.nodeAfter : o.node(i),
            l = o.before(i);
        if (s.inlineContent) mn(t, A.create(r, l + 1, l + 1 + s.content.size), "pointer");
...
we.mousedown = (t, e) => {
    ...
    o - t.input.lastClick.time < 500 &&
        ...
        (t.input.lastClick.type == "singleClick" ? (i = "doubleClick") : t.input.lastClick.type == "doubleClick" && (i = "tripleClick")),
        (t.input.lastClick = { time: o, x: n.clientX, y: n.clientY, type: i, button: n.button });
    let s = t.posAtCoords(Ur(n));
    s &&
        (i == "singleClick"
            ? (t.input.mouseDown && t.input.mouseDown.done(), (t.input.mouseDown = new rs(t, s, n, !!r)))
...
var rs = class {
    constructor(e, n, r, o) {
        ...
        ((r.button == 0 && i.type.spec.draggable && i.type.spec.selectable !== !1) || (c instanceof O && c.from <= s && c.to > s)) &&
            (this.mightDrag = {
                node: i,
                pos: s,
    ...
    up(e) {
        ...
        let n = this.pos;
        this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(Ur(e))),
            ...
            this.allowDefault || !n
                ...
                : Am(this.view, n.pos, n.inside, e, this.selectNode)
                  ...
                  : e.button == 0 &&
                      (this.flushed ||
                          (xe && this.mightDrag && !this.mightDrag.node.isAtom) ||
                          (ge &&
                              !this.view.state.selection.visible &&
                              Math.min(Math.abs(n.pos - this.view.state.selection.from), Math.abs(n.pos - this.view.state.selection.to)) <= 2))
                    ? (mn(this.view, E.near(this.view.state.doc.resolve(n.pos)), "pointer"), e.preventDefault())
                    : vt(this.view, "pointer");
    }
    move(e) {
...
function qc(t, e) {
    return t.composing ? !0 : xe && Math.abs(e.timeStamp - t.input.compositionEndedAt) < 500 ? ((t.input.compositionEndedAt = -2e8), !0) : !1;
}
var Rm = dt ? 5e3 : -1;
Se.compositionstart = Se.compositionupdate = (t) => {
    if (!t.composing) {
        ...
        if (
            ...
            (e.storedMarks || (!n.textOffset && n.parentOffset && n.nodeBefore.marks.some((r) => r.type.spec.inclusive === !1)))
        )
            (t.markCursor = t.state.storedMarks || n.marks()), $r(t, !0), (t.markCursor = null);
        else if (($r(t, !e.selection.empty), Ve && e.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)) {
            let r = t.domSelectionRange();
...
function Gc(t, e) {
    clearTimeout(t.input.composingTimeout), e > -1 && (t.input.composingTimeout = setTimeout(() => $r(t), e));
}
function Yc(t) {
    for (t.composing && ((t.input.composing = !1), (t.input.compositionEndedAt = Pm())); t.input.compositionNodes.length > 0; )
        t.input.compositionNodes.pop().markParentsDirty();
}
function Dm(t) {
    let e = t.domSelectionRange();
    if (!e.focusNode) return null;
    let n = Op(e.focusNode, e.focusOffset),
        r = Np(e.focusNode, e.focusOffset);
    if (n && r && n != r) {
        let o = r.pmViewDesc,
...
function $r(t, e = !1) {
    if (!(dt && t.domObserver.flushingSoon >= 0)) {
        if ((t.domObserver.forceFlush(), Yc(t), e || (t.docView && t.docView.dirty))) {
            let n = cs(t),
                r = t.state.selection;
            return (
                n && !n.eq(r)
...
var Kn = (ke && Tt < 15) || (yn && Lp < 604);
we.copy = Se.cut = (t, e) => {
    let n = e,
        r = t.state.selection,
        o = n.type == "cut";
    if (r.empty) return;
    let i = Kn ? null : n.clipboardData,
        s = r.content(),
        { dom: l, text: a } = ds(t, s);
    i ? (n.preventDefault(), i.clearData(), i.setData("text/html", l.innerHTML), i.setData("text/plain", a)) : Im(t, l),
...
function Bm(t, e) {
    ...
    setTimeout(() => {
        t.focus(), r.parentNode && r.parentNode.removeChild(r), n ? Un(t, r.value, null, o, e) : Un(t, r.textContent, r.innerHTML, o, e);
    }, 50);
}
function Un(t, e, n, r, o) {
    let i = Vc(t, e, n, r, t.state.selection.$from);
...
Se.paste = (t, e) => {
    ...
    let r = Kn ? null : n.clipboardData,
        o = t.input.shiftKey && t.input.lastKeyCode != 45;
    r && Un(t, Xc(r), r.getData("text/html"), o, n) ? n.preventDefault() : Bm(t, n);
};
var Vr = class {
        constructor(e, n, r) {
...
we.dragstart = (t, e) => {
    ...
    let o = t.state.selection,
        i = o.empty ? null : t.posAtCoords(Ur(n)),
        s;
    if (!(i && i.pos >= o.from && i.pos <= (o instanceof O ? o.to - 1 : o.to))) {
        if (r && r.mightDrag) s = O.create(t.state.doc, r.mightDrag.pos);
        else if (n.target && n.target.nodeType == 1) {
            let d = t.docView.nearestDesc(n.target, !0);
            d && d.node.type.spec.draggable && d != t.docView && (s = O.create(t.state.doc, d.posBefore));
        }
    }
    let l = (s || t.state.selection).content(),
        { dom: a, text: c, slice: u } = ds(t, l);
    (!n.dataTransfer.files.length || !ge || Ac > 120) && n.dataTransfer.clearData(),
...
Se.drop = (t, e) => {
    ...
    s
        ...
        : (s = Vc(t, Xc(n.dataTransfer), Kn ? null : n.dataTransfer.getData("text/html"), !1, i));
    let l = !!(r && Qc(t, n));
    ...
    if (d && O.isSelectable(s.content.firstChild) && h.nodeAfter && h.nodeAfter.sameMarkup(s.content.firstChild)) c.setSelection(new O(h));
    else {
        let p = c.mapping.map(a);
        c.mapping.maps[c.mapping.maps.length - 1].forEach((m, g, y, b) => (p = b)), c.setSelection(us(t, h, c.doc.resolve(p)));
    }
...
we.focus = (t) => {
    (t.input.lastFocus = Date.now()),
        t.focused ||
            ...
            (t.focused = !0),
            setTimeout(() => {
                t.docView && t.hasFocus() && !t.domObserver.currentSelection.eq(t.domSelectionRange()) && ft(t);
            }, 20));
};
we.blur = (t, e) => {
    let n = e;
...
we.beforeinput = (t, e) => {
    if (ge && dt && e.inputType == "deleteContentBackward") {
        ...
        setTimeout(() => {
            if (t.input.domChangeCount != r || (t.dom.blur(), t.focus(), t.someProp("handleKeyDown", (i) => i(t, Vt(8, "Backspace"))))) return;
...
var Wr = class t {
        constructor(e, n) {
            (this.toDOM = e), (this.spec = n || Kt), (this.side = this.spec.side || 0);
        }
        map(e, n, r, o) {
        ...
        eq(e) {
            return (
                this == e || (e instanceof t && ((this.spec.key && this.spec.key == e.spec.key) || (this.toDOM == e.toDOM && Jn(this.spec, e.spec))))
            );
        }
        destroy(e) {
    ...
    jt = class t {
        ...
        eq(e) {
            return this == e || (e instanceof t && Jn(this.attrs, e.attrs) && Jn(this.spec, e.spec));
        }
        static is(e) {
    ...
    is = class t {
        ...
        map(e, n, r, o) {
            ...
            return s.deleted || s.pos <= i.pos ? null : new Y(i.pos - r, s.pos - r, this);
        }
        valid(e, n) {
    ...
    J = class t {
        ...
        map(e, n, r) {
            return this == me || e.maps.length == 0 ? this : this.mapInner(e, n, 0, 0, r || Kt);
        }
        mapInner(e, n, r, o, i) {
            let s;
            ...
            return this.children.length ? Hm(this.children, s || [], e, n, r, o, i) : s ? new t(s.sort(Ut), pn) : me;
        }
        add(e, n) {
            return n.length ? (this == me ? t.create(e, n) : this.addInner(e, n, 0)) : this;
        }
        addInner(e, n, r) {
            let o,
                i = 0;
            e.forEach((l, a) => {
                ...
                if ((u = eu(n, l, c))) {
                    ...
                    o[i] == a ? (o[i + 2] = o[i + 2].addInner(l, u, c + 1)) : o.splice(i, 0, a, a + l.nodeSize, jr(u, l, c + 1, Kt)), (i += 3);
                }
            });
            let s = Zc(i ? tu(n) : n, -r);
            for (let l = 0; l < s.length; l++) s[l].type.valid(e, s[l]) || s.splice(l--, 1);
            return new t(s.length ? this.local.concat(s).sort(Ut) : this.local, o || this.children);
        }
        remove(e) {
        ...
        removeInner(e, n) {
            ...
            if (o.length) {
                for (let i = 0, s; i < e.length; i++)
                    if ((s = e[i]))
                        for (let l = 0; l < o.length; l++) o[l].eq(s, n) && (o == this.local && (o = this.local.slice()), o.splice(l--, 1));
            }
            return r == this.children && o == this.local ? this : o.length || r.length ? new t(o, r) : me;
        }
        forChild(e, n) {
        ...
        localsInner(e) {
            ...
            let n = [];
            for (let r = 0; r < this.local.length; r++) this.local[r].type instanceof jt || n.push(this.local[r]);
            return n;
        }
        forEachSet(e) {
            e(this);
        ...
        static from(e) {
            switch (e.length) {
                ...
                case 1:
                    return e[0];
                default:
                    return new t(e.every((n) => n instanceof J) ? e : e.reduce((n, r) => n.concat(r instanceof J ? r : r.members), []));
            }
        }
        forEachSet(e) {
...
function eu(t, e, n) {
    ...
    let r = n + e.nodeSize,
        o = null;
    for (let i = 0, s; i < t.length; i++) (s = t[i]) && s.from > n && s.to < r && ((o || (o = [])).push(s), (t[i] = null));
    return o;
}
function tu(t) {
    let e = [];
...
function jr(t, e, n, r) {
    ...
    e.forEach((l, a) => {
        ...
        if (c) {
            i = !0;
            let u = jr(c, l, n + a + 1, r);
            u != me && o.push(a, a + l.nodeSize, u);
        }
    });
    let s = Zc(i ? tu(t) : t, -n).sort(Ut);
    ...
    for (let n = 0; n < e.length - 1; n++) {
        ...
        if (r.from != r.to)
            for (let o = n + 1; o < e.length; o++) {
                let i = e[o];
                if (i.from == r.from) {
                    i.to != r.to && (e == t && (e = t.slice()), (e[o] = i.copy(i.from, r.to)), mc(e, o + 1, i.copy(r.to, i.to)));
                    continue;
                } else {
                    i.from < r.to && (e == t && (e = t.slice()), (e[n] = r.copy(r.from, i.from)), mc(e, o, r.copy(i.from, r.to)));
                    break;
                }
            }
    }
...
function Vi(t) {
    ...
    return (
        ...
        t.cursorWrapper && e.push(J.create(t.state.doc, [t.cursorWrapper.deco])),
        _r.from(e)
    );
}
var $m = { childList: !0, characterData: !0, characterDataOldValue: !0, attributes: !0, attributeOldValue: !0, subtree: !0 },
    Vm = ke && Tt <= 11,
    ss = class {
        constructor() {
    ...
    ls = class {
        ...
        start() {
            this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, $m)),
        ...
        onSelectionChange() {
            if (lc(this.view)) {
                ...
                if (ke && Tt <= 11 && !this.view.state.selection.empty) {
                    ...
                    if (e.focusNode && Jt(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset)) return this.flushSoon();
                }
                this.flush();
            }
        }
        ...
        ignoreSelectionChange(e) {
            ...
            if (o && o.ignoreMutation({ type: "selection", target: r.nodeType == 3 ? r.parentNode : r })) return this.setCurSelection(), !0;
        }
        pendingRecords() {
        ...
        flush() {
            ...
            let r = e.domSelectionRange(),
                o = !this.suppressingSelectionUpdates && !this.currentSelection.eq(r) && lc(e) && !this.ignoreSelectionChange(r),
                i = -1,
                s = -1,
                l = !1,
                a = [];
            ...
            if (Ve && a.length) {
                ...
                if (u.length == 2) {
                    ...
                    for (let f of u) {
                        let h = f.parentNode;
                        h && h.nodeName == "LI" && (!d || jm(e, d) != h) && f.remove();
                    }
                }
            }
            let c = null;
            ...
            c.eq(E.near(e.state.doc.resolve(0), 1))
                ? ((e.input.lastFocus = 0), ft(e), this.currentSelection.set(r), e.scrollToSelection())
                : (i > -1 || o) &&
                  (i > -1 && (e.docView.markDirty(i, s), Wm(e)),
                  this.handleDOMChange(i, s, l, a),
                  e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || ft(e),
    ...
    yc = !1;
function Wm(t) {
    if (!gc.has(t) && (gc.set(t, null), ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(t.dom).whiteSpace) !== -1)) {
...
function bc(t, e) {
    ...
    return Jt(s.node, s.offset, o, i) && ([n, r, o, i] = [o, i, n, r]), { anchorNode: n, anchorOffset: r, focusNode: o, focusOffset: i };
}
function _m(t, e) {
...
function Km(t, e, n) {
    ...
    if (
        (u &&
            ...
            ((c = [{ node: u, offset: a.anchorOffset }]), Kr(a) || c.push({ node: a.focusNode, offset: a.focusOffset })),
...
function Um(t) {
    ...
    if (t.nodeName == "BR" && t.parentNode) {
        ...
        } else if (t.parentNode.lastChild == t || (xe && /^(tr|table)$/i.test(t.parentNode.nodeName))) return { ignore: !0 };
...
function qm(t, e, n, r, o) {
    ...
    if (((t.input.compositionPendingChanges = 0), e < 0)) {
        let v = t.input.lastSelectionTime > Date.now() - 50 ? t.input.lastSelectionOrigin : null,
            B = cs(t, v);
        if (B && !t.state.selection.eq(B)) {
            ...
            v == "pointer" ? D.setMeta("pointer", !0) : v == "key" && D.scrollIntoView(), i && D.setMeta("composition", i), t.dispatch(D);
        }
        return;
    }
    ...
    t.state.selection.from < t.state.selection.to &&
        ...
        (p.start > t.state.selection.from && p.start <= t.state.selection.from + 2 && t.state.selection.from >= c.from
    ...
    let m = c.doc.resolveNoCache(p.start - c.from),
        ...
        x;
    if (
        ((yn && t.input.lastIOSEnter > Date.now() - 225 && (!b || o.some((v) => v.nodeName == "DIV" || v.nodeName == "P"))) ||
            (!b &&
    ...
    if (t.state.selection.anchor > p.start && Ym(u, p.start, p.endA, m, g) && t.someProp("handleKeyDown", (v) => v(t, Vt(8, "Backspace")))) {
    ...
    let C = p.start,
        S = p.endA,
        R = (v) => {
            let B = v || t.state.tr.replace(C, S, c.doc.slice(p.start - c.from, p.endB - c.from));
            if (c.sel) {
                let D = xc(t, B.doc, c.sel);
                D &&
                    !(
                        (ge &&
                            t.composing &&
    ...
    if (b) {
        if (m.pos == g.pos) {
            ke && Tt <= 11 && m.parentOffset == 0 && (t.domObserver.suppressSelectionUpdates(), setTimeout(() => ft(t), 20));
            let v = R(t.state.tr.delete(C, S)),
                B = u.resolve(p.start).marksAcross(u.resolve(p.endA));
            B && v.ensureMarks(B), t.dispatch(v);
        } else if (
            p.endA == p.endB &&
            (P = Gm(m.parent.content.cut(m.parentOffset, g.parentOffset), y.parent.content.cut(y.parentOffset, p.endA - y.start())))
        ) {
            let v = R(t.state.tr);
            P.type == "add" ? v.addMark(C, S, P.mark) : v.removeMark(C, S, P.mark), t.dispatch(v);
        } else if (m.parent.child(m.index()).isText && m.index() == g.index() - (g.textOffset ? 0 : 1)) {
            let v = m.parent.textBetween(m.parentOffset, g.parentOffset),
                B = () => R(t.state.tr.insertText(v, C, S));
            t.someProp("handleTextInput", (D) => D(t, C, S, v, B)) || t.dispatch(B());
        }
    } else t.dispatch(R());
}
function xc(t, e, n) {
    return Math.max(n.anchor, n.head) > e.content.size ? null : us(t, e.resolve(n.anchor), e.resolve(n.head));
}
function Gm(t, e) {
    ...
    if (o.length == 1 && i.length == 0) (l = o[0]), (s = "add"), (a = (u) => u.mark(l.addToSet(u.marks)));
    else if (o.length == 0 && i.length == 1) (l = i[0]), (s = "remove"), (a = (u) => u.mark(l.removeFromSet(u.marks)));
    else return null;
    let c = [];
...
function Ym(t, e, n, r, o) {
    ...
    let s = t.resolve(Wi(i, !0, !0));
    return !s.parent.isTextblock || s.pos > n || Wi(s, !0, !1) < n ? !1 : r.parent.content.cut(r.parentOffset).eq(s.parent.content);
}
function Wi(t, e, n) {
    let r = t.depth,
        o = e ? t.end() : t.pos;
...
function Xm(t, e, n, r, o) {
    ...
    if (s < i && t.size < e.size) {
        let a = r <= i && r >= s ? i - r : 0;
        (i -= a), i && i < e.size && wc(e.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1), (l = i + (l - s)), (s = i);
    } else if (l < i) {
        let a = r <= i && r >= l ? i - r : 0;
        (i -= a), i && i < t.size && wc(t.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1), (s = i + (s - l)), (l = i);
    }
...
var qn = class {
    constructor(e, n) {
        (this._root = null),
            ...
            (this.docView = tc(this.state.doc, Sc(this), Vi(this), this.dom, this)),
            (this.domObserver = new ls(this, (r, o, i, s) => qm(this, r, o, i, s))),
    ...
    update(e) {
        ...
        let n = this._props;
        (this._props = e), e.plugins && (e.plugins.forEach(vc), (this.directPlugins = e.plugins)), this.updateStateInner(e.state, n);
    }
    setProps(e) {
        let n = {};
    ...
    updateStateInner(e, n) {
        ...
        let o = this.state,
            i = !1,
            s = !1;
        e.storedMarks && this.composing && (Yc(this), (s = !0)), (this.state = e);
        ...
        (l || n.handleDOMEvents != this._props.handleDOMEvents) && ns(this), (this.editable = Cc(this)), kc(this);
        let a = Vi(this),
            c = Sc(this),
            u = o.plugins != e.plugins && !o.doc.eq(e.doc) ? "reset" : e.scrollToSelection > o.scrollToSelection ? "to selection" : "preserve",
            d = i || !this.docView.matchesNode(e.doc, c, a);
        (d || !e.selection.eq(o.selection)) && (s = !0);
        let f = u == "preserve" && s && this.dom.style.overflowAnchor == null && Hp(this);
        if (s) {
            this.domObserver.stop();
            let h = d && (ke || ge) && !this.composing && !o.selection.empty && !e.selection.empty && Qm(o.selection, e.selection);
            if (d) {
                ...
                this.composing && (this.input.compositionNode = Dm(this)),
                    (i || !this.docView.update(e.doc, c, a, this)) &&
                        (this.docView.updateOuterDeco(c), this.docView.destroy(), (this.docView = tc(e.doc, c, a, this.dom, this))),
                    p && !this.trackWrites && (h = !0);
            }
            h || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && im(this))
                ? ft(this, h)
        ...
        this.updatePluginViews(o),
            ...
            u == "reset" ? (this.dom.scrollTop = 0) : u == "to selection" ? this.scrollToSelection() : f && Fp(f);
    }
    scrollToSelection() {
    ...
    updateDraggedNode(e, n) {
        ...
        this.dragging = new Vr(e.slice, e.move, o < 0 ? void 0 : O.create(this.state.doc, o));
    }
    someProp(e, n) {
    ...
    focus() {
        this.domObserver.stop(), this.editable && $p(this.dom), ft(this), this.domObserver.start();
    }
    get root() {
        let e = this._root;
        if (e == null) {
    ...
    destroy() {
        this.docView &&
            ...
            this.mounted
                ? (this.docView.update(this.state.doc, [], Vi(this), this), (this.dom.textContent = ""))
    ...
    domSelectionRange() {
        ...
        return e
            ? (xe && this.root.nodeType === 11 && Dp(this.dom.ownerDocument) == this.dom && _m(this, e)) || e
...
function kc(t) {
    if (t.markCursor) {
        ...
        (e.className = "ProseMirror-separator"),
            ...
            e.setAttribute("alt", ""),
            (t.cursorWrapper = { dom: e, deco: Y.widget(t.state.selection.from, e, { raw: !0, marks: t.markCursor }) });
...
var ht = {
    ...
    eg = typeof navigator < "u" && /Mac/.test(navigator.platform),
    tg = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (re = 0; re < 10; re++) ht[48 + re] = ht[96 + re] = String(re);
var re;
for (re = 1; re <= 24; re++) ht[re + 111] = "F" + re;
var re;
for (re = 65; re <= 90; re++) (ht[re] = String.fromCharCode(re + 32)), (qr[re] = String.fromCharCode(re));
var re;
for (Jr in ht) qr.hasOwnProperty(Jr) || (qr[Jr] = ht[Jr]);
var Jr;
function nu(t) {
    var e = (eg && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) || (tg && t.shiftKey && t.key && t.key.length == 1) || t.key == "Unidentified",
        n = (!e && t.key) || (t.shiftKey ? qr : ht)[t.keyCode] || t.key || "Unidentified";
    return (
        n == "Esc" && (n = "Escape"),
        n == "Del" && (n = "Delete"),
        n == "Left" && (n = "ArrowLeft"),
...
var ng = typeof navigator < "u" && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
    rg = typeof navigator < "u" && /Win/.test(navigator.platform);
function og(t) {
    let e = t.split(/-(?!$)/),
        n = e[e.length - 1];
    n == "Space" && (n = " ");
...
function Xn(t) {
    ...
    return function (n, r) {
        ...
        if (o.length == 1 && o != " ") {
            ...
            if ((r.altKey || r.metaKey || r.ctrlKey) && !(rg && r.ctrlKey && r.altKey) && (i = ht[r.keyCode]) && i != o) {
                let l = e[gs(i, r)];
                if (l && l(n.state, n.dispatch, n)) return !0;
            }
        }
...
var Gr = (t, e) => (t.selection.empty ? !1 : (e && e(t.tr.deleteSelection().scrollIntoView()), !0));
function iu(t, e) {
...
var bs = (t, e, n) => {
        ...
        if (r.parent.content.size == 0 && (xn(i, "end") || O.isSelectable(i)))
            for (let s = r.depth; ; s--) {
                let l = $n(t.doc, r.before(s), r.after(s), M.empty);
                if (l && l.slice.size < l.to - l.from) {
                    if (e) {
                        let a = t.tr.step(l);
                        a.setSelection(xn(i, "end") ? E.findFrom(a.doc.resolve(a.mapping.map(o.pos, -1)), -1) : O.create(a.doc, o.pos - i.nodeSize)),
                            e(a.scrollIntoView());
                    }
                    return !0;
                }
...
var xs = (t, e, n) => {
    ...
    return !s || !O.isSelectable(s) ? !1 : (e && e(t.tr.setSelection(O.create(t.doc, i.pos - s.nodeSize)).scrollIntoView()), !0);
};
function ws(t) {
...
var Ss = (t, e, n) => {
        ...
        if (r.parent.content.size == 0 && (xn(i, "start") || O.isSelectable(i))) {
            let s = $n(t.doc, r.before(), r.after(), M.empty);
            if (s && s.slice.size < s.to - s.from) {
                if (e) {
                    let l = t.tr.step(s);
                    l.setSelection(xn(i, "start") ? E.findFrom(l.doc.resolve(l.mapping.map(o.pos)), 1) : O.create(l.doc, l.mapping.map(o.pos))),
                        e(l.scrollIntoView());
                }
                return !0;
            }
    ...
    ks = (t, e, n) => {
        ...
        let s = i && i.nodeAfter;
        return !s || !O.isSelectable(s) ? !1 : (e && e(t.tr.setSelection(O.create(t.doc, i.pos)).scrollIntoView()), !0);
    };
function Cs(t) {
    if (!t.parent.type.spec.isolating)
        for (let e = t.depth - 1; e >= 0; e--) {
...
var uu = (t, e) => {
        ...
        if (e) {
            let i = t.tr.join(o);
            r && i.setSelection(O.create(i.doc, o - t.doc.resolve(o).nodeBefore.nodeSize)), e(i.scrollIntoView());
        }
        return !0;
    },
    du = (t, e) => {
...
var Ts = (t, e) => {
    ...
    As = (t, e) => {
        let n = t.selection,
            { $from: r, $to: o } = n;
        if (n instanceof be || r.parent.inlineContent || o.parent.inlineContent) return !1;
        let i = vs(o.parent.contentMatchAt(o.indexAfter()));
...
function sg(t) {
    return (e, n) => {
        ...
        if (e.selection instanceof O && e.selection.node.isBlock)
            return !r.parentOffset || !Ae(e.doc, r.pos) ? !1 : (n && n(e.tr.split(r.pos).scrollIntoView()), !0);
        if (!r.depth) return !1;
        let i = [],
            s,
            l,
        ...
        for (let h = r.depth; ; h--)
            if (r.node(h).isBlock) {
                (a = r.end(h) == r.pos + (r.depth - h)),
                    ...
                    (l = vs(r.node(h - 1).contentMatchAt(r.indexAfter(h - 1))));
        ...
        let u = e.tr;
        (e.selection instanceof A || e.selection instanceof be) && u.deleteSelection();
        let d = u.mapping.map(r.pos),
            f = Ae(u.doc, d, i.length, i);
        if ((f || ((i[0] = l ? { type: l } : null), (f = Ae(u.doc, d, i.length, i))), !f)) return !1;
...
var hu = (t, e) => {
        let { $from: n, to: r } = t.selection,
            o,
            i = n.sharedDepth(r);
        return i == 0 ? !1 : ((o = n.before(i)), e && e(t.tr.setSelection(O.create(t.doc, o))), !0);
    },
    ag = (t, e) => (e && e(t.tr.setSelection(new be(t.doc))), !0);
function cg(t, e, n) {
    let r = e.nodeBefore,
        o = e.nodeAfter,
        i = e.index();
    return !r || !o || !r.type.compatibleContent(o.type)
        ...
        : !r.content.size && e.parent.canReplace(i - 1, i)
          ...
          : !e.parent.canReplace(i, i + 1) || !(o.isTextblock || Ne(t.doc, e.pos))
            ? !1
...
function pu(t, e, n, r) {
    ...
    if (c && (s = (l = o.contentMatchAt(o.childCount)).findWrapping(i.type)) && l.matchType(s[0] || i.type).validEnd) {
        if (n) {
            let h = e.pos + i.nodeSize,
                p = w.empty;
            for (let y = s.length - 1; y >= 0; y--) p = w.from(s[y].create(null, p));
            p = w.from(o.copy(p));
            let m = t.tr.step(new ne(e.pos - 1, h, e.pos, h, new M(p, 1, 0), s.length, !0)),
                g = m.doc.resolve(h + 2 * s.length);
            g.nodeAfter && g.nodeAfter.type == o.type && Ne(m.doc, g.pos) && m.join(g.pos), n(m.scrollIntoView());
        }
        return !0;
    }
    ...
    if (c && xn(i, "start", !0) && xn(o, "end")) {
        ...
        if (h.canReplace(h.childCount, h.childCount, m.content)) {
            if (n) {
                let y = w.empty;
                for (let x = p.length - 1; x >= 0; x--) y = w.from(p[x].copy(y));
                let b = t.tr.step(new ne(e.pos - p.length, e.pos + i.nodeSize, e.pos + g, e.pos + i.nodeSize - g, new M(y, p.length, 0), 0, !0));
                n(b.scrollIntoView());
            }
            return !0;
        }
...
function mu(t) {
    return function (e, n) {
        ...
        return o.node(i).isTextblock ? (n && n(e.tr.setSelection(A.create(e.doc, t < 0 ? o.start(i) : o.end(i)))), !0) : !1;
    };
}
var Os = mu(-1),
    Ns = mu(1);
...
for (let t in Ot) ug[t] = Ot[t];
var Hw = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : typeof os < "u" && os.platform ? os.platform() == "darwin" : !1;
...
function dg(t, e, n, r = null) {
    ...
    if (e.depth >= 2 && e.$from.node(e.depth - 1).type.compatibleContent(n) && e.startIndex == 0) {
        ...
        (i = new zt(a, a, e.depth)), e.endIndex < e.parent.childCount && (e = new zt(e.$from, s.resolve(e.$to.end(e.depth)), e.depth)), (o = !0);
    }
    let l = cn(i, n, r, e);
...
function fg(t, e, n, r, o) {
    let i = w.empty;
    for (let u = n.length - 1; u >= 0; u--) i = w.from(n[u].type.create(n[u].attrs, i));
    t.step(new ne(e.start - (r ? 2 : 0), e.end, e.start, e.end, new M(i, 0, 0), n.length, !0));
    let s = 0;
    ...
    for (let u = e.startIndex, d = e.endIndex, f = !0; u < d; u++, f = !1)
        !f && Ae(t.doc, a, l) && (t.split(a, l), (a += 2 * l)), (a += c.child(u).nodeSize);
    return t;
}
function bu(t) {
    return function (e, n) {
        ...
        return i ? (n ? (r.node(i.depth - 1).type == t ? hg(e, n, t, i) : pg(e, n, i)) : !0) : !1;
    };
}
function hg(t, e, n, r) {
    let o = t.tr,
        ...
        s = r.$to.end(r.depth);
    i < s &&
        (o.step(new ne(i - 1, s, i, s, new M(w.from(n.create(null, r.parent.copy())), 1, 0), 1, !0)),
        (r = new zt(o.doc.resolve(r.$from.pos), o.doc.resolve(s), r.depth)));
    let l = at(r);
    if (l == null) return !1;
    o.lift(r, l);
    let a = o.doc.resolve(o.mapping.map(i, -1) - 1);
    return Ne(o.doc, a.pos) && a.nodeBefore.type == a.nodeAfter.type && o.join(a.pos), e(o.scrollIntoView()), !0;
}
function pg(t, e, n) {
    let r = t.tr,
        o = n.parent;
    for (let h = n.end, p = n.endIndex - 1, m = n.startIndex; p > m; p--) (h -= o.child(p).nodeSize), r.delete(h - 1, h + 1);
    ...
    let l = n.startIndex == 0,
        ...
        c = i.node(-1),
        u = i.index(-1);
    if (!c.canReplace(u + (l ? 0 : 1), u + 1, s.content.append(a ? w.empty : w.from(o)))) return !1;
    let d = i.pos,
        f = d + s.nodeSize;
    return (
        r.step(
            new ne(
                ...
                d + 1,
                f - 1,
                new M((l ? w.empty : w.from(o.copy(w.empty))).append(a ? w.empty : w.from(o.copy(w.empty))), l ? 0 : 1, a ? 0 : 1),
                l ? 0 : 1,
            ),
        ),
        e(r.scrollIntoView()),
    ...
    return function (e, n) {
        ...
        if (n) {
            let c = a.lastChild && a.lastChild.type == l.type,
                ...
                d = new M(w.from(t.create(null, w.from(l.type.create(null, u)))), c ? 3 : 1, 0),
                f = i.start,
                h = i.end;
...
var mg = Object.defineProperty,
    Au = (t, e) => {
        for (var n in e) mg(t, n, { get: e[n], enumerable: !0 });
    };
function ro(t) {
...
var oo = class {
        ...
        createChain(t, e = !0) {
            let { rawCommands: n, editor: r, state: o } = this,
                ...
                l = !!t,
                a = t || o.tr,
                c = () => (!l && e && !a.getMeta("preventDispatch") && !this.hasCustomState && i.dispatch(a), s.every((d) => d === !0)),
                u = {
                    ...Object.fromEntries(
        ...
        createCan(t) {
            ...
            return {
                ...Object.fromEntries(Object.entries(e).map(([l, a]) => [l, (...c) => a(...c)({ ...i, dispatch: void 0 })])),
...
var Eu = (t) => {
    ...
    for (let n = e.length - 1; n >= 0; n -= 1) {
        let r = e[n];
        r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? t.removeChild(r) : r.nodeType === 1 && Eu(r);
    }
    return t;
};
function Yr(t) {
...
function Qn(t, e, n) {
    ...
    if (r)
        try {
            if (Array.isArray(t) && t.length > 0) return w.fromArray(t.map((l) => e.nodeFromJSON(l)));
            ...
            return console.warn("[tiptap warn]: Invalid content.", "Passed value:", t, "Error:", i), Qn("", e, n);
        }
    if (o) {
                ...
                a = new sn({
                    ...
                    nodes: e.spec.nodes.append({
                        __tiptap__private__unknown__catch__all__node: {
                            content: "inline*",
                            group: "block",
                            parseDOM: [{ tag: "*", getAttrs: (c) => ((s = !0), (l = typeof c == "string" ? c : c.outerHTML), null) }],
                        },
                    }),
                });
            if (
                (n.slice ? Ue.fromSchema(a).parseSlice(Yr(t), n.parseOptions) : Ue.fromSchema(a).parse(Yr(t), n.parseOptions),
        ...
        return n.slice ? i.parseSlice(Yr(t), n.parseOptions).content : i.parse(Yr(t), n.parseOptions);
    }
    return Qn("", e, n);
}
function Bs(t, e, n = {}, r = {}) {
    return Qn(t, e, { slice: !1, parseOptions: n, errorOnInvalidContent: r.errorOnInvalidContent });
}
function er(t) {
...
function I(t, e, n) {
    return t.config[e] === void 0 && t.parent
        ...
        : typeof t.config[e] == "function"
          ? t.config[e].bind({ ...n, parent: t.parent ? I(t.parent, e, n) : null })
          : t.config[e];
}
function $s(t) {
    return t
...
function Ru(t) {
    let e = [],
        { nodeExtensions: n, markExtensions: r } = Zn(t),
        o = [...n, ...r],
        i = { default: null, validate: void 0, rendered: !0, renderHTML: null, parseHTML: null, keepOnSplit: !0, isRequired: !1 };
    return (
        t.forEach((s) => {
            let l = { name: s.name, options: s.options, storage: s.storage, extensions: o },
    ...
    return "style" in t
        ...
        : {
              ...
              getAttrs: (n) => {
                  ...
                  if (r === !1) return !1;
                  let o = e.reduce((i, s) => {
                      let l = s.attribute.parseHTML ? s.attribute.parseHTML(n) : bg(n.getAttribute(s.name));
...
function Su(t) {
    return Object.fromEntries(Object.entries(t).filter(([e, n]) => (e === "attrs" && yg(n) ? !1 : n != null)));
}
function xg(t, e) {
    var n;
    let r = Ru(t),
        { nodeExtensions: o, markExtensions: i } = Zn(t),
                            ...
                            u.map((y) => {
                                ...
                                return [
                                    y.name,
                                    {
                                        ...
                                        validate: (x = y?.attribute) == null ? void 0 : x.validate,
                                    },
                                ];
                            }),
                        ),
        ...
        a = Object.fromEntries(
            i.map((c) => {
                        ...
                        attrs: Object.fromEntries(
                            u.map((g) => {
                                ...
                                return [
                                    g.name,
                                    {
                                        default: (y = g?.attribute) == null ? void 0 : y.default,
                                        validate: (b = g?.attribute) == null ? void 0 : b.validate,
                                    },
                                ];
                            }),
                        ),
                ...
                let m = I(c, "renderHTML", d);
                return m && (h.toDOM = (g) => m({ mark: g, HTMLAttributes: to(g, u) })), [c.name, h];
            }),
        );
...
function Du(t) {
    let e = Ws($s(t)),
        n = wg(e.map((r) => r.name));
    return (
        n.length && console.warn(`[tiptap warn]: Duplicate extension names found: [${n.map((r) => `'${r}'`).join(", ")}]. This can lead to issues.`),
        e
    );
}
function Pu(t, e, n) {
...
function _s(t, e) {
    let n = io(typeof e == "string" ? e : e.name, t.schema);
...
function no(t, e, n = { strict: !0 }) {
    let r = Object.keys(e);
    return r.length ? r.every((o) => (n.strict ? e[o] === t[o] : Ks(e[o]) ? e[o].test(t[o]) : e[o] === t[o])) : !0;
}
function Bu(t, e, n = {}) {
    return t.find((r) => r.type === e && no(Object.fromEntries(Object.keys(n).map((o) => [o, r.attrs[o]])), n));
}
function ku(t, e, n = {}) {
    return !!Bu(t, e, n);
}
function Us(t, e, n) {
    ...
    if (
        ((!o.node || !o.node.marks.some((u) => u.type === e)) && (o = t.parent.childBefore(t.parentOffset)),
        !o.node ||
            !o.node.marks.some((u) => u.type === e) ||
            ((n = n || ((r = o.node.marks[0]) == null ? void 0 : r.attrs)), !Bu([...o.node.marks], e, n)))
    )
        return;
    let s = o.index,
        l = t.start() + o.offset,
        a = s + 1,
        c = l + o.node.nodeSize;
    for (; s > 0 && ku([...t.parent.child(s - 1).marks], e, n); ) (s -= 1), (l -= t.parent.child(s).nodeSize);
    for (; a < t.parent.childCount && ku([...t.parent.child(a).marks], e, n); ) (c += t.parent.child(a).nodeSize), (a += 1);
    return { from: l, to: c };
}
function so(t, e, n) {
    let r = [];
    return (
        t === e
            ...
            : n.nodesBetween(t, e, (o, i) => {
                  !o || o?.nodeSize === void 0 || r.push(...o.marks.map((s) => ({ from: i, to: i + o.nodeSize, mark: s })));
              }),
        r
    );
}
...
var vg = (t, e = 500) => {
    ...
    return (
        t.parent.nodesBetween(Math.max(0, r - e), r, (o, i, s, l) => {
            var a, c;
            let u =
                ((c = (a = o.type.spec).toText) == null ? void 0 : c.call(a, { node: o, pos: i, parent: s, index: l })) || o.textContent || "%leaf%";
        ...
        (o.forEach(({ $from: d, $to: f }) => {
            ...
            t.doc.nodesBetween(h, p, (m, g) => {
                ...
                let y = Math.max(h, g),
                    ...
                    x = b - y;
                (s += x), l.push(...m.marks.map((C) => ({ mark: C, from: y, to: b })));
            });
        }),
        s === 0)
    )
...
function Ge(t, e, n = {}) {
    ...
    let a = o - r,
        c = l.filter((d) => (s ? s.name === d.node.type.name : !0)).filter((d) => no(d.node.attrs, n, { strict: !1 }));
...
function tr(t, { checkChildren: e = !0, ignoreWhitespace: n = !1 } = {}) {
    ...
    if (e) {
        ...
        return (
            t.content.forEach((i) => {
                o !== !1 && (tr(i, { ignoreWhitespace: n, checkChildren: e }) || (o = !1));
            }),
            o
        );
    }
...
function $u(t, e, n) {
    let o = t.state.doc.content.size,
        ...
        h = f - d,
        p = u - c,
        y = { top: c, bottom: u, left: d, right: f, width: h, height: p, x: d, y: c };
    return { ...y, toJSON: () => y };
}
function Vu(t, e = null) {
    ...
    let o = n.from,
        i = r.to;
    return e === "all" ? A.create(t, pt(0, o, i), pt(t.content.size, o, i)) : A.create(t, pt(e, o, i), pt(e, o, i));
}
function Tg(t, e, n) {
    let r = t.steps.length - 1;
    if (r < e) return;
...
var co = class {
    ...
    Ag = (t, e) => {
        ...
        return (
            ...
            (r.data = n.data),
            n.replaceWith &&
                (n.text.includes(n.replaceWith) || console.warn('[tiptap warn]: "inputRuleMatch.replaceWith" must be part of "inputRuleMatch.text".'),
...
function Xr(t) {
    ...
    return (
        s.forEach((f) => {
            ...
            if (!h) return;
            let p = a.state.tr,
                m = ro({ state: a.state, transaction: p }),
                g = { from: r - (h[0].length - i.length), to: o },
                { commands: y, chain: b, can: x } = new oo({ editor: n, state: m });
            f.handler({ state: m, range: g, match: h, commands: y, chain: b, can: x }) === null ||
                !p.steps.length ||
                (p.setMeta(l, { transform: p, from: r, to: o, text: i }), a.dispatch(p), (u = !0));
        }),
        u
    );
}
        ...
        r = new N({
                ...
                apply(o, i, s) {
                    ...
                    return (
                        !!a &&
                            setTimeout(() => {
                                let { text: u } = a;
                                typeof u == "string" ? (u = u) : (u = Vs(w.from(u), s.schema));
                                let { from: d } = a,
                                    f = d + u.length;
                                Xr({ editor: e, from: d, to: f, text: u, rules: n, plugin: r });
                            }),
            ...
            props: {
                handleTextInput(o, i, s, l) {
                    return Xr({ editor: e, from: i, to: s, text: l, rules: n, plugin: r });
                },
                handleDOMEvents: {
                    compositionend: (o) => (
                        setTimeout(() => {
                            let { $cursor: i } = o.state.selection;
                            i && Xr({ editor: e, from: i.pos, to: i.pos, text: "", rules: n, plugin: r });
                        }),
                        !1
                    ),
                },
...
function Qr(t) {
    return Og(t) !== "Object" ? !1 : t.constructor === Object && Object.getPrototypeOf(t) === Object.prototype;
}
function Wu(t, e) {
    let n = { ...t };
    return (
...
var qs = class {
        ...
        get storage() {
            return { ...(W(I(this, "addStorage", { name: this.name, options: this.options })) || {}) };
        }
        configure(t = {}) {
            let e = this.extend({ ...this.config, addOptions: () => Wu(this.options, t) });
...
function Pg(t) {
    let { editor: e, state: n, from: r, to: o, rule: i, pasteEvent: s, dropEvent: l } = t,
        { commands: a, chain: c, can: u } = new oo({ editor: e, state: n }),
        d = [];
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            ...
            Dg(y, i.find, s).forEach((x) => {
                ...
                let C = m + x.index + 1,
                    ...
                    P = i.handler({ state: n, range: R, match: x, commands: a, chain: c, can: u, pasteEvent: s, dropEvent: l });
                d.push(P);
            });
        }),
        d.every((h) => h !== null)
...
function Lg(t) {
    ...
    let a = ({ state: u, from: d, to: f, rule: h, pasteEvt: p }) => {
        let m = u.tr,
            g = ro({ state: u, transaction: m });
        if (!(!Pg({ editor: e, state: g, from: Math.max(d - 1, 0), to: f.b - 1, rule: h, pasteEvent: p, dropEvent: l }) || !m.steps.length)) {
            try {
                l = typeof DragEvent < "u" ? new DragEvent("drop") : null;
            } catch {
                l = null;
        ...
        (u) =>
            new N({
                view(d) {
                    let f = (p) => {
                            var m;
                            (r = (m = d.dom.parentElement) != null && m.contains(p.target) ? d.dom.parentElement : null), r && (Zr = e);
                        },
                        h = () => {
                            Zr && (Zr = null);
                        };
                ...
                appendTransaction: (d, f, h) => {
                    ...
                    if (b) {
                        let { text: S } = y;
                        typeof S == "string" ? (S = S) : (S = Vs(w.from(S), h.schema));
                        let { from: R } = y,
                            P = R + S.length,
                            v = Ig(S);
                        return a({ rule: u, state: h, from: R, to: { b: P }, pasteEvt: v });
                    }
                    let x = f.doc.content.findDiffStart(h.doc.content),
                        C = f.doc.content.findDiffEnd(h.doc.content);
                    if (!(!Ng(x) || !C || x === C.b)) return a({ rule: u, state: h, from: x, to: C, pasteEvt: s });
                },
            }),
    );
}
var uo = class {
    constructor(t, e) {
        (this.splittableMarks = []), (this.editor = e), (this.extensions = Du(t)), (this.schema = xg(this.extensions, e)), this.setupExtensions();
    }
    get commands() {
            ...
            o = e
                .map((i) => {
                    let s = {
                        ...
                        c = {};
                    if ((i.type === "mark" && I(i, "exitable", s) && (c.ArrowRight = () => te.handleExit({ editor: t, mark: i })), a)) {
                        let p = Object.fromEntries(Object.entries(a()).map(([m, g]) => [m, () => g({ editor: t })]));
                        c = { ...c, ...p };
                    }
                    let u = ru(c);
                    l.push(u);
                ...
                .flat();
        return [Eg({ editor: t, rules: n }), ...Lg({ editor: t, rules: r }), ...o];
    }
    get attributes() {
    ...
    get nodeViews() {
        let { editor: t } = this,
            { nodeExtensions: e } = Zn(this.extensions);
        return Object.fromEntries(
            e
                ...
                .map((n) => {
                    ...
                    let s = (l, a, c, u, d) => {
                        let f = to(l, r);
                        return i()({ node: l, view: a, getPos: c, decorations: u, innerDecorations: d, editor: t, extension: n, HTMLAttributes: f });
                    };
                    return [n.name, s];
                }),
        );
    ...
    get markViews() {
        let { editor: t } = this,
            { markExtensions: e } = Zn(this.extensions);
        return Object.fromEntries(
            e
    ...
    setupExtensions() {
        ...
        (this.editor.extensionStorage = Object.fromEntries(t.map((e) => [e.name, e.storage]))),
            t.forEach((e) => {
                ...
                e.type === "mark" && ((n = W(I(e, "keepOnSplit", r))) == null || n) && this.splittableMarks.push(e.name);
...
var zg =
    ...
    Wg =
        ...
        ({ editor: n, tr: r }) => {
            ...
            return r.insert(s, i.content), r.setSelection(new A(r.doc.resolve(Math.max(s - 1, 0)))), !0;
        },
    _g =
        () =>
        ({ tr: t, dispatch: e }) => {
...
var Qg =
    ...
    ny =
        ...
        ({ tr: r, dispatch: o, editor: i }) => {
            var s;
            if (o) {
                n = { parseOptions: i.options.parseOptions, updateSelection: !0, applyInputRules: !1, applyPasteRules: !1, ...n };
                let l,
                    { selection: a } = i.state,
                    c = (y) => {
                        i.emit("contentError", {
                ...
                if (!n.errorOnInvalidContent && !i.options.enableContentCheck && i.options.emitContentError)
                    try {
                        Qn(e, i.schema, { parseOptions: u, errorOnInvalidContent: !0 });
                    } catch (y) {
                        c(y);
                    }
                try {
                ...
                let { from: d, to: f } = typeof t == "number" ? { from: t, to: t } : { from: t.from, to: t.to },
                    h = !0,
                    p = !0;
                if (
                    ((ty(l) ? l : [l]).forEach((y) => {
                    ...
                    y.isTextblock && !y.type.spec.code && !y.childCount && ((d -= 1), (f += 1));
                }
                let g;
                if (h) {
                    ...
                    y && b && x && (d = Math.max(0, d - 1)), r.replaceWith(d, f, g);
                }
                n.updateSelection && Tg(r, r.steps.length - 1, -1),
                    n.applyInputRules && r.setMeta("applyInputRules", { from: d, text: g }),
                    n.applyPasteRules && r.setMeta("applyPasteRules", { from: d, text: g });
            }
            return !0;
        },
    ry =
...
var yy =
        ...
        ({ tr: n, state: r, dispatch: o }) => {
            let i = null,
                s = null,
                l = io(typeof t == "string" ? t : t.name, r.schema);
            return l
                  ...
                  o &&
                      n.selection.ranges.forEach((a) => {
                          r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, u) => {
                              i && i === c.type && n.setNodeMarkup(u, void 0, vu(c.attrs, e)),
                                  s &&
                                      c.marks.length &&
                                      c.marks.forEach((d) => {
                                          s === d.type && n.addMark(u, u + c.nodeSize, s.create(vu(d.attrs, e)));
                                      });
                          });
                      }),
                  !0)
    ...
    vy =
        ...
        ({ editor: o, tr: i, dispatch: s, commands: l }) => {
            ...
            if (r.preserveWhitespace !== "full") {
                let c = Bs(t, o.schema, r, { errorOnInvalidContent: e ?? o.options.enableContentCheck });
                return s && i.replaceWith(0, a.content.size, c).setMeta("preventUpdate", !n), !0;
            }
            return (
                s && i.setMeta("preventUpdate", !n),
                l.insertContentAt({ from: 0, to: a.content.size }, t, { parseOptions: r, errorOnInvalidContent: e ?? o.options.enableContentCheck })
            );
        };
function Ty(t, e, n) {
    var r;
    ...
    Oy =
        ...
        ({ state: n, dispatch: r, chain: o }) => {
            ...
            return (
                ...
                i.isTextblock
                    ? o()
                          .command(({ commands: l }) => (Rs(i, { ...s, ...e })(n) ? !0 : l.clearNodes()))
...
var Py =
        ...
        ({ tr: e, state: n, dispatch: r, editor: o }) => {
            let { selection: i, doc: s } = e,
                ...
                u = eo(c, l.node().type.name, l.node().attrs);
            if (i instanceof O && i.node.isBlock)
                return !l.parentOffset || !Ae(s, l.pos)
                    ? !1
                    : (r && (t && Tu(n, o.extensionManager.splittableMarks), e.split(l.pos).scrollIntoView()), !0);
            if (!l.parent.isBlock) return !1;
            let d = a.parentOffset === a.parent.content.size,
                f = l.depth === 0 ? void 0 : er(l.node(-1).contentMatchAt(l.indexAfter(-1))),
                h = d && f ? [{ type: f, attrs: u }] : void 0,
                p = Ae(e.doc, e.mapping.map(l.pos), 1, h);
            if (
                (!h && !p && Ae(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) && ((p = !0), (h = f ? [{ type: f, attrs: u }] : void 0)),
                r)
            ) {
                if (
                    p &&
                    (i instanceof A && e.deleteSelection(), e.split(e.mapping.map(l.pos), 1, h), f && !d && !l.parentOffset && l.parent.type !== f)
                ) {
                    let m = e.mapping.map(l.before()),
                        g = e.doc.resolve(m);
                    l.node(-1).canReplaceWith(g.index(), g.index() + 1, f) && e.setNodeMarkup(e.mapping.map(l.before()), f);
                }
                t && Tu(n, o.extensionManager.splittableMarks), e.scrollIntoView();
            }
            return p;
        },
    Iy =
        ...
        ({ tr: n, state: r, dispatch: o, editor: i }) => {
            ...
            if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
                ...
                if (o) {
                    ...
                    for (let v = a.depth - b; v >= a.depth - 3; v -= 1) y = w.from(a.node(v).copy(y));
                    let x = a.indexAfter(-1) < a.node(-2).childCount ? 1 : a.indexAfter(-2) < a.node(-3).childCount ? 2 : 3,
                        C = { ...eo(f, a.node().type.name, a.node().attrs), ...e },
                        S = ((s = l.contentMatch.defaultType) == null ? void 0 : s.createAndFill(C)) || void 0;
            ...
            let h = c.pos === a.end() ? d.contentMatchAt(0).defaultType : null,
                p = { ...eo(f, d.type.name, d.attrs), ...e },
                m = { ...eo(f, a.node().type.name, a.node().attrs), ...e };
    ...
    Ly =
        (t, e, n, r = {}) =>
        ({ editor: o, tr: i, state: s, dispatch: l, chain: a, commands: c, can: u }) => {
            ...
            if (!x) return !1;
            let S = Ye((R) => Mu(R.type.name, d))(m);
            if (x.depth >= 1 && S && x.depth - S.depth <= 1) {
                if (S.node.type === h) return c.liftListItem(p);
                if (Mu(S.node.type.name, d) && h.validContent(S.node.content) && l)
                    return a()
    ...
    By =
        ...
        ({ state: r, commands: o }) => {
            let { extendEmptyMarkRange: i = !1 } = n,
                s = mt(t, r.schema);
            return zs(r, s, e) ? o.unsetMark(s, { extendEmptyMarkRange: i }) : o.setMark(s, e);
        },
    zy =
        (t, e, n = {}) =>
        ({ state: r, commands: o }) => {
                  ...
                  o &&
                      n.selection.ranges.forEach((a) => {
                          ...
                          n.selection.empty
                              ...
                              : r.doc.nodesBetween(c, u, (m, g) => {
                                    g < c && i && i === m.type && ((h = Math.max(g, c)), (p = Math.min(g + m.nodeSize, u)), (d = g), (f = m)),
                                        g >= c &&
                                            g <= u &&
                                            (i && i === m.type && n.setNodeMarkup(g, void 0, { ...m.attrs, ...e }),
                                            s &&
                                                m.marks.length &&
                                                m.marks.forEach((y) => {
                                                    if (s === y.type) {
                                                        let b = Math.max(g, c),
                                                            x = Math.min(g + m.nodeSize, u);
                                                        n.addMark(b, x, s.create({ ...y.attrs, ...e }));
                                                    }
                                                }));
                                }),
                              f &&
                                  ...
                                  s &&
                                      f.marks.length &&
                                      f.marks.forEach((m) => {
                                          s === m.type && n.addMark(h, p, s.create({ ...m.attrs, ...e }));
                                      }));
                      }),
                  !0)
                : !1;
        ...
        onUpdate({ transaction: t, appendedTransactions: e }) {
            ...
            let i = () => {
                ...
                if (
                    (c =
                        (a =
                            (l = (s = this.editor.options.coreExtensionOptions) == null ? void 0 : s.delete) == null
                                ? void 0
                ...
                u.steps.forEach((h, p) => {
                    ...
                    if (h instanceof lt) {
                        let y = f.slice(p).map(h.from, -1),
                            ...
                            x = f.invert().map(y, -1),
                            C = f.invert().map(b),
                            S = (m = u.doc.nodeAt(y - 1)) == null ? void 0 : m.marks.some((P) => P.eq(h.mark)),
                            R = (g = u.doc.nodeAt(b)) == null ? void 0 : g.marks.some((P) => P.eq(h.mark));
                        this.editor.emit("delete", {
                            type: "mark",
                            mark: h.mark,
                            from: h.from,
            ...
            (o = (r = (n = this.editor.options.coreExtensionOptions) == null ? void 0 : n.delete) == null ? void 0 : r.async) == null || o
                ? setTimeout(i, 0)
                : i();
        },
    }),
    ...
    Xu = $.create({
        name: "editable",
        addProseMirrorPlugins() {
            return [new N({ key: new L("editable"), props: { editable: () => this.editor.options.editable } })];
        },
    }),
    Qu = new L("focusEvents"),
    Zu = $.create({
        name: "focusEvents",
        addProseMirrorPlugins() {
            let { editor: t } = this;
                        ...
                        () =>
                            s.command(({ tr: l }) => {
                                let { selection: a, doc: c } = l,
                                    ...
                                    y = m && p.parent.childCount === 1 ? g === d.pos : E.atStart(c).from === f;
                                return !u || !h.type.isTextblock || h.textContent.length || !y || (y && d.parent.type.name === "paragraph")
                                    ? !1
                                    : s.clearNodes();
                            }),
                        () => s.deleteSelection(),
            ...
            return [
                new N({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        let f = n.tr,
                            h = ro({ state: n, transaction: f }),
                            { commands: p } = new oo({ editor: this.editor, state: h });
    ...
    nd = $.create({
        name: "tabindex",
        addProseMirrorPlugins() {
            return [new N({ key: new L("tabindex"), props: { attributes: () => (this.editor.isEditable ? { tabindex: "0" } : {}) } })];
        },
    }),
    Ky = class wn {
        ...
        get children() {
            ...
            return (
                this.node.content.forEach((n, r) => {
                    ...
                    o && (a.actualDepth = this.depth + 1), e.push(new wn(l, this.editor, o, o ? n : null));
                }),
                e
            );
        }
...
var rd = class extends gg {
    constructor(t = {}) {
        ...
        let e = this.createDoc(),
            n = Vu(e, this.options.autofocus);
        (this.editorState = Ir.create({ doc: e, schema: this.schema, selection: n || void 0 })),
    ...
    unmount() {
        ...
        (this.editorView = null), (this.isInitialized = !1), (t = this.css) == null || t.remove(), (this.css = null);
    }
    get storage() {
    ...
    injectCSS() {
        this.options.injectCSS && typeof document < "u" && (this.css = Jy(Uy, this.options.injectNonce));
    }
    setOptions(t = {}) {
    ...
    registerPlugin(t, e) {
        let n = Nu(e) ? e(t, [...this.state.plugins]) : [...this.state.plugins, t],
        ...
        let r = [
            ...(this.options.enableCoreExtensions
                ? [
                      ...
                      Ku.configure({
                          blockSeparator:
                              (e = (t = this.options.coreExtensionOptions) == null ? void 0 : t.clipboardTextSerializer) == null
                                  ? void 0
                                  : e.blockSeparator,
                      }),
                      qu,
            ...
            this.emit("contentError", {
                ...
                disableCollaboration: () => {
                    "collaboration" in this.storage &&
                        ...
                        (this.options.extensions = this.options.extensions.filter((n) => n.name !== "collaboration")),
                        this.createExtensionManager();
                },
            }),
    ...
    createView(t) {
        ...
        this.editorView = new qn(t, {
            ...
            attributes: { role: "textbox", ...((e = this.options.editorProps) == null ? void 0 : e.attributes) },
            dispatchTransaction: this.dispatchTransaction.bind(this),
            state: this.editorState,
        });
        let n = this.state.reconfigure({ plugins: this.extensionManager.plugins });
        this.view.updateState(n), this.createNodeViews(), this.prependClass(), this.injectCSS();
        let r = this.view.dom;
        r.editor = this;
    }
    createNodeViews() {
    ...
    dispatchTransaction(t) {
        ...
        let { state: e, transactions: n } = this.state.applyTransaction(t),
            ...
            o = n.includes(t),
            i = this.state;
        if ((this.emit("beforeTransaction", { editor: this, transaction: t, nextState: e }), !o)) return;
...
`,
        ...
        return Sg(this.state.doc, { blockSeparator: e, textSerializers: { ...Iu(this.schema), ...n } });
    }
    get isEmpty() {
...
function Xe(t) {
    return new co({
        ...
        handler: ({ state: e, range: n, match: r, chain: o }) => {
            ...
            if (t.keepAttributes) {
                let d = t.type.name === "bulletList" || t.type.name === "orderedList" ? "listItem" : "taskList";
                o().updateAttributes(d, i).run();
            }
            let u = s.doc.resolve(n.from - 1).nodeBefore;
            u && u.type === t.type && Ne(s.doc, n.from - 1) && (!t.joinPredicate || t.joinPredicate(r, u)) && s.join(n.from - 1);
        },
    });
}
function od(t, e) {
...
function Gy(t) {
    for (let e = t.depth; e >= 0; e--) {
        ...
        for (let o = r.child(n - 1); ; o = o.lastChild) {
            if ((o.childCount == 0 && !o.inlineContent) || o.isAtom || o.type.spec.isolating) return !0;
...
var Xy = Xn({ ArrowLeft: ho("horiz", -1), ArrowRight: ho("horiz", 1), ArrowUp: ho("vert", -1), ArrowDown: ho("vert", 1) });
function ho(t, e) {
...
function Qy(t, e, n) {
    ...
    return o && o.inside > -1 && O.isSelectable(t.state.doc.nodeAt(o.inside)) ? !1 : (t.dispatch(t.state.tr.setSelection(new se(r))), !0);
}
function Zy(t, e) {
    if (e.inputType != "insertCompositionText" || !(t.state.selection instanceof se)) return !1;
    let { $from: n } = t.state.selection,
        r = n.parent.contentMatchAt(n.index()).findWrapping(t.state.schema.nodes.text);
    if (!r) return !1;
    let o = w.empty;
    for (let s = r.length - 1; s >= 0; s--) o = w.from(r[s].createAndFill(null, o));
...
function e0(t) {
    ...
    return (e.className = "ProseMirror-gapcursor"), J.create(t.doc, [Y.widget(t.selection.head, e, { key: "gapcursor" })]);
}
var po = 200,
    de = function () {};
de.prototype.append = function (e) {
    return e.length
        ? ((e = de.from(e)),
          (!this.length && e) || (e.length < po && this.leafAppend(e)) || (this.length < po && e.leafPrepend(this)) || this.appendInner(e))
        : this;
};
...
de.prototype.slice = function (e, n) {
    return e === void 0 && (e = 0), n === void 0 && (n = this.length), e >= n ? de.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, n));
};
...
var cd = (function (t) {
    ...
    return (
        ...
        (e.prototype.leafAppend = function (o) {
            if (this.length + o.length <= po) return new e(this.values.concat(o.flatten()));
        }),
        (e.prototype.leafPrepend = function (o) {
            if (this.length + o.length <= po) return new e(o.flatten().concat(this.values));
        }),
        ...
        return (
            ...
            (e.prototype.forEachInner = function (r, o, i, s) {
                ...
                if (
                    ...
                    (i > l && this.right.forEachInner(r, Math.max(o - l, 0), Math.min(this.length, i) - l, s + l) === !1)
                )
                    return !1;
            }),
...
var n0 = 500,
    Yt = class t {
                ...
                this.items.forEach(
                    (d, f) => {
                        ...
                        if (o) {
                            ...
                            h &&
                                s.maybeStep(h).doc &&
                                ((p = s.mapping.maps[s.mapping.maps.length - 1]), c.push(new Qe(p, void 0, void 0, c.length + u.length))),
                                i--,
                                p && o.appendMap(p, i);
                        ...
                        if (d.selection)
                            return (
                                ...
                                (a = new t(this.items.slice(0, r).append(u.reverse().concat(c)), this.eventCount - 1)),
                                !1
                            );
                    },
                    this.items.length,
        ...
        addMaps(e) {
            return this.eventCount == 0 ? this : new t(this.items.append(e.map((n) => new Qe(n))), this.eventCount);
        }
        rebased(e, n) {
...
function i0(t, e, n, r) {
    ...
    if (s && s.getMeta(Gt))
        return s.getMeta(Gt).redo
            ? new Ze(t.done.addTransform(n, void 0, r, mo(e)), t.undone, ud(n.mapping.maps), t.prevTime, t.prevComposition)
            : new Ze(t.done, t.undone.addTransform(n, void 0, r, mo(e)), null, t.prevTime, t.prevComposition);
    if (n.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
        let l = n.getMeta("composition"),
            a = t.prevTime == 0 || (!s && t.prevComposition != l && (t.prevTime < (n.time || 0) - r.newGroupDelay || !s0(n, t.prevRanges))),
            c = s ? Zs(t.prevRanges, n.mapping) : ud(n.mapping.maps);
        return new Ze(t.done.addTransform(n, a ? e.selection.getBookmark() : void 0, r, mo(e)), Yt.empty, c, n.time, l ?? t.prevComposition);
    } else
        return (i = n.getMeta("rebased"))
            ? new Ze(t.done.rebased(n, i), t.undone.rebased(n, i), Zs(t.prevRanges, n.mapping), t.prevTime, t.prevComposition)
            : new Ze(t.done.addMaps(n.mapping.maps), t.undone.addMaps(n.mapping.maps), Zs(t.prevRanges, n.mapping), t.prevTime, t.prevComposition);
}
function s0(t, e) {
    if (!e) return !1;
...
function ud(t) {
    let e = [];
    for (let n = t.length - 1; n >= 0 && e.length == 0; n--) t[n].forEach((r, o, i, s) => e.push(i, s));
    return e;
}
function Zs(t, e) {
    if (!t) return null;
...
function l0(t, e, n) {
    ...
    return i.transform.setSelection(s).setMeta(Gt, { redo: n, historyState: a });
}
var el = !1,
    dd = null;
function mo(t) {
        ...
        new N({
            ...
            props: {
                handleDOMEvents: {
                    beforeinput(e, n) {
                        let r = n.inputType,
                            o = r == "historyUndo" ? tl : r == "historyRedo" ? nl : null;
...
var I1 = $.create({
        name: "characterCount",
        addOptions() {
            return { limit: null, mode: "textSize", textCounter: (t) => t.length, wordCounter: (t) => t.split(" ").filter((e) => e !== "").length };
        },
        addStorage() {
                        ...
                        decorations: ({ doc: t, selection: e }) => {
                            ...
                            return (
                                t.descendants((a, c) => {
                                    ...
                                    i.push(Y.node(c, c + a.nodeSize, { class: this.options.className }));
                                }),
                                J.create(t, i)
                            );
                        },
    ...
    md = $.create({
        ...
        extendNodeSchema(t) {
            ...
            return { allowGapCursor: (e = W(I(t, "allowGapCursor", n))) != null ? e : null };
        },
    }),
    rl = $.create({
        name: "placeholder",
                                        ...
                                        let d = Y.node(l, l + s.nodeSize, {
                                            ...
                                            "data-placeholder":
                                                typeof this.options.placeholder == "function"
                                                    ? this.options.placeholder({ editor: this.editor, node: s, pos: l, hasAnchor: a })
        ...
        addProseMirrorPlugins() {
            ...
            return [
                new N({
                    ...
                    props: {
                        decorations(n) {
                            return n.selection.empty || t.isFocused || !t.isEditable || lo(n.selection) || t.view.dragging
                                ? null
                                : J.create(n.doc, [Y.inline(n.selection.from, n.selection.to, { class: e.className })]);
                        },
                    },
                }),
            ];
        ...
        addProseMirrorPlugins() {
            let t = new L(this.name),
                e = Object.entries(this.editor.schema.nodes)
                    .map(([, n]) => n)
                    .filter((n) => (this.options.notAfter || []).concat(this.options.node).includes(n.name));
            return [
                new N({
                    key: t,
...
var c0 = /^\s*>\s$/,
    u0 = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return kn("blockquote", { ...T(this.options.HTMLAttributes, t), children: kn("slot", {}) });
        },
        addCommands() {
            return {
                setBlockquote:
...
var d0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
    ...
    m0 = te.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return kn("strong", { ...T(this.options.HTMLAttributes, t), children: kn("slot", {}) });
        },
        addCommands() {
            return {
                setBold:
        ...
        addInputRules() {
            return [Ie({ find: d0, type: this.type }), Ie({ find: h0, type: this.type })];
        },
        addPasteRules() {
            return [Ce({ find: f0, type: this.type }), Ce({ find: p0, type: this.type })];
        },
    }),
    bd = m0;
var g0 = /(^|[^`])`([^`]+)`(?!`)/,
                ...
                language: {
                    ...
                    parseHTML: (t) => {
                        ...
                        let { languageClassPrefix: n } = this.options,
                            i = [...(((e = t.firstElementChild) == null ? void 0 : e.classList) || [])]
...
`);
                ...
                ArrowDown: ({ editor: t }) => {
                    ...
                    let { state: e } = t,
                        { selection: n, doc: r } = e,
                        { $from: o, empty: i } = n;
                    if (!i || o.parent.type !== this.type || !(o.parentOffset === o.parent.nodeSize - 2)) return !1;
                    let l = o.after();
                    return l === void 0
                        ? !1
                        : r.nodeAt(l)
                          ? t.commands.command(({ tr: c }) => (c.setSelection(E.near(r.resolve(l))), !0))
                          : t.commands.exitCode();
                },
            };
        },
        addInputRules() {
            return [
                nr({ find: x0, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
                nr({ find: w0, type: this.type, getAttributes: (t) => ({ language: t[1] }) }),
            ];
        },
        addProseMirrorPlugins() {
            return [
...
`,
                            ...
                            return (
                                ...
                                s.selection.$from.parent.type !== this.type &&
                                    s.setSelection(A.near(s.doc.resolve(Math.max(0, s.selection.from - 2)))),
                                s.setMeta("paste", !0),
                                t.dispatch(s),
                                !0
                            );
...
var Sd = z.create({
    ...
    addNodeView() {
        return ({ editor: t, node: e, getPos: n, HTMLAttributes: r, decorations: o, extension: i }) => {
            ...
            s.setAttribute("data-config", e.attrs.config), s.setAttribute("data-id", e.attrs.id), s.setAttribute("data-type", "customBlock");
            let l = document.createElement("div");
            if (
                ((l.className = "fi-fo-rich-editor-custom-block-header fi-not-prose"),
                s.appendChild(l),
                t.isEditable && typeof e.attrs.config == "object" && e.attrs.config !== null && Object.keys(e.attrs.config).length > 0)
            ) {
                ...
                (u.className = "fi-icon-btn"),
                    ...
                    u.addEventListener("click", () => i.options.editCustomBlockUsing(e.attrs.id, e.attrs.config)),
                    c.appendChild(u);
            }
            let a = document.createElement("p");
            if (((a.className = "fi-fo-rich-editor-custom-block-heading"), (a.textContent = e.attrs.label), l.appendChild(a), t.isEditable)) {
                let c = document.createElement("div");
                ...
                (u.className = "fi-icon-btn"),
                    ...
                    u.addEventListener("click", () => t.chain().setNodeSelection(n()).deleteSelection().run()),
                    c.appendChild(u);
            }
            if (e.attrs.preview) {
                let c = document.createElement("div");
                (c.className = "fi-fo-rich-editor-custom-block-preview fi-not-prose"),
                    (c.innerHTML = new TextDecoder().decode(Uint8Array.from(atob(e.attrs.preview), (u) => u.charCodeAt(0)))),
                    s.appendChild(c);
            }
            return { dom: s };
        };
    ...
    addAttributes() {
        return {
            config: { default: null, parseHTML: (t) => JSON.parse(t.getAttribute("data-config")) },
            id: { default: null, parseHTML: (t) => t.getAttribute("data-id"), renderHTML: (t) => (t.id ? { "data-id": t.id } : {}) },
...
var yo = (t, e) => e.view.domAtPos(t).node.offsetParent !== null,
    k0 = (t, e, n) => {
    ...
    kd = (t, e) => {
        ...
        if (!l || a.parent.type !== i.nodes.detailsSummary || !c || (e === "right" && a.parentOffset !== a.parent.nodeSize - 2)) return !1;
    ...
    Cd = z.create({
        ...
        addAttributes() {
            return this.options.persist
                ? { open: { default: !1, parseHTML: (t) => t.hasAttribute("open"), renderHTML: ({ open: t }) => (t ? { open: "" } : {}) } }
                : [];
        },
        parseHTML() {
            return [{ tag: "details" }];
        ...
        addNodeView() {
            return ({ editor: t, getPos: e, node: n, HTMLAttributes: r }) => {
                let o = document.createElement("div"),
                    i = T(this.options.HTMLAttributes, r, { "data-type": this.name });
                ...
                let a = (c) => {
                    ...
                    let u = new Event("toggleDetailsContent"),
                        d = l.querySelector(':scope > div[data-type="detailsContent"]');
                    d?.dispatchEvent(u);
                };
                return (
                        ...
                        if (t.isEditable && typeof e == "function") {
                            ...
                            t.chain()
                                .command(({ tr: d }) => {
                                    ...
                                    return h?.type !== this.type ? !1 : (d.setNodeMarkup(f, void 0, { open: !h.attrs.open }), !0);
                                })
                    ...
                    }),
                    {
                        ...
                        contentDOM: l,
                        ignoreMutation(c) {
                            return c.type === "selection" ? !1 : !o.contains(c.target) || o === c.target;
                        },
                        update: (c) => (c.type !== this.type ? !1 : (c.attrs.open !== void 0 && a(c.attrs.open), !0)),
                    }
                );
            };
        },
            ...
            return {
                setDetails:
                    ...
                    ({ state: t, chain: e }) => {
                        ...
                        let u = ((n = a.toJSON()) == null ? void 0 : n.content) || [];
                        return e()
                            .insertContentAt(
                                { from: l.start, to: l.end },
                                { type: this.name, content: [{ type: "detailsSummary" }, { type: "detailsContent", content: u }] },
                            )
            ...
            return [
                new N({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        if (!t.some((g) => g.selectionSet) || !e.selection.empty || !n.selection.empty || !Js(n, o.name)) return;
                        let { $from: l } = n.selection;
                        if (yo(l.pos, r)) return;
                        let c = k0(l, (g) => g.type === o, r);
                        if (!c) return;
                        let u = Sn(c.node, (g) => g.type === n.schema.nodes.detailsSummary);
                        if (!u.length) return;
                        let d = u[0],
                            h =
    ...
    Md = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["div", T(this.options.HTMLAttributes, t, { "data-type": this.name }), 0];
        },
        addNodeView() {
            return ({ HTMLAttributes: t }) => {
                let e = document.createElement("div"),
                    n = T(this.options.HTMLAttributes, t, { "data-type": this.name, hidden: "hidden" });
                return (
...
var C0 = z.create({ name: "doc", topNode: !0, content: "block+" }),
    Td = C0;
var M0 = z.create({
        name: "hardBreak",
        addOptions() {
...
var v0 = z.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            return [`h${this.options.levels.includes(t.attrs.level) ? t.attrs.level : this.options.levels[0]}`, T(this.options.HTMLAttributes, e), 0];
        },
        addCommands() {
            return {
                setHeading:
        ...
        addInputRules() {
            return this.options.levels.map((t) =>
                nr({ find: new RegExp(`^(#{${Math.min(...this.options.levels)},${t}})\\s$`), type: this.type, getAttributes: { level: t } }),
            );
        },
    }),
    Ed = v0;
                ...
                setHorizontalRule:
                    ...
                    ({ chain: t, state: e }) => {
                        ...
                        let { selection: n } = e,
                            ...
                            o = t();
                        return (
                            lo(n) ? o.insertContentAt(r.pos, { type: this.name }) : o.insertContent({ type: this.name }),
                            o
                                    ...
                                    if (s) {
                                        ...
                                        if (a.nodeAfter)
                                            a.nodeAfter.isTextblock
                                                ? i.setSelection(A.create(i.doc, a.pos + 1))
                                                : a.nodeAfter.isBlock
                                                  ? i.setSelection(O.create(i.doc, a.pos))
                                                  : i.setSelection(A.create(i.doc, a.pos));
                                        else {
                                            let u = (l = a.parent.type.contentMatch.defaultType) == null ? void 0 : l.create();
                                            u && (i.insert(c, u), i.setSelection(A.create(i.doc, c + 1)));
                                        }
                                        i.scrollIntoView();
                                    }
                                    return !0;
...
var N0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
    ...
    I0 = te.create({
        ...
        addInputRules() {
            return [Ie({ find: N0, type: this.type }), Ie({ find: D0, type: this.type })];
        },
        addPasteRules() {
            return [Ce({ find: R0, type: this.type }), Ce({ find: P0, type: this.type })];
        },
    }),
    Rd = I0;
var L0 = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/,
...
Me.prototype = {
    ...
    tr(t, e, n, r) {
        r = r || Me.groups;
        let o;
        return e && e.j ? (o = e) : ((o = new Me(e)), n && r && Xt(e, n, r)), this.jr.push([t, o]), o;
    },
    ts(t, e, n, r) {
        let o = this,
            i = t.length;
    ...
    tt(t, e, n, r) {
        ...
        let i = e,
            s,
            l = o.go(t);
        if ((l ? ((s = new Me()), Mn(s.j, l.j), s.jr.push.apply(s.jr, l.jr), (s.jd = l.jd), (s.t = l.t)) : (s = new Me()), i)) {
            if (r)
...
var F = (t, e, n, r, o) => t.ta(e, n, r, o),
    ...
    vo = "CLOSEPAREN",
    To = "OPENANGLEBRACKET",
    Ao = "CLOSEANGLEBRACKET",
    Eo = "FULLWIDTHLEFTPAREN",
    Oo = "FULLWIDTHRIGHTPAREN",
    No = "LEFTCORNERBRACKET",
    Ro = "RIGHTCORNERBRACKET",
    Do = "LEFTWHITECORNERBRACKET",
    Po = "RIGHTWHITECORNERBRACKET",
    Io = "FULLWIDTHLESSTHAN",
    Lo = "FULLWIDTHGREATERTHAN",
    Bo = "AMPERSAND",
    zo = "APOSTROPHE",
    Ho = "ASTERISK",
    Rt = "AT",
...
function K0(t = []) {
    ...
    bo == null && (bo = zd(z0)),
        ...
        k(n, "\\", Fo),
        k(n, "\u30FB", jd);
    let r = Z(n, yt, bl, { [ul]: !0 });
    Z(r, yt, r);
    let o = Z(r, gt, Wd, { [ir]: !0 }),
        i = Z(r, rr, _d, { [or]: !0 }),
        s = Z(n, gt, bt, { [dl]: !0 });
    Z(s, yt, o), Z(s, gt, s), Z(o, yt, o), Z(o, gt, o);
    let l = Z(n, rr, pl, { [fl]: !0 });
    Z(l, gt), Z(l, yt, i), Z(l, rr, l), Z(i, yt, i), Z(i, gt), Z(i, rr, i);
    let a = k(n, ll, xl, { [ol]: !0 }),
        c = k(n, Bd, yl, { [ol]: !0 }),
        u = Z(n, sl, yl, { [ol]: !0 });
    k(n, al, u), k(c, ll, a), k(c, al, u), Z(c, sl, u), k(u, Bd), k(u, ll), Z(u, sl, u), k(u, al, u);
    let d = Z(n, il, Kd, { [Vd]: !0 });
    ...
    for (let m = 0; m < t.length; m++) {
        let g = t[m][0],
            b = t[m][1] ? { [F0]: !0 } : { [$0]: !0 };
        g.indexOf("-") >= 0 ? (b[hl] = !0) : gt.test(g) ? (yt.test(g) ? (b[ir] = !0) : (b[dl] = !0)) : (b[ul] = !0), Ld(n, g, g, b);
    }
    return Ld(n, "localhost", dr, { ascii: !0 }), (n.jd = new Me(qo)), { start: n, tokens: Mn({ groups: e }, Ud) };
}
function Jd(t, e) {
    let n = U0(e.replace(/[A-Z]/g, (l) => l.toLowerCase())),
        r = n.length,
        o = [],
        i = 0,
        s = 0;
    for (; s < r; ) {
        ...
        (i -= d), (s -= f), (c -= d), o.push({ t: u.t, v: e.slice(i - c, i), s: i - c, e: i });
    }
    return o;
}
function U0(t) {
...
function Nt(t, e, n, r, o) {
    ...
    for (let l = 0; l < s - 1; l++) {
        let a = e[l];
        t.j[a] ? (i = t.j[a]) : ((i = new Me(r)), (i.jr = o.slice()), (t.j[a] = i)), (t = i);
    }
...
Ml.prototype = {
    ...
    get(t, e, n) {
        ...
        return (
            o &&
            (typeof o == "object"
                ? ((o = n.t in o ? o[n.t] : fr[t]), typeof o == "function" && r && (o = o(e, n)))
...
function q0({ groups: t }) {
    let e = t.domain.concat([Bo, Ho, Rt, Fo, $o, Vo, Wo, _o, Be, bl, ar, jo, Ko, Uo, tt, qo, ur, Jo]),
        n = [zo, Dt, wl, et, Sl, ar, cr, kl, Cl, To, Ao, sr, lr, Co, ko, Mo, vo, Eo, Oo, No, Ro, Do, Po, Io, Lo],
        r = [Bo, zo, Ho, Fo, $o, Vo, Wo, _o, Be, sr, lr, ar, jo, Ko, Uo, cr, tt, qo, ur, Jo],
        o = Le(),
        i = k(o, ur);
    ...
    let b = Le(wo);
    F(y, t.tld, b), F(y, t.utld, b), F(b, t.domain, s), F(b, r, i), k(b, et, y), k(b, Be, g), k(b, Rt, c);
    let x = k(b, Dt),
        C = Le(wo);
    F(x, t.numeric, C);
    let S = Le(wo),
    ...
    for (let H = 0; H < _.length; H++) {
        ...
        F(oe, e, X);
        let G = Le();
        F(oe, n), F(X, e, X), F(X, n, G), F(G, e, X), F(G, n, G), k(X, U, S), k(G, U, S);
    }
...
function G0(t, e, n) {
    ...
    for (; o < r; ) {
        ...
        for (; o < r && (c = a || l.go(n[o].t)); ) (a = null), (l = c), l.accepts() ? ((f = 0), (d = l)) : f >= 0 && f++, o++, u++;
        if (f < 0) (o -= u), o < r && (s.push(n[o]), o++);
        else {
            s.length > 0 && (i.push(cl($d, e, s)), (s = [])), (o -= f), (u -= f);
            let h = d.t,
                p = n.slice(o - u, o);
            i.push(cl(h, e, p));
        }
...
var Y0 = (typeof console < "u" && console && console.warn) || (() => {}),
    X0 = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.",
    q = { scanner: null, parser: null, tokenQueue: [], pluginQueue: [], customSchemes: [], initialized: !1 };
function Gd() {
    return (
        (Me.groups = {}),
        (q.scanner = null),
...
function vl(t, e = !1) {
    if ((q.initialized && Y0(`linkifyjs: already initialized - will not register custom scheme "${t}" ${X0}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(t)))
...
function Q0() {
    ...
    for (let t = 0; t < q.tokenQueue.length; t++) q.tokenQueue[t][1]({ scanner: q.scanner });
    q.parser = q0(q.scanner.tokens);
    for (let t = 0; t < q.pluginQueue.length; t++) q.pluginQueue[t][1]({ scanner: q.scanner, parser: q.parser });
    return (q.initialized = !0), q;
}
function Yo(t) {
    return q.initialized || Q0(), G0(q.parser.start, t, Jd(q.scanner.start, t));
}
Yo.scan = Jd;
        ...
        appendTransaction: (e, n, r) => {
            ...
            if (
                (js(l).forEach(({ newRange: c }) => {
                    let u = Ou(r.doc, c, (h) => h.isTextblock),
                        d,
                        f;
                    ...
                    if (d && f) {
                        let h = f.split(Z0).filter(Boolean);
                        if (h.length <= 0) return !1;
                        let p = h[h.length - 1],
                            m = d.pos + f.lastIndexOf(p);
                        if (!p) return !1;
                        let g = Yo(p).map((y) => y.toObject(t.defaultProtocol));
                        if (!nb(g)) return !1;
                        g.filter((y) => y.isLink)
                            ...
                            .forEach((y) => {
                                so(y.from, y.to, r.doc).some((b) => b.mark.type === t.type) ||
        ...
        props: {
            handleClick: (e, n, r) => {
                ...
                if (r.target instanceof HTMLAnchorElement) s = r.target;
                    ...
                    let u = r.target,
                        d = [];
                    for (; u.nodeName !== "DIV"; ) d.push(u), (u = u.parentNode);
                    s = d.find((f) => f.nodeName === "A");
                }
                if (!s) return !1;
                let l = _s(e.state, t.type.name),
    ...
    return new N({
        ...
        props: {
            handlePaste: (e, n, r) => {
                ...
                let a = Xo(l, { defaultProtocol: t.defaultProtocol }).find((c) => c.isLink && c.value === l);
...
function Qt(t, e) {
    ...
    return (
        ...
        !t || t.replace(tb, "").match(new RegExp(`^(?:(?:${n.join("|")}):|[^a-z]|[a-z0-9+.-]+(?:[^a-z+.-:]|$))`, "i"))
    );
}
var sb = te.create({
        name: "link",
                        ...
                        if (t) {
                            let { protocols: n, defaultProtocol: r } = this.options,
                                o = Xo(t).filter(
                                    (i) =>
                                        i.isLink &&
                                        this.options.isAllowedUri(i.value, { defaultValidate: (s) => !!Qt(s, n), protocols: n, defaultProtocol: r }),
                                );
                            o.length && o.forEach((i) => e.push({ text: i.value, data: { href: i.href }, index: i.start }));
                        }
                        return e;
                    },
                    type: this.type,
                ...
                this.options.autolink &&
                    t.push(
                        rb({
                            type: this.type,
                            defaultProtocol: this.options.defaultProtocol,
                            validate: (r) => this.options.isAllowedUri(r, { defaultValidate: (o) => !!Qt(o, e), protocols: e, defaultProtocol: n }),
                            shouldAutoLink: this.options.shouldAutoLink,
                        }),
                    ),
                this.options.openOnClick === !0 &&
                    t.push(ob({ type: this.type, editor: this.editor, enableClickSelection: this.options.enableClickSelection })),
                this.options.linkOnPaste && t.push(ib({ editor: this.editor, defaultProtocol: this.options.defaultProtocol, type: this.type })),
                t
            );
        },
    }),
...
var lb = Object.defineProperty,
    ab = (t, e) => {
        for (var n in e) lb(t, n, { get: e[n], enumerable: !0 });
    },
    cb = "listItem",
    Xd = "textStyle",
    Qd = /^\s*([-+*])\s$/,
                    ...
                    ({ commands: t, chain: e }) =>
                        this.options.keepAttributes
                            ? e()
                                  ...
                                  .updateAttributes(cb, this.editor.getAttributes(Xd))
                                  .run()
...
var hr = (t, e) => {
    ...
    Al = (t, e, n) => {
        ...
        let i = t.state.doc.resolve(r.$pos.pos - 2).node(r.depth),
            s = rf(e, t.state, i);
        return nf(e, t.state) && !s ? t.commands.joinItemBackward() : t.chain().liftListItem(e).run();
    },
    of = (t, e) => {
        let n = Rl(t, e),
            r = hr(t, e);
                ...
                Delete: ({ editor: t }) => {
                    ...
                    return (
                        this.options.listTypes.forEach(({ itemName: n }) => {
                            t.state.schema.nodes[n] !== void 0 && El(t, n) && (e = !0);
                        }),
                        e
                    );
                },
                ...
                Backspace: ({ editor: t }) => {
                    ...
                    return (
                        this.options.listTypes.forEach(({ itemName: n, wrapperNames: r }) => {
                            t.state.schema.nodes[n] !== void 0 && Al(t, n, r) && (e = !0);
                        }),
                        e
                    );
                },
    ...
    Dl = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            let { start: e, ...n } = t;
            return e === 1 ? ["ol", T(this.options.HTMLAttributes, n), 0] : ["ol", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                toggleOrderedList:
                    ...
                    ({ commands: t, chain: e }) =>
                        this.options.keepAttributes
                            ? e()
                                  .toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
                                  .updateAttributes(hb, this.editor.getAttributes(Zd))
                                  .run()
                            : t.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks),
            };
        },
            ...
            return (
                (this.options.keepMarks || this.options.keepAttributes) &&
                    (t = Xe({
                        ...
                        keepMarks: this.options.keepMarks,
                        keepAttributes: this.options.keepAttributes,
                        getAttributes: (e) => ({ start: +e[1], ...this.editor.getAttributes(Zd) }),
                        joinPredicate: (e, n) => n.childCount + n.attrs.start === +e[1],
                        editor: this.editor,
                    })),
                [t]
    ...
    mb = z.create({
        ...
        addKeyboardShortcuts() {
            let t = { Enter: () => this.editor.commands.splitListItem(this.name), "Shift-Tab": () => this.editor.commands.liftListItem(this.name) };
            ...
            return ({ node: t, HTMLAttributes: e, getPos: n, editor: r }) => {
                let o = document.createElement("li"),
                    ...
                    c = () => {
                        var u, d;
                        l.ariaLabel =
                            ((d = (u = this.options.a11y) == null ? void 0 : u.checkboxLabel) == null ? void 0 : d.call(u, t, l.checked)) ||
                ...
                return (
                        ...
                        r.isEditable &&
                            ...
                            r
                                ...
                                .command(({ tr: f }) => {
                                    ...
                                    return f.setNodeMarkup(h, void 0, { ...p?.attrs, checked: d }), !0;
                                })
                                .run(),
                            !r.isEditable && this.options.onReadOnlyChecked && (this.options.onReadOnlyChecked(t, d) || (l.checked = !l.checked));
                    }),
                    ...
                    }),
                    {
                        dom: o,
                        contentDOM: a,
                        update: (u) => (u.type !== this.type ? !1 : ((o.dataset.checked = u.attrs.checked), (l.checked = u.attrs.checked), c(), !0)),
                    }
                );
            };
        },
        addInputRules() {
            return [Xe({ find: pb, type: this.type, getAttributes: (t) => ({ checked: t[t.length - 1] === "x" }) })];
        },
    }),
    gb = z.create({
        name: "taskList",
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["ul", T(this.options.HTMLAttributes, t, { "data-type": this.name }), 0];
        },
        addCommands() {
            return {
                toggleTaskList:
    ...
    gC = $.create({
        ...
        addExtensions() {
            let t = [];
            return (
                this.options.bulletList !== !1 && t.push(Ol.configure(this.options.bulletList)),
                this.options.listItem !== !1 && t.push(Nl.configure(this.options.listItem)),
                this.options.listKeymap !== !1 && t.push(fb.configure(this.options.listKeymap)),
                this.options.orderedList !== !1 && t.push(Dl.configure(this.options.orderedList)),
                this.options.taskItem !== !1 && t.push(mb.configure(this.options.taskItem)),
                this.options.taskList !== !1 && t.push(gb.configure(this.options.taskList)),
                t
            );
        },
    });
var lf = ["image/png", "image/jpeg", "image/gif", "image/webp"],
    Qo = (t, e, n = {}) => {
        t.dom.closest("form")?.dispatchEvent(new CustomEvent(e, { composed: !0, cancelable: !0, detail: n }));
    },
    yb = ({ editor: t, get$WireUsing: e, key: n, statePath: r, uploadingMessage: o }) => {
        let i = (s) => e().callSchemaComponentMethod(n, "getUploadedFileAttachmentTemporaryUrl", { attachment: s });
        return new N({
            key: new L("localFiles"),
            props: {
                handleDrop(s, l) {
                    if (!l.dataTransfer?.files.length) return !1;
                    let a = Array.from(l.dataTransfer.files).filter((u) => lf.includes(u.type));
                    if (!a.length) return !1;
                    Qo(s, "form-processing-started", { message: o }), l.preventDefault(), l.stopPropagation();
                    let c = s.posAtCoords({ left: l.clientX, top: l.clientY });
                    return (
                        a.forEach((u, d) => {
                            t.setEditable(!1),
                                s.dom.dispatchEvent(
                                    new CustomEvent("rich-editor-uploading-file", { bubbles: !0, detail: { key: n, livewireId: e().id } }),
                                );
                            let f = new FileReader();
                            f.readAsDataURL(u),
                                (f.onload = () => {
                                    t.chain()
                                        .insertContentAt(c?.pos ?? 0, { type: "image", attrs: { class: "fi-loading", src: f.result } })
                                        .run();
                                });
                            let h = ("10000000-1000-4000-8000" + -1e11).replace(/[018]/g, (p) =>
                                (p ^ (crypto.getRandomValues(new Uint8Array(1))[0] & (15 >> (p / 4)))).toString(16),
                            );
                            e().upload(`componentFileAttachments.${r}.${h}`, u, () => {
                                i(h).then((p) => {
                                    p &&
                                        (t.chain().updateAttributes("image", { class: null, id: h, src: p }).run(),
                                        t.setEditable(!0),
                                        s.dom.dispatchEvent(
                                            new CustomEvent("rich-editor-uploaded-file", { bubbles: !0, detail: { key: n, livewireId: e().id } }),
                                        ),
                                        d === a.length - 1 && Qo(s, "form-processing-finished"));
                                });
                            });
                        }),
                        !0
                ...
                handlePaste(s, l) {
                    ...
                    let a = Array.from(l.clipboardData.files).filter((c) => lf.includes(c.type));
                    return a.length
                        ? (l.preventDefault(),
                          l.stopPropagation(),
                          ...
                          a.forEach((c, u) => {
                              ...
                              d.readAsDataURL(c),
                                  (d.onload = () => {
                                      t.chain()
                                          .insertContentAt(t.state.selection.anchor, { type: "image", attrs: { class: "fi-loading", src: d.result } })
                                          .run();
                                  });
                              let f = ("10000000-1000-4000-8000" + -1e11).replace(/[018]/g, (h) =>
                                  (h ^ (crypto.getRandomValues(new Uint8Array(1))[0] & (15 >> (h / 4)))).toString(16),
                              );
                              e().upload(`componentFileAttachments.${r}.${f}`, c, () => {
                                  i(f).then((h) => {
                                      h &&
                                          (t.chain().updateAttributes("image", { class: null, id: f, src: h }).run(),
                                          t.setEditable(!0),
                                          s.dom.dispatchEvent(
                                              new CustomEvent("rich-editor-uploaded-file", { bubbles: !0, detail: { key: n, livewireId: e().id } }),
                                          ),
                                          u === a.length - 1 && Qo(s, "form-processing-finished"));
                                  });
                              });
                          }),
                          !0)
    ...
    af = $.create({
        name: "localFiles",
        addOptions() {
            return { key: null, statePath: null, uploadingMessage: null, get$WireUsing: null };
        },
        addProseMirrorPlugins() {
...
function bb(t) {
    var e;
    let { char: n, allowSpaces: r, allowToIncludeChar: o, allowedPrefixes: i, startOfLine: s, $position: l } = t,
        a = r && !o,
        c = id(n),
        u = new RegExp(`\\s${c}$`),
        d = s ? "^" : "",
        f = o ? "" : c,
        h = a ? new RegExp(`${d}${c}.*?(?=\\s${f}|$)`, "gm") : new RegExp(`${d}(?:^)?${c}[^\\s${f}]*`, "gm"),
    ...
    return (
        ...
        x < l.pos && C >= l.pos ? { range: { from: x, to: C }, query: g[0].slice(n.length), text: g[0] } : null
    );
}
var xb = new L("suggestion");
function wb({
    pluginKey: t = xb,
    editor: e,
    char: n = "@",
        ...
        b = new N({
                ...
                return {
                    update: async (x, C) => {
                        ...
                        let H = (S = this.key) == null ? void 0 : S.getState(C),
                            j = (R = this.key) == null ? void 0 : R.getState(x.state),
                            U = H.active && j.active && H.range.from !== j.range.from,
                        ...
                        if (!ie && !Te && !On) return;
                        let rn = On && !ie ? H : j,
                            Ql = x.dom.querySelector(`[data-decoration-id="${rn.decorationId}"]`);
                        (g = {
                            editor: e,
                            range: rn.range,
                            query: rn.query,
                            text: rn.text,
                            items: [],
                            command: (wr) => d({ editor: e, range: rn.range, props: wr }),
                            decorationNode: Ql,
                            clientRect: Ql
                                ? () => {
                                      var wr;
                                      let { decorationId: zh } = (wr = this.key) == null ? void 0 : wr.getState(e.state),
                                          Zl = x.dom.querySelector(`[data-decoration-id="${zh}"]`);
                            ...
                            (Te || ie) && (g.items = await f({ editor: e, query: rn.query })),
            ...
            state: {
                ...
                apply(x, C, S, R) {
                    ...
                    if (((H.composing = v), P && (D || e.view.composing))) {
                        (_ < C.range.from || _ > C.range.to) && !v && !C.composing && (H.active = !1);
                        let j = m({ char: n, allowSpaces: r, allowToIncludeChar: o, allowedPrefixes: i, startOfLine: s, $position: B.$from }),
                            U = `id_${Math.floor(Math.random() * 4294967295)}`;
                        j && p({ editor: e, state: R, range: j.range, isActive: C.active })
                            ? ((H.active = !0),
                              (H.decorationId = C.decorationId ? C.decorationId : U),
                              (H.range = j.range),
                              (H.query = j.query),
                              (H.text = j.text))
                            : (H.active = !1);
            ...
            props: {
                handleKeyDown(x, C) {
                    ...
                    return (R && ((S = y?.onKeyDown) == null ? void 0 : S.call(y, { view: x, event: C, range: P }))) || !1;
                },
                decorations(x) {
                    let { active: C, range: S, decorationId: R, query: P } = b.getState(x);
                    if (!C) return null;
                    let v = !P?.length,
                        B = [a];
                    return (
                        v && B.push(u),
                        J.create(x.doc, [
                            Y.inline(S.from, S.to, { nodeName: l, class: B.join(" "), "data-decoration-id": R, "data-decoration-content": c }),
                        ])
                    );
                },
            },
...
var cf = wb;
var Sb = function ({ editor: t, overrideSuggestionOptions: e, extensionName: n }) {
        let r = new L();
        return {
            editor: t,
            char: "{{",
    ...
    uf = z.create({
        ...
        addOptions() {
            return {
                ...
                renderHTML({ options: t, node: e }) {
                    return ["span", T(this.HTMLAttributes, t.HTMLAttributes), `${e.attrs.label ?? e.attrs.id}`];
                },
                suggestions: [],
                suggestion: {},
            };
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let n = this.editor?.extensionStorage?.[this.name]?.getSuggestionFromChar("{{"),
                r = { ...this.options };
            r.HTMLAttributes = T({ "data-type": this.name }, this.options.HTMLAttributes, e);
            let o = this.options.renderHTML({ options: r, node: t, suggestion: n });
            return typeof o == "string" ? ["span", T({ "data-type": this.name }, this.options.HTMLAttributes, e), o] : o;
        },
        renderText({ node: t }) {
            let e = { options: this.options, node: t, suggestion: this.editor?.extensionStorage?.[this.name]?.getSuggestionFromChar("{{") };
                ...
                Backspace: () =>
                    this.editor.commands.command(({ tr: t, state: e }) => {
                        ...
                        return (
                            ...
                            n && t.insertText(this.options.deleteTriggerWithBackspace ? "" : "{{", l, l + s.nodeSize),
                            n
                        );
                    }),
            };
        ...
        onBeforeCreate() {
            (this.storage.suggestions = (this.options.suggestions.length ? this.options.suggestions : [this.options.suggestion]).map((t) =>
                Sb({ editor: this.editor, overrideSuggestionOptions: t, extensionName: this.name }),
            )),
...
var ee = class {
    ...
    rectBetween(t, e) {
        ...
        return { left: Math.min(n, s), top: Math.min(o, a), right: Math.max(r, l), bottom: Math.max(i, c) };
    }
    cellsInRect(t) {
        let e = [],
            n = {};
        for (let r = t.top; r < t.bottom; r++)
            for (let o = t.left; o < t.right; o++) {
                let i = r * this.width + o,
                    s = this.map[i];
                n[s] ||
                    ((n[s] = !0), !((o == t.left && o && this.map[i - 1] == s) || (r == t.top && r && this.map[i - this.width] == s)) && e.push(s));
            }
        return e;
    }
    positionAt(t, e, n) {
...
function Eb(t) {
    ...
    for (let c = 0, u = 0; c < n; c++) {
        ...
        for (let p = 0; ; p++) {
            ...
            for (let x = 0; x < y; x++) {
                if (x + c >= n) {
                    (i || (i = [])).push({ type: "overlong_rowspan", pos: u, n: y - x });
                    break;
                }
                let C = o + x * e;
                for (let S = 0; S < g; S++) {
                    r[C + S] == 0 ? (r[C + S] = u) : (i || (i = [])).push({ type: "collision", row: c, pos: u, n: g - S });
                    let R = b && b[S];
                    if (R) {
                        let P = ((C + S) % e) * 2,
                            v = s[P];
                        v == null || (v != R && s[P + 1] == 1) ? ((s[P] = R), (s[P + 1] = 1)) : v == R && s[P + 1]++;
                    }
                }
            }
            (o += g), (u += m.nodeSize);
...
function Nb(t, e, n) {
    ...
    for (let o = 0; o < t.map.length; o++) {
        ...
        for (let c = 0; c < a.colspan; c++) {
            let u = (o + c) % t.width,
                d = e[u * 2];
            d != null && (!a.colwidth || a.colwidth[c] != d) && ((l || (l = Rb(a)))[c] = d);
        }
...
var K = class xt extends E {
    ...
    map(e, n) {
        ...
        if (Bl(r) && Bl(o) && Fl(r, o)) {
            ...
            return i && this.isRowSelection() ? xt.rowSelection(r, o) : i && this.isColSelection() ? xt.colSelection(r, o) : new xt(r, o);
        }
    ...
    content() {
        ...
        for (let a = o.top; a < o.bottom; a++) {
            ...
            for (let u = a * n.width + o.left, d = o.left; d < o.right; d++, u++) {
                ...
                if (m > 0 || g > 0) {
                    let y = p.attrs;
                    if ((m > 0 && (y = Zt(y, 0, m)), g > 0 && (y = Zt(y, y.colspan - g, g)), h.left < o.left)) {
        ...
        return (
            s.top <= l.top
                ...
                : (l.top > 0 && (n = a.resolve(i + o.map[l.left])),
                  s.bottom < o.height && (e = a.resolve(i + o.map[o.width * (o.height - 1) + s.right - 1]))),
            new xt(e, n)
        );
    }
    isRowSelection() {
...
function $b(t, e, n) {
    ...
    } else r instanceof A && Hb(r) ? (i = A.create(o, r.from)) : r instanceof A && Fb(r) && (i = A.create(o, r.$from.start(), r.$from.end()));
    return i && (e || (e = t.tr)).setSelection(i), e;
}
var Vb = new L("fix-tables");
function Of(t, e, n, r) {
    let o = t.childCount,
        i = e.childCount;
    e: for (let s = 0, l = 0; s < i; s++) {
        ...
        r(a, n), l < o && t.child(l).sameMarkup(a) ? Of(t.child(l), a, n + 1, r) : a.nodesBetween(0, a.content.size, r, n + 1), (n += a.nodeSize);
    }
}
function $l(t, e) {
    let n,
    ...
    return e ? e.doc != t.doc && Of(e.doc, t.doc, 0, r) : t.doc.descendants(r), n;
}
function Wb(t, e, n, r) {
    let o = ee.get(e);
    ...
    for (let a = 0; a < o.problems.length; a++) {
        ...
        if (c.type == "collision") {
            ...
            let u = e.nodeAt(c.pos);
            if (!u) continue;
            r.setNodeMarkup(r.mapping.map(n + 1 + c.pos), null, { ...u.attrs, rowspan: u.attrs.rowspan - c.n });
...
function nt(t) {
    let e = t.selection,
        ...
        i = ee.get(r);
    return {
        ...(e instanceof K ? i.rectBetween(e.$anchorCell.pos - o, e.$headCell.pos - o) : i.findCell(n.pos - o)),
        tableStart: o,
        map: i,
        table: r,
    };
...
function Nf(t, { map: e, tableStart: n, table: r }, o) {
    ...
    for (let s = 0; s < e.height; s++) {
        ...
        if (o > 0 && o < e.width && e.map[l - 1] == e.map[l]) {
            let a = e.map[l],
                c = r.nodeAt(a);
            t.setNodeMarkup(t.mapping.map(n + a), null, Af(c.attrs, o - e.colCount(a))), (s += c.attrs.rowspan - 1);
        } else {
            let a = i == null ? ye(r.type.schema).cell : r.nodeAt(e.map[l + i]).type,
...
function _b(t, { map: e, table: n, tableStart: r }, o) {
    ...
    for (let s = 0; s < e.height; ) {
        ...
        if ((o > 0 && e.map[l - 1] == a) || (o < e.width - 1 && e.map[l + 1] == a))
            t.setNodeMarkup(t.mapping.slice(i).map(r + a), null, Zt(u, o - e.colCount(a)));
        else {
...
function jb(t, e, n) {
    ...
    for (let i = 0; i < t.width; i++) if (((r = e.nodeAt(t.map[i + n * t.width])) == null ? void 0 : r.type) != o) return !1;
    return !0;
}
function If(t, { map: e, tableStart: n, table: r }, o) {
    ...
    for (let c = 0, u = e.width * o; c < e.width; c++, u++)
        if (o > 0 && o < e.height && e.map[u] == e.map[u - e.width]) {
            ...
            let d = a == null ? ye(r.type.schema).cell : (i = r.nodeAt(e.map[u + a * e.width])) == null ? void 0 : i.type,
                f = d?.createAndFill();
            f && l.push(f);
        }
    ...
    for (let c = 0, u = o * e.width; c < e.width; c++, u++) {
        ...
        if (!a.has(d)) {
            if ((a.add(d), o > 0 && d == e.map[u - e.width])) {
                ...
                t.setNodeMarkup(t.mapping.slice(l).map(d + r), null, { ...f, rowspan: f.rowspan - 1 }), (c += f.colspan - 1);
    ...
    if (e) {
        ...
        if (
            (i.setNodeMarkup(a + r.tableStart, null, {
                ...Af(c.attrs, c.attrs.colspan, r.right - r.left - c.attrs.colspan),
...
function Jb(t) {
    return (e, n) => {
        ...
        if (n) {
            ...
            let u = nt(e),
                d = e.tr;
            for (let h = 0; h < u.right - u.left; h++) a.push(c ? { ...l, colwidth: c && c[h] ? [c[h]] : null } : l);
            let f;
            for (let h = u.top; h < u.bottom; h++) {
                ...
                for (let m = u.left, g = 0; m < u.right; m++, g++)
                    (m == u.left && h == u.top) ||
                        d.insert((f = d.mapping.map(p + u.tableStart, 1)), t({ node: i, row: h, col: m }).createAndFill(a[g]));
            }
            d.setNodeMarkup(s, t({ node: i, row: u.top, col: u.left }), a[0]),
                o instanceof K && d.setSelection(new K(d.doc.resolve(o.$anchorCell.pos), f ? d.doc.resolve(f) : void 0)),
                n(d);
        }
        return !0;
    };
...
function bf(t, e, n) {
    let r = e.map.cellsInRect({ left: 0, top: 0, right: t == "row" ? e.map.width : 1, bottom: t == "column" ? e.map.height : 1 });
    for (let o = 0; o < r.length; o++) {
                          ...
                          d =
                              t == "column"
                                  ...
                                  : t == "row"
                                    ...
                                    : i,
                          f = t == "column" ? (a ? o.cell : o.header_cell) : t == "row" ? (l ? o.cell : o.header_cell) : o.cell;
...
var eM = Tn("row", { useDeprecatedLogic: !0 }),
    tM = Tn("column", { useDeprecatedLogic: !0 }),
    Ff = Tn("cell", { useDeprecatedLogic: !0 });
function Gb(t, e) {
    if (e < 0) {
        let n = t.nodeBefore;
...
function $f(t, e) {
    ...
    for (let r = n.depth; r > 0; r--)
        if (n.node(r).type.spec.tableRole == "table") return e && e(t.tr.delete(n.before(r), n.after(r)).scrollIntoView()), !0;
    return !1;
}
function Zo(t, e) {
    let n = t.selection;
    ...
    if (e) {
        ...
        n.forEachCell((i, s) => {
            i.content.eq(o) || r.replace(r.mapping.map(s + 1), r.mapping.map(s + i.nodeSize - 1), new M(o, 0, 0));
        }),
            r.docChanged && e(r);
    }
    return !0;
...
function Yb(t) {
    ...
    for (; e.childCount == 1 && ((n > 0 && r > 0) || e.child(0).type.spec.tableRole == "table"); ) n--, r--, (e = e.child(0).content);
    let o = e.child(0),
    ...
    if (i == "row")
        for (let a = 0; a < e.childCount; a++) {
            ...
            (u || d) && (c = zl(ye(s).row, new M(c, u, d)).content), l.push(c);
        }
    else if (i == "cell" || i == "header_cell") l.push(n || r ? zl(ye(s).row, new M(e, n, r)).content : e);
    else return null;
    return Xb(s, l);
}
function Xb(t, e) {
    ...
    if (t != r) {
        ...
        for (let l = 0; l < n.length; l++) {
            ...
            for (let u = i[l] || 0, d = 0; u < r; d++) {
                ...
                u + f.attrs.colspan > r && (f = f.type.createChecked(Zt(f.attrs, f.attrs.colspan, u + f.attrs.colspan - r), f.content)),
                    c.push(f),
                    (u += f.attrs.colspan);
    ...
    if (e != o) {
        ...
        for (let s = 0, l = 0; s < o; s++, l++) {
            ...
            for (let u = 0; u < c.childCount; u++) {
                let d = c.child(u);
                s + d.attrs.rowspan > o && (d = d.type.create({ ...d.attrs, rowspan: Math.max(1, o - d.attrs.rowspan) }, d.content)), a.push(d);
            }
            i.push(w.from(a));
        }
        (n = i), (e = o);
...
function xf(t, e, n, r, o, i, s, l) {
    ...
    for (let c = o; c < i; c++) {
        ...
        if (e.map[u - e.width] == d) {
            ...
            t.setNodeMarkup(t.mapping.slice(l).map(d + r), null, { ...f.attrs, rowspan: s - h }),
                t.insert(t.mapping.slice(l).map(e.positionAt(s, p, n)), f.type.createAndFill({ ...f.attrs, rowspan: h + f.attrs.rowspan - s })),
                (c += f.attrs.colspan - 1);
        }
    }
    return a;
...
function wf(t, e, n, r, o, i, s, l) {
    ...
    for (let c = o; c < i; c++) {
        ...
        if (e.map[u - 1] == d) {
            ...
            t.setNodeMarkup(p, null, Zt(f.attrs, s - h, f.attrs.colspan - (s - h))),
                t.insert(p + f.nodeSize, f.type.createAndFill(Zt(f.attrs, 0, s - h))),
                (c += f.attrs.rowspan - 1);
        }
    }
    return a;
...
function Sf(t, e, n, r, o) {
    ...
    for (let p = l; p < u; p++) {
        ...
        d.replace(d.mapping.slice(f).map(m + n), d.mapping.slice(f).map(g + n), new M(o.rows[p - l], 0, 0));
    }
    h(), d.setSelection(new K(d.doc.resolve(n + s.positionAt(l, a, i)), d.doc.resolve(n + s.positionAt(u - 1, c - 1, i)))), e(d);
}
var ex = Xn({
    ...
    return (n, r, o) => {
        ...
        if (t == "horiz") return ni(n, r, E.near(n.doc.resolve(i.head + e), e));
        {
            let l = n.doc.resolve(s),
                ...
                c;
            return (
                a ? (c = E.near(a, 1)) : e < 0 ? (c = E.near(n.doc.resolve(l.before(-1)), -1)) : (c = E.near(n.doc.resolve(l.after(-1)), 1)),
                ni(n, r, c)
            );
        }
    };
...
function nx(t, e, n) {
    ...
    let r = Yb(n),
        o = t.state.selection;
    if (o instanceof K) {
        r || (r = { width: 1, height: 1, rows: [w.from(zl(ye(t.state.schema).cell, n))] });
        let i = o.$anchorCell.node(-1),
            s = o.$anchorCell.start(-1),
            l = ee.get(i).rectBetween(o.$anchorCell.pos - s, o.$headCell.pos - s);
        return (r = Qb(r, l.right - l.left, l.bottom - l.top)), Sf(t.state, t.dispatch, s, l, r), !0;
    } else if (r) {
        let i = oi(t.state),
            s = i.start(-1);
        return Sf(t.state, t.dispatch, s, ee.get(i.node(-1)).findCell(i.pos - s), r), !0;
    } else return !1;
}
function rx(t, e) {
    var n;
    ...
    let r = kf(t, e.target),
        o;
    if (e.shiftKey && t.state.selection instanceof K) i(t.state.selection.$anchorCell, e), e.preventDefault();
    else if (e.shiftKey && r && (o = vn(t.state.selection.$anchor)) != null && ((n = Pl(t, e)) == null ? void 0 : n.pos) != o.pos)
    ...
    function s() {
        t.root.removeEventListener("mouseup", s),
            ...
            Pt.getState(t.state) != null && t.dispatch(t.state.tr.setMeta(Pt, -1));
    }
    function l(a) {
        let c = a,
...
var ox = class {
    ...
    update(t) {
        return t.type != this.node.type ? !1 : ((this.node = t), Hl(t, this.colgroup, this.table, this.defaultCellMinWidth), !0);
    }
    ignoreMutation(t) {
...
function Wf({ handleWidth: t = 5, cellMinWidth: e = 25, defaultCellMinWidth: n = 100, View: r = ox, lastColumnResizable: o = !0 } = {}) {
    let i = new N({
        key: Ee,
        state: {
            init(s, l) {
                var a, c;
                let u = (c = (a = i.spec) == null ? void 0 : a.props) == null ? void 0 : c.nodeViews,
                    d = ye(l.schema).table.name;
                return r && u && (u[d] = (f, h) => new r(f, n, h)), new ix(-1, !1);
            },
            apply(s, l) {
                return l.apply(s);
            },
...
var ix = class ri {
    ...
    apply(e) {
        ...
        if (r && r.setDragging !== void 0) return new ri(n.activeHandle, r.setDragging);
...
function sx(t, e, n, r) {
    ...
    if (o && !o.dragging) {
        ...
        if (i) {
            ...
            e.clientX - l <= n ? (s = Cf(t, e, "left", n)) : a - e.clientX <= n && (s = Cf(t, e, "right", n));
        }
        if (s != o.activeHandle) {
            if (!r && s !== -1) {
...
function ax(t, e, n, r) {
    ...
    let l = t.state.doc.nodeAt(s.activeHandle),
        a = cx(t, s.activeHandle, l.attrs);
    t.dispatch(t.state.tr.setMeta(Ee, { setDragging: { startX: e.clientX, startWidth: a } }));
    function c(d) {
        i.removeEventListener("mouseup", c), i.removeEventListener("mousemove", u);
        let f = Ee.getState(t.state);
        f?.dragging && (dx(t, f.activeHandle, Mf(f.dragging, d, n)), t.dispatch(t.state.tr.setMeta(Ee, { setDragging: null })));
    }
    function u(d) {
        if (!d.which) return c(d);
        let f = Ee.getState(t.state);
        if (f && f.dragging) {
            let h = Mf(f.dragging, d, n);
            vf(t, f.activeHandle, h, r);
        }
    }
    return vf(t, s.activeHandle, a, r), i.addEventListener("mouseup", c), i.addEventListener("mousemove", u), e.preventDefault(), !0;
}
...
function dx(t, e, n) {
    ...
    for (let c = 0; c < i.height; c++) {
        ...
        let p = f.colwidth ? f.colwidth.slice() : fx(f.colspan);
        ...
        if ((a == s.width - 1 || s.map[u] != s.map[u + 1]) && (c == 0 || s.map[u] != s.map[u - s.width])) {
            ...
            (h.className = "column-resize-handle"),
                (n = Ee.getState(t)) != null &&
                    n.dragging &&
                    r.push(Y.node(l + d, l + d + i.nodeAt(d).nodeSize, { class: "column-resize-dragging" })),
                r.push(Y.widget(f, h));
        }
    }
...
var yx = class {
    ...
    update(t) {
        return t.type !== this.node.type ? !1 : ((this.node = t), Kf(t, this.colgroup, this.table, this.cellMinWidth), !0);
    }
    ignoreMutation(t) {
        return t.type === "attributes" && (t.target === this.table || this.colgroup.contains(t.target));
    }
...
var ii = ({ editor: t }) => {
        ...
        if (!Sx(e)) return !1;
        let n = 0,
            r = Fs(e.ranges[0].$from, (i) => i.type.name === "table");
        return (
    ...
    kx = z.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let { colgroup: n, tableWidth: r, tableMinWidth: o } = bx(t, this.options.cellMinWidth);
            return ["table", T(this.options.HTMLAttributes, e, { style: r ? `width: ${r}` : `min-width: ${o}` }), n, ["tbody", 0]];
        },
        addCommands() {
            return {
                insertTable:
        ...
        addProseMirrorPlugins() {
            return [
                ...(this.options.resizable && this.editor.isEditable
                    ...
                    : []),
                jf({ allowTableNodeSelection: this.options.allowTableNodeSelection }),
            ];
        },
        extendNodeSchema(t) {
    ...
    Jf = $.create({
        ...
        addExtensions() {
            let t = [];
            return (
                this.options.table !== !1 && t.push(kx.configure(this.options.table)),
                this.options.tableCell !== !1 && t.push(px.configure(this.options.tableCell)),
                this.options.tableHeader !== !1 && t.push(mx.configure(this.options.tableHeader)),
                this.options.tableRow !== !1 && t.push(gx.configure(this.options.tableRow)),
                t
            );
        },
    });
var Cx = z.create({ name: "text", group: "inline" }),
    qf = Cx;
var Mx = $.create({
        name: "textAlign",
        addOptions() {
                ...
                setTextAlign:
                    ...
                    ({ commands: e }) =>
                        this.options.alignments.includes(t)
                            ? this.options.types.map((n) => e.updateAttributes(n, { textAlign: t })).every((n) => n)
                            : !1,
                unsetTextAlign:
                    () =>
                    ({ commands: t }) =>
                        this.options.types.map((e) => t.resetAttributes(e, "textAlign")).every((e) => e),
                toggleTextAlign:
                    (t) =>
                    ({ editor: e, commands: n }) =>
                        this.options.alignments.includes(t) ? (e.isActive({ textAlign: t }) ? n.unsetTextAlign() : n.setTextAlign(t)) : !1,
            };
        },
        addKeyboardShortcuts() {
            return {
...
var vx = te.create({
        ...
        parseHTML() {
            return [{ tag: "u" }, { style: "text-decoration", consuming: !1, getAttrs: (t) => (t.includes("underline") ? {} : !1) }];
        },
        renderHTML({ HTMLAttributes: t }) {
    ...
    Yf = vx;
var Kl = ["top", "right", "bottom", "left"],
    Xf = ["start", "end"],
    Ul = Kl.reduce((t, e) => t.concat(e, e + "-" + Xf[0], e + "-" + Xf[1]), []),
    ze = Math.min,
    fe = Math.max,
    gr = Math.round;
var _e = (t) => ({ x: t, y: t }),
    Tx = { left: "right", right: "left", bottom: "top", top: "bottom" },
...
function th(t, e, n, r) {
    let o = He(t),
        i = Rx(Oe(t), n === "start", r);
    return o && ((i = i.map((s) => s + "-" + o)), e && (i = i.concat(i.map(pr)))), i;
}
function mr(t) {
...
function ci(t) {
    return typeof t != "number" ? Dx(t) : { top: t, right: t, bottom: t, left: t };
}
function wt(t) {
        ...
        (u = b ?? u),
            ...
            S &&
                ...
                typeof S == "object" &&
                    ...
                    S.rects && (c = S.rects === !0 ? await s.getElementRects({ reference: t, floating: e, strategy: o }) : S.rects),
                    ({ x: u, y: d } = nh(c, f, a))),
                (m = -1));
    }
    ...
    let { x: r, y: o, platform: i, rects: s, elements: l, strategy: a } = t,
            ...
            await i.getClippingRect({
                element:
                    (n = await (i.isElement == null ? void 0 : i.isElement(g))) == null || n
                        ? g
                        : g.contextElement || (await (i.getDocumentElement == null ? void 0 : i.getDocumentElement(l.floating))),
                boundary: c,
                rootBoundary: u,
                strategy: a,
            }),
        ...
        S = wt(
            i.convertOffsetParentRelativeRectToViewportRelativeRect
                ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({ elements: l, rect: b, offsetParent: x, strategy: a })
                : b,
        );
    return {
...
var sh = (t) => ({
    ...
    async fn(e) {
        ...
        let d = ci(u),
            ...
            P = R ? R[x] : 0;
        (!P || !(await (s.isElement == null ? void 0 : s.isElement(R)))) && (P = l.floating[x] || i.floating[p]);
        let v = C / 2 - S / 2,
            B = P / 2 - m[p] / 2 - 1,
            D = ze(d[y], B),
            _ = ze(d[b], B),
            ...
            U = P / 2 - m[p] / 2 + v,
            oe = si(H, U, j),
            X = !a.arrow && He(o) != null && U !== oe && i.reference[p] / 2 - (U < H ? D : _) - m[p] / 2 < 0,
            G = X ? (U < H ? U - H : U - j) : 0;
        return { [h]: f[h] + G, data: { [h]: oe, centerOffset: U - oe - G, ...(X && { alignmentOffset: G }) }, reset: X };
    },
});
function Px(t, e, n) {
    return (t ? [...n.filter((o) => He(o) === t), ...n.filter((o) => He(o) !== t)] : n.filter((o) => Oe(o) === o)).filter((o) =>
        t ? He(o) === t || (e ? pr(o) !== o : !1) : !0,
    );
}
var lh = function (t) {
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let { rects: i, middlewareData: s, placement: l, platform: a, elements: c } = e,
                        { crossAxis: u = !1, alignment: d, allowedPlacements: f = Ul, autoAlignment: h = !0, ...p } = rt(t, e),
                        m = d !== void 0 || f === Ul ? Px(d || null, h, f) : f,
                        g = await en(e, p),
                        y = ((n = s.autoPlacement) == null ? void 0 : n.index) || 0,
                        b = m[y];
                    if (b == null) return {};
                    let x = ql(b, i, await (a.isRTL == null ? void 0 : a.isRTL(c.floating)));
                    if (l !== b) return { reset: { placement: m[0] } };
                    let C = [g[Oe(b)], g[x[0]], g[x[1]]],
                        S = [...(((r = s.autoPlacement) == null ? void 0 : r.overflows) || []), { placement: b, overflows: C }],
                        R = m[y + 1];
                    if (R) return { data: { index: y + 1, overflows: S }, reset: { placement: R } };
                    let P = S.map((D) => {
                            let _ = He(D.placement);
                            return [D.placement, _ && u ? D.overflows.slice(0, 2).reduce((H, j) => H + j, 0) : D.overflows[0], D.overflows];
                        }).sort((D, _) => D[1] - _[1]),
                        B = ((o = P.filter((D) => D[2].slice(0, He(D[0]) ? 2 : 3).every((_) => _ <= 0))[0]) == null ? void 0 : o[0]) || P[0][0];
                    return B !== l ? { data: { index: y + 1, overflows: S }, reset: { placement: B } } : {};
                },
            }
        );
    },
    ah = function (t) {
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    var n, r;
                    let { placement: o, middlewareData: i, rects: s, initialPlacement: l, platform: a, elements: c } = e,
                        {
                            mainAxis: u = !0,
                            crossAxis: d = !0,
                    ...
                    if (((D = [...D, { placement: o, overflows: B }]), !B.every((U) => U <= 0))) {
                        var _, H;
                        let U = (((_ = i.flip) == null ? void 0 : _.index) || 0) + 1,
                            oe = P[U];
                        if (oe && (!(d === "alignment" ? b !== je(oe) : !1) || D.every((ie) => ie.overflows[0] > 0 && je(ie.placement) === b)))
                            return { data: { index: U, overflows: D }, reset: { placement: oe } };
                        let X =
                            (H = D.filter((G) => G.overflows[0] <= 0).sort((G, ie) => G.overflows[1] - ie.overflows[1])[0]) == null
                                ? void 0
                                : H.placement;
                        if (!X)
                            switch (h) {
                                case "bestFit": {
                                    ...
                                    let G =
                                        (j = D.filter((ie) => {
                                            ...
                                            .map((ie) => [ie.placement, ie.overflows.filter((Te) => Te > 0).reduce((Te, On) => Te + On, 0)])
            ...
            async fn(e) {
                ...
                switch (r) {
                    case "referenceHidden": {
                        let i = await en(e, { ...o, elementContext: "reference" }),
                            s = rh(i, n.reference);
                        return { data: { referenceHiddenOffsets: s, referenceHidden: oh(s) } };
                    }
                    case "escaped": {
            ...
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    let { placement: n, elements: r, rects: o, platform: i, strategy: s } = e,
                        ...
                        u = Array.from((await (i.getClientRects == null ? void 0 : i.getClientRects(r.reference))) || []),
                        d = Ix(u),
                        f = wt(uh(u)),
                        h = ci(l);
                    function p() {
                        ...
                        if (d.length >= 2) {
                            if (je(n) === "y") {
                                let D = d[0],
                                    ...
                                    G = X - oe,
                                    ie = U - j;
                                return { top: j, bottom: U, left: oe, right: X, width: G, height: ie, x: oe, y: j };
                            }
                            let g = Oe(n) === "left",
                                y = fe(...d.map((D) => D.right)),
                                b = ze(...d.map((D) => D.left)),
                                x = d.filter((D) => (g ? D.left === b : D.right === y)),
                                C = x[0].top,
                                ...
                                v = P - R,
                                B = S - C;
                            return { top: C, bottom: S, left: R, right: P, width: v, height: B, x: R, y: C };
                        }
                        return f;
                    }
                    let m = await i.getElementRects({ reference: { getBoundingClientRect: p }, floating: r.floating, strategy: s });
...
async function Bx(t, e) {
    ...
    return l && typeof p == "number" && (h = l === "end" ? p * -1 : p), a ? { x: h * u, y: f * c } : { x: f * c, y: h * u };
}
var fh = function (t) {
        return (
            t === void 0 && (t = 0),
        ...
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    return { ...m, data: { x: m.x - n, y: m.y - r, enabled: { [f]: i, [d]: s } } };
                },
            }
        );
    };
        ...
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                let { placement: o, rects: i, platform: s, elements: l } = e,
                    ...
                    y;
                d === "top" || d === "bottom"
                    ? ((g = d), (y = f === ((await (s.isRTL == null ? void 0 : s.isRTL(l.floating))) ? "start" : "end") ? "left" : "right"))
                ...
                let b = m - u.top - u.bottom,
                    ...
                    v = S;
                if (
                    ((n = e.middlewareData.shift) != null && n.enabled.x && (v = x),
                    (r = e.middlewareData.shift) != null && r.enabled.y && (P = b),
                    R && !f)
                ) {
                    let D = fe(u.left, 0),
                        _ = fe(u.right, 0),
                        ...
                        j = fe(u.bottom, 0);
                    h
                        ? (v = p - 2 * (D !== 0 || _ !== 0 ? D + _ : fe(u.left, u.right)))
                        : (P = m - 2 * (H !== 0 || j !== 0 ? H + j : fe(u.top, u.bottom)));
                }
                await a({ ...e, availableWidth: v, availableHeight: P });
                let B = await s.getDimensions(l.floating);
                return p !== B.width || m !== B.height ? { reset: { rects: !0 } } : {};
            },
        }
    );
};
...
function ot(t) {
    var e;
    return (e = (gh(t) ? t.ownerDocument : t.document) || window.document) == null ? void 0 : e.documentElement;
}
function gh(t) {
...
function Ke(t) {
    return di() ? t instanceof HTMLElement || t instanceof ve(t).HTMLElement : !1;
}
function mh(t) {
    return !di() || typeof ShadowRoot > "u" ? !1 : t instanceof ShadowRoot || t instanceof ve(t).ShadowRoot;
}
var zx = new Set(["inline", "contents"]);
function An(t) {
    let { overflow: e, overflowX: n, overflowY: r, display: o } = $e(t);
    return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !zx.has(o);
}
var Hx = new Set(["table", "td", "th"]);
function yh(t) {
    return Hx.has(tn(t));
}
...
var $x = ["transform", "translate", "scale", "rotate", "perspective"],
...
var _x = new Set(["html", "body", "#document"]);
function nn(t) {
    return _x.has(tn(t));
}
function $e(t) {
...
function St(t) {
    ...
    let e = t.assignedSlot || t.parentNode || (mh(t) && t.host) || ot(t);
    return mh(e) ? e.host : e;
}
function xh(t) {
    let e = St(t);
    return nn(e) ? (t.ownerDocument ? t.ownerDocument.body : t.body) : Ke(e) && An(e) ? e : xh(e);
}
function ui(t, e, n) {
    var r;
    ...
    if (i) {
        let l = pi(s);
        return e.concat(s, s.visualViewport || [], An(o) ? o : [], l && n ? ui(l) : []);
    }
...
function En(t) {
    ...
    let n = e.getBoundingClientRect(),
        { width: r, height: o, $: i } = kh(e),
        s = (i ? gr(n.width) : n.width) / r,
        l = (i ? gr(n.height) : n.height) / o;
    return (!s || !Number.isFinite(s)) && (s = 1), (!l || !Number.isFinite(l)) && (l = 1), { x: s, y: l };
}
var jx = _e(0);
function Mh(t) {
    let e = ve(t);
    return !hi() || !e.visualViewport ? jx : { x: e.visualViewport.offsetLeft, y: e.visualViewport.offsetTop };
}
function Kx(t, e, n) {
...
function xr(t, e, n, r) {
    ...
    if (i) {
        ...
        for (; m && r && h !== p; ) {
            ...
            (a *= g.x), (c *= g.y), (u *= g.x), (d *= g.y), (a += x), (c += C), (p = ve(m)), (m = pi(p));
        }
    }
    return wt({ width: u, height: d, x: a, y: c });
}
function Yl(t, e) {
    let n = br(t).scrollLeft;
    return e ? e.left + n : xr(ot(t)).left + n;
}
function vh(t, e, n) {
    n === void 0 && (n = !1);
    let r = t.getBoundingClientRect(),
        o = r.left + e.scrollLeft - (n ? 0 : Yl(t, r)),
        i = r.top + e.scrollTop;
    return { x: o, y: i };
}
function Ux(t) {
    ...
    let a = { scrollLeft: 0, scrollTop: 0 },
        ...
        u = _e(0),
        d = Ke(r);
    if ((d || (!d && !i)) && ((tn(r) !== "body" || An(s)) && (a = br(r)), Ke(r))) {
        let h = xr(r);
        (c = En(r)), (u.x = h.x + r.clientLeft), (u.y = h.y + r.clientTop);
    }
    let f = s && !d && !i ? vh(s, a, !0) : _e(0);
    return {
        width: n.width * c.x,
        height: n.height * c.y,
...
function qx(t) {
    let e = ot(t),
        ...
        s = -n.scrollLeft + Yl(t),
        l = -n.scrollTop;
    return $e(r).direction === "rtl" && (s += fe(e.clientWidth, r.clientWidth) - o), { width: o, height: i, x: s, y: l };
}
function Gx(t, e) {
    let n = ve(t),
        r = ot(t),
...
var Yx = new Set(["absolute", "fixed"]);
function Xx(t, e) {
    let n = xr(t, !0, e === "fixed"),
        r = n.top + t.clientTop,
...
function Th(t, e) {
    let n = St(t);
    return n === e || !Fe(n) || nn(n) ? !1 : $e(n).position === "fixed" || Th(n, e);
}
function Qx(t, e) {
    let n = e.get(t);
    if (n) return n;
    ...
    for (; Fe(s) && !nn(s); ) {
        ...
        !a && l.position === "fixed" && (o = null),
            (i ? !a && !o : (!a && l.position === "static" && !!o && Yx.has(o.position)) || (An(s) && !a && Th(t, s)))
                ? (r = r.filter((u) => u !== s))
                : (o = l),
            (s = St(s));
    }
...
function Zx(t) {
    let { element: e, boundary: n, rootBoundary: r, strategy: o } = t,
        s = [...(n === "clippingAncestors" ? (yr(e) ? [] : Qx(e, this._c)) : [].concat(n)), r],
        l = s[0],
        a = s.reduce(
            (c, u) => {
                let d = wh(e, u, o);
...
var nw = async function (t) {
    let e = this.getOffsetParent || Ah,
        n = this.getDimensions,
        r = await n(t.floating);
    return { reference: tw(t.reference, await e(t.floating), t.strategy), floating: { x: 0, y: 0, width: r.width, height: r.height } };
};
function rw(t) {
...
var Ih = (t, e) => {
        yi(
            ...
            e,
            { placement: "bottom-start", strategy: "absolute", middleware: [mi(), gi()] },
        ).then(({ x: r, y: o, strategy: i }) => {
            (e.style.width = "max-content"), (e.style.position = i), (e.style.left = `${r}px`), (e.style.top = `${o}px`);
        });
    },
    Lh = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
        items: ({ query: n }) => t.filter((r) => r.toLowerCase().replace(/\s/g, "").includes(n.toLowerCase())),
        render: () => {
            let n,
                r = 0,
                o = null,
                ...
                s = () => {
                    ...
                    if (((n.innerHTML = ""), d.length))
                        ...
                        (f.className = "fi-dropdown-header"), (f.textContent = e), n.appendChild(f);
                    }
                },
                l = (d) => {
                    if (!o) return;
            ...
            return {
                onStart: (d) => {
                    (o = d), (r = 0), (n = i()), (n.style.position = "absolute"), s(), document.body.appendChild(n), d.clientRect && Ih(d.editor, n);
                },
                onUpdate: (d) => {
...
var Bh = async ({
    ...
    xd,
    wd,
    Sd.configure({ deleteCustomBlockButtonIconHtml: e, editCustomBlockButtonIconHtml: n, editCustomBlockUsing: r, insertCustomBlockUsing: o }),
    Cd,
    vd,
    Md,
    Td,
    ...
    Nl,
    af.configure({ get$WireUsing: () => d, key: i, statePath: c, uploadingMessage: u }),
    ...(s.length ? [uf.configure({ deleteTriggerWithBackspace: !0, suggestion: Lh({ mergeTags: s, noMergeTagSearchResultsMessage: l }) })] : []),
    Dl,
    df,
    ...
    qf,
    Gf.configure({ types: ["heading", "paragraph"], alignments: ["start", "center", "end", "justify"], defaultAlignment: "start" }),
    Yf,
    gd,
    ...(
        await Promise.all(
            t.map(async (f) => (new RegExp("^(?:[a-z+]+:)?//", "i").test(f) || (f = new URL(f, document.baseURI).href), (await import(f)).default)),
        )
    ).flat(),
];
function iw(t, e) {
...
var sw = class {
        constructor({ editor: t, element: e, view: n, updateDelay: r = 250, resizeDelay: o = 60, shouldShow: i, options: s }) {
            (this.preventHide = !1),
                (this.isVisible = !1),
                ...
                (this.shouldShow = ({ view: l, state: a, from: c, to: u }) => {
                    let { doc: d, selection: f } = a,
                        { empty: h } = f,
                        p = !d.textBetween(c, u).length && ao(a.selection),
                ...
                (this.blurHandler = ({ event: l }) => {
                    ...
                    (l?.relatedTarget && (a = this.element.parentNode) != null && a.contains(l.relatedTarget)) ||
        ...
        get middlewares() {
            let t = [];
            return (
                this.floatingUIOptions.flip && t.push(gi(typeof this.floatingUIOptions.flip != "boolean" ? this.floatingUIOptions.flip : void 0)),
                this.floatingUIOptions.shift && t.push(mi(typeof this.floatingUIOptions.shift != "boolean" ? this.floatingUIOptions.shift : void 0)),
                this.floatingUIOptions.offset &&
                    t.push(Eh(typeof this.floatingUIOptions.offset != "boolean" ? this.floatingUIOptions.offset : void 0)),
                this.floatingUIOptions.arrow && t.push(Dh(this.floatingUIOptions.arrow)),
                this.floatingUIOptions.size && t.push(Nh(typeof this.floatingUIOptions.size != "boolean" ? this.floatingUIOptions.size : void 0)),
                this.floatingUIOptions.autoPlacement &&
                    t.push(Oh(typeof this.floatingUIOptions.autoPlacement != "boolean" ? this.floatingUIOptions.autoPlacement : void 0)),
                this.floatingUIOptions.hide && t.push(Rh(typeof this.floatingUIOptions.hide != "boolean" ? this.floatingUIOptions.hide : void 0)),
                this.floatingUIOptions.inline &&
                    t.push(Ph(typeof this.floatingUIOptions.inline != "boolean" ? this.floatingUIOptions.inline : void 0)),
                t
            );
        }
        updatePosition() {
            let { selection: t } = this.editor.state,
                e = { getBoundingClientRect: () => $u(this.view, t.from, t.to) };
            if (t instanceof K) {
                ...
                if (!s || !l) return;
                let a = s === l ? s.getBoundingClientRect() : iw(s.getBoundingClientRect(), l.getBoundingClientRect());
        ...
        getShouldShow(t) {
            ...
            return (e = this.shouldShow) == null
                ? void 0
                : e.call(this, { editor: this.editor, element: this.element, view: this.view, state: n, oldState: t, from: i, to: s });
        }
        show() {
            var t;
            this.isVisible ||
                ...
                (t = this.view.dom.parentElement) == null || t.appendChild(this.element),
    ...
    Xl = (t) => new N({ key: typeof t.pluginKey == "string" ? new L(t.pluginKey) : t.pluginKey, view: (e) => new sw({ view: e, ...t }) }),
    Cv = $.create({
        name: "bubbleMenu",
        addOptions() {
            return { element: null, pluginKey: "bubbleMenu", updateDelay: void 0, shouldShow: null };
        },
        addProseMirrorPlugins() {
    ...
    return {
        ...
        async init() {
            (y = new rd({
                ...
                extensions: await Bh({
                    ...
                    editCustomBlockUsing: (b, x) =>
                        this.$wire.mountAction(
                            "customBlock",
                            { editorSelection: this.editorSelection, id: b, config: x, mode: "edit" },
                            { schemaComponent: o },
                        ),
                    insertCustomBlockUsing: (b, x = null) =>
                        this.$wire.mountAction("customBlock", { id: b, dragPosition: x, mode: "insert" }, { schemaComponent: o }),
                    key: o,
                    mergeTags: u,
                    noMergeTagSearchResultsMessage: d,
                    placeholder: f,
                ...
                Object.keys(g).forEach((b) => {
                    ...
                    y.registerPlugin(
                        Xl({
                            ...
                            shouldShow: ({ editor: C }) => C.isFocused && C.isActive(b),
                ...
                y.on("update", ({ editor: b }) =>
                    this.$nextTick(() => {
                        (this.editorUpdatedAt = Date.now()),
                            ...
                            s && Alpine.debounce(() => this.$wire.commit(), a ?? 300);
                    }),
                ),
                y.on("selectionUpdate", ({ transaction: b }) => {
                    (this.editorUpdatedAt = Date.now()), (this.editorSelection = b.selection.toJSON());
                }),
                ...
                window.addEventListener("run-rich-editor-commands", (b) => {
                    b.detail.livewireId === c && b.detail.key === o && this.runEditorCommands(b.detail);
                }),
                window.addEventListener("rich-editor-uploading-file", (b) => {
                    b.detail.livewireId === c && b.detail.key === o && ((this.isUploadingFile = !0), b.stopPropagation());
                }),
                window.addEventListener("rich-editor-uploaded-file", (b) => {
                    b.detail.livewireId === c && b.detail.key === o && ((this.isUploadingFile = !1), b.stopPropagation());
                }),
                window.dispatchEvent(new CustomEvent(`schema-component-${c}-${o}-loaded`));
        },
        getEditor() {
            return y;
        },
        ...
        setEditorSelection(b) {
            b &&
                ...
                y
                    .chain()
                    .command(({ tr: x }) => (x.setSelection(E.fromJSON(y.state.doc, this.editorSelection)), !0))
                    .run());
        },
        ...
        isPanelActive(b = null) {
            return b === null ? this.activePanel !== null : this.activePanel === b;
        },
        insertMergeTag(b) {
            y.chain()
                .focus()
